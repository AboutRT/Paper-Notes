...
**[Free-Form Motion Control: Controlling the 6D Poses of Camera and Objects in Video Generation](3d_vision/free-form_motion_control_controlling_the_6d_poses_of_camera_and_objects_in_video.md)**
...
**[PhysSplat: Efficient Physics Simulation for 3D Scenes via MLLM-Guided Gaussian Splatting](3d_vision/physsplat_efficient_physics_simulation_for_3d_scenes_via_mllm-guided_gaussian_sp.md)**
...
**[RealCam-I2V: Real-World Image-to-Video Generation with Interactive Complex Camera Control](3d_vision/realcam-i2v_real-world_image-to-video_generation_with_interactive_complex_camera.md)**
...
**[Self-supervised Learning of Hybrid Part-aware 3D Representations of 2D Gaussians and Superquadrics](3d_vision/self-supervised_learning_of_hybrid_part-aware_3d_representations_of_2d_gaussians.md)**
...
**[EfficientMT: Efficient Temporal Adaptation for Motion Transfer in Text-to-Video Diffusion Models](image_generation/efficientmt_efficient_temporal_adaptation_for_motion_transfer_in_text-to-video_d.md)**
...
**[TIP-I2V: A Million-Scale Real Text and Image Prompt Dataset for Image-to-Video Generation](image_generation/tip-i2v_a_million-scale_real_text_and_image_prompt_dataset_for_image-to-video_ge.md)**
...
**[V.I.P.: Iterative Online Preference Distillation for Efficient Video Diffusion Models](image_generation/vip_iterative_online_preference_distillation_for_efficient_video_diffusion_model.md)**
...
**[MagicDrive-V2: High-Resolution Long Video Generation for Autonomous Driving with Adaptive Control](autonomous_driving/magicdrive-v2_high-resolution_long_video_generation_for_autonomous_driving_with_.md)**
...
**[DualReal: Adaptive Joint Training for Lossless Identity-Motion Fusion in Video Customization](video_understanding/dualreal_adaptive_joint_training_for_lossless_identity-motion_fusion_in_video_cu.md)**
...
**[Free-MoRef: Instantly Multiplexing Context Perception Capabilities of Video-MLLMs within Single Inference](video_understanding/free-moref_instantly_multiplexing_context_perception_capabilities_of_video-mllms.md)**
...
**[Generating, Fast and Slow: Scalable Parallel Video Generation with Video Interface Networks](video_understanding/generating_fast_and_slow_scalable_parallel_video_generation_with_video_interface.md)**
...
**[MotionShot: Adaptive Motion Transfer across Arbitrary Objects for Text-to-Video Generation](video_understanding/motionshot_adaptive_motion_transfer_across_arbitrary_objects_for_text-to-video_g.md)**
...
**[OmniHuman-1: Rethinking the Scaling-Up of One-Stage Conditioned Human Animation Models](video_understanding/omnihuman-1_rethinking_the_scaling-up_of_one-stage_conditioned_human_animation_m.md)**
...
**[SweetTok: Semantic-Aware Spatial-Temporal Tokenizer for Compact Video Discretization](video_understanding/sweettok_semantic-aware_spatial-temporal_tokenizer_for_compact_video_discretizat.md)**
...
**[From Easy to Hard: The MIR Benchmark for Progressive Interleaved Multi-Image Reasoning](human_understanding/from_easy_to_hard_the_mir_benchmark_for_progressive_interleaved_multi-image_reas.md)**
...
**[GUIOdyssey: A Comprehensive Dataset for Cross-App GUI Navigation on Mobile Devices](human_understanding/guiodyssey_a_comprehensive_dataset_for_cross-app_gui_navigation_on_mobile_device.md)**
...
**[HiNeuS: High-fidelity Neural Surface Mitigating Low-texture and Reflective Ambiguity](human_understanding/hineus_high-fidelity_neural_surface_mitigating_low-texture_and_reflective_ambigu.md)**
...
**[OrderChain: Towards General Instruct-Tuning for Stimulating the Ordinal Understanding Ability of MLLM](human_understanding/orderchain_towards_general_instruct-tuning_for_stimulating_the_ordinal_understan.md)**
...
**[SAMO: A Lightweight Sharpness-Aware Approach for Multi-Task Optimization with Joint Global-Local Perturbation](human_understanding/samo_a_lightweight_sharpness-aware_approach_for_multi-task_optimization_with_joi.md)**
...
**[PASG: A Closed-Loop Framework for Automated Geometric Primitive Extraction and Semantic Anchoring in Robotic Manipulation](object_detection/pasg_a_closed-loop_framework_for_automated_geometric_primitive_extraction_and_se.md)**
...
**[SketchSplat: 3D Edge Reconstruction via Differentiable Multi-view Sketch Splatting](object_detection/sketchsplat_3d_edge_reconstruction_via_differentiable_multi-view_sketch_splattin.md)**
...
**[Enhancing Adversarial Transferability by Balancing Exploration and Exploitation with Gradient-Guided Sampling](ai_safety/enhancing_adversarial_transferability_by_balancing_exploration_and_exploitation_.md)**
...
**[Decouple and Track: Benchmarking and Improving Video Diffusion Transformers for Motion Transfer](llm_evaluation/decouple_and_track_benchmarking_and_improving_video_diffusion_transformers_for_m.md)**
...
**[ETVA: Evaluation of Text-to-Video Alignment via Fine-Grained Question Generation and Answering](llm_evaluation/etva_evaluation_of_text-to-video_alignment_via_fine-grained_question_generation_.md)**
...
**[Quantifying and Narrowing the Unknown: Interactive Text-to-Video Retrieval via Uncertainty Minimization](llm_evaluation/quantifying_and_narrowing_the_unknown_interactive_text-to-video_retrieval_via_un.md)**
...
**[PHATNet: A Physics-guided Haze Transfer Network for Domain-adaptive Real-world Image Dehazing](llm_efficiency/phatnet_a_physics-guided_haze_transfer_network_for_domain-adaptive_real-world_im.md)**
...
**[Taming the Untamed: Graph-Based Knowledge Retrieval and Reasoning for MLLMs to Conquer the Unknown](graph_learning/taming_the_untamed_graph-based_knowledge_retrieval_and_reasoning_for_mllms_to_co.md)**
