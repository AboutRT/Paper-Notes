---
title: >-
  ICCV2025 音频/语音方向 10篇论文解读
description: >-
  10篇ICCV2025 音频/语音方向论文深度解读，每篇5分钟读懂核心思想。每篇笔记含一句话总结、背景动机、方法详解、实验数据、亮点洞察与局限性分析。
---
...
**[25 Years In Class A Multimodal Textbook For Visionlanguage P](25_years_in_class_a_multimodal_textbook_for_visionlanguage_p.md)**
...
**[How Would It Sound Material-Controlled Multimodal Acoustic Profile Generation Fo](how_would_it_sound_material-controlled_multimodal_acoustic_profile_generation_fo.md)**
...
**[Lyra An Efficient And Speechcentric Framework For Omnicognit](lyra_an_efficient_and_speechcentric_framework_for_omnicognit.md)**
...
**[Memorytalker Personalized Speech-Driven 3D Facial Animation Via Audio-Guided Sty](memorytalker_personalized_speech-driven_3d_facial_animation_via_audio-guided_sty.md)**

:   提出 MemoryTalker，通过两阶段训练策略（Memorizing + Animating）利用键值记忆网络存储通用面部运动，并通过音频驱动的风格化记忆实现仅凭音频即可生成个性化 3D 面部动画，无需任何额外先验信息。

**[Mug Pseudo Labeling Augmented Audio-Visual Mamba Network For Audio-Visual Video ](mug_pseudo_labeling_augmented_audio-visual_mamba_network_for_audio-visual_video_.md)**
...
**[Zero-Avsr Zero-Shot Audio-Visual Speech Recognition With Llms By Learning Langua](zero-avsr_zero-shot_audio-visual_speech_recognition_with_llms_by_learning_langua.md)**
