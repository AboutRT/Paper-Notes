---
description: "【论文笔记】Text2VDM: Text to Vector Displacement Maps for Expressive and Interactive 3D Sculpting 论文解读 | ICCV 2025 | arXiv 2502.20045 | VDM笔刷生成 | 提出Text2VDM,首个从文本生成VDM雕刻笔刷的框架,通过Sobolev预条件网格变形和语义增强SDS损失解决子对象结构生成中的语义耦合问题。"
tags:
  - ICCV 2025
  - VDM笔刷生成
  - Score Distillation
...
然而现有方法无法生成VDM笔刷:
1. **T2I模型** — VDM不是自然图像,难以直接生成
2. **3D生成方法** — 生成完整对象,无法控制子对象结构
3. **SDS损失的语义耦合** — 生成鹿角时会附带整个鹿头,生成龟壳时会包含龟尾巴
