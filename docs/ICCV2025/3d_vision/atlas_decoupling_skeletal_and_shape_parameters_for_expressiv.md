...
description: >-
  [ICCV 2025][3D视觉][参数化人体模型] 提出ATLAS参数化人体模型，通过显式解耦外部表面形状和内部骨骼参数，并引入稀疏非线性姿态校正变形，在60万高分辨率扫描数据上训练，实现了比SMPL-X更精确、更可控的3D人体建模。
tags:
  - ICCV 2025
  - 3D视觉
  - 参数化人体模型
...
**代码**: [项目主页](https://jindapark.github.io/projects/atlas)  
**领域**: 3D人体建模 / 参数化人体模型  
