---
description: "【论文笔记】4D Visual Pre-training for Robot Learning 论文解读 | ICCV 2025 | arXiv 2508.17230 | 3D点云预训练 | FVP提出了一种基于4D（3D空间+时间）点云预测的视觉预训练框架，通过将预训练目标建模为\"下一帧点云预测\"并用扩散模型实现，显著提升了多种3D模仿学习方法在真实机器人操作任务上的成功率（DP3平均提升28%）。"
tags:
  - ICCV 2025
  - 3D点云预训练
  - 扩散模型
