...
1. **物种多样性**：不同物种（鬣狗、豹子、海龟、鲸鲨）视觉外观和行为差异极大
2. **环境变异性**：从草原到海洋，不同物种栖息环境差异巨大，远非行人 ReID 中相对可控的城市场景
3. **姿态差异**：四足行走（鬣狗/豹子）与水中游泳（海龟/鲸鲨）完全不同于人类双足行走
4. **数据稀缺**：野生环境下数据采集和标注困难，可用数据量远少于行人数据集
