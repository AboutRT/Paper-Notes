...
1. **InterGen/Inter-X**：提供双人交互运动数据集和文本标注，但缺少专业舞蹈动作和同步音频
2. **Duolando (DD100)**：首个双人舞蹈数据集但仅含 1.95 小时数据，且缺少文本标注
3. **InterDance**：3.93 小时双人舞蹈，仍无文本标注
4. **TM2D**：结合文本和音乐但存在数据分布不匹配问题
