...
description: >-
  [ICCV 2025][视频理解][Character Animation] 提出 MikuDance，一种基于扩散模型的角色艺术动画系统，通过 Mixed Motion Modeling（将角色运动和 3D 相机运动统一到像素空间表示）和 Mixed-Control Diffusion（在 Referenc…
tags:
  - "ICCV 2025"
  - "视频理解"
  - "Character Animation"
