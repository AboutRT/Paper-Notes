---
title: >-
  ICCV2025 遥感方向 11篇论文解读
description: >-
  11篇ICCV2025 遥感方向论文深度解读，每篇5分钟读懂核心思想。每篇笔记含一句话总结、背景动机、方法详解、实验数据、亮点洞察与局限性分析。
---
...
**[Geodistill Geometry-Guided Self-Distillation For Weakly Supervised Cross-View Lo](geodistill_geometry-guided_self-distillation_for_weakly_supervised_cross-view_lo.md)**
...
**[Towards A Unified Copernicus Foundation Model For Earth Visi](towards_a_unified_copernicus_foundation_model_for_earth_visi.md)**
