...
description: >-
  [ICCV 2025][LLM预训练] 本文定义了图像内在尺度（IIS）这一新概念——即图像展现最高感知质量的最大缩放比例，并提出 IISA 任务、构建了 785 张图像的数据集，以及基于弱标签的 WIISA 训练策略，在多个 NR-IQA 方法上一致提升了 IIS 预测性能。
tags:
  - ICCV 2025
  - LLM预训练
  - 内在尺度
...
- [\[NeurIPS 2025\] Language Model Behavioral Phases are Consistent Across Architecture, Training Data, and Scale](../../NeurIPS2025/llm_pretraining/lm_behavioral_phases.md)
