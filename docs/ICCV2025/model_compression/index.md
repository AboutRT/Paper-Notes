...
description: >-
  45篇ICCV2025 模型压缩方向论文深度解读，每篇5分钟读懂核心思想。每篇笔记含一句话总结、背景动机、方法详解、实验数据、亮点洞察与局限性分析。
---
...
**[Achieving More With Less Additive Prompt Tuning For Rehearsal-Free Class-Increme](achieving_more_with_less_additive_prompt_tuning_for_rehearsal-free_class-increme.md)**
...
**[Beyond Low-Rank Tuning Model Prior-Guided Rank Allocation For Effective Transfer](beyond_low-rank_tuning_model_prior-guided_rank_allocation_for_effective_transfer.md)**
...
**[Bridging Continuous And Discrete Tokens For Autoregressive V](bridging_continuous_and_discrete_tokens_for_autoregressive_v.md)**
...
**[Color Matching Using Hypernetwork-Based Kolmogorov-Arnold Networks](color_matching_using_hypernetwork-based_kolmogorov-arnold_networks.md)**
...
**[Competitive Distillation A Simple Learning Strategy For Improving Visual Classif](competitive_distillation_a_simple_learning_strategy_for_improving_visual_classif.md)**
...
**[Efficient Adaptation Of Pre-Trained Vision Transformer Underpinned By Approximat](efficient_adaptation_of_pre-trained_vision_transformer_underpinned_by_approximat.md)**
...
**[Generalized Tensor-Based Parameter-Efficient Fine-Tuning Via Lie Group Transform](generalized_tensor-based_parameter-efficient_fine-tuning_via_lie_group_transform.md)**
...
**[Integrating Task-Specific And Universal Adapters For Pre-Trained Model-Based Cla](integrating_task-specific_and_universal_adapters_for_pre-trained_model-based_cla.md)**
...
**[Mixa-Q Revisiting Activation Sparsity For Vision Transformers From A Mixed-Preci](mixa-q_revisiting_activation_sparsity_for_vision_transformers_from_a_mixed-preci.md)**
...
**[Motionfollower Editing Video Motion Via Score-Guided Diffusion](motionfollower_editing_video_motion_via_score-guided_diffusion.md)**
...
**[Partial Forward Blocking A Novel Data Pruning Paradigm For Lossless Training Acc](partial_forward_blocking_a_novel_data_pruning_paradigm_for_lossless_training_acc.md)**
...
**[Soft Separation And Distillation Toward Global Uniformity In Federated Unsupervi](soft_separation_and_distillation_toward_global_uniformity_in_federated_unsupervi.md)**
...
**[Uniconvnet Expanding Effective Receptive Field While Maintaining Asymptotically ](uniconvnet_expanding_effective_receptive_field_while_maintaining_asymptotically_.md)**
