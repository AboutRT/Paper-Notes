...
description: >-
  [ICCV 2025][医学图像][多参数持久同调] 提出 CuMPerLay，一个可微的立方多参数持久同调 (Cubical Multiparameter Persistence, CMP) 向量化层，将 CMP 分解为多条可学习的单参数持久同调线…
tags:
  - "ICCV 2025"
  - "医学图像"
  - "多参数持久同调"
...
**代码**: [circle-group/cumperlay](https://github.com/circle-group/cumperlay)  
**领域**: 医学图像 / 拓扑深度学习  
