...
### 现有挑战
1. **数据稀缺**: 隐私法规、机构间数据碎片化和互操作性限制导致医学影像数据严重不足
2. **解剖保真不足**: 现有方法难以在保持解剖结构准确性的同时建模病理特征
3. **弥散性病理困难**: 肝硬化等弥散性病变涉及多器官系统的细微组织变化，远比肿瘤等局灶性病变复杂
4. **采样效率低**: 传统扩散模型需要50步以上的多步采样，计算开销大
5. **缺少病理控制**: 现有方法无法精细控制合成病理的严重程度
