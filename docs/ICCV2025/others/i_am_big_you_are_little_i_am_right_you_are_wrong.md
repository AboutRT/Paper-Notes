...
description: >-
  [ICCV 2025][Minimal Pixel Sets] 利用因果推理 XAI 工具 rex 提取图像分类模型的最小充分像素集（MPS），系统比较 5 种架构 15 个模型的"注意力集中度"，发现大型模型（EVA/ConvNext）仅用图像 5% 像素即可做出分类…
tags:
  - "ICCV 2025"
  - "Minimal Pixel Sets"
...
- [\[ACL 2025\] BIG-Bench Extra Hard](../../ACL2025/others/big-bench_extra_hard.md)
