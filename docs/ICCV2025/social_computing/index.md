---
title: >-
  ICCV2025 社会计算方向 2篇论文解读
description: >-
  2篇ICCV2025 社会计算方向论文深度解读，每篇5分钟读懂核心思想。每篇笔记含一句话总结、背景动机、方法详解、实验数据、亮点洞察与局限性分析。
---
...
**[Propvg End-To-End Proposal-Driven Visual Grounding With Multi-Granularity Discri](propvg_end-to-end_proposal-driven_visual_grounding_with_multi-granularity_discri.md)**
