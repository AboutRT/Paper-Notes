...
description: >-
  [ICCV 2025][语义分割][无监督动作分割] 提出闭环最优传输（CLOT）框架，通过三级循环特征学习（帧嵌入→段嵌入→交叉注意力精化帧嵌入）联合求解三个OT问题，在帧级和段级表征之间建立显式反馈循环，显著提升无监督动作分割的边界检测和聚类质量。
tags:
  - "ICCV 2025"
  - "语义分割"
  - "无监督动作分割"
...
**代码**: [https://github.com/elenabbbuenob/CLOT](https://github.com/elenabbbuenob/CLOT)  
**领域**: 视频理解/动作分割  
