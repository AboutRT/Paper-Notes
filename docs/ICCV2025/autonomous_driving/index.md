...
**[3D Gaussian Splatting Driven Multiview Robust Physical Adver](3d_gaussian_splatting_driven_multiview_robust_physical_adver.md)**
...
**[3Drealcar An Inthewild Rgbd Car Dataset With 360Degree Views](3drealcar_an_inthewild_rgbd_car_dataset_with_360degree_views.md)**
...
**[4Dsegstreamer Streaming 4D Panoptic Segmentation Via Dual Th](4dsegstreamer_streaming_4d_panoptic_segmentation_via_dual_th.md)**
...
**[6Dopegs Online 6D Object Pose Estimation Using Gaussian Spla](6dopegs_online_6d_object_pose_estimation_using_gaussian_spla.md)**

:   利用2D Gaussian Splatting的高效可微渲染能力，提出一种无需CAD模型的在线6D物体位姿估计与跟踪方法，通过联合优化高斯物体场和关键帧位姿，实现比BundleSDF快约5倍的速度同时保持可比精度。

**[A Constrained Optimization Approach For Gaussian Splatting F](a_constrained_optimization_approach_for_gaussian_splatting_f.md)**

:   提出一种无需SfM的约束优化方法，通过相机位姿分解、灵敏度预调节、对数障碍约束和几何约束，从多相机SLAM系统输出的粗糙位姿和噪声点云中联合优化相机参数与3DGS场景重建。

**[A Constrained Optimization Approach For Gaussian Splatting From Coarsely-Posed I](a_constrained_optimization_approach_for_gaussian_splatting_from_coarsely-posed_i.md)**
...
**[Ad-Gs Object-Aware B-Spline Gaussian Splatting For Self-Supervised Autonomous Dr](ad-gs_object-aware_b-spline_gaussian_splatting_for_self-supervised_autonomous_dr.md)**
...
**[Adaptive Dual Uncertainty Optimization Boosting Monocular 3D](adaptive_dual_uncertainty_optimization_boosting_monocular_3d.md)**

:   提出DUO（Dual Uncertainty Optimization），首个面向单目3D检测（M3OD）的测试时自适应框架，通过共轭焦点损失减少语义不确定性和法线场一致性约束减少几何不确定性，形成互补优化闭环。

**[Adaptive Dual Uncertainty Optimization Boosting Monocular 3D Object Detection Un](adaptive_dual_uncertainty_optimization_boosting_monocular_3d_object_detection_un.md)**
...
**[Cooptrack Exploring End-To-End Learning For Efficient Cooperative Sequential Per](cooptrack_exploring_end-to-end_learning_for_efficient_cooperative_sequential_per.md)**
...
**[Dist-4D Disentangled Spatiotemporal Diffusion With Metric Depth For 4D Driving S](dist-4d_disentangled_spatiotemporal_diffusion_with_metric_depth_for_4d_driving_s.md)**
...
**[Drivex Omni Scene Modeling For Learning Generalizable World Knowledge In Autonom](drivex_omni_scene_modeling_for_learning_generalizable_world_knowledge_in_autonom.md)**
...
**[Embodiedocc Embodied 3D Occupancy Prediction For Vision-Based Online Scene Under](embodiedocc_embodied_3d_occupancy_prediction_for_vision-based_online_scene_under.md)**
...
**[Eta Efficiency Through Thinking Ahead A Dual Approach To Self-Driving With Large](eta_efficiency_through_thinking_ahead_a_dual_approach_to_self-driving_with_large.md)**
...
**[Frequency-Aligned Knowledge Distillation For Lightweight Spatiotemporal Forecast](frequency-aligned_knowledge_distillation_for_lightweight_spatiotemporal_forecast.md)**
...
**[Gaussianflowocc Sparse And Weakly Supervised Occupancy Estimation Using Gaussian](gaussianflowocc_sparse_and_weakly_supervised_occupancy_estimation_using_gaussian.md)**
...
**[Generative Active Learning For Long-Tail Trajectory Prediction Via Controllable ](generative_active_learning_for_long-tail_trajectory_prediction_via_controllable_.md)**
...
**[Gs-Livm Real-Time Photo-Realistic Lidar-Inertial-Visual Mapping With Gaussian Sp](gs-livm_real-time_photo-realistic_lidar-inertial-visual_mapping_with_gaussian_sp.md)**
...
**[Hermes A Unified Self-Driving World Model For Simultaneous 3D Scene Understandin](hermes_a_unified_self-driving_world_model_for_simultaneous_3d_scene_understandin.md)**
...
**[Instinct Instance-Level Interaction Architecture For Query-Based Collaborative P](instinct_instance-level_interaction_architecture_for_query-based_collaborative_p.md)**

:   提出 INSTINCT，一种基于 LiDAR 的实例级交互协作感知框架，通过质量感知过滤、双分支检测路由和跨智能体局部实例融合三个核心模块，在多个数据集上实现 SOTA 性能的同时将通信带宽降低至现有方法的 1/264~1/281。

**[Langtraj Diffusion Model And Dataset For Language-Conditioned Trajectory Simulat](langtraj_diffusion_model_and_dataset_for_language-conditioned_trajectory_simulat.md)**

:   提出 LangTraj，首个在训练阶段直接以自然语言为条件的扩散模型轨迹仿真器，并构建了包含 150K 人工标注交互行为的 InterDrive 数据集，支持语言可控的多智能体交互仿真和安全关键场景生成。

**[Language Driven Occupancy Prediction](language_driven_occupancy_prediction.md)**
...
**[Leveraging 2D Priors And Sdf Guidance For Urban Scene Rendering](leveraging_2d_priors_and_sdf_guidance_for_urban_scene_rendering.md)**
...
**[Leveraging Bev Paradigm For Ground-To-Aerial Image Synthesis](leveraging_bev_paradigm_for_ground-to-aerial_image_synthesis.md)**
...
**[Long-Term Traffic Simulation With Interleaved Autoregressive Motion And Scenario](long-term_traffic_simulation_with_interleaved_autoregressive_motion_and_scenario.md)**
...
**[Mixed Signals A Diverse Point Cloud Dataset For Heterogeneous Lidar V2X Collabor](mixed_signals_a_diverse_point_cloud_dataset_for_heterogeneous_lidar_v2x_collabor.md)**
...
**[Od-Rase Ontology-Driven Risk Assessment And Safety Enhancement For Autonomous Dr](od-rase_ontology-driven_risk_assessment_and_safety_enhancement_for_autonomous_dr.md)**
...
**[Pbcat Patch-Based Composite Adversarial Training Against Physically Realizable A](pbcat_patch-based_composite_adversarial_training_against_physically_realizable_a.md)**
...
**[Recondreamer Harmonizing Generative And Reconstructive Models For Driving Scene ](recondreamer_harmonizing_generative_and_reconstructive_models_for_driving_scene_.md)**
...
**[Resonance Learning To Predict Social-Aware Pedestrian Trajectories As Co-Vibrati](resonance_learning_to_predict_social-aware_pedestrian_trajectories_as_co-vibrati.md)**
...
**[Robust 3D Object Detection Using Probabilistic Point Clouds From Single-Photon L](robust_3d_object_detection_using_probabilistic_point_clouds_from_single-photon_l.md)**
...
**[Sparselanestp Leveraging Spatio-Temporal Priors With Sparse Transformers For 3D ](sparselanestp_leveraging_spatio-temporal_priors_with_sparse_transformers_for_3d_.md)**
...
**[Trackany3D Transferring Pretrained 3D Models For Category-Unified 3D Point Cloud](trackany3d_transferring_pretrained_3d_models_for_category-unified_3d_point_cloud.md)**
...
**[Uniocc A Unified Benchmark For Occupancy Forecasting And Prediction In Autonomou](uniocc_a_unified_benchmark_for_occupancy_forecasting_and_prediction_in_autonomou.md)**
...
**[Unleashing The Temporal Potential Of Stereo Event Cameras For Continuous-Time 3D](unleashing_the_temporal_potential_of_stereo_event_cameras_for_continuous-time_3d.md)**
...
**[World4Drive End-To-End Autonomous Driving Via Intention-Aware Physical Latent Wo](world4drive_end-to-end_autonomous_driving_via_intention-aware_physical_latent_wo.md)**
