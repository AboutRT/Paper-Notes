...
1. **全局-局部信息不平衡**：CNN方法难以学习全局光照分布，Transformer过度关注全局信息导致颜色失真
2. **跨域泛化能力不足**：现有方法通常在特定数据集上训练，面对未知光照条件时性能急剧下降
3. **多问题耦合优化困难**：噪声、颜色失真、细节模糊相互耦合，单一模型难以协同优化——抑制噪声可能牺牲细节，提亮暗区可能放大颜色失真
