...
**代码**: https://github.com/OpenDriveLab/ETA  
**领域**: 自动驾驶  
...
- **做什么**：将大模型在当前帧的计算推迟到前序时间步执行，并通过批量处理多帧使大模型特征在每帧都可用。
...
- **做什么**：用轻量模型处理当前帧，捕捉预测模型无法预见的突变信息。
