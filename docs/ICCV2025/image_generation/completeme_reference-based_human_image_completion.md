---
description: "【论文笔记】CompleteMe: Reference-based Human Image Completion 论文解读 | ICCV 2025 | arXiv 2504.20042 | Image Completion | 提出CompleteMe框架，通过双U-Net架构和Region-focused Attention（RFA）Block，利用参考图像中的细粒度人物细节（衣物纹理、纹身等），实现高保真的参考引导人体图像补全。"
tags:
  - ICCV 2025
  - Image Completion
...
人体图像补全是计算机视觉的重要任务，应用于照片编辑、虚拟试穿、动画等领域。现有方法存在两类问题：

**无参考方法的局限**：
- LOHC、BrushNet等方法能生成合理的人体形状，但无法恢复个人独有细节（如特定衣物花纹、纹身图案、独特配饰）
- 没有参考图像时，这些独特信息无法凭空生成

**参考引导方法的不足**：
- Paint-by-Example、AnyDoor等主要关注物体级别的插入/补全
- MimicBrush等方法在源图像和参考图像姿态差异较大时，难以建立准确的对应关系
- 现有方法无法有效捕捉并整合参考图像中的细粒度细节
