...
1. **总时长不足**：CelebV-HQ 68h、CelebV-Text 279h，远不能满足预训练需求
2. **质量与数量的权衡**：VoxCeleb2 有 2,400h 但分辨率仅 224×224；TalkingHead-1KH 分辨率同样受限
3. **多样性不足**：现有数据集中亚洲人脸严重缺乏，限制了模型在不同种族上的泛化能力
