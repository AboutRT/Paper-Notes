...
1. **绑定特定游戏**：DIAMOND（Atari/CS:GO）、GameNGen（DOOM）、Oasis（Minecraft）都只能在训练过的固定游戏中生成内容
2. **缺乏场景泛化**：无法创造超越现有游戏的新内容——这限制了其作为"创造新游戏"的能力
3. **收集大规模动作标注数据不现实**：对开放域视频进行动作标注成本极高
