...
description: >-
  [NeurIPS 2025][红外可见光融合] 提出 ControlFusion，一种基于语言-视觉退化提示的可控红外-可见光图像融合框架，通过物理驱动的退化成像模型模拟复合退化，并用 prompt-modulated 网络动态恢复+融合，在真实世界和复合退化场景下全面超越 SOTA。
tags:
  - NeurIPS 2025
  - 红外可见光融合
  - 退化恢复
...
**代码**: [https://github.com/Linfeng-Tang/ControlFusion](https://github.com/Linfeng-Tang/ControlFusion)  
**领域**: 图像融合 / 多模态  
...
**核心 idea**：语言提示指定退化类型/程度 + 视觉适配器自动感知退化 → 动态调制特征恢复和融合。
...
1. **物理驱动退化成像模型**:
    ...
    - 功能：为红外/可见光图像分别模拟退化，构建训练数据集 DDL-12（12 种退化 × 4 级程度，约 48,000 训练对）
