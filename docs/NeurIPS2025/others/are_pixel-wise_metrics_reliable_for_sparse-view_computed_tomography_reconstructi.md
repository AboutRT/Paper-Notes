...
**本文目标** 如何可靠评估并保持 CT 重建中的解剖完整性？

**切入角度**：利用在 3151 例 CT 上训练的 nnU-Net 分割器自动评估——NSD 评估紧凑器官表面保真度，clDice 评估管状结构拓扑连续性。

**核心 idea**：用分割器替代像素指标评估 CT 重建，并将分割损失反向传播到扩散模型训练中保护解剖结构。
...
1. **解剖感知指标（NSD + clDice）**
    ...
    - 功能：按类别（大器官/小器官/肠道/血管）分别评估结构完整性。
