---
description: >-
  NeurIPS 2025 Position Paper，通过分析73个公开数据交易案例揭示ML价值链中的"经济数据处理不等式"——技术信号精炼但数据生成者经济权益系统性流失，诊断三个结构性缺陷并提出EDVEX框架构建公平数据交换市场。
tags:
  - NeurIPS 2025
  - 数据市场
  - 数据估值
