---
description: "【论文笔记】MoESD: 揭示稀疏MoE推理中投机解码的潜力 论文解读 | NeurIPS 2025 | arXiv 2505.19645 | 投机解码、稀疏性分析、目标效率、中等批大小、传输效率 | 揭示投机解码在中等批大小下对MoE比对稠密模型更有效，通过目标效率指标捕捉系统级瓶颈，建立可靠的性能建模，达到2.29×加速。"
tags:
  - NeurIPS 2025
  - 投机解码、稀疏性分析、目标效率、中等批大小、传输效率
---
