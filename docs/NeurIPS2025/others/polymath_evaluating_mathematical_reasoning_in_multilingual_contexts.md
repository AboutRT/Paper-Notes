---
description: "【论文笔记】笔记7：价值引导搜索 - 高效链式思考推理 论文解读 | NeurIPS 2025 | arXiv 2504.18428 | 价值模型 | 提出Value-Guided Search(VGS)——通过token级价值模型指导块级束搜索，无需预定义\"步骤\"，相对多数投票在竞赛数学上准确度提升+14.5%，同时推理计算效率提升30%，超越现有PRM方案。"
tags:
  - NeurIPS 2025
  - 价值模型
  - 块级搜索
