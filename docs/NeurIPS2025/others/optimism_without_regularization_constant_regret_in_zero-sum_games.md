...
description: >-
  [NeurIPS 2025][Fictitious Play] 首次证明无正则化的Optimistic Fictitious Play在2×2零和博弈中获得O(1)常数遗憾，匹配了正则化Optimistic FTRL的最优率，同时证明Alternating Fictitious Play的遗憾下界为Ω(√T)…
tags:
  - "NeurIPS 2025"
  - "Fictitious Play"
  - "乐观学习"
