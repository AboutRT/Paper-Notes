...
description: >-
  [NeurIPS 2025][其他] ReSearch框架将搜索操作嵌入推理链中作为第一类原语，通过GRPO强化学习自动学习何时何如搜索，无需任何推理步骤的监督标注，在多跳QA任务上相对基线平均提升15.81%。
tags:
  - NeurIPS 2025
  - 其他
  - GRPO
...
## 研究背景与动机
**多步RAG的困境**：现有方法依赖手工设计启发式策略或繁琐的推理步骤标注，难以扩展到复杂问题

**信息检索的自适应缺陷** ：智能决策"何时搜索、搜什么"通常依靠静态规则或不完美的启发

**RL机遇**：DeepSeek-R1验证纯RL可诱发复杂推理，但无监督情况下如何有效结合外部搜索？

**核心问题**：能否训练LLM自主学会在思考过程中交织搜索操作，无需标注推理链？
