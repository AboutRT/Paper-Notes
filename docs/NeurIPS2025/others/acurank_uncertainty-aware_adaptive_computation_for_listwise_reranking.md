---
description: "【论文笔记】AcuRank: 不确定性感知的自适应计算重排序 论文解读 | NeurIPS 2025 | arXiv 2505.18512 | 不确定性估计、自适应计算、贝叶斯模型、重排序、上下文长度优化 | 通过基于TrueSkill模型的不确定性估计，动态调整重排序子集大小和验证范围，在实现更优精度效率权衡的同时避免过度计算。"
tags:
  - NeurIPS 2025
  - 不确定性估计、自适应计算、贝叶斯模型、重排序、上下文长度优化
---
