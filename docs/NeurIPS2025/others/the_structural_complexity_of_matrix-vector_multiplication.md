---
title: >-
  [论文解读] The Structural Complexity of Matrix-Vector Multiplication
description: >-
  [NeurIPS 2025][矩阵-向量乘法] 证明对于 corrupted VC-dimension 为 $d$ 的布尔矩阵 $\mathbf{M} \in \{0,1\}^{m \times n}$，矩阵-向量乘法可在 $\widetilde{O}(nm^{1-1/d}+m)$ 时间内完成…
tags:
  - "NeurIPS 2025"
  - "矩阵-向量乘法"
  - "VC维"
