---
description: 提出FAST前景感知扩散框架，通过AIAS加速采样和FARM前景重建模块实现高效高质量的工业异常分割合成
tags:
- anomaly-detection
- diffusion-model
