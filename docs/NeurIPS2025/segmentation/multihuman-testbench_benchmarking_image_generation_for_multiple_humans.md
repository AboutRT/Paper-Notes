...
description: >-
  [NeurIPS 2025][语义分割][多人图像生成] 提出 MultiHuman-Testbench，首个系统性评估多人图像生成的基准，包含 1800 个测试样本配对 5550 张人脸图像，以及基于匈牙利匹配的身份相似度等多维度评估指标，并提出区域隔离和隐式匹配技术提升现有方法性能。
tags:
  - "NeurIPS 2025"
  - "语义分割"
  - "多人图像生成"
...
- [\[ICML 2025\] Sounding that Object: Interactive Object-Aware Image to Audio Generation](../../ICML2025/segmentation/sounding_that_object_interactive_object-aware_image_to_audio_generation.md)
