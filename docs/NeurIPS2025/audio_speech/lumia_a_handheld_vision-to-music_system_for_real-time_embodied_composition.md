...
description: >-
  [NeurIPS 2025][音频/语音][视觉转音乐] 提出Lumia——一个手持相机式设备，通过GPT-4 Vision分析拍摄画面生成结构化提示，再由Stable Audio合成音乐循环段，实现从视觉到音乐的实时、具身化即兴创作工作流。
tags:
  - "NeurIPS 2025"
  - "音频/语音"
  - "视觉转音乐"
...
**本文目标**：如何将多模态生成AI嵌入物理设备中，使视觉场景成为音乐素材来源，实现环境感知的即兴创作？
