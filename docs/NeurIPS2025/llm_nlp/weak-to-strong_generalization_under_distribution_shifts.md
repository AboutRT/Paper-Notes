...
description: >-
  [NeurIPS 2025][LLM/NLP][弱到强泛化] 本文发现朴素的弱到强泛化在分布偏移下会失败（强模型甚至不如弱监督者），并提出 RAVEN 框架，通过动态学习多个弱模型的最优组合权重来实现鲁棒的弱到强泛化，在 OOD 任务上超越 baseline 超过 30%。
tags:
  - "NeurIPS 2025"
  - "LLM/NLP"
  - "弱到强泛化"
...
- [\[ACL 2025\] ConsistencyChecker: Tree-based Evaluation of LLM Generalization Capabilities](../../ACL2025/llm_nlp/consistencychecker_tree_evaluation.md)
...
- [\[ACL 2025\] Circuit Stability Characterizes Language Model Generalization](../../ACL2025/llm_nlp/circuit_stability_characterizes_language_model_generalization.md)
