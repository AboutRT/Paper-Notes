---
description: "AttentionPredictor首次用学习型时序预测器直接预测注意力模式进行KV缓存压缩，统一预测模型仅21KB可跨层共享，实现13倍压缩和5.6倍加速。"
tags: [KV-cache, LLM-inference, attention-prediction, cache-compression, efficient-inference]
---
