---
description: 提出SynTSBench合成数据评估范式，通过可编程特征配置系统评估时间序列预测模型在趋势、周期、鲁棒性等维度的能力
tags:
- time-series
- benchmark
- forecasting
