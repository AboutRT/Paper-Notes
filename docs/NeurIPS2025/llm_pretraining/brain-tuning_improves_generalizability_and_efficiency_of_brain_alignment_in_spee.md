...
description: >-
  [NEURIPS2025][LLM预训练][brain-tuning] 提出 Multi-brain-tuning 方法，通过联合多个被试的 fMRI 数据微调预训练语音模型，将脑对齐所需数据量降低 5 倍，同时脑对齐度提升最高 50%，并可泛化到全新被试和数据集。
tags:
  - NEURIPS2025
  - LLM预训练
  - brain-tuning
...
- [\[ICML 2025\] Tokenized Bandit for LLM Decoding and Alignment](../../ICML2025/llm_pretraining/tokenized_bandit_for_llm_decoding_and_alignment.md)
