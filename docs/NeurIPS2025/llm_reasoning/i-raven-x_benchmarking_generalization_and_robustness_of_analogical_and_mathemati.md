...
description: >-
  [NeurIPS 2025][LLM推理][abstract reasoning] 提出 I-RAVEN-X，一个增强版的符号化推理基准，通过增加操作数复杂度、属性范围和感知不确定性来评估 LLM 和 LRM 的类比推理与数学推理的泛化能力和鲁棒性，发现 LRM 在确定性推理上显著优于 LLM…
tags:
  - "NeurIPS 2025"
  - "LLM推理"
  - "abstract reasoning"
...
**代码**: [GitHub](https://github.com/IBM/raven-large-language-models)  
**领域**: LLM推理  
...
**本文目标** 构建一个可参数化的、更具挑战性的推理基准，系统评估 LLM 和 LRM 在泛化（更长推理链、更大属性范围）和鲁棒性（感知不确定性）上的表现。

**切入角度**: 在 I-RAVEN 基础上沿四个维度扩展——生产力、系统性、混淆因子鲁棒性、值分布鲁棒性。

**核心 idea**: RPM 推理不仅要测"做对了没有"，还要测"推理链变长/值域变大/加入噪声后还能不能做对"。
...
- [\[ACL 2025\] Chain-of-Reasoning: Towards Unified Mathematical Reasoning in Large Language Models](../../ACL2025/llm_reasoning/chain_of_reasoning_unified_math.md)
