...
description: >-
  [NeurIPS 2025][LLM推理][test-time scaling] 提出 Atom of Thoughts (AoT)，将 LLM 推理建模为马尔可夫链，每个状态是与原问题答案等价但复杂度递减的自包含子问题，通过 DAG 分解+收缩的两阶段转移机制消除历史依赖，可与 ToT/反思等方法无缝集成…
tags:
  - "NeurIPS 2025"
  - "LLM推理"
  - "test-time scaling"
...
**代码**: 随论文提交（将公开）  
**领域**: LLM推理  
**关键词**: test-time scaling, Markov process, atomic reasoning, DAG decomposition, reasoning framework
