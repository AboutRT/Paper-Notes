...
**[Adaptive Dual Reasoner Large Reasoning Models Can Think Efficiently By Hybrid Re](adaptive_dual_reasoner_large_reasoning_models_can_think_efficiently_by_hybrid_re.md)**
...
**[Are Large Reasoning Models Good Translation Evaluators Analysis And Performance ](are_large_reasoning_models_good_translation_evaluators_analysis_and_performance_.md)**
...
**[Atom Of Thoughts For Markov Llm Testtime Scaling](atom_of_thoughts_for_markov_llm_testtime_scaling.md)**
...
**[Beyond Chemical Qa Evaluating Llms Chemical Reasoning With Modular Chemical Oper](beyond_chemical_qa_evaluating_llms_chemical_reasoning_with_modular_chemical_oper.md)**
...
**[Cot Redhanded Stress Testing Chainofthought Monitoring](cot_redhanded_stress_testing_chainofthought_monitoring.md)**
...
**[Disco Reinforcing Large Reasoning Models With Discriminative Constrained Optimiz](disco_reinforcing_large_reasoning_models_with_discriminative_constrained_optimiz.md)**
...
**[I-Raven-X Benchmarking Generalization And Robustness Of Analogical And Mathemati](i-raven-x_benchmarking_generalization_and_robustness_of_analogical_and_mathemati.md)**
...
**[Is Chain-Of-Thought Reasoning Of Llms A Mirage A Data Distribution Lens](is_chain-of-thought_reasoning_of_llms_a_mirage_a_data_distribution_lens.md)**

:   通过构建完全可控的抽象环境DataAlchemy，本文揭示CoT推理是一种幻觉——其有效性完全由训练数据分布主导，在分布外场景表现极其脆弱。

**[Know What You Dont Know Uncertainty Calibration Of Process Reward Models](know_what_you_dont_know_uncertainty_calibration_of_process_reward_models.md)**
...
**[Let Me Think A Long Chainofthought Can Be Worth Exponentiall](let_me_think_a_long_chainofthought_can_be_worth_exponentiall.md)**
...
**[Realmath A Continuous Benchmark For Evaluating Language Models On Research-Level](realmath_a_continuous_benchmark_for_evaluating_language_models_on_research-level.md)**

:   提出 RealMath，一个从 arXiv 论文和 Math StackExchange 中自动提取可验证数学问题的**可持续刷新**基准，用于评估 LLM 在真实研究级数学任务上的能力。

**[Reasonfluxprm Trajectoryaware Prms For Long Chainofthought R](reasonfluxprm_trajectoryaware_prms_for_long_chainofthought_r.md)**
...
**[Reasoning By Superposition A Theoretical Perspective On Chain Of Continuous Thou](reasoning_by_superposition_a_theoretical_perspective_on_chain_of_continuous_thou.md)**
...
**[Reasoning Models Hallucinate More Factuality-Aware Reinforcement Learning For La](reasoning_models_hallucinate_more_factuality-aware_reinforcement_learning_for_la.md)**
...
**[Rethinking Optimal Verification Granularity For Compute-Efficient Test-Time Scal](rethinking_optimal_verification_granularity_for_compute-efficient_test-time_scal.md)**
...
**[Sampling-Efficient Test-Time Scaling Self-Estimating The Best-Of-N Sampling In E](sampling-efficient_test-time_scaling_self-estimating_the_best-of-n_sampling_in_e.md)**
...
**[Segment Policy Optimization Effective Segment-Level Credit Assignment In Rl For ](segment_policy_optimization_effective_segment-level_credit_assignment_in_rl_for_.md)**

:   提出SPO框架，采用段级（而非令牌级或轨迹级）的advantage估计，通过新颖的蒙特卡洛方法和树形采样，在短CoT和长CoT场景下分别超越PPO和GRPO 6-12和7-11个百分点。

**[Self-Evaluating Llms For Multi-Step Tasks Stepwise Confidence Estimation For Fai](self-evaluating_llms_for_multi-step_tasks_stepwise_confidence_estimation_for_fai.md)**

:   PolyMath构建的18语言、4难度级、500问题数学推理基准揭露：(1)推理性能跨语言差异达10分，(2)推理模型输入-输出语言一致性低且可能影响性能，(3)思考长度在语言间显著不一致，为多语言推理研究提供新视角。

**[Smaller Models Smarter Rewards A Two-Sided Approach To Process And Outcome Rewar](smaller_models_smarter_rewards_a_two-sided_approach_to_process_and_outcome_rewar.md)**
...
**[Sql-R1 Training Natural Language To Sql Reasoning Model By Reinforcement Learnin](sql-r1_training_natural_language_to_sql_reasoning_model_by_reinforcement_learnin.md)**
...
**[Stop Summation Minform Credit Assignment Is All Process Rewa](stop_summation_minform_credit_assignment_is_all_process_rewa.md)**
...
**[The Illusion Of Thinking Understanding The Strengths And Limitations Of Reasonin](the_illusion_of_thinking_understanding_the_strengths_and_limitations_of_reasonin.md)**
...
**[Transformers Provably Learn Chain-Of-Thought Reasoning With Length Generalizatio](transformers_provably_learn_chain-of-thought_reasoning_with_length_generalizatio.md)**
...
**[Two-Stage Learning Of Stabilizing Neural Controllers Via Zubov Sampling And Iter](two-stage_learning_of_stabilizing_neural_controllers_via_zubov_sampling_and_iter.md)**
