...
description: >-
  [NeurIPS 2025][LLM安全][Text-to-SQL] 提出 MaskSQL 框架，通过提示抽象（abstraction）将敏感的表名、列名和数据值替换为抽象符号后发送给远程 LLM，结合本地 SLM 做 schema linking 和 SQL 重建…
tags:
  - "NeurIPS 2025"
  - "LLM安全"
  - "Text-to-SQL"
...
**代码**: [https://github.com/sepideh-abedini/MaskSQL](https://github.com/sepideh-abedini/MaskSQL)  
**领域**: AI 安全 / 隐私保护  
