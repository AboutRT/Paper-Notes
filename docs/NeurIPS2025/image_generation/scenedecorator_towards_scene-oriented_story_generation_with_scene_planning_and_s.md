...
1. **场景规划缺失**：现有方法仅依赖文本描述生成场景，缺乏场景级别的叙事连贯性。同一个故事的不同场景之间缺乏语义关联
2. **场景一致性未探索**：在电影故事板等实际应用中，需要在同一场景下生成不同剧情的多个故事，但现有方法无法保持跨故事的场景一致性
3. **角色单一化**：过度关注角色一致性导致生成的主体风格趋同，缺乏多样性
