---
title: >-
  NeurIPS2025 图像生成方向 242篇论文解读
description: >-
  242篇NeurIPS2025 图像生成论文解读，主题涵盖：DFloat11 利用 BFloat16、发现扩散模型在自消耗循环（用生成数据训练下一代模型、证明去噪得分匹配损失（denoising等，每篇含核心思想与方法详解。
---

<!-- 由 src/gen_blog_index.py 自动生成 -->
# 🎨 图像生成

**🧠 NeurIPS2025** · **242** 篇论文解读
