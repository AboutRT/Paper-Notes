...
description: >-
  [NeurIPS 2025][图像生成][RGB-热红外翻译] 提出 ThermalGen，一种基于 Flow 的自适应生成模型，通过 RGB 图像条件化架构和风格解耦机制，首次实现了跨视角、跨传感器、跨环境条件的高保真 RGB-to-Thermal 图像翻译…
tags:
  - "NeurIPS 2025"
  - "图像生成"
  - "RGB-热红外翻译"
...
**完美对齐**：合成热图像与原始 RGB 图像具有像素级对应，适合稠密特征匹配等精细任务

**规模化扩展**：可利用海量公开 RGB 数据，远超硬件采集的 RGB-T 配对规模

**多样性模拟**：从单张 RGB 输入模拟不同热特性和环境条件，增强下游模型鲁棒性
