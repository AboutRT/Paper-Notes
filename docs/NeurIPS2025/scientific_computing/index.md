...
description: >-
  22篇NeurIPS2025 科学计算方向论文深度解读，每篇5分钟读懂核心思想。每篇笔记含一句话总结、背景动机、方法详解、实验数据、亮点洞察与局限性分析。
---
...
**[Deltaphi Physical States Residual Learning For Neural Operators In Data-Limited ](deltaphi_physical_states_residual_learning_for_neural_operators_in_data-limited_.md)**
...
**[F-Adapter Frequency-Adaptive Parameter-Efficient Fine-Tuning In Scientific Machi](f-adapter_frequency-adaptive_parameter-efficient_fine-tuning_in_scientific_machi.md)**
...
**[From Black Hole To Galaxy Neural Operator Framework For Accretion And Feedback D](from_black_hole_to_galaxy_neural_operator_framework_for_accretion_and_feedback_d.md)**
...
**[Multi-Trajectory Physics-Informed Neural Networks For Hjb Equations With Hard-Ze](multi-trajectory_physics-informed_neural_networks_for_hjb_equations_with_hard-ze.md)**
...
**[Neural Emulator Superiority When Machine Learning For Pdes Surpasses Its Trainin](neural_emulator_superiority_when_machine_learning_for_pdes_surpasses_its_trainin.md)**
...
**[One-Shot Transfer Learning For Nonlinear Pdes With Perturbative Pinns](one-shot_transfer_learning_for_nonlinear_pdes_with_perturbative_pinns.md)**
...
**[Physics-Informed Neural Networks With Fourier Features And Attention-Driven Deco](physics-informed_neural_networks_with_fourier_features_and_attention-driven_deco.md)**
...
**[Stable Minima Of Relu Neural Networks Suffer From The Curse Of Dimensionality Th](stable_minima_of_relu_neural_networks_suffer_from_the_curse_of_dimensionality_th.md)**
...
**[Symbolic Regression Is All You Need From Simulations To Scaling Laws In Binary N](symbolic_regression_is_all_you_need_from_simulations_to_scaling_laws_in_binary_n.md)**
