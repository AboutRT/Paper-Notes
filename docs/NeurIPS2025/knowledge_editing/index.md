---
title: >-
  NeurIPS2025 知识编辑方向 6篇论文解读
description: >-
  6篇NeurIPS2025 知识编辑方向论文深度解读，每篇5分钟读懂核心思想。每篇笔记含一句话总结、背景动机、方法详解、实验数据、亮点洞察与局限性分析。
---
...
**[Memoir Lifelong Model Editing With Minimal Overwrite And Informed Retention For ](memoir_lifelong_model_editing_with_minimal_overwrite_and_informed_retention_for_.md)**
