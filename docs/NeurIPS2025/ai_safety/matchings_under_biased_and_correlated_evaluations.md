...
4. **公平性干预的 Pareto 前沿**
    ...
    - 功能：给定当前参数 $(\beta_0, \gamma_0)$ 和目标公平性 $\tau$，寻找最小成本的干预组合
