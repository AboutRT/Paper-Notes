---
description: "【论文笔记】Matchings Under Biased and Correlated Evaluations 论文解读 | NeurIPS 2025 | arXiv 2510.23628 | stable matching | 在两机构稳定匹配模型中引入评估相关性参数 $\gamma$（机构间评分的对齐程度），分析偏差 $\beta$ 和相关性 $\gamma$ 如何联合影响弱势群体的代表性比率，证明即使轻微的相关性损失也可导致代表性急剧下降，并提出公平性干预策略的 Pareto 前沿。"
tags:
  - NeurIPS 2025
  - stable matching
  - bias
