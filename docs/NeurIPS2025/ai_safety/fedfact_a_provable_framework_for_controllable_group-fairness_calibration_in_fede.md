...
description: >-
  [NeurIPS 2025][AI安全][联邦学习] 提出FedFACT框架，通过刻画联邦学习下的**贝叶斯最优公平分类器**结构，将公平联邦学习分别在训练中（in-processing）化归为**个性化代价敏感学习**、在训练后（post-processing）化归为**双层优化**…
tags:
  - "NeurIPS 2025"
  - "AI安全"
  - "联邦学习"
...
**领域现状**: 联邦学习日益应用于医疗、金融等高风险决策领域，需要保证对敏感群体（如性别、种族）的组间公平性。FL中存在两种公平性概念：**全局公平性**（跨所有客户端的整体模型差异）和**局部公平性**（每个客户端内部的差异）。
