...
**代码**: [https://github.com/Jeffateth/Biased_Oracle](https://github.com/Jeffateth/Biased_Oracle)  
**领域**: 医学AI / LLM评估  
...
**领域现状**：LLM 在医疗诊断准确率上已接近甚至超越人类医生，但诊断沟通的质量——患者能否理解、是否感受到被关心——很少被系统评估。

**现有痛点**：现有评估聚焦于准确率/安全性，忽略了以患者为中心的沟通质量。医疗建议的可读性直接影响患者依从性——超过 8 年级阅读水平会导致大量患者无法理解。

**核心矛盾**：LLM 生成的医疗文本可能对高教育人群清晰有用，但对低教育/特定文化背景的患者构成理解障碍。不同人口群体是否得到平等质量的沟通未知。

**本文目标** 系统量化 LLM 医疗沟通的可读性和共情水平，检测人口统计维度（年龄/性别/地域/教育）上的偏差。

**切入角度**：设计 156 个合成提示（人口统计 × 诊断场景），用 5 种可读性指标 + 情感/认知共情双维评估框架，配合 LLM-as-Judge 和人类评注者进行交叉验证。

**核心 idea**：用 156 个合成场景 × 双重评估框架（可读性+共情）× LLM-as-Judge 交叉验证，系统揭示 LLM 医疗沟通中的可读性超标和共情偏差。
