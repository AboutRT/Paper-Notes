...
**本文目标**：在不牺牲任务性能的前提下，让 LLM 系统性地偏好更可靠、更易调试的工具，使最终解决方案对人类用户更加透明可控。
...
- **功能**：推理时让 LLM 生成最多 4 个候选解决方案，每个方案由一系列顺序工具调用组成
...
- **功能**：设计包含成本公式说明和 5 个示例解法的详细 prompt
...
- **功能**：构建含 1,300 个问题的 benchmark，涵盖 13 种问题模板、3 个难度级别、2 个外部数据集
