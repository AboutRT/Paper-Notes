...
description: >-
  [NeurIPS 2025][机器人][embodied agent] 提出 LabUtopia——面向科学实验室的高保真仿真与层级基准套件，包含支持化学反应建模的 LabSim 仿真器、可程序化生成实验室场景的 LabScene、以及从原子操作到长程移动操纵的五级 LabBench 基准…
tags:
  - "NeurIPS 2025"
  - "机器人"
  - "embodied agent"
...
**核心 idea**：高保真化学反应仿真 + 程序化实验室场景生成 + 五级层级基准 = 科学具身AI的完整测试台
