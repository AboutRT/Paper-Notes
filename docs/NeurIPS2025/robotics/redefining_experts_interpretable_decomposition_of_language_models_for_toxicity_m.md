...
1. **神经元激活不稳定**：单个神经元的AUROC多在0.50-0.55之间，几乎等同随机分类器。当AUROC阈值从0.50提高到0.55时，BERT中"专家"神经元比例从11.13%骤降至3.68%
2. **检测vs生成的混淆**：现有方法将"毒性检测专家"和"毒性生成专家"混为一谈。抑制检测专家会导致模型丧失识别毒性的能力，引发灾难性遗忘
3. **激进干预破坏流畅性**：Det-0方法虽将毒性降至0%，但困惑度从6.23飙升至43517，TPH得分仅0.03%
