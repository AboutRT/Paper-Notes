...
description: >-
  [NeurIPS 2025][模型压缩][搜索策略学习] 提出 Guided-ReST，通过将最优解作为子目标逐步融入模型自生成的搜索轨迹中，生成高质量训练数据并蒸馏更高效的搜索策略，在Countdown和代码自修复任务上显著提升搜索效率和准确率。
tags:
  - NeurIPS 2025
  - 模型压缩
  - 搜索策略学习
...
- [\[ICLR 2026\] Is Finer Better? The Limits of Microscaling Formats in Large Language Models](../../ICLR2026/model_compression/is_finer_better_the_limits_of_microscaling_formats_in_large_language_models.md)
