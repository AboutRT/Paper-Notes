...
description: >-
  [NeurIPS 2025][模型压缩][持续学习] 提出Perturb-and-Merge (P&M)框架，将模型合并机制引入持续学习范式：训练时沿任务向量方向添加随机扰动以平滑损失面，推理时通过闭式最优系数对历史模型和当前任务模型做凸组合合并，结合LoRA实现内存高效的SOTA持续学习性能。
tags:
  - NeurIPS 2025
  - 模型压缩
  - 持续学习
...
- [LIFT the Veil for the Truth: Principal Weights Emerge after Rank Reduction for Reliable Model Merging](../../ICML2025/model_compression/lift_the_veil_for_the_truth_principal_weights_emerge_after_rank_reduction_for_re.md)
