...
description: >-
  [NeurIPS 2025][模型压缩][车辆路径问题] 提出 **State-Decomposable MDP (SDMDP)** 框架将多种 VRP 变体重新表述为基础状态空间的笛卡尔积…
tags:
  - "NeurIPS 2025"
  - "模型压缩"
  - "车辆路径问题"
...
**现有痛点**：专用神经求解器需要为每种VRP变体从头训练，成本极高；统一求解器虽然能同时处理多种变体，但未能充分利用VRP变体的**组合结构**——每种变体都由共享的基础VRP变体派生。
