...
description: >-
  [NeurIPS 2025][图学习][图神经网络] 从理论上揭示了 GNN 消息传递中平滑性（smoothness）与泛化性（generalization）之间的两难困境，提出 IGNN 框架通过三个简约设计原则（分离邻域变换、感知聚合、邻域关系学习）缓解该困境…
tags:
  - "NeurIPS 2025"
  - "图学习"
  - "图神经网络"
...
**代码**: [https://github.com/galogm/IGNN](https://github.com/galogm/IGNN)  
**领域**: 图学习 / 节点分类  
