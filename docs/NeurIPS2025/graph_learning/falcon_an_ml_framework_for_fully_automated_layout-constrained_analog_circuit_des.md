...
description: >-
  [NeurIPS 2025][图学习][模拟电路设计] FALCON 提出端到端的模拟/RF 电路自动化设计框架，通过 MLP 拓扑选择 + 边中心 GNN 性能预测 + 可微版图约束梯度推理三阶段流水线，在 100 万级 Cadence 仿真数据集上实现 >99% 拓扑选择准确率、&lt;10% 性能预测误差…
tags:
  - "NeurIPS 2025"
  - "图学习"
  - "模拟电路设计"
...
**代码**: [https://github.com/AsalMehradfar/FALCON](https://github.com/AsalMehradfar/FALCON)  
**领域**: 图学习  
