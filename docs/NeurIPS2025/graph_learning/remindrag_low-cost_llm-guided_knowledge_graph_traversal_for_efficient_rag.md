---
description: "【论文笔记】ReMindRAG: Low-Cost LLM-Guided Knowledge Graph Traversal for Efficient RAG 论文解读 | NeurIPS 2025 | arXiv 2510.13193 | 知识图谱 | 提出ReMindRAG，一种结合LLM引导的KG遍历（节点探索+利用）与无训练记忆重放机制的KG-RAG系统，将LLM遍历经验存储在边嵌入中，在后续相似查询时显著减少LLM调用次数（约50%成本降低），同时提升回答准确率（5%-10%提升）。"
tags:
  - NeurIPS 2025
  - 知识图谱
  - RAG
