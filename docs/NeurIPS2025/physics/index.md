...
description: >-
  18篇NeurIPS2025 物理学方向论文深度解读，每篇5分钟读懂核心思想。每篇笔记含一句话总结、背景动机、方法详解、实验数据、亮点洞察与局限性分析。
---
...
**[Knowledge Is Overrated A Zero-Knowledge Machine Learning And Cryptographic Hashi](knowledge_is_overrated_a_zero-knowledge_machine_learning_and_cryptographic_hashi.md)**
...
**[Titan A Trajectory-Informed Technique For Adaptive Parameter Freezing In Large-S](titan_a_trajectory-informed_technique_for_adaptive_parameter_freezing_in_large-s.md)**
