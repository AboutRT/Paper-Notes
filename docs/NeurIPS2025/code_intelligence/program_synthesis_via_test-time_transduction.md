...
1. **有限假设类的构建**：
    ...
    - 功能：将候选程序转化为 test inputs 上输出的 N-tuple 集合
...
2. **Greedy Maximin 查询选择**：
    ...
    - 功能：选择"最有区分力"的 test input 来查询 LLM
...
3. **LLM 转导预测（伪标签）**：
    ...
    - 功能：给定 test input 和候选输出集合，让 LLM 选择正确输出
