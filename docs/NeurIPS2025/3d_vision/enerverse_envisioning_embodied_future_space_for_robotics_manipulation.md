...
description: >-
  [NeurIPS 2025][3D视觉][embodied AI] EnerVerse 是一个生成式机器人基础模型，通过 chunk-wise 自回归视频扩散 + 稀疏上下文记忆 + 多视角生成先验构建 4D 具身空间，结合 4DGS 数据飞轮缩小 Sim2Real 差距…
tags:
  - "NeurIPS 2025"
  - "3D视觉"
  - "embodied AI"
...
- [\[CVPR 2025\] 3D-Mem: 3D Scene Memory for Embodied Exploration and Reasoning](../../CVPR2025/3d_vision/3d-mem_3d_scene_memory_for_embodied_exploration_and_reasoning.md)
