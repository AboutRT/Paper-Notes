...
- [SegmentDreamer: Towards High-Fidelity Text-to-3D Synthesis with Segmented Consistency Trajectory Distillation](../../ICCV2025/3d_vision/segmentdreamer_towards_high-fidelity_text-to-3d_synthesis_with_segmented_consist.md)
- [DreamView: Injecting View-specific Text Guidance into Text-to-3D Generation](../../ECCV2024/3d_vision/dreamview_injecting_view-specific_text_guidance_into_text-to-3d_generation.md)
- [DreamScene360: Unconstrained Text-to-3D Scene Generation with Panoramic Gaussian Splatting](../../ECCV2024/3d_vision/dreamscene360_unconstrained_text-to-3d_scene_generation_with_panoramic_gaussian_.md)
- [On Denoising Walking Videos for Gait Recognition](../../CVPR2025/3d_vision/on_denoising_walking_videos_for_gait_recognition.md)
- [Turbo3D: Ultra-Fast Text-to-3D Generation](../../CVPR2025/3d_vision/turbo3d_ultra-fast_text-to-3d_generation.md)
