---
description: "【论文笔记】Pixel-Perfect Depth with Semantics-Prompted Diffusion Transformers 论文解读 | NeurIPS 2025 | arXiv 2510.07316 | 单目深度估计 | 提出Pixel-Perfect Depth——在像素空间（而非潜空间）直接做扩散生成的单目深度估计模型，通过语义提示DiT（SP-DiT）引入视觉基础模型的高层语义表示和级联DiT设计，生成无飞点（flying-pixel-free）的深度图，在五个benchmark上超越所有已发表的生成式模型。"
tags:
  - NeurIPS 2025
  - 单目深度估计
  - 像素空间扩散
