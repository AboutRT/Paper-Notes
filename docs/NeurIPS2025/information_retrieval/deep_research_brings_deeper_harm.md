...
description: >-
  [NeurIPS 2025][信息检索/RAG][deep research agent] 揭示 Deep Research (DR) 智能体的严重安全隐患——即使底层 LLM 能正确拒绝有害请求，部署为 DR 智能体后仍能生成详细专业的危险报告…
tags:
  - "NeurIPS 2025"
  - "信息检索/RAG"
  - "deep research agent"
