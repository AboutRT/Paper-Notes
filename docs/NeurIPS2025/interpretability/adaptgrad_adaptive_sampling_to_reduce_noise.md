...
- [LANTERN: Modeling User Behavior from Adaptive Surveys with Supplemental Context](../../ICML2025/interpretability/modeling_user_behavior_from_adaptive_surveys_with_supplemental_context.md)
- [Reallocating Attention Across Layers to Reduce Multimodal Hallucination](../../CVPR2026/interpretability/reallocating_attention_reduce_hallucination.md)
