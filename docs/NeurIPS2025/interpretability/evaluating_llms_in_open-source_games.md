...
description: >-
  [NeurIPS 2025][可解释性][博弈论] 通过开源游戏（智能体提交程序而非原始行动）这一新范式，系统评估 LLM 在战略推理、互相学习和合作博弈中的能力，发现 LLM 可自动发现近似程序平衡。
tags:
  - "NeurIPS 2025"
  - "可解释性"
  - "博弈论"
...
**本文目标** 利用代码透明性设计评估框架，研究 LLM 的战略推理和合作涌现。

**切入角度**：开源游戏——推翻"黑箱"限制，让智能体交换源代码，在已知对手策略的基础上推理。

**核心 idea**：通过 SPARC 基准（代码理解）+ 开源博弈（动态战略）+ 进化分析（长期稳定性）的三层递进研究 LLM 的策略推理。
...
2. **开源博弈实验**:
    ...
    - 功能：二人对战，agent 提交 Python 程序而非直接动作
