...
description: >-
  [NeurIPS 2025][优化][SAM] 通过线性稳定性分析框架，证明了"平坦极小值⇒好泛化"和"SGD偏好简单函数"是同一枚硬币的两面——数据一致性(coherence)同时控制着两者，且SAM通过更严格的稳定性条件进一步放大了简单性偏好。
tags:
  - NeurIPS 2025
  - 优化
  - SAM
...
**代码**: [https://github.com/changwk1001/Stability_Analysis_and_Simplicity-Bias.git](https://github.com/changwk1001/Stability_Analysis_and_Simplicity-Bias.git)  
**领域**: 优化理论  
