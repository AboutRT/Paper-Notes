---
description: "【论文笔记】Extragradient Method for (L₀, L₁)-Lipschitz Root-finding Problems 论文解读 | NeurIPS 2025 | arXiv 2510.22421 | Extragradient方法 | 本文在 α-对称 (L₀,L₁)-Lipschitz 条件下（放松经典 L-Lipschitz 假设）为 extragradient (EG) 方法提出自适应步长策略 γₖ = 1/(c₀ + c₁|F(xₖ)|^α)，建立了强单调（线性收敛）、单调（次线性收敛）和 weak Minty（局部收敛）三类根问题的首个完整收敛保证。"
tags:
  - NeurIPS 2025
  - Extragradient方法
  - $(L_0
