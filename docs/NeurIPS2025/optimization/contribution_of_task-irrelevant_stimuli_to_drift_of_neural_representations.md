...
description: >-
  [NeurIPS 2025][优化/理论][representational drift] 理论证明在线学习中任务无关刺激的统计特性（方差和维度）是表示漂移的重要驱动因素，在 Oja 规则、Similarity Matching、自编码器和监督两层网络中均观察到漂移率 $D \propto \lambda_\…
tags:
  - "NeurIPS 2025"
  - "优化/理论"
...
1. **SDE 分解框架**
    ...
    - 功能：将学习后的参数动力学近似为连续时间随机微分方程，分解为解流形的法向和切向分量
...
3. **学习噪声 vs 突触噪声的几何区分**
    ...
    - 功能：对比学习噪声（来自在线采样随机性）和高斯突触噪声（$\varepsilon_{ij} \sim \mathcal{N}(0, \eta\sigma^2_{syn})$）诱导的漂移特征
