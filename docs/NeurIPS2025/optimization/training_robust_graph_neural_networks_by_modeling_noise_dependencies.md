---
description: "【论文笔记】Training Robust Graph Neural Networks by Modeling Noise Dependencies 论文解读 | NeurIPS 2025 | arXiv 2502.19670 | 图神经网络鲁棒性 | 提出依赖感知图噪声(DANG)和DA-GNN框架，通过建模节点特征噪声→图结构噪声→标签噪声的因果依赖链，利用变分推断推导ELBO来训练对多源协同噪声鲁棒的GNN。"
tags:
  - NeurIPS 2025
  - 图神经网络鲁棒性
  - 噪声依赖
