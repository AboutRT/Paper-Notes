---
title: >-
  [论文解读] Diffusion Model as a Noise-Aware Latent Reward Model for Step-Level Preference Optimization
description: >-
  [NeurIPS 2025][LLM对齐][扩散模型] 提出 Latent Reward Model (LRM) 和 Latent Preference Optimization (LPO)，将预训练扩散模型本身复用为噪声感知的潜空间奖励模型，在噪声潜在空间直接进行步级偏好优化…
tags:
  - "NeurIPS 2025"
  - "LLM对齐"
  - "扩散模型"
...
- [\[CVPR 2025\] InPO: Inversion Preference Optimization with Reparametrized DDIM for Efficient Diffusion Model Alignment](../../CVPR2025/llm_alignment/inpo_inversion_preference_optimization_diffusion_alignment.md)
