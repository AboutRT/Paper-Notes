...
description: >-
  [NeurIPS 2025][多语言/翻译][Preference Dataset] NVIDIA 发布的 40K+ 开源人工标注偏好数据集，覆盖通用/STEM/代码/多语言（13 种语言），训练的奖励模型在 RM-Bench 上达 82.4%（+10%），CC-BY-4.0 许可对商业友好。
tags:
  - "NeurIPS 2025"
  - "多语言/翻译"
  - "Preference Dataset"
...
**本文目标**：构建涵盖 STEM/Code/Multilingual 的高质量、宽许可、大规模偏好数据集。

**切入角度**：聘请具备专业背景的标注者（科学家、工程师、多语言流利者），分层质量控制。

**核心 idea**：专家分层标注 + 多领域多语言覆盖 + CC-BY-4.0 = 最全面的开源偏好数据集。
