---
description: "【论文笔记】Sample-Efficient Tabular Self-Play for Offline Robust Reinforcement Learning 论文解读 | NeurIPS 2025 | arXiv 2512.00352 | offline RL | 提出 RTZ-VI-LCB 算法用于离线鲁棒两人零和 Markov 博弈（RTZM G），通过乐观鲁棒值迭代 + Bernstein 风格惩罚，实现近最优样本复杂度 $O(C_r^* \cdot H^4 \cdot S \cdot (A+B) / \varepsilon^2)$，较此前最优结果 $O(H^5 \cdot S^2 \cdot AB / \varepsilon^2)$ 在状态空间和动作空间依赖上均有显著改善。"
tags:
  - NeurIPS 2025
  - offline RL
  - robust MDP
