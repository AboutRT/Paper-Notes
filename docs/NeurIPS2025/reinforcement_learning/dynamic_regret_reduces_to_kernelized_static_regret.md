---
description: "【论文笔记】Dynamic Regret Reduces to Kernelized Static Regret 论文解读 | NeurIPS 2025 | arXiv 2507.05478 | dynamic regret | 将动态遗憾最小化问题重新建模为再生核希尔伯特空间(RKHS)中的静态遗憾问题，通过精心设计平移不变核实现最优路径长度依赖 widetildeO(sqrtMP_TT)，且天然不需要时间范围先验知识。"
tags:
  - NeurIPS 2025
  - dynamic regret
