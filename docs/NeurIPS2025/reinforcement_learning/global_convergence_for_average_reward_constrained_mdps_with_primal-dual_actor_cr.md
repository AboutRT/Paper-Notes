---
description: "【论文笔记】Global Convergence for Average Reward Constrained MDPs with Primal-Dual Actor-Critic 论文解读 | NeurIPS 2025 | arXiv 2505.15138 | 约束MDP | 提出Primal-Dual Natural Actor-Critic（PDNAC）算法，首次在一般参数化策略下的平均奖励约束MDP中实现 tildeO(1/sqrtT) 的全局收敛率和约束违反率，匹配理论下界。"
tags:
  - NeurIPS 2025
  - 约束MDP
  - 平均奖励
