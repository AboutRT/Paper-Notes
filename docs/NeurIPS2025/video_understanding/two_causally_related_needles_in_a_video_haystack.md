---
description: >-
  [NeurIPS2025][视频理解][因果推理] 提出Causal2Needles长视频理解基准，评估VLM从长视频中提取两个因果相关事件并联合推理的能力，通过桥接实体设计强制模型进行双针检索，揭示现有模型在因果二针问题上的严重不足。
tags: [NeurIPS2025, 视频理解, 因果推理, 长视频, 基准测试, VLM, needle-in-haystack]
---
...
**本文要解决什么**: 构建一个同时评估双针联合理解能力和因果推理能力的长视频理解基准。

**切入角度**: 利用电影摘要视频中的因果事件对，通过"桥接实体"设计强制模型必须先检索效果事件才能定位原因事件。

**核心idea一句话**: 用模糊化的桥接实体将双针问题变成不可分解的联合推理任务，防止退化为两个独立的单针问题。
...
1. **桥接实体驱动的双针问题设计**:
    ...
    - 做什么：设计一种问题结构，强制模型必须联合理解原因事件和效果事件
