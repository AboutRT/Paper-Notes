---
description: >-
  NeurIPS2025论文提出DanmakuTPPBench，首个多模态时间点过程基准：DanmakuTPP-Events基于B站弹幕构建7250个序列共1080万事件的时间-文本-视频联合数据集，DanmakuTPP-QA通过5个专业化Agent协作自动生成10类时序-视觉-文本推理问答，系统评估经典TPP模型和MLLM，暴露现有方法在多模态事件动态理解上的显著短板。
tags:
  - NeurIPS 2025
...
1. **DanmakuTPP-Events数据集构建**:
    - 做什么：从B站2024年Top 100创作者的所有视频中收集弹幕数据，构建首个三模态TPP数据集
...
2. **DanmakuTPP-QA多智能体构建Pipeline**:
    - 做什么：自动构建10类评估任务（8闭合题+2开放题），涵盖时间预测、情感分析、事件归因等
