---
description: "【论文笔记】Unified Reinforcement and Imitation Learning for Vision-Language Models 论文解读 | NeurIPS 2025 | arXiv 2510.19307 | VLM蒸馏 | 提出 RIL（Unified Reinforcement and Imitation Learning）训练框架，结合 GRPO 强化学习和 GAIL 对抗模仿学习，让小型 VLM（7B）通过学习大型 VLM（72B）的文本生成风格来大幅提升性能，无需增加推理延迟或\"思考\"过程。"
tags:
  - NeurIPS 2025
  - VLM蒸馏
  - 强化学习
...
**现有策略及痛点**：
1. **模型规模扩大**：GPT-4o、Qwen2.5-VL-72B 等效果好但无法在手机、AR设备上部署
2. **Think-Answer 范式**：DeepSeek-R1 等通过长思维链显著提升推理能力，但推理延迟和计算开销大幅增加
3. **架构修改**：增加多视觉编码器等，改变推理流程，部署灵活性降低
4. **传统知识蒸馏**：基于特征距离的蒸馏在高维空间中效果有限
