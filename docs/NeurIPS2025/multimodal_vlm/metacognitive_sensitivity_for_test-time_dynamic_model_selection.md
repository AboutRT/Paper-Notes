...
1. **领域现状**：深度学习日益专门化——CNN 擅长视觉感知、Transformer/LLM 主导 NLP、VLM 融合跨模态。No Free Lunch 定理决定了没有单一架构对所有问题最优，引出**动态模型选择**需求。
...
4. **本文思路**：将 meta-d' 从诊断工具提升为**功能性信号**，嵌入 bandit 选择框架中，实现测试时自适应模型选择。
