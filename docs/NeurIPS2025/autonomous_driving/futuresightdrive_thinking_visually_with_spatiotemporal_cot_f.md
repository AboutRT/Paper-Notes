---
description: 提出FSDrive框架，用视觉时空CoT替代文本CoT实现自动驾驶轨迹规划的视觉推理
tags:
- NEURIPS2025
- 自动驾驶
- chain-of-thought
...
现有VLA自动驾驶模型大多使用文本CoT（如场景描述、坐标文字）作为推理中间步骤，但存在关键问题：
...
1. **视觉时空CoT**:
    - 做什么：生成一张融合了多种未来信息的统一图像帧作为推理中间步骤
