...
description: >-
  [ECCV 2024][LLM/NLP][Tool-Augmented LLM] 提出 ControlLLM 框架，通过任务分解、Thoughts-on-Graph (ToG) 图搜索范式和执行引擎三大组件，让 LLM 在预构建的工具图上搜索最优解决方案路径，准确高效地调用多模态工具完成复杂任务，在困难任务上达到 93% 的解决方案成功率。
tags:
  - ECCV 2024
  - LLM/NLP
  - Tool-Augmented LLM
...
**代码**: [https://github.com/OpenGVLab/ControlLLM](https://github.com/OpenGVLab/ControlLLM)  
**领域**: LLM/NLP  
