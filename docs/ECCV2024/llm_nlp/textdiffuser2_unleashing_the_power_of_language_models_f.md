...
description: >-
  [ECCV 2024][LLM/NLP][文本渲染] TextDiffuser-2 利用两个语言模型（一个用于布局规划、一个用于布局编码）实现灵活自动的文本渲染，克服了现有方法在灵活性、布局能力和样式多样性方面的局限。
tags:
  - ECCV 2024
  - LLM/NLP
  - 文本渲染
...
**代码**: [https://aka.ms/textdiffuser-2](https://aka.ms/textdiffuser-2)  
**领域**: LLM/NLP  
