...
description: >-
  [ECCV 2024][LLM/NLP][zero-shot recognition] 提出 MPVR（Meta-Prompting for Visual Recognition），通过两阶段元提示策略自动让 LLM 生成任务特定且类别特定的 VLM 提示，在 20 个数据集上将 CLIP 零样本识别提升最高 19.8%，完全消除人工提示设计。
tags:
  - ECCV 2024
  - LLM/NLP
...
**代码**: [https://github.com/jmiemirza/Meta-Prompting](https://github.com/jmiemirza/Meta-Prompting)  
**领域**: LLM/NLP  
