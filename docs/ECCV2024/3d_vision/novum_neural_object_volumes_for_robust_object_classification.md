...
**代码**: [https://github.com/GenIntel/NOVUM](https://github.com/GenIntel/NOVUM)  
**领域**: 3D视觉  
...
1. **3D 高斯神经物体体积**:
    ...
    - 功能：为每个类别定义约 1100 个 3D 高斯，均匀分布在立方体表面，形成类别级 3D 表征
...
2. **三层对比学习损失**:
    ...
    - 功能：用 vMF 分布建模特征匹配概率，通过三层对比确保特征判别性
...
3. **无几何快速分类推理**:
    ...
    - 功能：分类时丢弃 3D 空间结构，仅用高斯特征与图像特征做卷积式匹配
...
- [\[ECCV 2024\] D-SCo: Dual-Stream Conditional Diffusion for Monocular Hand-Held Object Reconstruction](d-sco_dual-stream_conditional_diffusion_for_monocular_hand-held_object_reconstru.md)
