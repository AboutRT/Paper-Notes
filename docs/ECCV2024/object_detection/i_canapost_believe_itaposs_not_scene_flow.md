...
**代码**: https://github.com/kylevedder/BucketedSceneFlowEval  
**领域**: 自动驾驶 / 3D视觉  
...
- [Rectified-CFG++ for Flow Based Models](../../NeurIPS2025/object_detection/rectified-cfg_for_flow_based_models.md)
