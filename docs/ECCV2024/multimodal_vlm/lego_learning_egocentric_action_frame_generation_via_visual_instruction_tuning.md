...
description: >-
  [ECCV 2024][图像生成] 提出第一人称视角动作帧生成新问题，通过视觉指令微调 VLLM 生成丰富动作描述并将其嵌入作为扩散模型的额外条件，实现高质量的自我中心动作图像合成。
tags:
  - ECCV 2024
  - 图像生成
---
...
在技能传递场景中，LLM 生成的文字指导不够直观，而人脑处理图像远快于文字。本文提出 **自我中心动作帧生成** 新问题：给定第一人称图像和动作文本查询，合成展示该动作执行过程的图像。
