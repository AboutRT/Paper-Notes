...
description: >-
  [ECCV 2024][多模态][图像地址定位] AddressCLIP 定义了"图像地址定位"(IAL) 新任务，提出端到端框架通过图像-文本对齐（图像↔地址/场景描述的对比学习）和图像-地理匹配（流形学习约束特征空间距离与地理距离一致）直接预测图像拍摄的可读文本地址，在自建的 Pittsburgh 和 San Francisco 数据集上优于现有 VLM 迁移方法。
tags:
  - ECCV 2024
  - 多模态
  - 图像地址定位
...
**代码**: [https://github.com/xsx1001/AddressCLIP](https://github.com/xsx1001/AddressCLIP)  
**领域**: 多模态VLM / 地理定位  
...
3. **IAL 数据集构建**:
    ...
    - 功能：从 Pittsburgh 和 San Francisco 构建三个不同规模的 IAL 专用数据集
