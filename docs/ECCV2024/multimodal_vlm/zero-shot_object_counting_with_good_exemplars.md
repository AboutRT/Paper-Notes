...
**代码**: [GitHub](https://github.com/HopooLinZ/VA-Count)  
**领域**: 多模态VLM  
...
- [\[ECCV 2024\] LayoutDETR: Detection Transformer Is a Good Multimodal Layout Designer](layoutdetr_detection_transformer_is_a_good_multimodal_layout_designer.md)
