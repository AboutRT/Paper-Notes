...
description: >-
  [ECCV 2024][人体理解][视频异常检测] 提出一个将加权单类分类 (wOCC) 与弱监督 (WS) 模型交替训练的无监督视频异常检测框架，通过软标签缓解训练波动、自适应阈值策略逐步优化分割阈值，无需任何人工标注即可实现接近弱监督方法的性能。
tags:
  - ECCV 2024
  - 人体理解
  - 视频异常检测
...
- [\[ECCV 2024\] Self-supervised Feature Adaptation for 3D Industrial Anomaly Detection](selfsupervised_feature_adaptation_for_3d_industrial_ano.md)
