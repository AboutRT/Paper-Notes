...
description: >-
  [ECCV 2024][语义分割][数据增强] 提出一种基于预训练扩散模型的实例级数据增强方法，通过在保持原始标注不变的前提下逐个重绘图像中的目标实例，显著提升了显著性目标检测、语义分割和目标检测的性能，同时支持数据匿名化。
tags:
  - "ECCV 2024"
  - "语义分割"
  - "数据增强"
...
**代码**: [https://github.com/kupynorest/instance-augmentation](https://github.com/kupynorest/instance-augmentation)  
**领域**: 图像分割  
