---
title: >-
  ECCV2024 语义分割方向 57篇论文解读
description: >-
  57篇ECCV2024 语义分割方向论文深度解读，每篇5分钟读懂核心思想。每篇笔记含一句话总结、背景动机、方法详解、实验数据、亮点洞察与局限性分析。
---
...
**[Frest Feature Restoration For Semantic Segmentation Under Multiple Adverse Condi](frest_feature_restoration_for_semantic_segmentation_under_multiple_adverse_condi.md)**
...
**[Learning From The Web Language Drives Weakly-Supervised Incremental Learning For](learning_from_the_web_language_drives_weakly-supervised_incremental_learning_for.md)**

:   首次提出完全使用网络图像（而非精心设计的数据集图像）进行弱监督增量语义分割，通过傅里叶域判别器筛选网络图像 + caption 驱动的 rehearsal 策略保持旧类知识，在 PASCAL VOC 15-5 设定下达到 73.4% mIoU。

**[Lift A Surprisingly Simple Lightweight Feature Transform For Dense Vit Descripto](lift_a_surprisingly_simple_lightweight_feature_transform_for_dense_vit_descripto.md)**
...
**[Occlusion-Aware Seamless Segmentation](occlusion-aware_seamless_segmentation.md)**
...
**[Olaf A Plug-And-Play Framework For Enhanced Multi-Object Multi-Part Scene Parsin](olaf_a_plug-and-play_framework_for_enhanced_multi-object_multi-part_scene_parsin.md)**
...
**[Udifftext A Unified Framework For High-Quality Text Synthesis In Arbitrary Image](udifftext_a_unified_framework_for_high-quality_text_synthesis_in_arbitrary_image.md)**
