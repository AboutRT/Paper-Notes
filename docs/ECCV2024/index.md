...
title: >-
  ECCV2024 879篇论文解读
description: >-
  879篇ECCV2024论文解读，涵盖3D视觉(174篇)、图像生成(108篇)、人体理解(57篇)、自动驾驶(53篇)等40个方向，每篇含核心思想、方法详解与实验分析。
---
...
**[Approaching Outside: Scaling Unsupervised 3D Object Detection from 2D Scene](3d_vision/approaching_outside_scaling_unsupervised_3d_object_detection_from_2d_scene.md)**
...
**[Weakly Supervised 3D Object Detection via Multi-Level Visual Guidance](3d_vision/weakly_supervised_3d_object_detection_via_multi-level_visual_guidance.md)**
...
**[Controlling the World by Sleight of Hand](human_understanding/controlling_the_world_by_sleight_of_hand.md)**
...
**[GiT: Towards Generalist Vision Transformer through Universal Language Interface](human_understanding/git_towards_generalist_vision_transformer_through_universal_language_interface.md)**
...
**[QUAR-VLA: Vision-Language-Action Model for Quadruped Robots](robotics/quar-vla_vision-language-action_model_for_quadruped_robots.md)**
...
**[Evaluating Text-to-Visual Generation with Image-to-Text Generation](nlp_generation/evaluating_text-to-visual_generation_with_image-to-text_generation.md)**
...
**[Facial Affective Behavior Analysis with Instruction Tuning](llm_alignment/facial_affective_behavior_analysis_with_instruction_tuning.md)**
