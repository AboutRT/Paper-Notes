...
description: >-
  [ECCV 2024][视频理解][Egocentric Video] 提出 AMEGO，一种从长第一人称视频中在线构建结构化"活跃记忆"的方法，通过 HOI tracklet + 位置分段 + 语义无关的视觉查询…
tags:
  - "ECCV 2024"
  - "视频理解"
  - "Egocentric Video"
...
**本文目标** (a) 构建不依赖语义标签的长视频结构化表示；(b) 支持语义无关的视觉查询

**切入角度**：模仿人的情景记忆——在线处理视频，只记录物体交互和位置变换，构建轻量的"活跃记忆"

**核心 idea**：用 HOI 检测器 + 单目标跟踪器 + DINOv2 特征在线构建手-物体交互 tracklets 和位置分段，形成可查询的语义无关结构化记忆
