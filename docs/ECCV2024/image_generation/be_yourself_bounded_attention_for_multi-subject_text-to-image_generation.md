...
description: >-
  [ECCV 2024][图像生成][多主体生成] 提出 Bounded Attention，一种无需训练的注意力约束方法，通过在去噪过程中限制 cross-attention 和 self-attention 的信息流动来解决多主体文本到图像生成中的语义泄漏问题。
tags:
  - ECCV 2024
  - 图像生成
  - 多主体生成
...
- [\[ECCV 2024\] AnyControl: Create Your Artwork with Versatile Control on Text-to-Image Generation](anycontrol_create_your_artwork_with_versatile_control_on_tex.md)
