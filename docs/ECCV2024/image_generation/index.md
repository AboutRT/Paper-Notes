---
title: >-
  ECCV2024 图像生成方向 109篇论文解读
description: >-
  109篇ECCV2024 图像生成方向论文深度解读，每篇5分钟读懂核心思想。每篇笔记含一句话总结、背景动机、方法详解、实验数据、亮点洞察与局限性分析。
---

<!-- 由 src/gen_blog_index.py 自动生成 -->
# 🎨 图像生成

**🎞️ ECCV2024** · **109** 篇论文解读
...
**[Dreamdiffusion High-Quality Eeg-To-Image Generation With Temporal Masked Signal ](dreamdiffusion_high-quality_eeg-to-image_generation_with_temporal_masked_signal_.md)**
...
**[Eta Inversion Designing An Optimal Eta Function For Diffusion-Based Real Image E](eta_inversion_designing_an_optimal_eta_function_for_diffusion-based_real_image_e.md)**
...
**[Lego Learning To Disentangle And Invert Personalized Concepts Beyond Object Appe](lego_learning_to_disentangle_and_invert_personalized_concepts_beyond_object_appe.md)**

:   提出Lego方法，通过主体分离和上下文损失实现超越外观的个性化概念（如形容词、动词）的解纠缠与反演，用于扩散模型的个性化内容生成。

**[Linearly Controllable Gan Unsupervised Feature Categorization And Decomposition ](linearly_controllable_gan_unsupervised_feature_categorization_and_decomposition_.md)**
...
**[Panofree Tuning-Free Holistic Multi-View Image Generation With Cross-View Self-G](panofree_tuning-free_holistic_multi-view_image_generation_with_cross-view_self-g.md)**
...
**[Probabilistic Weather Forecasting With Deterministic Guidance-Based Diffusion Mo](probabilistic_weather_forecasting_with_deterministic_guidance-based_diffusion_mo.md)**
...
**[Stable Preference Redefining Training Paradigm Of Human Preference Model For Tex](stable_preference_redefining_training_paradigm_of_human_preference_model_for_tex.md)**

:   重新定义了文本到图像生成中人类偏好模型的训练范式，通过引入质量感知的margin机制和抗干扰损失函数，解决了传统交叉熵训练中"相似质量图像对的盲目惩罚"和"对视觉扰动不鲁棒"两大问题，在主流人类偏好数据集上取得了SOTA性能。

**[Styletokenizer Defining Image Style By A Single Instance For Controlling Diffusi](styletokenizer_defining_image_style_by_a_single_instance_for_controlling_diffusi.md)**
...
**[Textual-Visual Logic Challenge Understanding And Reasoning In Text-To-Image Gene](textual-visual_logic_challenge_understanding_and_reasoning_in_text-to-image_gene.md)**
...
**[You Only Need One Step Fast Super-Resolution With Stable Diffusion Via Scale Dis](you_only_need_one_step_fast_super-resolution_with_stable_diffusion_via_scale_dis.md)**
