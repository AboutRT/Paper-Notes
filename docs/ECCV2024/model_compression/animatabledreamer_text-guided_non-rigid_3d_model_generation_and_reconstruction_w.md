...
description: >-
  [ECCV 2024][模型压缩][Text-to-4D] 提出 AnimatableDreamer，通过 Canonical Score Distillation (CSD) 技术，从单目视频提取骨骼和运动后生成文本引导的可动画化 3D 非刚体模型，在生成质量和时序一致性上全面超越现有方法。
tags:
  - "ECCV 2024"
  - "模型压缩"
  - "Text-to-4D"
...
**代码**: [https://zz7379.github.io/AnimatableDreamer/](https://zz7379.github.io/AnimatableDreamer/)  
**领域**: 模型压缩  
