...
1. **视角剧烈变化**：地面相机约2米高，UAV飞行高度20-60米，俯仰角度差异巨大
2. **分辨率差异悬殊**：地面相机中行人宽度10-70像素，UAV中仅5-35像素
3. **严重的自遮挡**：从空中俯拍时行人的外观信息大量丢失，传统时序建模方法反而性能下降
4. **视觉对齐困难**：跨平台间的视觉特征对齐远比同平台困难
...
2. **Video Set-Level-Adapter (VSLA)**：
   ...
   做什么：参数高效地将预训练图像基础模型适配到视频ReID任务。
