---
description: "【论文笔记】Relative Error Fair Clustering in the Weak-Strong Oracle Model 论文解读 | ICML 2025 | arXiv 2506.12287 | 公平聚类 | 提出首个在弱强预言机模型下实现 (1+ε) 逼近的公平 k-median 聚类算法，仅需 poly(k log n / ε) 次昂贵的强预言机查询，相比此前大于 10 的常数因子逼近有根本性提升。"
tags:
  - ICML 2025
  - 公平聚类
  - 弱强预言机
