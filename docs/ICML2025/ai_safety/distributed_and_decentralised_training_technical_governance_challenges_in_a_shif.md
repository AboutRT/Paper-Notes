...
description: >-
  [ICML 2025][AI安全][分布式训练] 本文系统区分了分布式训练（multi-data centre）与去中心化训练（community-driven）两种新兴范式，分析了低通信训练算法（如 DiLoCo）如何使这两种范式成为可能…
tags:
  - "ICML 2025"
  - "AI安全"
  - "分布式训练"
...
- [\[NeurIPS 2025\] CTRL-ALT-DECEIT: Sabotage Evaluations for Automated AI R&D](../../NeurIPS2025/ai_safety/ctrl-alt-deceit_sabotage_evaluations_for_automated_ai_rd.md)
