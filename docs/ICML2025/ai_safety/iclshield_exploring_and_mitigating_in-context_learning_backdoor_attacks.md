...
**代码**: 无  
**领域**: AI安全  
**关键词**: 后门攻击, 上下文学习, 大语言模型安全, 潜在概念, 防御机制
...
1. **机制理解缺乏**：现有研究（ICLAttack、BadChain 等）主要验证攻击有效性，但未揭示攻击如何影响模型输出的内在机理
2. **防御方法空白**：传统后门防御（Anti-Backdoor Learning、ONION、Back-Translation 等）主要针对数据投毒或模型投毒，对不修改模型参数的 ICL 攻击效果有限
