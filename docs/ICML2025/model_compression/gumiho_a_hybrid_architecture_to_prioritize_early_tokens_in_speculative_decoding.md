...
description: >-
  [ICML 2025][模型压缩][推测解码] 提出 Gumiho，一种用于推测解码的混合 draft 模型架构：前两个 token 使用串行 Transformer 以确保精度，后续 token 使用并行 MLP heads 以提升效率，并通过 Full Tree Attention 机制进一步增加接受长度…
tags:
  - "ICML 2025"
  - "模型压缩"
  - "推测解码"
