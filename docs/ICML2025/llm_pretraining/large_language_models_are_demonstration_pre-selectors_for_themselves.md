...
description: >-
  [ICML 2025][预训练][in-context learning] 提出 FEEDER（FEw yet Essential Demonstration prE-selectoR），一个基于"充分性"和"必要性"度量的示例预选框架，利用 LLM 自身能力从训练数据中识别代表性子集…
tags:
  - "ICML 2025"
  - "预训练"
  - "in-context learning"
...
**代码**: 无  
**领域**: LLM预训练  
**关键词**: in-context learning, demonstration selection, data pre-selection, sufficiency & necessity, bilevel optimization
