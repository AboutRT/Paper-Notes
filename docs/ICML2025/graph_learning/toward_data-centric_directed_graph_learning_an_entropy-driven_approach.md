...
1. **拓扑感知的有向结构度量与粗粒度 HKT 构建**:
    ...
    - 做什么：基于有向图的信息熵量化拓扑不确定性，构建初始层级知识树
