---
description: >-
  PiPE统一位置编码与持续同调用于图学习，理论证明两者互不可比，新方法可证明更具表达力，在分子预测/图分类/OOD等任务上全面提升。
tags:
  - ICML2025
  - 图学习
  - 位置编码
...
1. **PE-驱动的持续同调计算**:
    - 做什么：利用可学习位置编码作为节点颜色，构建 vertex-color 过滤函数来计算持续图
