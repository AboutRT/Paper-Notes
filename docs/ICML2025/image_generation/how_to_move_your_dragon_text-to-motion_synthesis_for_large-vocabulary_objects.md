...
description: >-
  [ICML2025][图像生成][motion synthesis] 本文首次提出一个统一框架，通过为 Truebones Zoo 数据集（70+ 物种）标注文本描述、引入 rig augmentation 技术以及在 Motion Diffusion Model 中融入 TreePE 和 RestPE 编码…
tags:
  - "ICML2025"
  - "图像生成"
  - "motion synthesis"
