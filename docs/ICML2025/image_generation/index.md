---
title: >-
  ICML2025 图像生成方向 114篇论文解读
description: >-
  114篇ICML2025 图像生成方向论文深度解读，每篇5分钟读懂核心思想。每篇笔记含一句话总结、背景动机、方法详解、实验数据、亮点洞察与局限性分析。
---
...
**[All-Atom Diffusion Transformers Unified Generative Modelling Of Molecules And Ma](all-atom_diffusion_transformers_unified_generative_modelling_of_molecules_and_ma.md)**
...
**[Angle Domain Guidance Latent Diffusion Requires Rotation Rather Than Extrapolati](angle_domain_guidance_latent_diffusion_requires_rotation_rather_than_extrapolati.md)**
...
**[Annealing Flow Generative Models Towards Sampling High-Dimensional And Multi-Mod](annealing_flow_generative_models_towards_sampling_high-dimensional_and_multi-mod.md)**
...
**[Beyond Bradley-Terry Models A General Preference Model For Language Model Alignm](beyond_bradley-terry_models_a_general_preference_model_for_language_model_alignm.md)**
...
**[Binauralflow A Causal And Streamable Approach For High-Quality Binaural Speech S](binauralflow_a_causal_and_streamable_approach_for_high-quality_binaural_speech_s.md)**

:   提出 BinauralFlow，一个基于条件 Flow Matching 的流式双耳语音合成框架，通过因果 U-Net 架构和连续推理管线实现高保真、可流式生成的双耳音频，感知测试中 42% 的混淆率表明生成结果几乎无法与真实录音区分。

**[Bridge Bootstrapping Text To Control Time-Series Generation Via Multi-Agent Iter](bridge_bootstrapping_text_to_control_time-series_generation_via_multi-agent_iter.md)**
...
**[Diffusion-Vla Generalizable And Interpretable Robot Foundation Model Via Self-Ge](diffusion-vla_generalizable_and_interpretable_robot_foundation_model_via_self-ge.md)**
...
**[Direct Discriminative Optimization Your Likelihood-Based Visual Generative Model](direct_discriminative_optimization_your_likelihood-based_visual_generative_model.md)**
...
**[Distillation Of Discrete Diffusion Through Dimensional Correlations](distillation_of_discrete_diffusion_through_dimensional_correlations.md)**
...
**[Editable Noise Map Inversion Encoding Target-Image Into Noise For High-Fidelity ](editable_noise_map_inversion_encoding_target-image_into_noise_for_high-fidelity_.md)**
...
**[Elucidating Flow Matching Ode Dynamics With Respect To Data Geometries And Denoi](elucidating_flow_matching_ode_dynamics_with_respect_to_data_geometries_and_denoi.md)**
...
**[Exploring Position Encoding In Diffusion U-Net For Training-Free High-Resolution](exploring_position_encoding_in_diffusion_u-net_for_training-free_high-resolution.md)**
...
**[Expressive Score-Based Priors For Distribution Matching With Geometry-Preserving](expressive_score-based_priors_for_distribution_matching_with_geometry-preserving.md)**
...
**[Graph Generative Pre-Trained Transformer](graph_generative_pre-trained_transformer.md)**
...
**[Integrating Intermediate Layer Optimization And Projected Gradient Descent For S](integrating_intermediate_layer_optimization_and_projected_gradient_descent_for_s.md)**
...
**[Label-Efficient Hyperspectral Image Classification Via Spectral Film Modulation ](label-efficient_hyperspectral_image_classification_via_spectral_film_modulation_.md)**
...
**[Llavaguard An Open Vlm-Based Framework For Safeguarding Vision Datasets And Mode](llavaguard_an_open_vlm-based_framework_for_safeguarding_vision_datasets_and_mode.md)**
...
**[Multidimensional Adaptive Coefficient For Inference Trajectory Optimization In F](multidimensional_adaptive_coefficient_for_inference_trajectory_optimization_in_f.md)**
...
**[One Image Is Worth A Thousand Words A Usability Preservable Text-Image Collabora](one_image_is_worth_a_thousand_words_a_usability_preservable_text-image_collabora.md)**
...
**[Performance Plateaus In Inference-Time Scaling For Text-To-Image Diffusion Witho](performance_plateaus_in_inference-time_scaling_for_text-to-image_diffusion_witho.md)**
...
**[Restoregrad Signal Restoration Using Conditional Denoising Diffusion Models With](restoregrad_signal_restoration_using_conditional_denoising_diffusion_models_with.md)**
...
**[Sample Complexity Of Distributionally Robust Off-Dynamics Reinforcement Learning](sample_complexity_of_distributionally_robust_off-dynamics_reinforcement_learning.md)**
...
**[Simple And Critical Iterative Denoising A Recasting Of Discrete Diffusion In Gra](simple_and_critical_iterative_denoising_a_recasting_of_discrete_diffusion_in_gra.md)**
...
**[Synthetic Face Datasets Generation Via Latent Space Exploration From Brownian Id](synthetic_face_datasets_generation_via_latent_space_exploration_from_brownian_id.md)**
...
**[Task-Agnostic Pre-Training And Task-Guided Fine-Tuning For Versatile Diffusion P](task-agnostic_pre-training_and_task-guided_fine-tuning_for_versatile_diffusion_p.md)**

:   提出 SODP 框架：先用大量无奖励标签的次优多任务轨迹预训练扩散规划器，再用基于策略梯度的 RL 微调快速适配下游任务，并引入 BC 正则化防止性能崩溃，在 Meta-World 50 任务上达到 60.56% 成功率（SOTA）。

**[Tcp-Diffusion A Multi-Modal Diffusion Model For Global Tropical Cyclone Precipit](tcp-diffusion_a_multi-modal_diffusion_model_for_global_tropical_cyclone_precipit.md)**
...
**[Video Prediction Policy A Generalist Robot Policy With Predictive Visual Represe](video_prediction_policy_a_generalist_robot_policy_with_predictive_visual_represe.md)**
...
**[When Diffusion Models Memorize Inductive Biases In Probability Flow Of Minimum-N](when_diffusion_models_memorize_inductive_biases_in_probability_flow_of_minimum-n.md)**
