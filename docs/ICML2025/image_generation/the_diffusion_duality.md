---
description: "【论文笔记】The Diffusion Duality 论文解读 | ICML 2025 | arXiv 2506.10892 | 离散扩散对偶性 | 揭示了 Uniform-state 离散扩散过程本质上从底层高斯扩散中涌现（通过 argmax 映射），利用这一对偶性将高斯扩散的课程学习策略和一致性蒸馏迁移到离散设置，实现训练速度翻倍和采样加速两个数量级（1024步→8步），在零样本困惑度上 3/7 数据集超越自回归模型。"
tags:
  - ICML 2025
  - 离散扩散对偶性
  - Uniform-state 扩散
