---
description: "【论文笔记】The Impact of On-Policy Parallelized Data Collection on Deep Reinforcement Learning Networks 论文解读 | ICML 2025 | arXiv 2506.03404 | 并行数据采集 | 系统研究 on-policy RL 中并行数据采集的两个维度（并行环境数 N_envs vs 轨迹长度 N_RO）对 PPO 性能的影响，发现在固定数据预算下增加并行环境数比增加轨迹长度更有效，且更大的数据集可改善网络可塑性和优化稳定性。"
tags:
  - ICML 2025
  - 并行数据采集
  - PPO
