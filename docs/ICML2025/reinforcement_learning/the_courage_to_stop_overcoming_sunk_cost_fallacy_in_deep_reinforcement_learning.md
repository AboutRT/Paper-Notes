---
description: >-
  [ICML2025][深度RL样本效率] 提出 LEAST 机制，通过基于 Q 值中位数和梯度幅值的双准则自适应阈值实现 episode 战略性提前终止，在 MuJoCo 4 任务上为 TD3/SAC/REDQ 带来一致提升，DMC 视觉 RL 中收敛加速约 30%，有效缓解 replay buffer 被低质量转移污染的"沉没成本谬误"。
tags:
  - ICML2025
  - 深度强化学习
  - 样本效率
...
1. **Q值质量阈值（步级中位数）**:
    ...
    - 做什么：为 episode 内每一步 $i$ 独立构造质量参考线
