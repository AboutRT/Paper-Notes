...
1. **耦合问题**：Atari、DM Control 等经典基准的性能指标**混杂了表征学习、策略优化和环境动力学**，无法单独评估表征学习
2. **ProcGen**：同时改变视觉和任务难度，无法分离表征学习的影响
3. **Distracting Control Suite**：引入与任务无关的视觉干扰，智能体可以安全忽略
4. **COOM**：关注灾难性遗忘而非单任务内的表征学习
