...
description: >-
  [ICML2025][安全强化学习] 提出 PIGDreamer，基于非对称约束 POMDP 理论框架，利用训练时特权信息（底层状态）增强世界模型表征、预测器和 critic，实现部分可观测下的安全高效策略学习，在 Safety-Gymnasium 和 Guard 基准上全面超越现有 Safe RL 方法。
tags:
  - ICML2025
  - 安全强化学习
  - 世界模型
...
3. **Twisted Imagination（TI）轨迹生成**:
    ...
    - 做什么：同步两个世界模型生成连贯的抽象轨迹供 Actor-Critic 学习
