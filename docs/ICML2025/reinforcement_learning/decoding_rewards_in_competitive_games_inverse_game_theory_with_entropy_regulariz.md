---
description: "【论文笔记】Decoding Rewards in Competitive Games: Inverse Game Theory with Entropy Regularization 论文解读 | ICML2025 | arXiv 2601.12707 | 逆博弈论 | 提出基于熵正则化的零和博弈逆问题统一框架，利用 Quantal Response Equilibrium (QRE) 在线性假设下建立奖励函数的可辨识性条件，并给出从观测动作恢复奖励函数的置信集构造算法，附带 O(T^-1/2) 收敛速率保证。"
tags:
  - ICML2025
  - 逆博弈论
  - 零和博弈
...
1. **逆问题病态性**：多个奖励函数可能导致相同的均衡策略，需识别整个可行奖励集而非单一解
2. **离线数据覆盖不足**：观测策略可能无法遍历整个状态-动作空间，导致奖励恢复不鲁棒
3. **动态博弈复杂性**：在 Markov 博弈中，策略随时间演变，增加了可辨识性和估计的难度
