...
**嵌入**：数字 token 嵌入像普通词一样学习，无法保留数值关系

**顺序预测**：逐 token 解码忽略高位数字的更大重要性

**训练目标**：交叉熵 (CE) 损失假设名义尺度，预测 3 vs 预测 9 对真实值 2 的惩罚相同
...
- [\[ACL 2025\] Tell, Don't Show: Leveraging Language Models' Abstractive Retellings to Model Literary Themes](../../ACL2025/llm_nlp/tell_dont_show_leveraging_language_models_abstractive_retellings_to_model_litera.md)
