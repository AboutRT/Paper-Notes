...
- [Automating Complex Document Workflows via Stepwise and Rollback-Enabled Operations](../../AAAI2026/llm_agent/automating_complex_document_workflows_via_stepwise_and_rollback-enabled_operatio.md)
