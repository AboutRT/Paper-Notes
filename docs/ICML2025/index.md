...
title: >-
  ICML2025 1076篇论文解读
description: >-
  1076篇ICML2025论文解读，涵盖图像生成(115篇)、强化学习(78篇)、模型压缩(70篇)、医学图像(63篇)、AI 安全(60篇)、优化/理论(55篇)、多模态 VLM(50篇)、人体理解(39篇)等 41个方向。每篇含一句话总结、核心思想、方法详解、实验结果与局限性分析，5分钟读懂一篇论文核心思想。
---
...
**[Local Manifold Approximation and Projection for Manifold-Aware Diffusion Planning](image_generation/local_manifold_approximation_and_projection_for_manifold-aware_diffusion_plannin.md)**
...
**[NTPP: Generative Speech Language Modeling for Dual-Channel Spoken Dialogue via Next-Token-Pair Prediction](image_generation/ntpp_generative_speech_language_modeling_for_dual-channel_spoken_dialogue_via_ne.md)**
...
**[A Theoretical Study of (Hyper) Self-Attention through the Lens of Interactions: Representation, Training, Generalization](reinforcement_learning/a_theoretical_study_of_hyper_self-attention_through_the_lens_of_interactions_rep.md)**
...
**[Of Mice and Machines: A Comparison of Learning Between Real World Mice and RL Agents](reinforcement_learning/of_mice_and_machines_a_comparison_of_learning_between_real_world_mice_and_rl_age.md)**
...
**[From Low Rank Gradient Subspace Stabilization to Low-Rank Weights: Observations, Theories, and Applications](model_compression/from_low_rank_gradient_subspace_stabilization_to_low-rank_weights_observations_t.md)**
...
**[LaCache: Ladder-Shaped KV Caching for Efficient Long-Context Modeling of Large Language Models](model_compression/lacache_ladder-shaped_kv_caching_for_efficient_long-context_modeling_of_large_la.md)**

:   提出梯形（ladder-shaped）KV 缓存模式，在不同层保留不同 token 范围的 KV 状态，从而在固定缓存预算下扩展可捕获的上下文跨度，并通过迭代压缩机制支持无限长度的连续生成。

**[Lego Sketch: A Scalable Memory-augmented Neural Network for Sketching Data Streams](model_compression/lego_sketch_a_scalable_memory-augmented_neural_network_for_sketching_data_stream.md)**
...
**[TreeLoRA: Efficient Continual Learning via Layer-Wise LoRAs Guided by a Hierarchical Gradient-Similarity Tree](model_compression/treelora_efficient_continual_learning_via_layer-wise_loras_guided_by_a_hierarchi.md)**
...
**[An Attack to Break Permutation-Based Private Third-Party Inference Schemes for LLMs](ai_safety/an_attack_to_break_permutation-based_private_third-party_inference_schemes_for_l.md)**
...
**[Collaborative Mean Estimation Among Heterogeneous Strategic Agents: Individual Rationality, Fairness, and Truthful Contribution](ai_safety/collaborative_mean_estimation_among_heterogeneous_strategic_agents_individual_ra.md)**
...
**[Benefits of Early Stopping in Gradient Descent for Overparameterized Logistic Regression](optimization/benefits_of_early_stopping_in_gradient_descent_for_overparameterized_logistic_re.md)**
...
**[SK-VQA: Synthetic Knowledge Generation at Scale for Training Context-Augmented Multimodal LLMs](multimodal_vlm/sk-vqa_synthetic_knowledge_generation_at_scale_for_training_context-augmented_mu.md)**
...
**[SparseVLM: Visual Token Sparsification for Efficient Vision-Language Model Inference](multimodal_vlm/sparsevlm_visual_token_sparsification_for_efficient_vision-language_model_infere.md)**
...
**[MERIT: Maximum-normalized Element-wise Ratio for Language Model Large-batch Training](human_understanding/merit_maximum-normalized_element-wise_ratio_for_language_model_large-batch_train.md)**
...
**[DiLQR: Differentiable Iterative Linear Quadratic Regulator via Implicit Differentiation](llm_evaluation/dilqr_differentiable_iterative_linear_quadratic_regulator_via_implicit_different.md)**
...
**[MultiCogEval: Evaluating LLMs Across Multi-Cognitive Levels](llm_evaluation/evaluating_llms_across_multi-cognitive_levels_from_medical_knowledge_mastery_to_.md)**
...
**[Improved and Oracle-Efficient Online $\ell_1$-Multicalibration](llm_evaluation/improved_and_oracle-efficient_online_ell_1-multicalibration.md)**
...
**[IBDR: Promoting Ensemble Diversity with Interactive Bayesian Distributional Robustness](llm_evaluation/promoting_ensemble_diversity_with_interactive_bayesian_distributional_robustness.md)**
...
**[Graph-constrained Reasoning: Faithful Reasoning on Knowledge Graphs with Large Language Models](graph_learning/graph-constrained_reasoning_faithful_reasoning_on_knowledge_graphs_with_large_la.md)**
...
**[L-STEP: Learnable Spatial-Temporal Positional Encoding for Link Prediction](graph_learning/learnable_spatial-temporal_positional_encoding_for_link_prediction.md)**
...
**[Chameleon: A Flexible Data-mixing Framework for Language Model Pretraining and Finetuning](llm_pretraining/chameleon_a_flexible_data-mixing_framework_for_language_model_pretraining_and_fi.md)**
...
**[Density Ratio Estimation-based Bayesian Optimization with Semi-Supervised Learning](llm_pretraining/density_ratio_estimation-based_bayesian_optimization_with_semi-supervised_learni.md)**
...
**[ReSA: Clustering Properties of Self-Supervised Learning](self_supervised/clustering_properties_of_self-supervised_learning.md)**
...
**[ActionPiece: Contextually Tokenizing Action Sequences for Generative Recommendation](segmentation/actionpiece_contextually_tokenizing_action_sequences_generative_recommendation.md)**
...
**[Recommendations with Sparse Comparison Data: Provably Fast Convergence for Nonconvex Matrix Factorization](recommender/recommendations_with_sparse_comparison_data_provably_fast_convergence_for_noncon.md)**
...
**[MATCHA: Toward Safe and Human-Aligned Game Conversational Recommendation via Multi-Agent Decomposition](recommender/toward_safe_and_human-aligned_game_conversational_recommendation_via_multi-agent.md)**
...
**[Position: Causal Machine Learning Requires Rigorous Synthetic Experiments for Broader Adoption](causal_inference/position_causal_machine_learning_requires_rigorous_synthetic_experiments_for_bro.md)**
...
**[DyCodeEval: Dynamic Benchmarking of Reasoning Capabilities in Code Large Language Models Under Data Contamination](code_intelligence/dynamic_benchmarking_of_reasoning_capabilities_in_code_large_language_models_und.md)**
...
**[Resampling Augmentation for Time Series Contrastive Learning: Application to Remote Sensing](remote_sensing/resampling_augmentation_for_time_series_contrastive_learning_application_to_remo.md)**
...
**[AsymRnR: Video Diffusion Transformers Acceleration with Asymmetric Reduction and Restoration](video_generation/asymrnr_video_diffusion_transformers_acceleration_with_asymmetric_reduction_and_.md)**

:   提出 AsymRnR——一种免训练的视频 DiT 加速方法，基于注意力中不同组件（Q/K/V）、不同层、不同去噪步骤的冗余程度不同的观察，非对称地削减 token 以实现无损加速。

**[Ca2-VDM: Efficient Autoregressive Video Diffusion Model with Causal Generation and Cache Sharing](video_generation/ca2-vdm_efficient_autoregressive_video_diffusion_model_with_causal_generation_an.md)**
...
**[Data-Juicer Sandbox: A Feedback-Driven Suite for Multimodal Data-Model Co-development](video_generation/data-juicer_sandbox_a_feedback-driven_suite_for_multimodal_data-model_co-develop.md)**
...
**[MimicMotion: High-Quality Human Motion Video Generation with Confidence-aware Pose Guidance](video_generation/mimicmotion_high-quality_human_motion_video_generation_with_confidence-aware_pos.md)**
...
**[DRO-BAS: Decision Making under the Exponential Family DRO with Bayesian Ambiguity Sets](others/decision_making_under_the_exponential_family_distributionally_robust_optimisatio.md)**
...
**[Exploiting Similarity for Computation and Communication-Efficient Decentralized Optimization](others/exploiting_similarity_for_computation_and_communication-efficient_decentralized_.md)**
...
**[Feature Learning beyond the Lazy-Rich Dichotomy: Insights from Representational Geometry](others/feature_learning_beyond_the_lazy-rich_dichotomy_insights_from_representational_g.md)**
...
**[Fixing the Loose Brake: Exponential-Tailed Stopping Time in Best Arm Identification](others/fixing_the_loose_brake_exponential-tailed_stopping_time_in_best_arm_identificati.md)**
