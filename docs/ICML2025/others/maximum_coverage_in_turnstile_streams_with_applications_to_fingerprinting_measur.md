---
description: "【论文笔记】Maximum Coverage in Turnstile Streams with Applications to Fingerprinting Measures 论文解读 | ICML2025 | arXiv 2504.18394 | maximum coverage | 首次在 turnstile 流模型（支持任意插入/删除）下给出最大覆盖问题的单遍流算法，空间 tildeO(d/ε³)、更新时间 tildeO(1)，并将其推广到隐私指纹识别（fingerprinting）场景，实验比先前方法快 210×。"
tags:
  - ICML2025
  - maximum coverage
  - turnstile streaming
