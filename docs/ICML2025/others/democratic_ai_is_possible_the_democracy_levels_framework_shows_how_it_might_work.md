---
description: "【论文笔记】Democratic AI is Possible. The Democracy Levels Framework Shows How It Might Work 论文解读 | ICML2025 | arXiv 2411.09222 | OCR democratic AI | 提出\"Democracy Levels\"（民主等级）框架，将 AI 决策权从单方面权威向民主系统的转移划分为 L0–L5 六个等级，并配套维度评估体系和实操工具，为 AI 治理的民主化提供了系统性路线图。"
tags:
  - ICML2025
  - OCR
  - participatory AI
...
1. **权力集中风险**：AI 开发主要由少数公司和政府驱动，可能导致前所未有的权力集中
2. **治理真空**：AI 的通用性、变化速度、市场激励和跨司法管辖套利使传统监管难以跟上
3. **民主化概念模糊**：当前"AI 民主化"多被理解为"让 AI 开放和可访问"，而非真正的民主治理
4. **早期实验不成体系**：Anthropic 的 Collective Constitutional AI、OpenAI 的 Democratic inputs、Meta 的 Community Forums 等实验虽有启发性，但缺乏系统的评估框架
