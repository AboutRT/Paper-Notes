...
1. **因果推断的根本问题**：对同一个体，无法同时观察到"接受处理"和"未接受处理"两种结果（反事实不可观测），这意味着真实数据几乎不可能提供因果查询的 ground truth
2. **评估实践的缺陷**：现有经验评估无法有效证明因果方法的可靠性和鲁棒性
3. **社区偏见**：ML 社区习惯于无假设的预测方法，对需要强假设的因果方法持怀疑态度
