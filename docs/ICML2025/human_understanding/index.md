...
**[PAS: Diffusion Sampling Correction via Approximately 10 Parameters](diffusion_sampling_correction_via_approximately_10_parameters.md)**
...
**[MERIT: Maximum-normalized Element-wise Ratio for LM Large-batch Training](merit_maximum-normalized_element-wise_ratio_for_language_model_large-batch_train.md)**
