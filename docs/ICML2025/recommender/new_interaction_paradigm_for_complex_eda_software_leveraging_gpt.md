---
description: "【论文笔记】New Interaction Paradigm for Complex EDA Software Leveraging GPT 论文解读 | ICML 2025 | arXiv 2307.14740 | LLM辅助交互 | 提出 SmartonAI 系统，将大语言模型（LLM）和检索增强生成（RAG）集成到 EDA 工具 KiCad 中，通过自然语言交互实现任务分解、文档检索和智能插件推荐与执行，大幅降低复杂工程软件的学习门槛。"
tags:
  - ICML 2025
  - LLM辅助交互
  - 电子设计自动化(EDA)
...
1. **学习曲线陡峭**：新手用户需要花费大量时间熟悉复杂的界面和工作流程，入门成本极高
2. **文档碎片化**：官方文档、社区论坛、教程分散在不同平台，且常常过时或面向专家用户编写
3. **缺乏自适应支持**：现有的 GUI 脚本、设计向导等辅助手段缺乏灵活性和交互性，无法根据用户上下文动态调整
4. **试错成本高**：用户在遇到具体场景问题时只能反复尝试，效率低下
