...
description: >-
  [ICML 2025][语义分割][交互式3D分割] NPISeg3D提出了首个基于层次化神经过程（Hierarchical Neural Processes）的概率交互式3D分割框架，通过场景级和物体级双层潜变量结构以及概率原型调制器，在少量点击下实现了优于AGILE3D的分割精度…
tags:
  - "ICML 2025"
  - "语义分割"
  - "交互式3D分割"
...
**代码**: [https://jliu4ai.github.io/NPISeg3D_projectpage/](https://jliu4ai.github.io/NPISeg3D_projectpage/)  
**领域**: 3D视觉  
...
- [\[ICML 2025\] Sounding that Object: Interactive Object-Aware Image to Audio Generation](sounding_that_object_interactive_object-aware_image_to_audio_generation.md)
