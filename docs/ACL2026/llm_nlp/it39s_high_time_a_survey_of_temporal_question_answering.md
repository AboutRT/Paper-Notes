...
description: >-
  [ACL 2026][LLM/NLP][时序问答] 本文提供了时序问答（TQA）的全面综述，提出了基于语料时间性、问题时间性和模型时间能力三个维度的统一分析框架，系统梳理了从规则管道到 Transformer/LLM 时代的 TQA 方法演进、基准数据集和评估策略，并识别了未来挑战。
tags:
  - "ACL 2026"
  - "LLM/NLP"
  - "时序问答"
...
- [\[ACL 2025\] Active LLMs for Multi-hop Question Answering](../../ACL2025/llm_nlp/active_llms_for_multi-hop_question_answering.md)
