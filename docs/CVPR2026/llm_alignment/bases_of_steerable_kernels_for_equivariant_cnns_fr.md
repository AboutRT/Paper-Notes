---
description: "【论文笔记】Bases of Steerable Kernels for Equivariant CNNs: From 2D Rotations to the Lorentz Group 论文解读 | CVPR 2026 | arXiv 2603.12459 | 可操纵卷积核 | 提出一种直接从输入/输出表示构造可操纵核显式基的方法，无需计算 Clebsch-Gordan 系数，统一覆盖 SO(2)、O(2)、SO(3)、O(3) 到非紧致 Lorentz 群，大幅简化等变 CNN 的核设计流程。"
tags:
  - CVPR 2026
  - 可操纵卷积核
  - 等变CNN
