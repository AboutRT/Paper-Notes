...
description: >-
  [CVPR 2026][LLM推理][多模态推理] 本文提出 Hallucination-as-Cue 分析框架，通过三种模态特定腐蚀策略（空白图像、随机图像、文本移除）系统研究 RL 后训练对多模态推理模型的真实作用机制，发现即使在 100% 腐蚀视觉输入下 GRPO 训练仍能显著提升推理性能…
tags:
  - "CVPR 2026"
  - "LLM推理"
  - "多模态推理"
...
- [\[CVPR 2026\] Harnessing Chain-of-Thought Reasoning in Multimodal Large Language Models for Face Anti-Spoofing](facecot_cot_reasoning_face_anti_spoofing.md)
