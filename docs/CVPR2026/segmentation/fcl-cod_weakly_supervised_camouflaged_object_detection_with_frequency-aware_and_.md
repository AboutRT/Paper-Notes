---
description: "【论文笔记】FCL-COD: Weakly Supervised Camouflaged Object Detection with Frequency-aware and Contrastive Learning 论文解读 | CVPR 2026 | arXiv 2603.22969 | 目标检测 Camouflaged Object Detection | 提出 FCL-COD 框架，通过频率感知低秩适配（FoRA）将伪装场景知识注入 SAM、梯度感知对比学习（GCL）增强前背景特征分离、多尺度频率注意力（MSFA）提炼边界敏感特征，在仅使用边界框标注的弱监督设定下超越了全监督 SOTA 方法。"
tags:
  - CVPR 2026
...
1. **全监督方法**依赖像素级标注，成本高昂且可能忽略目标整体结构特征
2. **弱监督方法**的性能与全监督差距显著
