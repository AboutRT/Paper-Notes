...
**[Bootstrap Dynamic-Aware 3D Visual Representation For Scalable Robot Learning](bootstrap_dynamic-aware_3d_visual_representation_for_scalable_robot_learning.md)**
...
**[Brewing Stronger Features Dual-Teacher Distillation For Multispectral Earth Obse](brewing_stronger_features_dual-teacher_distillation_for_multispectral_earth_obse.md)**
...
**[Direct Segmentation Without Logits Optimization For Training-Free Open-Vocabular](direct_segmentation_without_logits_optimization_for_training-free_open-vocabular.md)**

:   提出一种跳过logits优化过程的开放词汇语义分割方法，基于"同类区域的logits到退化分布的分布差异一致"这一假设，直接通过最优传输路径或最大传输速度的解析解来构造分割图，在8个基准上达到SOTA且无需训练或模型特定调制。

**[Discover Segment And Select A Progressive Mechanism For Zero-Shot Camouflaged Ob](discover_segment_and_select_a_progressive_mechanism_for_zero-shot_camouflaged_ob.md)**
...
**[Discriminative Perception Via Anchored Description For Reasoning Segmentation](discriminative_perception_via_anchored_description_for_reasoning_segmentation.md)**
...
**[Follow The Saliency Supervised Saliency For Retrieval-Augmented Dense Video Capt](follow_the_saliency_supervised_saliency_for_retrieval-augmented_dense_video_capt.md)**
...
**[Generalizable Knowledge Distillation From Vision Foundation Models For Semantic ](generalizable_knowledge_distillation_from_vision_foundation_models_for_semantic_.md)**
...
**[Reasoning With Pixel-Level Precision Qvlm Architecture And Squid Dataset For Qua](reasoning_with_pixel-level_precision_qvlm_architecture_and_squid_dataset_for_qua.md)**
...
**[Unrealpose Leveraging Game Engine Kinematics For Large-Scale Synthetic Human Pos](unrealpose_leveraging_game_engine_kinematics_for_large-scale_synthetic_human_pos.md)**
...
**[Videomt Encoder Only Video Segmentation](videomt_encoder_only_video_segmentation.md)**
