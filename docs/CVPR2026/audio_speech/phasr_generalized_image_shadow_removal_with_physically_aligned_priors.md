...
description: >-
  [CVPR 2026][图像复原][阴影去除] 提出PhaSR框架，通过物理对齐归一化(PAN)执行无参数Gray-world+对数域Retinex分解抑制色彩偏差，几何-语义校正注意力(GSRA)利用差分注意力对齐深度几何与DINO-v2语义先验，在传统阴影去除和环境光归一化上都取得SOTA，且计算复杂度最低(55.63G FLOPs)。
tags:
  - CVPR 2026
  - 图像复原
  - 阴影去除
