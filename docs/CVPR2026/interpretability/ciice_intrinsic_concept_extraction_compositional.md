...
description: >-
    [CVPR 2026][可解释性] 提出CI-ICE任务和HyperExpress方法，在双曲空间中提取可组合的物体级/属性级视觉概念
tags:
    - CVPR 2026
    - 可解释性
    - 概念提取
...
**本文要解决什么？** 从单张图像提取既在层次上解耦（物体级 vs 属性级）又具备可组合性（能重新组合重建原概念）的内在视觉概念。

**切入角度**：利用双曲空间固有的层次建模能力进行概念学习，利用horosphere的零曲率特性保证可组合性。

**核心idea一句话**：在Poincaré球中学习层级概念关系，在horosphere上投影保证线性可组合。
