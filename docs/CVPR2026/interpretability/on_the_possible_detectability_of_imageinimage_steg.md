---
title: "[论文解读] On the Possible Detectability of Image-in-Image Steganography"
description: "[CVPR 2026][隐写分析][信息安全] 揭示INN-based图像隐写方案的安全漏洞：嵌入过程是可通过ICA盲源分离的混合过程，8维特征+SVM达84.6%检测率，SRM+SVM达99%+"
tags:
  - CVPR 2026
  - 隐写分析
  - 信息安全
...
1. **混合过程分析与ICA盲源分离**:
    - 做什么：证明INN嵌入过程在DWT域中是一种可分离的混合过程，并用ICA提取出对应Cover和Payload的独立成分
...
2. **PCA弱分量选择与极简统计特征**:
    - 做什么：通过PCA预处理选择最可能包含嵌入痕迹的分量，并从ICA输出中提取极简特征
