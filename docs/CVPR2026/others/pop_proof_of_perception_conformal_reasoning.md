---
description: "【论文笔记】Proof-of-Perception: 带组合共形保证的工具使用多模态推理 论文解读 | CVPR 2026 | arXiv 2603.00324 | 共形预测 | 提出PoP框架将多模态推理建模为可执行DAG——每个感知/逻辑节点输出共形预测集提供逐步校准的不确定性，控制器在预算约束下按需调用更多工具扩展计算，在文档/图表/多图QA上优于CoT/ReAct/PoT基线。"
tags:
  - CVPR 2026
  - 共形预测
  - 工具使用
