...
description: >-
  [CVPR 2026][SNN] 提出HD-LIF混合驱动脉冲神经元模型族，通过在阈值上下区域采用不同脉冲计算机制实现梯度可分离性和对齐性，解决SNN在线训练前后向传播不一致问题，以10×参数压缩和11×功耗降低达到CIFAR-100上78.61%精度。
tags:
  - CVPR 2026
  - SNN
  - online training
...
3. **Mem-BN HD-LIF（膜电位批归一化 + 零开销推理）**:
    ...
    - 做什么：在膜电位上做时间维度 BN，增强在线训练稳定性，且推理时零额外开销
