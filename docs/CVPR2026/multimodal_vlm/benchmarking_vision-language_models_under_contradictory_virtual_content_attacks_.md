...
description: >-
  [CVPR 2026][AR安全] 首个AR矛盾虚拟内容攻击基准ContrAR（312个真实AR视频），系统评估11个VLM在检测AR场景语义矛盾中的能力，揭示准确率-延迟trade-off。
tags:
  - CVPR 2026
  - 多模态
  - 增强现实安全
...
**领域**: 多模态 / AR 安全  
**关键词**: 增强现实安全, 语义矛盾检测, VLM 鲁棒性, 基准测试, AR 攻击
...
**本文要解决什么？** 形式化定义 AR 矛盾虚拟内容攻击的威胁模型，构建标准基准数据集，系统评估主流 VLM 的检测能力和实时性。

**切入角度**：将 AR 语义矛盾检测建模为 VLM 的多模态推理任务，通过真实 HMD 设备录制视频数据构建标准化评估基准，提供首个该领域的 VLM 能力画像。

**核心 idea 一句话**：首次用真实 AR 视频基准系统揭示 VLM 在矛盾虚拟内容检测中的能力边界和准确率-延迟 trade-off。
...
1. **威胁模型与形式化定义**
    ...
    - **做什么**：建立 AR 矛盾攻击的理论框架，明确攻击者和检测者的能力边界
...
3. **VLM 评估框架**
    ...
    - **做什么**：设计标准化推理-评测流程，公平比较 11 个 VLM 的检测能力
