---
description: "【论文笔记】Cubic Discrete Diffusion: Discrete Visual Generation on High-Dimensional Representation Tokens 论文解读 | CVPR 2026 | arXiv 2603.19232 | 离散扩散模型 | 提出 CubiD，首个在高维表征 token（768维）上做离散扩散生成的模型，通过在 h × w × d 三维张量上进行细粒度 mask 预测实现高质量图像生成，同时保留理解能力。"
tags:
  - CVPR 2026
  - 离散扩散模型
  - 高维表征token
