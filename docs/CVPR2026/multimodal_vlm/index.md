...
**[A Closedform Solution For Debiasing Visionlanguage](a_closedform_solution_for_debiasing_visionlanguage.md)**

:   提出VLM去偏的闭式解方法，通过在跨模态嵌入空间中对属性子空间做正交分解并利用Chebyshev标量化求解，实现Pareto最优公平性与有界效用损失，免训练、免标注，统一覆盖零样本分类、文本-图像检索和文本-图像生成三大下游任务。

**[Activation Matters Test-Time Activated Negative Labels For Ood Detection With Vi](activation_matters_test-time_activated_negative_labels_for_ood_detection_with_vi.md)**
...
**[Adaptive Vision-Language Model Routing For Computer Use Agents](adaptive_vision-language_model_routing_for_computer_use_agents.md)**
...
**[Agft Alignment-Guided Fine-Tuning For Zero-Shot Adversarial Robustness Of Vision](agft_alignment-guided_fine-tuning_for_zero-shot_adversarial_robustness_of_vision.md)**

:   AGFT 提出了一种对齐引导的微调框架，通过文本引导的对抗训练和分布一致性校准，在增强 VLM 零样本对抗鲁棒性的同时保持预训练的跨模态语义结构，在 15 个零样本基准上平均鲁棒准确率达到 46.57%，超越 SOTA 3.1 个百分点。

**[Anomalyvfm -- Transforming Vision Foundation Models Into Zero-Shot Anomaly Detec](anomalyvfm_--_transforming_vision_foundation_models_into_zero-shot_anomaly_detec.md)**
...
**[Apet Approximation Error Token Compression](apet_approximation_error_token_compression.md)**
...
**[Balm A Model-Agnostic Framework For Balanced Multimodal Learning Under Imbalance](balm_a_model-agnostic_framework_for_balanced_multimodal_learning_under_imbalance.md)**
...
**[Beyond Recognition Evaluating Visual Perspective Taking In Vision Language Model](beyond_recognition_evaluating_visual_perspective_taking_in_vision_language_model.md)**
...
**[Can Vision-Language Models Count A Synthetic Benchmark And Analysis Of Attention](can_vision-language_models_count_a_synthetic_benchmark_and_analysis_of_attention.md)**
...
**[Conditional Factuality Controlled Llms With Generalization Certificates Via Conf](conditional_factuality_controlled_llms_with_generalization_certificates_via_conf.md)**
...
**[Continual Learning With Visionlanguage Models Via](continual_learning_with_visionlanguage_models_via.md)**
...
**[Covr-Rreason-Aware Composed Video Retrieval](covr-rreason-aware_composed_video_retrieval.md)**
...
**[Crit Graph-Based Automatic Data Synthesis To Enhance Cross-Modal Multi-Hop Reaso](crit_graph-based_automatic_data_synthesis_to_enhance_cross-modal_multi-hop_reaso.md)**
...
**[Demographic Fairness In Multimodal Llms A Benchmark Of Gender And Ethnicity Bias](demographic_fairness_in_multimodal_llms_a_benchmark_of_gender_and_ethnicity_bias.md)**
...
**[Diagnosing And Repairing Unsafe Channels In Vision-Language Models Via Causal Di](diagnosing_and_repairing_unsafe_channels_in_vision-language_models_via_causal_di.md)**

:   提出 CARE 框架，先用因果中介分析精确定位 VLM 中与不安全行为因果相关的神经元和层（诊断），再通过广义特征分解构建双模态安全子空间并在推理时投影激活值（修复），将攻击成功率降至 10% 以下且几乎不损失通用能力。

**[Disentangle-Then-Align Non-Iterative Hybrid Multimodal Image Registration Via Cr](disentangle-then-align_non-iterative_hybrid_multimodal_image_registration_via_cr.md)**
...
**[Downscaling Intelligence Exploring Perception And Reasoning Bottlenecks In Small](downscaling_intelligence_exploring_perception_and_reasoning_bottlenecks_in_small.md)**
...
**[Duet-Vlm Dual Stage Unified Efficient Token Reduction For Vlm Training And Infer](duet-vlm_dual_stage_unified_efficient_token_reduction_for_vlm_training_and_infer.md)**
...
**[Duet Vlm Dual Stage Token Reduction](duet_vlm_dual_stage_token_reduction.md)**
...
**[Dynamic Token Reweighting For Robust Visionlanguag](dynamic_token_reweighting_for_robust_visionlanguag.md)**
...
**[Dynamicgtr Leveraging Graph Topology Representation Preferences To Boost Vlm Cap](dynamicgtr_leveraging_graph_topology_representation_preferences_to_boost_vlm_cap.md)**

:   提出 DynamicGTR 框架，通过动态路由在推理时为每个查询选择最优的图拓扑表示（GTR，视觉/文本共8种），显著提升 VLM 在零样本图算法问答中的性能，并可迁移到链接预测和节点分类等真实场景。

**[Eaglenet Energy-Aware Fine-Grained Relationship Learning Network For Text-Video ](eaglenet_energy-aware_fine-grained_relationship_learning_network_for_text-video_.md)**
...
**[Emo-R3 Reflective Reinforcement Learning For Emotional Reasoning In Multimodal L](emo-r3_reflective_reinforcement_learning_for_emotional_reasoning_in_multimodal_l.md)**
...
**[Evolmm Self Evolving Lmm Continuous Rewards](evolmm_self_evolving_lmm_continuous_rewards.md)**
...
**[Evolving Contextual Safety In Multi-Modal Large Language Models Via Inference-Ti](evolving_contextual_safety_in_multi-modal_large_language_models_via_inference-ti.md)**

:   提出 MM-SafetyBench++ 基准和 EchoSafe 框架，通过推理时维护自反思记忆库来累积安全洞察，使 MLLM 能够根据上下文区分看起来相似但安全意图不同的场景，无需训练即可提升上下文安全性。

**[Evolving Prompt Adaptation For Vision-Language Models](evolving_prompt_adaptation_for_vision-language_models.md)**
...
**[Explore With Long-Term Memory A Benchmark And Multimodal Llm-Based Reinforcement](explore_with_long-term_memory_a_benchmark_and_multimodal_llm-based_reinforcement.md)**
...
**[Fine-Grained Post-Training Quantization For Large Vision Language Models With Qu](fine-grained_post-training_quantization_for_large_vision_language_models_with_qu.md)**
...
**[Focus Dont Prune Identifying Instruction-Relevant Regions For Information-Rich I](focus_dont_prune_identifying_instruction-relevant_regions_for_information-rich_i.md)**

:   提出 PinPoint，一个两阶段框架：先通过 Instruction-Region Alignment 定位与指令相关的图像区域，再对选中区域精细化编码，以更少的 visual token 实现更高的 VQA 精度。

**[From Intuition To Investigation A Tool-Augmented Reasoning Mllm Framework For Ge](from_intuition_to_investigation_a_tool-augmented_reasoning_mllm_framework_for_ge.md)**
...
**[From Observation To Action Latent Action-Based Primitive Segmentation For Vla Pr](from_observation_to_action_latent_action-based_primitive_segmentation_for_vla_pr.md)**
...
**[Gacd Gradient Self Reflection Hallucination](gacd_gradient_self_reflection_hallucination.md)**
...
**[Generate Analyze And Refine Training-Free Sound Source Localization Via Mllm Met](generate_analyze_and_refine_training-free_sound_source_localization_via_mllm_met.md)**
...
**[Graphvlm Benchmark Vlm Graph Learning](graphvlm_benchmark_vlm_graph_learning.md)**
...
**[Groundvts Visual Token Sampling In Multimodal Large Language Models For Video Te](groundvts_visual_token_sampling_in_multimodal_large_language_models_for_video_te.md)**
...
**[Handvqa Diagnosing And Improving Fine-Grained Spatial Reasoning About Hands In V](handvqa_diagnosing_and_improving_fine-grained_spatial_reasoning_about_hands_in_v.md)**
...
**[Hive Query Hypothesize Verify An Llm Framework For Multimodal Reasoning-Intensiv](hive_query_hypothesize_verify_an_llm_framework_for_multimodal_reasoning-intensiv.md)**
...
**[Its Time To Get It Right Improving Analog Clock Reading And Clock-Hand Spatial R](its_time_to_get_it_right_improving_analog_clock_reading_and_clock-hand_spatial_r.md)**
...
**[Kvsmooth Mitigating Hallucination In Multi-Modal Large Language Models Through K](kvsmooth_mitigating_hallucination_in_multi-modal_large_language_models_through_k.md)**
...
**[Llmind Bio-Inspired Training-Free Adaptive Visual Representations For Vision-Lan](llmind_bio-inspired_training-free_adaptive_visual_representations_for_vision-lan.md)**

:   受人眼中央凹编码和皮层放大机制启发，提出无需训练的自适应采样框架 LLMind，通过 Möbius 变换实现非均匀像素分配，并利用闭环语义反馈在测试时优化采样参数，在仅使用 1%-5% 像素的紧张预算下大幅超越均匀采样。

**[Locate-Then-Sparsify Attribution Guided Sparse Strategy For Visual Hallucination](locate-then-sparsify_attribution_guided_sparse_strategy_for_visual_hallucination.md)**
...
**[Masquant Modality-Aware Smoothing Quantization For Multimodal Large Language Mod](masquant_modality-aware_smoothing_quantization_for_multimodal_large_language_mod.md)**

:   揭示了通道平滑量化（如 SmoothQuant）直接应用于 MLLM 时的"平滑失配"问题——不同模态激活幅度差异巨大导致非主导模态被过度平滑，提出 MASQuant 通过模态感知平滑因子和基于 SVD 白化的跨模态低秩补偿解决该问题。

**[Mastering Negation Boosting Grounding Models Via G](mastering_negation_boosting_grounding_models_via_g.md)**
...
**[Modes Moe Dynamic Expert Skipping](modes_moe_dynamic_expert_skipping.md)**
...
**[Moe-Grpo Optimizing Mixture-Of-Experts Via Reinforcement Learning In Vision-Lang](moe-grpo_optimizing_mixture-of-experts_via_reinforcement_learning_in_vision-lang.md)**
...
**[Mos Mixture Of States Multimodal Generation](mos_mixture_of_states_multimodal_generation.md)**
...
**[Mostly Text Smart Visuals Asymmetric Text-Visual Pruning For Large Vision-Langua](mostly_text_smart_visuals_asymmetric_text-visual_pruning_for_large_vision-langua.md)**
...
**[Msjoe Jointly Evolving Mllm And Sampler For Efficient Long-Form Video Understand](msjoe_jointly_evolving_mllm_and_sampler_for_efficient_long-form_video_understand.md)**
...
**[Narrative Weaver Towards Controllable Long-Range Visual Consistency With Multi-M](narrative_weaver_towards_controllable_long-range_visual_consistency_with_multi-m.md)**

:   提出 Narrative Weaver 框架，结合 MLLM 的叙事规划与扩散模型的精细生成，通过可学习查询和动态 Memory Bank 实现多模态条件下的长程视觉一致性生成，并构建首个电商广告视频分镜数据集 EAVSD（330K+ 图像）。

**[No Hard Negatives Required Concept Centric Learning Leads To Compositionality Wi](no_hard_negatives_required_concept_centric_learning_leads_to_compositionality_wi.md)**
...
**[Noiseaware Fewshot Learning Through Bidirectional](noiseaware_fewshot_learning_through_bidirectional.md)**

:   提出NA-MVP框架，通过双向（clean+noise-aware）多视图prompt设计配合非平衡最优传输（UOT）实现细粒度patch-to-prompt对齐，并用经典OT对识别出的噪声样本做选择性标签修正，在噪声小样本学习场景下持续超越SOTA。

**[Oddgridbench Exposing The Lack Of Fine-Grained Visual Discrepancy Sensitivity In](oddgridbench_exposing_the_lack_of_fine-grained_visual_discrepancy_sensitivity_in.md)**
...
**[On Tokens Dilemma Dynamic Moe With Drift-Aware Token Assignment For Continual Le](on_tokens_dilemma_dynamic_moe_with_drift-aware_token_assignment_for_continual_le.md)**
...
**[Overthinking Causes Hallucination Tracing Confounder Propagation In Vision Langu](overthinking_causes_hallucination_tracing_confounder_propagation_in_vision_langu.md)**
...
**[Predictive Regularization Against Visual Representation Degradation In Multimoda](predictive_regularization_against_visual_representation_degradation_in_multimoda.md)**
...
**[Prime Once Then Reprogram Locally An Efficient Alternative To Black-Box Service ](prime_once_then_reprogram_locally_an_efficient_alternative_to_black-box_service_.md)**
...
**[Prune2Drive Vlm Accel Autonomous Driving](prune2drive_vlm_accel_autonomous_driving.md)**
...
**[Purify-Then-Align Towards Robust Human Sensing Under Modality Missing With Knowl](purify-then-align_towards_robust_human_sensing_under_modality_missing_with_knowl.md)**
...
**[Residual Decoding Mitigating Hallucinations In Large Vision-Language Models Via ](residual_decoding_mitigating_hallucinations_in_large_vision-language_models_via_.md)**
...
**[Revisiting Multimodal Kv Cache Compression A Frequency-Domain-Guided Outlier-Kv-](revisiting_multimodal_kv_cache_compression_a_frequency-domain-guided_outlier-kv-.md)**
...
**[Scaling The Long Video Understanding Of Multimodal Large Language Models Via Vis](scaling_the_long_video_understanding_of_multimodal_large_language_models_via_vis.md)**
...
**[Seeing Clearly Reasoning Confidently Plug-And-Play Remedies For Vision Language ](seeing_clearly_reasoning_confidently_plug-and-play_remedies_for_vision_language_.md)**
...
**[Ssr2Gcd Rate Reduction Category Discovery](ssr2gcd_rate_reduction_category_discovery.md)**

:   提出SSR2-GCD框架，通过半监督率缩减(SSR2)损失替代传统对比损失来学习均匀压缩的结构化表示，并发现模态间对齐在多模态GCD中不仅不必要甚至有害，在Stanford Cars和Flowers102上分别领先SOTA 3.1%和6.3%。

**[Star See Think Act Gui Agent Toggles](star_see_think_act_gui_agent_toggles.md)**
...
**[Taxonomy-Aware Representation Alignment For Hierarchical Visual Recognition With](taxonomy-aware_representation_alignment_for_hierarchical_visual_recognition_with.md)**

:   提出TARA框架，通过将LMM的中间表示与生物基础模型(BFM)的分类学感知特征对齐，为大型多模态模型注入分类层次知识，显著提升已知和新颖类别的层次化视觉识别性能。

**[Tell Model Where To Look Mitigating Hallucinations In Mllms By Vision-Guided Att](tell_model_where_to_look_mitigating_hallucinations_in_mllms_by_vision-guided_att.md)**
...
**[Text-Only Training For Image Captioning With Retrieval Augmentation And Modality](text-only_training_for_image_captioning_with_retrieval_augmentation_and_modality.md)**

:   提出TOMCap——一种纯文本训练的图像描述方法，通过检索增强+模态差距修正+LoRA微调，在训练时只用文本而推理时处理图像，超越了已有的无训练和纯文本方法。

**[The Llm Bottleneck Why Open-Source Vision Llms Struggle With Hierarchical Visual](the_llm_bottleneck_why_open-source_vision_llms_struggle_with_hierarchical_visual.md)**
...
**[Think 360 Evaluating The Width-Centric Reasoning Capability Of Mllms Beyond Dept](think_360_evaluating_the_width-centric_reasoning_capability_of_mllms_beyond_dept.md)**
...
**[Thinking In Dynamics How Multimodal Large Language Models Perceive Track And Rea](thinking_in_dynamics_how_multimodal_large_language_models_perceive_track_and_rea.md)**
...
**[Uncertainty-Guided Compositional Alignment With Part-To-Whole Semantic Represent](uncertainty-guided_compositional_alignment_with_part-to-whole_semantic_represent.md)**
...
**[Unimmad Multimodal Moe Anomaly Detection](unimmad_multimodal_moe_anomaly_detection.md)**
...
**[V2Drop Variation Aware Token Dropping](v2drop_variation_aware_token_dropping.md)**
...
**[Venus Benchmarking And Empowering Multimodal Large Language Models For Aesthetic](venus_benchmarking_and_empowering_multimodal_large_language_models_for_aesthetic.md)**

:   定义审美指导(AG)新任务并构建AesGuide基准(10748张照片含审美评分、分析和指导标注)，提出Venus两阶段框架——先通过渐进式审美问答赋能MLLM审美指导能力，再通过CoT推理激活审美裁剪能力，在两个任务上均达到SOTA。

**[Vggdrive Empowering Vision-Language Models With Cross-View Geometric Grounding F](vggdrive_empowering_vision-language_models_with_cross-view_geometric_grounding_f.md)**
...
**[Videofusion A Spatiotemporal Collaborative Network](videofusion_a_spatiotemporal_collaborative_network.md)**
...
**[Vision-Language Models Encode Clinical Guidelines For Concept-Based Medical Reas](vision-language_models_encode_clinical_guidelines_for_concept-based_medical_reas.md)**
...
**[Vision On Request Enhanced Vllm Efficiency With Sparse Dynamically Selected Visi](vision_on_request_enhanced_vllm_efficiency_with_sparse_dynamically_selected_visi.md)**
...
**[Vlm-Pruner Buffering For Spatial Sparsity In An Efficient Vlm Centrifugal Token ](vlm-pruner_buffering_for_spatial_sparsity_in_an_efficient_vlm_centrifugal_token_.md)**
...
**[When Token Pruning Is Worse Than Random Understanding Visual Token Information I](when_token_pruning_is_worse_than_random_understanding_visual_token_information_i.md)**
...
**[Which Concepts To Forget And How To Refuse Decomposing Concepts For Continual Un](which_concepts_to_forget_and_how_to_refuse_decomposing_concepts_for_continual_un.md)**
