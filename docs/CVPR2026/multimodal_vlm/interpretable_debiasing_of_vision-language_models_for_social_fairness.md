...
description: >-
  [CVPR 2026][多模态][VLM去偏] 提出 DeBiasLens，通过在 VLM 编码器上训练稀疏自编码器（SAE）来定位编码社会属性的"社会神经元"，然后在推理时选择性去激活这些神经元以缓解偏见，在 CLIP 上降低 Max Skew 9-16%，在 InternVL2 上降低性别偏差比例 40-50%，同时保持通用性能。
tags:
  - CVPR 2026
  - 多模态
  - VLM去偏
...
2. **社会神经元探测（Social Neuron Probing）**:
    ...
    - 功能：在 SAE 的稀疏表示中找到编码特定社会属性（性别/年龄/种族）的神经元
...
- [\[CVPR 2026\] A Closed-Form Solution for Debiasing Vision-Language Models with Utility Guarantees Across Modalities and Tasks](a_closed-form_solution_for_debiasing_vision-language_models_with_utility_guarant.md)
