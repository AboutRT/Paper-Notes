...
description: >-
  [CVPR 2026][多模态VLM][VLA预训练] 提出 JALA 框架，通过联合对齐预测嵌入与逆动力学生成的潜在动作，构建统一的潜在动作空间，使 VLA 能同时从标注数据和未标注的野外人类视频中学习，配合 7.5M 样本的 UniHand-Mix 数据集显著提升机器人操作泛化性。
tags:
  - "CVPR 2026"
  - "多模态VLM"
  - "VLA预训练"
...
2. **Latent Action Perceiver (LAP) + Latent State Perceiver (LSP) 的解耦更新**:
    ...
    - 功能：稳定地从视觉特征中提取潜在动作并与 VLA 上下文对齐
