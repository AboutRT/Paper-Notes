...
description: >-
  [CVPR 2026][多模态VLM][MLLM幻觉] 发现 MLLM 在细粒度负查询（涉及多个对象/属性/关系的查询中仅有一个细微错误）下幻觉率急剧上升，提出 FINER 基准和 FINER-Tuning 方法（基于 DPO），在 InternVL3.5-14B 上最高提升 24.2%。
tags:
  - "CVPR 2026"
  - "多模态VLM"
  - "MLLM幻觉"
...
1. **FINER 基准（FINER-CompreCap + FINER-DOCCI）**:
    ...
    - 功能：构建涵盖多对象(Multi-obj)、多属性(Multi-attr)、多关系(Multi-rel)和 Wh-问题四种设置的细粒度基准
