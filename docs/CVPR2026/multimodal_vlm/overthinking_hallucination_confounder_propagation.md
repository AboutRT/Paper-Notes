...
description: >-
  [CVPR 2026][VLM幻觉] 发现VLM幻觉的新机制——"过度思考"(overthinking)：模型中间层产生过多竞争性物体假设导致混杂因子传播到最终层，提出Overthinking Score量化层间假设多样性与不确定性，在MSCOCO上达78.9% F1、AMBER上71.58% F1。
tags:
  - CVPR 2026
  - 多模态
  - VLM幻觉
...
1. **混杂因子传播（Confounder Propagation）的发现与验证**:
    ...
    - 做什么：揭示幻觉的层间传播机制——中间层的语义关联物体假设如何"污染"最终预测
