...
description: >-
  [CVPR 2026][多模态VLM][自动驾驶] 提出VGGDrive框架，通过冻结的3D视觉基础模型VGGT为VLM注入跨视图几何感知能力，设计插拔式CVGE模块分层自适应地将3D特征注入VLM各层的2D视觉嵌入中，在五个自动驾驶基准上实现显著性能提升。
tags:
  - "CVPR 2026"
  - "多模态VLM"
  - "自动驾驶"
...
1. **分层自适应注入机制（Hierarchical Adaptive Injection）**:
    ...
    - 功能：将冻结VGGT的3D几何信息分层注入VLM每一层decoder的2D视觉嵌入中
