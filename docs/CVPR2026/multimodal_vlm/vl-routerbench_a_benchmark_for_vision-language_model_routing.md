...
description: >-
  [CVPR 2026][多模态VLM][模型路由] 提出VL-RouterBench，首个面向视觉-语言模型的系统性路由基准，涵盖14个数据集、17个候选模型和519,180个样本-模型对，评估10种路由方法，并发现当前最优路由器与理想Oracle之间仍存在显著差距。
tags:
  - "CVPR 2026"
  - "多模态VLM"
  - "模型路由"
...
2. **准确率-成本感知软标签策略**:
    ...
    - 功能：通过可调参数 $\lambda$ 显式控制训练时的准确率-成本权衡
