...
3. **Logits Reversal（本文核心方法）**:
    ...
    - 功能：在计算 FIM 时，将 logits $z_k$ 取反为 $\tilde{z}_k = -z_k$
...
- [Lifelong Learning with Behavior Consolidation for Vehicle Routing](../../ICLR2026/llm_safety/lifelong_learning_with_behavior_consolidation_for_vehicle_routing.md)
