...
description: >-
  [CVPR 2026][自动驾驶][毫米波雷达] 提出 EMDUL 管线，通过伪标签标注无标注毫米波数据（含新设计的无监督时序一致性损失 UTCL）和闭式 LiDAR→mmWave 点云转换器（含基于流的点过滤 FPF），大幅扩展毫米波 HPE 数据集的规模与多样性…
tags:
  - "CVPR 2026"
  - "自动驾驶"
  - "毫米波雷达"
...
1. **无监督时序一致性损失（UTCL）**
    ...
    - 功能：在无标注 mmWave 数据上施加时序一致性约束，提升伪标签质量
...
2. **基于流的点过滤（FPF）**
    ...
    - 功能：模拟 mmWave 雷达的运动检测机制，将 LiDAR 点云转换为具备 mmWave 特征的点云
