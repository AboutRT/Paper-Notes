...
description: >-
  8篇CVPR2026 优化/理论方向论文深度解读，每篇5分钟读懂核心思想。每篇笔记含一句话总结、背景动机、方法详解、实验数据、亮点洞察与局限性分析。
---
...
**[Fed-Ade Adaptive Learning Rate For Federated Post-Adaptation Under Distribution ](fed-ade_adaptive_learning_rate_for_federated_post-adaptation_under_distribution_.md)**
...
**[The Power Of Decaying Steps Enhancing Attack Stability And Transferability For S](the_power_of_decaying_steps_enhancing_attack_stability_and_transferability_for_s.md)**
...
**[Unifusion A Unified Image Fusion Framework With Robust Representation And Source](unifusion_a_unified_image_fusion_framework_with_robust_representation_and_source.md)**
