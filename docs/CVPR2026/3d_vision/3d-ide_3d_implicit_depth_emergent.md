---
description: "【论文笔记】3D-IDE: 3D Implicit Depth Emergent 论文解读 | CVPR 2026 | arXiv 2604.03296 | 3D场景理解 | 提出\"隐式几何涌现原则\"（IGEP），通过训练时的轻量级几何验证器和全局3D教师进行特权监督，使视觉编码器在仅输入RGB视频时即具备3D感知能力，推理时零延迟开销，在多个3D场景理解基准上超越同类方法。"
tags:
  - CVPR 2026
  - 3D场景理解
  - 多模态大语言模型
