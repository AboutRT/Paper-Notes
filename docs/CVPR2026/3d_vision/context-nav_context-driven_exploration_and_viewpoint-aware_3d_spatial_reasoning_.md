...
1. **上下文驱动的 Value Map**
    ...
    - 功能：将完整的文本描述编码为全局探索信号，引导 agent 优先探索与描述语义一致的区域
...
2. **房间级约束**
    ...
    - 功能：在特定条件下覆盖全局 value map 排序，强制 agent 优先探索目标所在房间的未知区域
...
3. **视点感知的 3D 空间关系验证**
    ...
    - 功能：在 3D 空间中验证候选目标与上下文物体之间的空间关系，显式处理视角歧义
    - 核心思路：四步流程：
