---
title: "[论文解读] Catalyst4D: High-Fidelity 3D-to-4D Scene Editing via Dynamic Propagation"
description: "[CVPR 2026][3D视觉][4D编辑] 提出Catalyst4D通过锚点运动引导(AMG)和颜色不确定性外观精炼(CUAR)将高质量3D静态编辑传播到动态4D高斯场景，实现时空一致的4D编辑"
tags:
  - CVPR 2026
  - 3D视觉
  - 4D编辑
...
1. **锚点运动引导（Anchor-based Motion Guidance, AMG）**:
    - 做什么：建立编辑前后高斯之间稳定的区域级运动对应，避免逐点匹配的噪声问题
