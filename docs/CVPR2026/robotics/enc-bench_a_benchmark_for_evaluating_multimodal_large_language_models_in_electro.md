---
title: "[论文解读] ENC-Bench: A Benchmark for Evaluating MLLMs in Electronic Navigational Chart Understanding"
description: "[CVPR 2026][多模态基准][海图理解] 首个面向电子航海图理解的专业级基准，三级层次评估揭示最佳MLLM准确率仅47.88%"
tags:
  - CVPR 2026
  - 多模态基准
  - 海图理解
...
**本文要解决什么？** 系统评估当前 MLLM 能否可靠解读 ENC，量化其在专业海事领域的实际能力边界。

**切入角度**：模拟持证航海员的认知流程，设计从符号识别到安全关键决策的层次化评估体系。

**核心idea一句话**：构建三级层次(感知→空间推理→决策)的 ENC 专业基准，首次严格评估 MLLM 在海事安全关键场景中的表现。
...
1. **三级层次评估体系**:
    - 做什么：将 ENC 理解分解为感知(L-1, 4 类任务)、空间推理(L-2, 3 类任务)、海事决策(L-3, 3 类任务)共 10 类任务
...
2. **多条件渲染与严格质量控制**:
    - 做什么：每张图在 3 种光照模式(日间/黄昏/夜间)×6 种缩放级别(1:50K~1:300K)下渲染，共 18 种条件变体
