...
description: >-
  [CVPR 2026][机器人][双臂操作] 利用预训练3D几何基础模型π3作为感知骨干，融合3D几何、2D语义和本体感知特征，通过扩散模型联合预测未来动作chunk和未来3D Pointmap，仅使用RGB输入就在RoboTwin双臂基准上全面超越点云方法。
tags:
  - "CVPR 2026"
  - "机器人"
  - "双臂操作"
...
**本文目标**：能否用预训练3D几何基础模型替代显式点云管线，实现仅RGB输入的3D感知双臂操作策略，并通过联合预测未来3D几何获得预测性规划能力？
