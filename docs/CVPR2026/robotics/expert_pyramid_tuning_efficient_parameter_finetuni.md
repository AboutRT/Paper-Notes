...
description: >-
  [CVPR 2026][机器人][参数高效微调] 提出 Expert Pyramid Tuning (EPT)，将 CV 中的多尺度特征金字塔思想引入 MoE-LoRA 框架，通过共享元知识子空间 + 不同尺度的反卷积专家 + 对比学习任务嵌入，以仅 0.41M 参数/任务在 GLUE 上达到 87.0% 均分（超越所有 MoE-LoRA 基线）。
tags:
  - CVPR 2026
  - 机器人
  - 参数高效微调
...
1. **共享元知识子空间（Meta-knowledge Subspace）**
    ...
    - 做什么：编码所有任务共享的通用语言模式，作为所有专家的"种子"
...
2. **金字塔投影机制（Pyramid Projection）**
    ...
    - 做什么：将低维元知识种子投影到不同粒度的高维特征空间，形成参数金字塔
