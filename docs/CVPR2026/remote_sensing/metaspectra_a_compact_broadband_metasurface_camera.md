...
description: >-
  [CVPR 2026][遥感/计算成像][超表面高光谱] 提出双层超表面-折射混合光学系统MetaSpectra+，通过色散控制实现250nm宽带多功能快照成像，同时获取高光谱+HDR/偏振，PSNR 33.31dB超越所有快照高光谱系统且总光程最短(17mm)
tags:
  - CVPR 2026
  - 遥感
  - 计算成像
...
**本文要解决什么？** 在保持超表面系统紧凑性的同时突破其带宽限制，并实现高光谱+HDR/偏振的多功能快照成像。

**切入角度**：将色散从"缺陷"重新定义为"可控功能"——部分通道保留色散用于光谱编码，部分通道消除色散用于HDR/偏振，两者共存于同一系统中。

**核心idea一句话**：分束超表面+色散控制超表面的双层设计，解耦成像与分束功能，通过联合调控偏转向量实现每个光通道的色散精确控制或消除。
