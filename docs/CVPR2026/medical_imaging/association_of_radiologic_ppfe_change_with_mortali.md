...
description: >-
  [CVPR 2026][医学影像][PPFE定量分析] 在NLST和SUMMIT两个大规模肺癌筛查队列中，用深度学习自动量化低剂量CT上PPFE纵向进展，验证其与全因死亡率和呼吸系统不良结局的独立关联
tags:
  - CVPR 2026
  - 医学影像
  - PPFE
