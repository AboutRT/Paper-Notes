---
description: "【论文笔记】Association of Radiologic PPFE Change with Mortality in Lung Cancer Screening Cohorts 论文解读 | CVPR 2026 | arXiv 2603.09531 | PPFE | 在 NLST（n=7980）和 SUMMIT（n=8561）两个大规模肺癌筛查队列中，利用深度学习自动分割量化低剂量 CT 上 PPFE 的纵向变化（dPPFE），验证其与全因死亡率（HR=1.25/3.14）和呼吸系统发病率的独立关联。"
tags:
  - CVPR 2026
  - PPFE
  - 肺癌筛查
