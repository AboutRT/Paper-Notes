---
description: 构建7408例CBCT-报告配对数据集，开发双语报告生成系统CBCTRepD，在多层级临床评估中帮助各经验水平放射科医生提升报告质量
tags:
  - CVPR2026
  - medical-imaging
  - report-generation
...
1. **大规模口腔颌面CBCT-报告配对数据集**:
    ...
    - 做什么：从真实临床环境中收集并标注约7,408例CBCT-报告配对数据
...
3. **多层级临床评估框架**:
    ...
    - 做什么：建立一套临床接地的评估体系，同时评估AI直接生成的草稿和医生编辑后的协作报告
