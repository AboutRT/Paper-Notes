---
title: "[论文解读] Bridging the Skill Gap in Clinical CBCT Interpretation with CBCTRepD"
description: "[CVPR 2026][医学图像][CBCT报告生成] 提出CBCTRepD口腔颌面CBCT双语报告生成系统，基于7408例配对数据集和多层级临床评估框架，实现不同经验水平放射科医生的分级赋能"
tags:
  - CVPR 2026
  - 医学图像
  - CBCT报告生成
...
1. **大规模高质量配对数据集**:
    - 做什么：构建口腔颌面CBCT领域迄今最大规模的影像-报告配对数据集
...
2. **多层级临床评估框架**:
    - 做什么：建立覆盖"AI直接输出"和"医生-AI协作输出"两个层级的评估体系
