...
**功能**：在每层为每个 patch 动态选择最优专家组合来适配其表示。
...
**功能**：在 LoRA 专家的输入端强制分离特征子空间，消除输入级冗余。
...
**功能**：在 LoRA 专家的输出端约束专家向量最大等角分离，消除输出级冗余。
...
**功能**：在训练阶段整合多尺度上下文信息，提升对不同大小异常的检测能力。
