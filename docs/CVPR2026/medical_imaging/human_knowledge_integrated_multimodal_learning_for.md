...
description: >-
  [CVPR 2026][医学影像][单源域泛化] 提出域保形界理论框架量化因果因子差异，通过知识精炼和MedGemma-4B LoRA微调整合专家知识到VLM中实现单源域泛化
tags:
  - CVPR 2026
  - 医学影像
  - 单源域泛化
