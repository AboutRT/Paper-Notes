...
description: >-
  [CVPR2026][图像生成][去中心化扩散模型] 提出异构去中心化扩散框架，允许不同专家使用不同扩散目标（DDPM ε-prediction 与 Flow Matching velocity-prediction）完全独立训练，在推理时通过确定性 schedule-aware 转换统一到速度空间进行融合…
tags:
  - "CVPR2026"
  - "图像生成"
  - "去中心化扩散模型"
