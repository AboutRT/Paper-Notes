...
description: >-
  [CVPR 2026][图像生成][VAE压缩] 提出 Detail-Aligned VAE (DA-VAE)，通过在预训练 VAE 的潜空间中引入结构化的"细节通道"并施加对齐约束，在不重训扩散模型的前提下将 token 数压缩 4 倍…
tags:
  - "CVPR 2026"
  - "图像生成"
  - "VAE压缩"
...
**代码**: [项目页面](https://caixin98.github.io/davae)  
**领域**: Image Generation  
