---
description: "【论文笔记】AS-Bridge: A Bidirectional Generative Framework Bridging Next-Generation Astronomical Surveys 论文解读 | CVPR 2026 | arXiv 2603.11928 | 天文巡天 | 提出 AS-Bridge，一个基于 Brownian Bridge 扩散过程的双向生成框架，在地基 LSST 与空基 Euclid 天文巡天之间建模概率条件分布，实现跨巡天图像翻译和罕见事件检测（引力透镜），并通过 ε-prediction 训练目标改进了标准 Brownian Bridge 的似然估计。"
tags:
  - CVPR 2026
  - 天文巡天
  - Brownian Bridge
