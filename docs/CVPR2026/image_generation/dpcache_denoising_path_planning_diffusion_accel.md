---
description: "【论文笔记】DPCache: 去噪即路径规划——免训练扩散模型加速 论文解读 | CVPR 2026 | arXiv 2602.22654 | 扩散加速 | 将扩散采样加速形式化为全局路径规划问题，通过Path-Aware Cost Tensor量化路径依赖的跳步误差，用动态规划选出最优关键时间步序列，在FLUX上实现4.87×加速且ImageReward反超全步基线。"
tags:
  - CVPR 2026
  - 扩散加速
  - 缓存
