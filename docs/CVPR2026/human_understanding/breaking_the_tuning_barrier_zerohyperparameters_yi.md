...
description: >-
  [CVPR 2026][人体理解][yield analysis] 用 TabPFN 基础模型的学习先验替代人工设计先验，实现零超参数调优的多角（PVT）良率分析，结合自动特征选择（1152D→48D）和不确定性引导主动学习，在工业级 SRAM 基准上达到 SOTA 精度（MRE 低至 0.11%）同时减少 10× 以上验证成本。
tags:
  - CVPR 2026
  - 人体理解
  - yield analysis
