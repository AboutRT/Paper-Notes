...
description: >-
  [CVPR 2026][图像恢复][图像去雾] 提出H2C文本引导无监督损失利用CLIP语义对齐做去雾，并通过双层优化自动搜索最佳LoRA注入层，实现高效的合成到真实域去雾适配
tags:
  - CVPR 2026
  - 图像恢复
  - 图像去雾
