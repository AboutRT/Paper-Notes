...
description: >-
  [CVPR 2026][自监督学习][Document Dewarping] 提出 D2Dewarp——首个从水平和垂直双维度学习文档几何表示的去畸变方法：UNet 双解码器分别预测水平线（文档/表格/文本行的上下边界）和垂直线（左右边界）…
tags:
  - "CVPR 2026"
  - "自监督学习"
  - "Document Dewarping"
...
- **功能**：共享编码器输出后分叉为 H-Decoder 和 V-Decoder，各自预测对应方向的几何线条
...
- **功能**：融合 H-Decoder 和 V-Decoder 中间层的特征，使两个方向互相提供上下文
- **核心结构**：
