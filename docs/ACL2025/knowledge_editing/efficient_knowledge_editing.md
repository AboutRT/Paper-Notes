...
description: >-
  [ACL 2025][知识编辑][knowledge editing] 证明了 MEMIT/ROME/EMMET 等知识编辑方法的预计算步骤（缓存 4400 万隐向量）可以减少到理论最小值的 2-10 倍（不到原来的 0.3%），将预计算时间从数十小时降到几分钟，且编辑性能基本无损。
tags:
  - "ACL 2025"
  - "知识编辑"
  - "knowledge editing"
...
**核心 idea**：预计算的向量数量只需达到 key 向量维度 $d_k$ 的数倍即可保证编辑性能
...
1. **理论最小值推导**:
    ...
    - 功能：推导 $C_{eff} = \lambda C_0 + K_E K_E^T$ 可逆的最小条件
