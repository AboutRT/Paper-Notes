...
description: >-
  [ACL 2025][注意力机制] 本文探究 Transformer Grammar（TG）的注意力机制能否作为人类记忆检索的认知模型，通过 Normalized Attention Entropy（NAE）将模型与人类阅读时间关联，发现基于句法结构的注意力比基于 token 的注意力更能解释人类句子处理行为…
tags:
  - "ACL 2025"
  - "注意力机制"
  - "人类记忆检索"
