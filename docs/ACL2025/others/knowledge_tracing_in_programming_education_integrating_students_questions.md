...
1. **代码提交的复杂性**：编程任务复杂，同一问题有多种正确解法，需要从非结构化、嘈杂的源码中评估学生能力
2. **传统 Q-matrix 方法的局限**：手动标注每道题所需技能（knowledge components）既耗时又难以捕捉学生实际使用的全部技能
3. **学生提问的信息价值被忽视**：学生的提问直接反映了困惑区域和理解深度，比代码提交更能清晰揭示学习状态
