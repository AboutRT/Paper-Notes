...
**本文要解决什么？** (1) 如何低成本地大规模收集与 BLV 偏好对齐的标注数据？ (2) 如何在没有 BLV 特化奖励模型的情况下进行偏好对齐微调？ (3) 如何构建一个支持补全、偏好、检索、VQA、推理等多任务的 BLV 数据集？
...
**核心idea一句话**：用 VLM 引导生成 + 视力正常者多维评估 + BLV 教育者验证，构建首个大规模 BLV 对齐的多任务图表描述数据集。
