...
2. **原作者交叉验证**:
    ...
    - 功能：将专家发现的疑似剽窃案例发回给被"剽窃"的原论文作者确认
    - 核心思路：最了解自己工作的人来判断相似度是否构成剽窃
    - 结果：原作者确认了专家的判断

3. **自动检测器评估**:

    - 功能：测试现有剽窃检测工具能否识别 AI 的"智能剽窃"
