...
1. **领域现状**：自闭症的医学模型将其定义为"疾病"和"缺陷"，这种框架在技术研究中被广泛使用，但与推崇所有神经类型均为人类多样性有效形式的"神经多样性"理念相冲突。反自闭症歧视语言因其微妙性和上下文依赖性，对 NLP 研究构成重大挑战。
2. **现有方法的不足**：
...
3. **核心动机**：构建以自闭症人群视角为中心的标注数据集，并评估当前 NLP 工具在该任务上的能力
