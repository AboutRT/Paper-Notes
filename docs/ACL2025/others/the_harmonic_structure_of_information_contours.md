...
description: >-
  [ACL 2025][uniform information density] 提出 Harmonic Surprisal (HS) 假说——文本中 surprisal 曲线呈周期性波动且周期与语篇结构（EDU/句子/段落）对齐，用带时间缩放的谐波回归检验，在 6 种语言上发现一致的周期模式…
tags:
  - "ACL 2025"
...
1. **谐波回归**：
    ...
    - 功能：将 surprisal 建模为多个正弦和余弦分量的线性组合
