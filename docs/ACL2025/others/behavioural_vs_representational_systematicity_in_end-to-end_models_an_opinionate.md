...
description: >-
  [ACL 2025][系统性] 区分行为系统性与表征系统性，基于 Hadley 三级分类分析主要基准，呼吁用机械可解释性补充行为评估。
tags:
  - ACL 2025
  - 系统性
  - 组合性
...
**本文要解决什么？** 澄清行为系统性与表征系统性的区别，分析现有基准的实际测试范围，指出通往强系统性评估的路径。

**切入角度**：引入 Hadley (1994) 的三级系统性分类作为分析工具，结合心理学中操作化和能力-表现区分的理论传统。

**核心idea一句话**：不是模型做对了就说明它"理解"了——行为证据需要机械可解释性的表征证据来补充。
