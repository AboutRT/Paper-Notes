---
description: "【论文笔记】A Little Human Data Goes A Long Way 论文解读 | ACL 2025 | arXiv 2410.13098 | 合成数据 | 首次系统研究合成数据在事实验证和问答中能否替代人工标注——替换 90% 仅轻微下降，但替换最后 10% 严重退化；仅 125 条人工数据可显著提升纯合成模型，等效增益需 10 倍以上合成数据。"
tags:
  - ACL 2025
  - 合成数据
  - 人工标注
