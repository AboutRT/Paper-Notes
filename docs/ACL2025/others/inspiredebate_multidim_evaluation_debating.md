...
**本文目标** 如何构建一个统一的主观-客观辩论评估体系，并用它来引导 LLM 辩论能力的多维优化？

**切入角度**：用一阶逻辑评逻辑有效性、用外部搜索验事实真实性、用 DPO 以多维评分为奖励信号来优化模型。

**核心 idea**：先建立一个融合主观（情感/清晰度/编排/相关性）+客观（逻辑符号推理+搜索验证事实）的评估系统InspireScore，再用InspireScore的多维反馈通过DPO来迭代优化辩论LLM。
