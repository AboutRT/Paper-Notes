---
title: >-
  [论文解读] Value Residual Learning
description: >-
  [ACL 2025][Value残差连接] 提出 ResFormer 和 SVFormer，通过在注意力机制中引入第一层 Value 向量到后续层的残差连接，增强初始 token 级信息在深层网络中的传播，以比标准 Transformer 少 16.11% 的参数和 20.3% 的训练数据达到同等性能…
tags:
  - "ACL 2025"
  - "Value残差连接"
  - "Transformer"
