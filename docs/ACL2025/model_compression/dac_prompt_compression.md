...
**本文目标** 更精准地识别低信息量 token 并处理压缩过程中的熵变化。

**切入角度**：融合信息熵和注意力分数两种信号，并引入迭代动态更新机制。

**核心 idea**：结合注意力分数和信息熵作为 token 重要性度量，通过迭代动态更新被影响 token 的熵来实现更精准的压缩。
