---
title: >-
  [论文解读] L4Q: Parameter Efficient Quantization-Aware Fine-Tuning on Large Language Models
description: >-
...
**QLoRA/LoftQ 方案**：先PTQ量化，再LoRA微调。高精度LoRA参数无法与低精度量化权重合并，推理时产生额外的混合精度开销

**QA-LoRA 方案**：通过约束LoRA矩阵结构使其可整合到量化偏置中，但这种约束限制了微调能力

**两阶段割裂问题**：量化和微调分开优化，量化参数更新不会影响LoRA参数，反之亦然，无法实现全局最优
