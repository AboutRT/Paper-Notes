...
description: >-
  [ACL 2025 (Findings)][多语言/翻译][multilingual ICL] 系统分析多语言 ICL 策略，发现在 prompt 中混合多种高资源语言（HRL）的 demonstrations 一致性优于纯英文 demonstrations…
tags:
  - "ACL 2025 (Findings)"
  - "多语言/翻译"
  - "multilingual ICL"
...
**核心矛盾**：Shi et al. (2023) 已经发现混合 HRL demonstrations 有效，但**为什么有效**缺乏系统理解——是多语言信息本身有用，还是特定语言组合更关键？

**本文目标**：系统化分析多语言 ICL 的工作机制——何时有效、为什么有效、哪些语言最有用。
