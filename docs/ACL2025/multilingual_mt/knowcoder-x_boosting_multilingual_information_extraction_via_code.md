...
description: >-
  [ACL 2025][多语言/翻译][跨语言IE] 提出 KnowCoder-X，通过统一的 Python 类表示多语言 IE schema，并引入 IE 跨语言对齐指令微调阶段（含高质量 ParallelNER 数据集），在 64 个 IE 基准上大幅提升跨语言信息抽取性能。
tags:
  - "ACL 2025"
  - "多语言/翻译"
  - "跨语言IE"
...
**代码**: [ICT-GoKnow/KnowCoder](https://github.com/ICT-GoKnow/KnowCoder)  
**领域**: 多语言翻译  
