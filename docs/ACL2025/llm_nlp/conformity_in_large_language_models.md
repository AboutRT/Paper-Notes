...
description: >-
  [ACL 2025 Main][LLM/NLP][从众效应] 将心理学中的 Asch 从众实验范式迁移到 LLM 上，系统研究了 LLM 的从众行为（conformity），发现所有模型都会受多数意见影响改变答案，且不确定性越高越容易从众…
tags:
  - "ACL 2025 Main"
  - "LLM/NLP"
  - "从众效应"
...
**Sycophancy（迎合性）研究**已发现 RLHF 训练的模型会讨好用户，但这主要是一对一场景下的问题，与多方对话中的从众效应不同
