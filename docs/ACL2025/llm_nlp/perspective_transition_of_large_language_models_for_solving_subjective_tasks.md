---
title: >-
  [论文解读] Perspective Transition of Large Language Models for Solving Subjective Tasks
description: >-
  [ACL 2025][LLM/NLP][视角转换] 提出 RPT（Reasoning through Perspective Transition），通过在同一 prompt 中让 LLM 依次探索直接/角色扮演/第三人称三种视角、按置信度排序、选最优视角推理，在 12 个主观任务、4 个模型（GPT-4/GPT-3.5/Llama-3/Qwen-2）上均超越固定视角与集成基线，GPT-3.5 上平均提升 +4.56 点。
tags:
  - ACL 2025
  - LLM/NLP
  - 视角转换
...
**领域现状**：LLM 在数学推理、代码生成、常识问答等客观任务上表现优异，但在**主观任务**（隐喻识别、讽刺检测、暗色幽默判断、立场检测、文化相关 NLI 等）上仍然受限。BigBench 数据显示，PaLM-535B 在隐喻识别、暗色幽默、讽刺检测等任务上零样本准确率不超过 50%。
...
**本文切入角度**：受心理学"心智理论"（Theory of Mind）启发——人类能从自身和他人视角理解行为，类似地让 LLM 在多种视角间**动态选择**。
