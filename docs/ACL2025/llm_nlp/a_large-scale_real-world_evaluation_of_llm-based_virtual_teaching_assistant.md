...
description: >-
  [ACL 2025][LLM应用][教育] 在韩国KAIST一门477人的研究生AI编程课程中部署基于GPT-4o-mini的虚拟助教(VTA)系统，通过三轮大规模问卷调查和3869条师生互动日志的深入分析，评估VTA在真实课堂中的有效性和接受度。
tags:
  - ACL 2025
  - LLM 应用
  - AI教育
...
**本文要解决什么**：通过大规模部署+纵向评估，系统性地回答VTA在真实课堂中的有效性、学生接受度演变以及与人类助教的互补关系。
