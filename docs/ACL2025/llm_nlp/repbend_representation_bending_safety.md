...
description: >-
  [ACL 2025][LLM/NLP][表示工程] 提出 RepBend，将 activation steering 的核心思想（安全/不安全表示的向量差异）引入 LoRA 微调的损失函数设计，通过"弯曲"模型的表示空间使安全和不安全状态在潜在空间中远离彼此…
tags:
  - "ACL 2025"
  - "LLM/NLP"
  - "表示工程"
...
**代码**: [https://github.com/AIM-Intelligence/RepBend](https://github.com/AIM-Intelligence/RepBend)  
**领域**: LLM/NLP  
...
**核心 idea**：用四项损失函数"弯曲"表示空间——保持安全表示不变、推远不安全表示、统一不安全响应方向、保留通用能力。
