...
description: >-
  [ACL 2025][LLM/NLP][alignment drift] 通过 LLM 模拟师生对话实验，发现基于 CEFR 等级的 system prompting 虽然能初步约束 LLM 输出的西班牙语难度，但随着对话轮次增加，这种约束效果逐渐衰减——作者将此现象命名为"alignment drift"…
tags:
  - "ACL 2025"
  - "LLM/NLP"
  - "alignment drift"
...
**代码**: [https://github.com/INTERACT-LLM/alignment-drift-llms](https://github.com/INTERACT-LLM/alignment-drift-llms)  
**领域**: LLM应用 / 教育NLP  
