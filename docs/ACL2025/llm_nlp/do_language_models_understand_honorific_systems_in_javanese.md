...
**本文要解决什么？** 系统评估 LLM 对爪哇语四级敬语系统的理解和生成能力，识别其偏向和局限。

**切入角度**：构建平衡分布的敬语语料库，设计覆盖理解和生成的四项基准任务。

**核心idea一句话**：通过构建首个标注爪哇语四级敬语的平衡语料库和四项评估任务，揭示当前 LLM 对复杂敬语系统的理解严重不足。
...
1. **Unggah-Ungguh 语料库构建**:
    ...
    - 做什么：从《Kamus Unggah-Ungguh Basa Jawa》等四本权威参考书中手动构建 4,024 句标注语料库
