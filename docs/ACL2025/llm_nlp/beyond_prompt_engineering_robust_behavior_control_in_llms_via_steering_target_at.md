...
description: >-
  [ACL 2025][LLM/NLP][行为控制] 提出 STA（Steering Target Atoms），利用稀疏自编码器 (SAE) 将 LLM 的表示解耦为原子知识组件，通过激活幅度和频率筛选目标原子并操控，实现比提示工程更鲁棒、更精细的行为控制…
tags:
  - "ACL 2025"
  - "LLM/NLP"
  - "行为控制"
...
**代码**: [https://github.com/zjunlp/steer-target-atoms](https://github.com/zjunlp/steer-target-atoms)  
**领域**: LLM / 可解释性 / AI安全  
