...
description: >-
  [ACL 2025][LLM/NLP][流式推理] 系统性地识别并量化了 batch-trained LLM 适配流式场景的三种不匹配（输入注意力 / 输出注意力 / 位置 ID），发现仅输入注意力不匹配才是关键瓶颈（+2.20 BLEU）…
tags:
  - "ACL 2025"
  - "LLM/NLP"
  - "流式推理"
...
**代码**: [https://github.com/EIT-NLP/StreamingLLM](https://github.com/EIT-NLP/StreamingLLM)  
**领域**: LLM/NLP  
