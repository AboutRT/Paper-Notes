...
description: >-
  [ACL 2025][LLM/NLP][token 粒度] 系统研究子词 token 粒度（词表大小 256~128K）对 LM surprisal 预测人类阅读时间能力的影响，发现 ~8K 词表的中等粒度在自然阅读时间预测上最优（甚至优于 GPT-2），而粗粒度 token 在花园路径句法效应上更敏感…
tags:
  - "ACL 2025"
  - "LLM/NLP"
  - "token 粒度"
...
- [\[ECCV 2024\] TextDiffuser-2: Unleashing the Power of Language Models for Text Rendering](../../ECCV2024/llm_nlp/textdiffuser-2_unleashing_the_power_of_language_models_for_text_rendering.md)
