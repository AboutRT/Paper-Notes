---
description: "【论文笔记】Computation Mechanism Behind LLM Position Generalization 论文解读 | ACL 2025 | arXiv 2503.13305 | position generalization | 揭示 LLM 注意力 logit 学习了位置相关性和语义重要性的近似算术加法解耦（$W_{i,j} \approx f(\mathbf{q}, i-j) + g(\mathbf{q}, \mathbf{k})$，线性相关 0.959），发现了使这种解耦成立的中间表示模式，并用此解释了 LLM 的位置排列容忍性和长度泛化能力。"
tags:
  - ACL 2025
