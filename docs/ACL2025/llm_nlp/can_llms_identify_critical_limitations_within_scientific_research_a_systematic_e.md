...
1. **现有基准不聚焦局限性识别**：现有审稿生成基准收集整篇评审，但不强调局限性识别的重要性，仅比较 LLM 生成与人类评审的整体质量
2. **LLM 评审的通用性问题**：研究发现 LLM 生成的评审往往通用化、缺乏针对性，未能提供技术细节和批判性分析
3. **知识密集性**：识别论文局限性需要多年领域专业知识和对最新文献的了解，是一项极其知识密集的任务
