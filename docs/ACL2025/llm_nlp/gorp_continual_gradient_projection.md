...
**领域**: LLM/NLP  
**关键词**: 持续学习, 梯度投影, LoRA, 灾难性遗忘, low-rank optimization
...
**核心 idea**：将全秩参数的梯度也投影到低秩空间，与 LoRA 梯度在统一的共享梯度子空间中联合更新
...
1. **梯度共享空间构建（Gradient Shared Space）**:
    ...
    - 功能：用 Adam 一阶矩 $M_t$ 近似每个任务的主梯度方向，SVD 分解后取前 $k$ 个基向量
...
2. **全秩+低秩联合低秩投影**:
    ...
    - 功能：对 LoRA 参数和全秩参数的梯度分别投影到共享空间的正交互补中
