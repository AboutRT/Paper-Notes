...
description: >-
  [ACL 2025][LLM/NLP][多语言QA] 构建了首个多语言长文本问答数据集 CaLMQA（51.7K 问题，23 种语言），通过无翻译方式收集文化特异性问题，发现 LLM 回答文化特异性问题的事实性（45-52%）显著低于文化无关问题（64-71%），低资源语言表现尤其差。
tags:
  - "ACL 2025"
  - "LLM/NLP"
  - "多语言QA"
...
1. **无翻译数据收集（高/中资源语言）**:
    ...
    - 功能：从各国本土社区问答网站（类似 Quora/Reddit）收集文化特异性问题
...
2. **低资源语言手工收集**:
    ...
    - 功能：覆盖 12 种低资源语言（Afar、Fijian、Kirundi 等）
