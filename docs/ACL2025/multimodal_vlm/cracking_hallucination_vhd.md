...
**本文要解决什么？** 从多头注意力机制的角度探究幻觉的内部驱动因素，并基于发现设计主动缓解方案。

**切入角度**：受 LLM 中"上下文头"和"记忆头"研究的启发，探索不同注意力头对视觉内容的差异化敏感性。

**核心 idea 一句话**：量化注意力头对视觉上下文的敏感度差异，自适应放大高敏感度注意力头的输出以增强模型的视觉依赖。
