---
description: "【论文笔记】EffiVLM-Bench: 大型视觉语言模型免训练加速的综合评测基准 论文解读 | ACL 2025 | 提出 EffiVLM-Bench，一个统一评估框架，系统性地评估大型视觉语言模型(LVLM)的免训练加速方法，涵盖 token 压缩和参数压缩两大类，从性能、泛化性、忠实度和效率四个维度进行全面对比分析。"
tags:
  - ACL 2025
---
