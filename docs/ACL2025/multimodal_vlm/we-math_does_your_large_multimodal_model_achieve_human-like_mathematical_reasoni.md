...
**领域**: 多模态VLM  
**关键词**: 视觉数学推理, 基准测试, 知识概念分解, 过程评估, 大规模多模态模型
...
1. **结果导向的评估方式**：MathVista、MathVerse等基准仅关注最终答案的正确性，忽略了推理过程中的内在问题，导致反直觉的评估结论（如MathVista发现LMM在大学级别问题上表现优于小学级别）
2. **无法诊断推理能力的真正缺陷**：正确答案不代表模型真正掌握了推理方法，错误答案也不代表模型缺乏基础知识
...
核心idea一句话：**基于知识概念的问题分解 + 四维推理评估指标，从"做对/做错"走向"为什么做对/做错"**。
