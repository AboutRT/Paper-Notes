...
**本文要解决什么？** 在不训练的前提下，如何让LVLM系统性地探索推理空间并可靠地评估推理质量？
...
**核心idea一句话**：用MCTS构建推理搜索树（节点=推理步骤，路径=推理链），通过整合视觉和文本线索的自奖励机制评估节点质量，系统性迭代探索后选择最优推理路径。
...
**本文要解决什么**: 如何在不训练的前提下，让LVLM系统性地探索推理空间、评估推理质量，从而找到最优推理路径？
