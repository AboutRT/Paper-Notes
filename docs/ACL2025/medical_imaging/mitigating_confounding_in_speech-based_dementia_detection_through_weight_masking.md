...
description: >-
  [ACL 2025][医学图像][dementia detection] 针对基于语音转录文本的痴呆检测任务中的性别混淆偏差问题，提出 Extended Confounding Filter（ECF）和 Dual Filter（DF）两种无需额外训练模块的权重掩码方法…
tags:
  - "ACL 2025"
  - "医学图像"
  - "dementia detection"
...
- [\[ACL 2025\] Align-Pro: Align Protein Representations Through Multi-Modal Learning](align-pro_align_protein_representations_through_multi-modal_learning.md)
