...
description: >-
  [ACL 2025][优化/理论][bilevel optimization] ScaleBiO 提出基于罚函数重构的全一阶双层优化算法，首次将双层优化应用于 30B+ 参数 LLM 的数据源重加权，在 Qwen-2.5-32B 上实现 GSM8K +9%、MATH +5.8% 的提升。
tags:
  - "ACL 2025"
  - "优化/理论"
...
**领域现状**：领域现状**：数据质量显著影响 LLM 性能，但找到不同数据源的最优权重很困难
