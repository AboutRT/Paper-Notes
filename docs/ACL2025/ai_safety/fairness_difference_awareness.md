...
description: >-
  [ACL 2025][AI公平性] 提出差异感知(DiffAware)概念挑战当前以"差异无视"为主导的LLM公平性范式，构建包含8个场景16K问题的基准套件，证明现有去偏方法反而降低了模型在需要区分群体时的表现。
tags:
  - ACL 2025
  - AI公平性
  - 偏见评估
...
**本文要解决什么**：补充一个此前被忽视的公平性维度——差异感知(difference awareness)，即模型在适当场景下区分群体的能力。
