...
**本文要解决什么：** 作者旨在建立一个覆盖非二元性别的综合性公平性评估框架，从代词识别到深层认知推理，系统量化 LLM 对 11 组不同性别代词的包容程度，并在 22 个主流模型上进行大规模基准测试。
...
**核心 idea 一句话：** 将七个 [0,1] 归一化维度聚合为一个可解释的 GIFI 综合分数（0-100），成为首个涵盖非二元性别的 LLM 公平性基准。
