---
description: "【论文笔记】Robust and Minimally Invasive Watermarking for EaaS 论文解读 | ACL 2025 | arXiv 2410.17552 | 嵌入水印 | 提出 ESpeW（Embedding-Specific Watermark），一种嵌入特异性水印方法，通过在每个嵌入向量的不同位置注入独特水印，实现对 Embeddings as a Service (EaaS) 的鲁棒版权保护，抵抗各种水印移除攻击且对嵌入质量的影响小于 1%。"
tags:
  - ACL 2025
  - 嵌入水印
  - EaaS版权保护
