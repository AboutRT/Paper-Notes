...
description: >-
  [ACL 2025][预训练][MBR Decoding] 从 bias-diversity 分解的理论视角重新解释 MBR 解码：质量估计误差 MSE = Bias - Diversity，增加 diversity（伪参考的多样性）是提升 MBR 性能的关键；进一步通过信息论扩展到一般推理方法…
tags:
  - "ACL 2025"
  - "预训练"
  - "MBR Decoding"
...
**代码**: [https://github.com/naist-nlp/mbr-bias-diversity](https://github.com/naist-nlp/mbr-bias-diversity)  
**领域**: LLM预训练  
