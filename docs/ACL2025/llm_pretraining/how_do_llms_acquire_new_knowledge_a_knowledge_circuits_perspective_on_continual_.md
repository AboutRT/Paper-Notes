...
description: >-
  [ACL 2025][LLM预训练][机制可解释性] 从知识电路(Knowledge Circuits)演化的视角研究LLM如何在持续预训练中获取新知识，发现知识获取受先验知识相关性影响，电路演化存在"形成→优化"的相变，且遵循"深层→浅层"的发展模式。
tags:
  - ACL 2025
  - LLM预训练
  - 机制可解释性
...
1. **合成知识语料构建**:
    - 做什么：生成5万个虚构人物实体，每个有5个关系(出生日期、城市、专业、大学、公司)
