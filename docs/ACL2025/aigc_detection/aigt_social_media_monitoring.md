...
## 研究背景与动机
**领域现状**：LLM 能力的快速提升使得 AI 生成文本在社交媒体上日益普遍。AIGT 可能被用于传播虚假信息和操纵舆论。

**现有痛点**：(a) 不清楚社交媒体上 AIGT 到底有多少——缺乏系统性的量化研究；(b) 不同平台的 AIGT 渗透率可能差异巨大但无人追踪；(c) 现有检测数据集不够多样化，缺乏针对社交媒体文本的基准。
