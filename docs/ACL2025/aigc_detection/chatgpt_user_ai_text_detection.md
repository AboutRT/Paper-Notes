...
description: >-
  [ACL 2025][AIGC检测] 通过 1,740 条标注实验发现，经常使用 LLM 进行写作任务的人类标注者可以极高精度（5人投票仅错 1/300）检测 AI 生成文本，即使面对改写和人性化逃逸策略也显著优于大多数自动检测器。
tags:
  - ACL 2025
  - AIGC检测
  - 人类检测者
...
3. **人类检测指南编纂与 LLM 模拟**:
    ...
    - 功能：从专家解释中提取检测线索，编纂成指南，尝试让 LLM 模拟人类检测
