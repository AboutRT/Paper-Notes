...
description: >-
  [ACL 2025][AI安全][watermarking] 提出集成水印方法，将文体特征（藏头词 acrostic + 感觉运动词 sensorimotor norms）与已有红绿水印组合，在 paraphrasing 攻击后三特征集成检测率达 95%，而单独红绿水印仅 49%。
tags:
  - ACL 2025
  - AI安全
  - watermarking
...
1. **藏头词特征（Acrostic）**:
    ...
    - 功能：每个新句子的首 token 被偏置为以特定字母开头（由密钥控制）
