...
description: >-
  [ACL 2025][音频/语音][audio spatialization] 提出 TAS（Text-guided Audio Spatialization）框架，用灵活的文本提示（3D 空间位置描述或声源间相对位置描述）引导潜在扩散模型将单声道音频转换为双耳音频…
tags:
  - "ACL 2025"
  - "音频/语音"
...
**本文目标** 用文本描述（而非视觉帧）灵活控制音频空间化，支持 3D 位置指定和声源间相对关系描述。

**切入角度**：学习双耳差异（左-右通道差）而非完整双耳音频，降低建模难度；用潜在扩散模型在 mel-spectrogram 潜空间中生成。

**核心 idea**：用文本描述声源空间位置，训练潜在扩散模型学习通道差异来实现灵活可控的音频空间化。
