---
description: "【论文笔记】Autoregressive Speech Synthesis without Vector Quantization 论文解读 | ACL 2025 | arXiv 2407.08551 | 语音合成 | MELLE 提出了一种基于连续 mel-spectrogram 帧的自回归语言模型 TTS 方法，通过回归损失 + 变分推断采样模块 + spectrogram flux loss 直接预测连续频谱帧，避免了向量量化带来的保真度损失和采样鲁棒性问题，单阶段模型即可达到与人类水平相当的语音合成质量。"
tags:
  - ACL 2025
  - 语音合成
  - 连续值token
