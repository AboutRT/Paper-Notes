...
description: >-
  [ACL 2025][LLM对齐][curiosity-driven] CD-RLHF 将好奇心驱动探索（curiosity-driven RL）引入 RLHF，通过前向动力学模型的预测误差作为内在奖励，结合 top-k 门控过滤与 reward whitening…
tags:
  - "ACL 2025"
  - "LLM对齐"
  - "curiosity-driven"
...
**代码**: [github](https://github.com/ernie-research/CD-RLHF)  
**领域**: LLM对齐 / RLHF  
**关键词**: curiosity-driven, RLHF, diversity, intrinsic reward, exploration, ICM
