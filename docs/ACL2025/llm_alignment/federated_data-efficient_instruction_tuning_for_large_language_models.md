---
description: "【论文笔记】Federated Data-Efficient Instruction Tuning for Large Language Models 论文解读 | ACL 2025 (Findings) | arXiv 2410.10926 | 联邦学习 | 提出 FedHDS（Federated Hierarchical Data Selection），通过 intra-client 和 inter-client 两级层次化数据选择消除联邦学习中客户端内部和跨客户端的数据冗余，结合多层 Transformer 特征融合提升 coreset 质量；仅用不到 1.5% 的数据，在 Rouge-L 上相对 SOTA 全数据联邦基线平均提升 10.72%，训练效率提升最高达 48.8 倍。"
tags:
  - ACL 2025 (Findings)
  - 联邦学习
  - 数据高效
