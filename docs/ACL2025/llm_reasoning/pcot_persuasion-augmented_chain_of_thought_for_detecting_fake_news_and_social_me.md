---
description: >-
  [ACL 2025][LLM推理][虚假信息检测] 提出说服增强链式思维(PCoT)方法，通过两阶段推理——先识别六类说服策略再融入检测推理——在零样本设置下将虚假信息检测F1平均提升15%，覆盖5个LLM和5个数据集。
tags:
  - ACL 2025
  - LLM推理
  - 虚假信息检测
