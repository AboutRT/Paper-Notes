---
description: "【论文笔记】Linguistic Generalizability of Test-Time Scaling in Mathematical Reasoning 论文解读 | ACL 2025 | arXiv 2502.17407 | Test-Time Scaling | 提出 MCLM（55 语言的竞赛级数学基准），发现三种 test-time scaling 方法（ORM/PRM/Budget Forcing）在英语上提升显著（如 AIME +20 分），但在其他语言上平均仅提升 1.94 分，表明 test-time scaling 的多语言泛化能力严重不足。"
tags:
  - ACL 2025
  - Test-Time Scaling
  - 多语言推理
