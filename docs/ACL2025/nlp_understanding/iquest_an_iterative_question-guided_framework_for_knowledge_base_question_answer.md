...
1. **多跳 KBQA 的核心挑战**：复杂问题需要在知识图谱中进行多跳推理（如"北太平洋地区，热带风暴 Fabio 影响区域的官方花是什么？"），但存在两个关键难题：
...
2. **现有方法不足**：ToG、Interactive-KBQA 等代理式方法虽有效但缺乏持续推理引导；问题分解方法多为一次性静态分解，无法根据推理进展自适应调整
3. **人类认知启发**：研究表明人类通过"提出并解决小问题"可维持更高注意力水平。iQUEST 将此洞见应用于 LLM 推理引导
