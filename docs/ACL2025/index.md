...
**[Com2: A Causal-Guided Benchmark for Complex Commonsense Reasoning](llm_evaluation/com2_causal_commonsense.md)**
...
**[HellaSwag-Pro: A Large-Scale Bilingual Benchmark for Evaluating the Robustness of LLMs](llm_evaluation/hellaswag-pro_a_large-scale_bilingual_benchmark_for_evaluating_the_robustness_of.md)**
...
**[StrucText-Eval: Evaluating Large Language Model's Reasoning Ability in Structure-Rich Text](llm_evaluation/structext_eval.md)**
...
**[Assessing Agentic LLMs in Multilingual National Bias](multilingual_mt/assessing_agentic_large_language_models_in_multilingual_national_bias.md)**
...
**[COSMMIC: Comment-Sensitive Multimodal Multilingual Indian Corpus for Summarization and Headline Generation](multilingual_mt/cosmmic_commentsensitive_multimodal_multilingual_indian_corpus.md)**
...
**[Edit Once, Update Everywhere: Cross-Lingual Knowledge Synchronization](multilingual_mt/edit_once_update_everywhere_a_simple_framework_for_cross-lingual_knowledge_synch.md)**
...
**[Q2E: Query-to-Event Decomposition for Zero-Shot Multilingual Text-to-Video Retrieval](multilingual_mt/q2e_query-to-event_decomposition_for_zero-shot_multilingual_text-to-video_retrie.md)**
...
**[IDR²: Accelerating Adaptive RAG via Instruction-Driven Representation Reduction of Retrieval Overlaps](information_retrieval/accelerating_adaptive_retrieval_augmented_generation_via_instruction-driven_repr.md)**
...
**[DRAMA: Diverse Augmentation from LLMs to Smaller Dense Retrievers](information_retrieval/drama_diverse_augmentation_from_large_language_models_to_smaller_dense_retriever.md)**
...
**[Shifting from Ranking to Set Selection for Retrieval Augmented Generation](information_retrieval/setr_set_selection_rag.md)**
...
**[NOVA: Aligning LLMs to Follow Instructions and Hallucinate Less via Effective Data Filtering](llm_safety/aligning_large_language_models_to_follow_instructions_and_hallucinate_less_via_e.md)**
...
**[PRISM: A Framework for Producing Interpretable Political Bias Embeddings](interpretability/prism_political_bias_embeddings.md)**
...
**[GKI-ICD: A General Knowledge Injection Framework for ICD Coding](knowledge_editing/a_general_knowledge_injection_framework_for_icd_coding.md)**
