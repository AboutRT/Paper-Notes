...
description: >-
  [ACL 2025][代码智能][代码生成] 提出 Gibbs Fine-Tuning（GiFT），受 Gibbs 采样启发，通过"代码→描述→代码"的迭代翻译从边际分布而非条件分布中采样自生成代码，结合困惑度引导的长尾数据选择…
tags:
  - "ACL 2025"
  - "代码智能"
  - "代码生成"
...
2. **困惑度引导的长尾数据选择**:
    ...
    - 功能：在自生成代码中平衡头部（常见）和尾部（罕见）代码的比例
