...
description: >-
  [CVPR 2025][LLM对齐][MLLM] 提出 Task Preference Optimization（TPO），通过可学习的任务 token 将视觉任务专用头（区域定位/时序定位/分割）接入 MLLM，利用视觉任务标注作为"任务偏好"反向优化 MLLM…
tags:
  - "CVPR 2025"
  - "LLM对齐"
  - "MLLM"
...
**代码**: [https://github.com/OpenGVLab/TPO](https://github.com/OpenGVLab/TPO)  
**领域**: LLM对齐  
