...
description: >-
  [CVPR 2025][人体理解][人体网格恢复] MEGA 提出了一种基于遮掩生成建模的人体网格恢复方法，通过将人体 mesh 离散化为 token 序列，在自监督预训练后进行图像条件生成，同时支持确定性单次预测和随机多输出生成模式，在两种模式下均达到 SOTA 性能。
tags:
  - "CVPR 2025"
  - "人体理解"
  - "人体网格恢复"
...
**代码**: [https://g-fiche.github.io/research-pages/mega/](https://g-fiche.github.io/research-pages/mega/) (项目页)  
**领域**: 3D视觉  
