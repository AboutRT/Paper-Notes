---
description: "【论文笔记】Competition-Aware CPC Forecasting with Near-Market Coverage 论文解读 | CVPR 2025 | arXiv 2603.13059 | CPC预测 | 将付费搜索CPC预测重构为\"部分可观测竞争下的预测\"问题，通过语义邻域（Transformer嵌入）、行为邻域（DTW对齐）和地理意图三类竞争代理逼近不可观测的竞争状态，在1811个关键词×127周的Google Ads数据上显示竞争感知增强在中长期预测（6/12周）上显著优于单变量和弱上下文baseline。"
tags:
  - CVPR 2025
  - CPC预测
  - 竞争代理
