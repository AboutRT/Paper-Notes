...
description: >-
  [CVPR 2025][语义分割][全景图分割] 将 360° 全景图分割重新定义为透视视频分割问题，通过沿 zigzag 轨迹分解全景图为重叠 patch 序列并微调 SAM2 的 memory 模块，配合 183K 合成 4K 全景图的大规模训练，实现零样本全景分割 +17.2 mIoU 的提升。
tags:
  - "CVPR 2025"
  - "语义分割"
  - "全景图分割"
...
**现有痛点**：**领域现状**：**全景图的广泛应用**: 360° 全景图像在自动驾驶、机器人导航、VR/AR 中广泛使用，但其等距柱状投影（ERP）格式带来严重的几何失真
