...
description: >-
  [CVPR 2025][图像分割][RGB-D 场景理解] 提出一个高效 RGB-D 多任务场景理解网络，通过改进融合编码器利用冗余特征加速推理，引入归一化聚焦通道层 (NFCL) 和上下文特征交互层 (CFIL) 进行跨维度特征引导，并设计多任务自适应损失函数动态调整任务权重，在 NYUv2/SUN RGB-D/Cityscapes 上达到 SOTA。
tags:
  - CVPR 2025
  - 图像分割
  - RGB-D 场景理解
...
### 关键设计一：高效融合编码器
- **功能**：同时从 RGB 和深度数据中提取互补特征，提高推理速度
...
### 关键设计三：上下文特征交互层 (CFIL)
- **功能**：弥补 MLP 语义解码器在融合局部和全局信息方面的不足
