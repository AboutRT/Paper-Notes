...
description: >-
  [CVPR 2025][图像分割][SAR 基础模型] 提出首个十亿参数级 SAR 视觉基础模型 CrossEarth-SAR，基于物理引导的稀疏混合专家 (MoE) 架构，构建了包含 200K 图像的训练集和 22 个子基准的评估体系，在 20/22 个跨域语义分割基准上达到 SOTA。
tags:
  - CVPR 2025
  - 图像分割
  - SAR 基础模型
...
### 关键设计一：SAR 物理描述符
- **功能**：为每张 SAR 图像计算三个标量物理特征，提供稳定的域感知信号
