---
title: >-
  [论文解读] Foveated Instance Segmentation
description: >-
  [CVPR 2025][语义分割][中央凹视觉] FSNet 提出一种模拟人眼中央凹视觉机制的实例分割框架，通过可学习的显著性图引导非均匀下采样，在注视目标区域保持高分辨率细节、在外围降低分辨率，实现了在不同预训练分割网络上的即插即用式效率提升。
tags:
  - "CVPR 2025"
  - "语义分割"
  - "中央凹视觉"
