...
description: >-
  [CVPR 2025][目标检测][主动学习] 提出EAOA框架，通过基于自由能的认知不确定性（EU）和偶然不确定性（AU）度量，结合自适应粗到细的查询策略，在开放集主动学习场景中有效选择既属于已知类又具有高信息量的样本。
tags:
  - CVPR 2025
  - 目标检测
  - 主动学习
...
- [AFreeCA: Annotation-Free Counting for All](../../ECCV2024/object_detection/afreeca_annotation-free_counting_for_all.md)
