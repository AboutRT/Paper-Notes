---
title: >-
  CVPR2025 自动驾驶方向94篇论文解读
description: >-
  94篇CVPR2025的自动驾驶方向论文解读，涵盖自动驾驶、3D 目标检测、扩散模型、3D 高斯渲染、点云、语义分割等方向。覆盖该方向前沿研究进展与技术创新，每篇含一句话总结、核心思想、方法详解、实验结果与局限性分析，5分钟读懂一篇论文核心思想。
tags:
  - "CVPR2025"
  - "自动驾驶"
  - "论文解读"
...
**[ForestLPR: LiDAR Place Recognition in Forests Attentioning Multiple BEV Density Images](forestlpr_lidar_place_recognition_in_forests_attentioning_multiple_bev_density_i.md)**
