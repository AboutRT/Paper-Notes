...
- [Surface Reconstruction from 3D Gaussian Splatting via Local Structural Hints](../../ECCV2024/3d_vision/surface_reconstruction_from_3d_gaussian_splatting_via_local_structural_hints.md)
