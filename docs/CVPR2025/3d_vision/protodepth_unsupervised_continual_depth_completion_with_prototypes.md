...
- [GaussianUpdate: Continual 3D Gaussian Splatting Update for Changing Environments](../../ICCV2025/3d_vision/gaussianupdate_continual_3d_gaussian_splatting_update_for_changing_environments.md)
