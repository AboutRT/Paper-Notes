---
title: >-
  CVPR2025 具身智能方向 25篇论文解读
description: >-
  25篇CVPR2025 具身智能方向论文深度解读，每篇5分钟读懂核心思想。每篇笔记含一句话总结、背景动机、方法详解、实验数据、亮点洞察与局限性分析。
---
...
**[Lift3D Policy Lifting 2D Foundation Models For Robust 3D Robotic Manipulation](lift3d_policy_lifting_2d_foundation_models_for_robust_3d_robotic_manipulation.md)**
...
**[Mitigating The Human-Robot Domain Discrepancy In Visual Pre-Training For Robotic](mitigating_the_human-robot_domain_discrepancy_in_visual_pre-training_for_robotic.md)**

:   提出 HR-Align 适配范式，利用配对人-机器人视频数据和对比对齐损失，以参数高效的方式弥合人类数据预训练模型与机器人域之间的语义差距，在 20 个仿真任务和 5 个真实任务上平均成功率提升 7%+。

**[Momanipvla Transferring Vision-Language-Action Models For General Mobile Manipul](momanipvla_transferring_vision-language-action_models_for_general_mobile_manipul.md)**
...
**[Phoenix A Motion-Based Self-Reflection Framework For Fine-Grained Robotic Action](phoenix_a_motion-based_self-reflection_framework_for_fine-grained_robotic_action.md)**
