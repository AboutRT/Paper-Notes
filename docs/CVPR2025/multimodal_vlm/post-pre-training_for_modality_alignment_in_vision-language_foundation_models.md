...
description: >-
  [CVPR 2025][多模态][CLIP] 提出 CLIP-Refine，一种介于预训练和微调之间的"后预训练"方法，通过随机特征对齐（RaFA）和混合对比蒸馏（HyCD）两个技术，仅用 1 个 epoch 在小数据集上训练即可缩小 CLIP 的模态间隙并提升零样本性能。
tags:
  - CVPR 2025
  - 多模态
  - CLIP
...
- [JARVIS-VLA: Post-Training Large-Scale Vision Language Models to Play Visual Games](../../ACL2025/multimodal_vlm/jarvis-vla_post-training_large-scale_vision_language_models_to_play_visual_games.md)
