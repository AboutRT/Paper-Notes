...
**本文目标** 如何在 exemplar-free 条件下精准保护 VLM 跨模态几何的脆弱区域？

**切入角度**：利用对抗攻击的思路——如果微小扰动能改变图像-文本对齐关系，那么同样的扰动可以用来主动发现和覆盖最脆弱的几何邻域。

**核心 idea**：用双目标 PGD 构造对抗锚点探测新旧语义边界，在锚点上做跨模态几何蒸馏保护脆弱区域。
