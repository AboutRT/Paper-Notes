...
description: >-
  [CVPR 2025][LLM/NLP][人物交互] 本文提出ROG框架，通过在物体网格上采样富含几何信息的关键点构建交互距离场（IDF），并利用基于扩散的关系模型在推理时引导运动生成模型产生关系感知且语义对齐的人物-物体交互动作，在FullBodyManipulation数据集上显著超越SOTA。
tags:
  - CVPR 2025
  - LLM/NLP
  - 人物交互
...
**代码**: https://lalalfhdh.github.io/rog_page/  
**领域**: 3D视觉 / 动作生成  
