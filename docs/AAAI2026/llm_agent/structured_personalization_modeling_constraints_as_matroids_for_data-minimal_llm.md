...
**本文目标**：提供一个数学上严格的框架来建模这些复杂约束，使得有保证的优化算法可以应用于现实世界的个性化场景。
...
- **功能**：将用户身份知识图谱中逻辑不可分的 facet 组合编译为 "macro-facet"。
...
- **功能**：证明在 macro-facet 集合上的层级配额约束构成层叠拟阵（laminar matroid）。
...
- **功能**：实现高效的贪心选择算法，迭代选择边际效用最大且保持独立的 macro-facet。
