...
description: >-
  [AAAI 2026][LLM Agent][GUI Agent] TongUI 提出从互联网上的多模态教程（视频+图文）自动转化为 GUI 操作轨迹数据的框架，构建了百万级的 GUI-Net-1M 数据集，用于微调 Qwen2.5-VL 模型…
tags:
  - "AAAI 2026"
  - "LLM Agent"
  - "GUI Agent"
...
1. **教程爬取（Tutorial Crawling）**:
    ...
    - 功能：从 YouTube、Bilibili、WikiHow、百度经验等平台爬取多模态 GUI 教程
...
2. **教程处理（Tutorial Processing）**:
    ...
    - 功能：将异构的多模态教程统一转化为 "文本描述 + 截图" 的结构化格式
