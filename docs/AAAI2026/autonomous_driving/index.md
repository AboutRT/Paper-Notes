---
title: >-
  AAAI2026 自动驾驶方向 58篇论文解读
description: >-
  58篇AAAI2026 自动驾驶方向论文深度解读，每篇5分钟读懂核心思想。每篇笔记含一句话总结、背景动机、方法详解、实验数据、亮点洞察与局限性分析。
---
...
**[Backdoor Attacks On Open Vocabulary Object Detectors Via Multi-Modal Prompt Tuni](backdoor_attacks_on_open_vocabulary_object_detectors_via_multi-modal_prompt_tuni.md)**
...
**[Beta Distribution Learning For Reliable Roadway Crash Risk A](beta_distribution_learning_for_reliable_roadway_crash_risk_a.md)**

:   提出基于 Beta 分布学习的地理空间深度学习框架，利用多尺度卫星图像预测道路致命事故风险的完整概率分布（而非点估计），在 Recall 上提升 17-23%，并通过分布形状自然表达不确定性。

**[Bridging Day And Night Target-Class Hallucination Suppressio](bridging_day_and_night_target-class_hallucination_suppressio.md)**

:   首次系统性解决无配对日→夜图像翻译中的"目标类幻觉"问题，通过双头判别器（风格头+SAM2伪标签分割头）检测幻觉 + 类原型对比学习抑制幻觉，在BDD100K日夜域适应检测上将mAP从15.08提升到17.40（+15.5%），交通灯AP提升31.7%。

**[Catformer Causal Temporal Transformer With Dynamic Contextual Fusion For Driving](catformer_causal_temporal_transformer_with_dynamic_contextual_fusion_for_driving.md)**

:   提出 CaTFormer，通过因果时序 Transformer 显式建模驾驶员行为与环境上下文之间的因果交互，在 Brain4Cars 数据集上以 98.6% F1 达到 SOTA。

**[Cheating Stereo Matching In Full-Scale Physical Adversarial Attack Against Binoc](cheating_stereo_matching_in_full-scale_physical_adversarial_attack_against_binoc.md)**
...
**[Decoupling Scene Perception And Ego Status A Multi-Context Fusion Approach For E](decoupling_scene_perception_and_ego_status_a_multi-context_fusion_approach_for_e.md)**
...
**[Differentiable Semantic Meta-Learning Framework For Long-Tail Motion Forecasting](differentiable_semantic_meta-learning_framework_for_long-tail_motion_forecasting.md)**
...
**[Diffrefiner Coarse To Fine Trajectory Planning Via Diffusion Refinement With Sem](diffrefiner_coarse_to_fine_trajectory_planning_via_diffusion_refinement_with_sem.md)**
...
**[Driveflow Rectified Flow Adaptation For Robust 3D Object Detection In Autonomous](driveflow_rectified_flow_adaptation_for_robust_3d_object_detection_in_autonomous.md)**
...
**[Dual-Branch Spatial-Temporal Self-Supervised Representation For Enhanced Road Ne](dual-branch_spatial-temporal_self-supervised_representation_for_enhanced_road_ne.md)**
...
**[Fastdrivevla Efficient End-To-End Driving Via Plug-And-Play ](fastdrivevla_efficient_end-to-end_driving_via_plug-and-play_.md)**
...
**[Fq-Petr Fully Quantized Position Embedding Transformation Fo](fq-petr_fully_quantized_position_embedding_transformation_fo.md)**
...
**[Hd2-Ssc High-Dimension High-Density Semantic Scene Completion For Autonomous Dri](hd2-ssc_high-dimension_high-density_semantic_scene_completion_for_autonomous_dri.md)**
...
**[Invisible Triggers Visible Threats Road-Style Adversarial Creation Attack For Vi](invisible_triggers_visible_threats_road-style_adversarial_creation_attack_for_vi.md)**
...
**[Lidar-Gsimproving Lidar Gaussian Reconstruction Via Diffusion Priors](lidar-gsimproving_lidar_gaussian_reconstruction_via_diffusion_priors.md)**
...
**[Mambaseg Harnessing Mamba For Accurate And Efficient Image-E](mambaseg_harnessing_mamba_for_accurate_and_efficient_image-e.md)**
...
**[Multimodal Data Fusion To Capture Dynamic Interactions Between Built Environment](multimodal_data_fusion_to_capture_dynamic_interactions_between_built_environment.md)**
...
**[Out-Of-Distribution Generalization With A Sparc Racing 100 U](out-of-distribution_generalization_with_a_sparc_racing_100_u.md)**
...
**[Priordrive Enhancing Online Hd Mapping With Unified Vector P](priordrive_enhancing_online_hd_mapping_with_unified_vector_p.md)**
...
**[Racketvision A Multiple Racket Sports Benchmark For Unified Ball And Racket Anal](racketvision_a_multiple_racket_sports_benchmark_for_unified_ball_and_racket_anal.md)**
...
**[Reflexdiffusion Reflection-Enhanced Trajectory Planning For ](reflexdiffusion_reflection-enhanced_trajectory_planning_for_.md)**
...
**[Roadscenevqa Benchmarking Visual Question Answering In Roadside Perception Syste](roadscenevqa_benchmarking_visual_question_answering_in_roadside_perception_syste.md)**
...
**[Stride-Qa Visual Question Answering Dataset For Spatiotemporal Reasoning In Urba](stride-qa_visual_question_answering_dataset_for_spatiotemporal_reasoning_in_urba.md)**

:   构建了自动驾驶领域最大规模时空推理VQA数据集STRIDE-QA（270K帧、16M QA对），定义了三类时空推理任务（物体间空间/自车空间/自车时空），通过微调VLM使空间定位成功率从近零提升至55%、时序一致性从0提升至28.4%。

**[Task Prototype-Based Knowledge Retrieval For Multi-Task Lear](task_prototype-based_knowledge_retrieval_for_multi-task_lear.md)**
...
**[Tawpipe Topology-Aware Weight Pipeline Parallelism For Accelerating Long-Context](tawpipe_topology-aware_weight_pipeline_parallelism_for_accelerating_long-context.md)**
...
**[Tsbow Traffic Surveillance Benchmark For Occluded Vehicles Under Various Weather](tsbow_traffic_surveillance_benchmark_for_occluded_vehicles_under_various_weather.md)**

:   提出TSBOW——一个基于CCTV的大规模交通监控数据集，包含198个视频、超32小时真实交通数据和320万帧，覆盖全年四季天气（晴/霾/雨/雪含极端灾害场景），涵盖8类交通参与者，重点解决恶劣天气下遮挡车辆检测的挑战。

**[Understanding Dynamic Scenes In Ego Centric 4D Point Clouds](understanding_dynamic_scenes_in_ego_centric_4d_point_clouds.md)**
...
**[Vilta A Vlm-In-The-Loop Adversary For Enhancing Driving Poli](vilta_a_vlm-in-the-loop_adversary_for_enhancing_driving_poli.md)**
...
**[Worldrft Latent World Model Planning With Reinforcement Fine-Tuning For Autonomo](worldrft_latent_world_model_planning_with_reinforcement_fine-tuning_for_autonomo.md)**
