...
description: >-
  [AAAI 2026][多模态VLM][提示学习] VP-Bench 提出了首个系统评估 MLLM 视觉提示（Visual Prompt）理解能力的两阶段 Benchmark：Stage 1 用 30K+ 图像覆盖 8 种 VP 形状×355 种属性组合评测 VP 感知能力…
tags:
  - "AAAI 2026"
  - "多模态VLM"
  - "提示学习"
...
1. **Stage 1: VP 感知评测**:
    ...
    - 功能：评测 MLLM 对 8 种 VP 形状、355 种属性组合的感知能力
...
2. **Stage 2: VP 下游任务评测**:
    ...
    - 功能：评估 VP 在真实应用场景中是否比纯文本空间描述更有用
...
3. **VP 描述（VP Description）**:
    ...
    - 功能：在文本指令中加入 VP 形状的自然语言描述（如"红色边界框标出了目标区域"）
