...
description: >-
  [AAAI 2026][多模态VLM][安全评估] 首个多模态大语言模型安全动态评估框架SDEval，通过文本/图像/跨模态三类动态策略可控调节安全基准的分布与复杂度，显著缓解数据泄露问题并暴露MLLM安全短板。
tags:
  - AAAI 2026
  - 多模态VLM
  - 安全评估
...
1. **文本动态策略（6种）**
    ...
    - **做什么**：从人类绕过审核的策略出发，在不改变语义的前提下修改文本以增加安全识别难度
    - **核心策略**：
...
2. **图像动态策略（2类）**
    ...
    - **做什么**：通过基础增强和生成式操作修改图像，降低数据泄露并测试模型视觉安全识别能力
