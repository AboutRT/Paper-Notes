...
description: >-
  [AAAI 2026][多模态VLM][长文档理解] URaG 发现 MLLM 处理长文档时存在类人的"粗到细"推理模式（浅层注意力均匀分散、深层集中于证据页），基于此洞察在第 6 层插入轻量跨模态检索模块（仅占参数 0.05%），选取 Top-5 相关页面丢弃其余内容…
tags:
  - "AAAI 2026"
  - "多模态VLM"
  - "长文档理解"
...
2. **跨模态检索模块**:
    ...
    - 功能：在第 6 层提取 hidden states，计算 query 与各页面的相关性，选取 Top-5
