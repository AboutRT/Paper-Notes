...
description: >-
  [AAAI 2026][多模态VLM][PET影像] 本文提出 PET2Rep，首个专用于正电子发射断层扫描（PET）放射报告生成的大规模基准数据集（565例全身 PET/CT 图像-报告对），并设计了 PET 临床效能（CE）评估指标，对 30 个前沿通用和医疗专用 VLM 进行系统评估…
tags:
  - "AAAI 2026"
  - "多模态VLM"
  - "PET影像"
...
- [\[CVPR 2025\] SketchAgent: Language-Driven Sequential Sketch Generation](../../CVPR2025/multimodal_vlm/sketchagent_language-driven_sequential_sketch_generation.md)
