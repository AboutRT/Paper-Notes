...
1. **空间蒸馏需要严格帧对齐**：MGD、CWD、FD3D 等方法要求教师和学生输入帧完全相同，无法利用教师的未来帧信息
2. **时序蒸馏忽视未来帧**：STXD 仅关注帧间关系，DistillBEV 蒸馏融合时空特征，但都未利用未来帧
3. **忽略背景信息**：GT 中前景框很少，大量预测为背景查询，但现有方法忽略了背景查询中的有价值信息
