...
- [DreamDissector: Learning Disentangled Text-to-3D Generation from 2D Diffusion Priors](../../ECCV2024/3d_vision/dreamdissector_learning_disentangled_text-to-3d_generation_from_2d_diffusion_pri.md)
...
- [Text–Image Conditioned 3D Generation](../../CVPR2026/3d_vision/text-image_conditioned_3d_generation.md)
