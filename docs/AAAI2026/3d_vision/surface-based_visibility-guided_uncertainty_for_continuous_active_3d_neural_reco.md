...
description: >-
  [AAAI 2026][3D视觉][主动3D重建] 提出基于表面的可见性场(SBV)，通过SDF推导的表面置信度和体素网格更新机制在连续主动学习过程中准确估计不确定性的可见性，指导Next-Best View选择…
tags:
  - "AAAI 2026"
  - "3D视觉"
  - "主动3D重建"
...
**代码**: [https://github.com/hskAlena/Surface-Based-Visibility](https://github.com/hskAlena/Surface-Based-Visibility)  
**领域**: 3D视觉  
