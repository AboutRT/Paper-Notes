---
description: "【论文笔记】Sketch-HARP: 分层自回归草图生成实现灵活笔画级绘制操控 论文解读 | AAAI 2026 | arXiv 2511.07889 | 草图生成 | 提出 Sketch-HARP 分层自回归草图生成框架，通过三阶段层次化过程（预测笔画嵌入→确定画布位置→生成绘制动作序列），首次实现草图绘制过程中的灵活笔画级操控，在替换/擦除/扩展等任务上显著优于 SketchEdit。"
tags:
  - AAAI 2026
  - 草图生成
  - 分层自回归
