...
description: >-
  [AAAI 2026][LLM对齐][结构对齐] 提出 Structural Alignment 方法，通过将语言学篇章结构框架（表层文本结构评分 + 基于RST的篇章motif分类器）融入PPO强化学习训练，并设计基于篇章motif的密集奖励机制，使LLM生成更连贯、更具人类写作风格的长文本，在论文写作和长文档摘要任务上均优于标准RLHF模型。
tags:
  - AAAI 2026
  - LLM对齐
  - 结构对齐
...
**代码**: [https://github.com/minnesotanlp/struct_align](https://github.com/minnesotanlp/struct_align)  
**领域**: LLM对齐  
...
## 评分
- 新颖性: ⭐⭐⭐⭐ 将 RST 篇章结构引入 LLM 对齐是跨领域创新，结构感知偏好数据构建方法新颖
- 实验充分度: ⭐⭐⭐⭐ essay 写作和摘要两个任务，自动+人工评估覆盖全面
- 写作质量: ⭐⭐⭐⭐ 语言学理论与 NLP 方法的结合论述清楚
- 对我的价值: ⭐⭐⭐ 结构化写作对齐有参考意义但应用场景相对窄
