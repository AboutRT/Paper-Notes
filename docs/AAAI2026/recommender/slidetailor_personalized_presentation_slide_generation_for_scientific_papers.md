...
description: >-
  [AAAI 2026][推荐系统][演示文稿生成] 首个偏好引导的论文到演示文稿生成任务，提出SlideTailor框架通过隐式偏好蒸馏、chain-of-speech叙事对齐和模板感知布局选择，从用户提供的样例对和模板中提取偏好并生成个性化可编辑幻灯片。
tags:
  - AAAI 2026
  - 推荐系统
  - 演示文稿生成
...
2. **Chain-of-Speech 机制**
    ...
    - **做什么**：在设计幻灯片大纲时同步起草演讲稿，使幻灯片内容与预期口述叙事对齐
...
3. **模板感知布局选择与编辑**
    ...
    - **做什么**：根据幻灯片语义内容为每页匹配最合适的模板布局，并通过代码 Agent 生成可编辑 .pptx
