...
description: >-
  [AAAI 2026][LLM/NLP][LLM人格测量] PERSIST 框架系统评估 29 个 LLM（1B-685B）在 200 万+响应上的人格测量稳定性，发现即使 400B+ 模型仍有 SD>0.3 的不稳定性，揭示 CoT 推理悖论性地增加变异性却降低困惑度，且会话历史对大小模型产生相反影响。
tags:
  - AAAI 2026
  - LLM/NLP
  - LLM人格测量
...
- [\[AAAI 2026\] Smart: 基于 GNN 与 LLM 融合的 Dragonfly 系统应用运行时代理模型](smart_a_surrogate_model_for_predicting_application_runtime_in_dragonfly_systems.md)
