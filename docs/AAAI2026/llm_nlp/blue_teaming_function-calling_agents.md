---
title: >-
  [论文解读] Blue Teaming Function-Calling Agents
description: >-
  [AAAI 2026][LLM/NLP][function-calling] 系统评估了四个开源function-calling LLM在三种攻击下的鲁棒性，并测试了八种防御方案的效果，揭示了当前模型默认不安全、防御方案在实际场景中仍难以部署的现状。
tags:
  - AAAI 2026
  - LLM/NLP
  - function-calling
...
**本文目标**: 系统评估开源function-calling模型的安全性，量化攻击成功率（ASR）和防御有效性，为设计更安全的智能体系统提供实证依据。
