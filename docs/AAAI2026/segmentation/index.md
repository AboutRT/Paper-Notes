...
description: >-
  30篇AAAI2026 语义分割方向论文深度解读，每篇5分钟读懂核心思想。每篇笔记含一句话总结、背景动机、方法详解、实验数据、亮点洞察与局限性分析。
---
...
**[A2Lc Active And Automated Label Correction For Semantic Segm](a2lc_active_and_automated_label_correction_for_semantic_segm.md)**
...
**[Adaptive Morph-Patch Transformer For Aortic Vessel Segmentat](adaptive_morph-patch_transformer_for_aortic_vessel_segmentat.md)**
...
**[Breaking The Stealth-Potency Trade-Off In Clean-Image Backdoors With Generative ](breaking_the_stealth-potency_trade-off_in_clean-image_backdoors_with_generative_.md)**
...
**[Bridging Granularity Gaps Hierarchical Semantic Learning For Cross-Domain Few-Sh](bridging_granularity_gaps_hierarchical_semantic_learning_for_cross-domain_few-sh.md)**

:   提出 HSL 框架，通过双重风格随机化 (DSR)、层次语义挖掘 (HSM) 和原型置信度调制阈值 (PCMT) 三个模块，解决跨域少样本分割中源域和目标域之间的**分割粒度差异**问题，在四个目标域数据集上达到 SOTA。

**[Causal-Tune Mining Causal Factors From Vision Foundation Mod](causal-tune_mining_causal_factors_from_vision_foundation_mod.md)**
...
**[Eagle Episodic Appearance- And Geometry-Aware Memory For Unified 2D-3D Visual Qu](eagle_episodic_appearance-_and_geometry-aware_memory_for_unified_2d-3d_visual_qu.md)**
...
**[Empowering Dino Representations For Underwater Instance Segmentation Via Aligner](empowering_dino_representations_for_underwater_instance_segmentation_via_aligner.md)**
...
**[Infoclip Bridging Vision-Language Pretraining And Open-Vocab](infoclip_bridging_vision-language_pretraining_and_open-vocab.md)**
...
**[Jodiffusion Jointly Diffusing Image With Pixel-Level Annotations For Semantic Se](jodiffusion_jointly_diffusing_image_with_pixel-level_annotations_for_semantic_se.md)**

:   提出JoDiffusion框架，通过在潜在空间中联合扩散图像与像素级标注掩码，首次实现仅基于文本提示同时生成语义一致的图像-标注对，在Pascal VOC、COCO和ADE20K上显著超越现有Image2Mask和Mask2Image方法。

**[Lwganet Addressing Spatial And Channel Redundancy In Remote Sensing Visual Tasks](lwganet_addressing_spatial_and_channel_redundancy_in_remote_sensing_visual_tasks.md)**
...
**[Rsvg-Zeroov Exploring A Training-Free Framework For Zero-Shot Open-Vocabulary Vi](rsvg-zeroov_exploring_a_training-free_framework_for_zero-shot_open-vocabulary_vi.md)**

:   提出 RSVG-ZeroOV，一个免训练框架，通过"概览-聚焦-进化"三阶段策略融合 VLM 的交叉注意力图和扩散模型的自注意力图，实现零样本开放词汇遥感视觉定位。

**[Sam-Daq Segment Anything Model With Depth-Guided Adaptive Queries For Rgb-D Vide](sam-daq_segment_anything_model_with_depth-guided_adaptive_queries_for_rgb-d_vide.md)**
...
**[Segment And Matte Anything In A Unified Model](segment_and_matte_anything_in_a_unified_model.md)**
...
**[Ssr Semantic And Spatial Rectification For Clip-Based Weakly Supervised Segmenta](ssr_semantic_and_spatial_rectification_for_clip-based_weakly_supervised_segmenta.md)**
...
**[Symmetrical Flow Matching Unified Image Generation Segmentation And Classificati](symmetrical_flow_matching_unified_image_generation_segmentation_and_classificati.md)**
...
**[Target Refocusing Via Attention Redistribution For Open-Vocabulary Semantic Segm](target_refocusing_via_attention_redistribution_for_open-vocabulary_semantic_segm.md)**
