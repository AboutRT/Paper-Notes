---
description: "提出CrossCheck-Bench诊断基准评估VLM的多模态冲突检测能力，包含三级推理层次和七种原子能力，揭示组合推理是当前模型的核心瓶颈"
tags: [benchmark, multimodal-reasoning, VLM-evaluation, conflict-detection, compositional-reasoning]
---
# CrossCheck-Bench: Diagnosing Compositional Failures in Multimodal Conflict Resolution

**会议**: AAAI2026  
**arXiv**: [2511.21717](https://arxiv.org/abs/2511.21717)  
**代码**: https://github.com/bytedance/CrossCheck-Bench (有)  
**领域**: 多模态评估 / VLM推理  
...
**本文要解决什么？** 如何系统地评估和诊断VLM检测、分析和解决跨模态不一致的能力。

**切入角度** 设计三级层次结构（感知→整合→推理）和七种原子能力的诊断框架，从真实世界数据构建有注入矛盾的评估样本。

**核心idea一句话** 通过层级化能力分解和级联失败分析，揭示VLM在多模态冲突推理中"感知层看似成功但推理层系统失败"的深层问题。
...
1. **三级诊断层次与七种原子能力**:
    ...
    - 做什么：将多模态冲突检测能力分解为可独立测量和组合分析的细粒度单元
...
2. **多模态线索图(MCG)与对抗性QA生成**:
    ...
    - 做什么：从真实世界数据构建结构化事实表征，并基于此生成具有注入矛盾的评估样本
