---
title: >-
  AAAI2026 人体理解方向 65篇论文解读
description: >-
  65篇AAAI2026 人体理解方向论文深度解读，每篇5分钟读懂核心思想。每篇笔记含一句话总结、背景动机、方法详解、实验数据、亮点洞察与局限性分析。
---
...
**[Anti-Adversarial Learning Desensitizing Prompts For Large La](anti-adversarial_learning_desensitizing_prompts_for_large_la.md)**
...
**[Auto-Pre An Automatic And Cost-Efficient Peer-Review Framework For Language Gene](auto-pre_an_automatic_and_cost-efficient_peer-review_framework_for_language_gene.md)**

:   提出 Auto-PRE 框架，通过自动资格考试从一致性、相关性、自信度三个维度筛选合格的 LLM 评估者，在无需人工标注的前提下实现了 SOTA 评估性能并大幅降低成本。

**[Behavior Tokens Speak Louder Disentangled Explainable Recommendation With Behavi](behavior_tokens_speak_louder_disentangled_explainable_recommendation_with_behavi.md)**
...
**[Can Llms Truly Embody Human Personality Analyzing Ai And Human Behavior Alignmen](can_llms_truly_embody_human_personality_analyzing_ai_and_human_behavior_alignmen.md)**
...
**[Coordar One-Reference 6D Pose Estimation Of Novel Objects Via Autoregressive Coo](coordar_one-reference_6d_pose_estimation_of_novel_objects_via_autoregressive_coo.md)**
...
**[Enhancing Robustness Of Offline Reinforcement Learning Under Data Corruption Via](enhancing_robustness_of_offline_reinforcement_learning_under_data_corruption_via.md)**
...
**[From Imitation To Discrimination Toward A Generalized Curriculum Advantage Mecha](from_imitation_to_discrimination_toward_a_generalized_curriculum_advantage_mecha.md)**
...
**[Hilomix Robust High- And Low-Frequency Graph Learning Framework For Mixing Addre](hilomix_robust_high-_and_low-frequency_graph_learning_framework_for_mixing_addre.md)**
...
**[Irote Human-Like Traits Elicitation Of Large Language Model Via In-Context Self-](irote_human-like_traits_elicitation_of_large_language_model_via_in-context_self-.md)**
...
**[Midb Multilingual Instruction Data Booster For Enhancing Cultural Equality In Mu](midb_multilingual_instruction_data_booster_for_enhancing_cultural_equality_in_mu.md)**
...
**[Modality-Aware Bias Mitigation And Invariance Learning For Unsupervised Visible-](modality-aware_bias_mitigation_and_invariance_learning_for_unsupervised_visible-.md)**
...
**[Modelling The Effects Of Hearing Loss On Neural Coding In The Auditory Midbrain ](modelling_the_effects_of_hearing_loss_on_neural_coding_in_the_auditory_midbrain_.md)**
...
**[New Synthetic Goldmine Hand Joint Angle-Driven Emg Data Generation Framework For](new_synthetic_goldmine_hand_joint_angle-driven_emg_data_generation_framework_for.md)**
...
**[Pa-Fas Towards Interpretable And Generalizable Multimodal Face Anti-Spoofing Via](pa-fas_towards_interpretable_and_generalizable_multimodal_face_anti-spoofing_via.md)**
...
**[Pararevsnn A Parallel Reversible Spiking Neural Network For Efficient Training A](pararevsnn_a_parallel_reversible_spiking_neural_network_for_efficient_training_a.md)**
...
**[Pathmind A Retrieve-Prioritize-Reason Framework For Knowledge Graph Reasoning Wi](pathmind_a_retrieve-prioritize-reason_framework_for_knowledge_graph_reasoning_wi.md)**
...
**[Personality-Guided Public-Private Domain Disentangled Hypergraph-Former Network ](personality-guided_public-private_domain_disentangled_hypergraph-former_network_.md)**

:   提出 P3HF 框架，通过人格引导的特征门控、时序感知的超图-Transformer（Hypergraph-Former）架构和事件级公私域解耦三大创新，在多事件多模态抑郁检测任务上实现约 10% 的准确率和 F1 提升。

**[Plug-And-Play Clarifier A Zero-Shot Multimodal Framework For Egocentric Intent D](plug-and-play_clarifier_a_zero-shot_multimodal_framework_for_egocentric_intent_d.md)**
...
**[Radar-Aplanc Unsupervised Radar-Based Heartbeat Sensing Via Augmented Pseudo-Lab](radar-aplanc_unsupervised_radar-based_heartbeat_sensing_via_augmented_pseudo-lab.md)**

:   提出首个雷达心跳感知的无监督学习框架 Radar-APLANC，通过噪声对比三元组损失（NCT loss）和增强伪标签生成器实现两阶段无监督训练，无需昂贵的生理信号标注即可达到接近监督方法的性能。

**[Ragfort Dual-Path Defense Against Proprietary Knowledge Base Extraction In Retri](ragfort_dual-path_defense_against_proprietary_knowledge_base_extraction_in_retri.md)**
...
**[Reina Regularized Entropy Information-Based Loss For Efficient Simultaneous Spee](reina_regularized_entropy_information-based_loss_for_efficient_simultaneous_spee.md)**
...
**[Remember Me Bridging The Long-Range Gap In Lvlms With Three-Step Inference-Only ](remember_me_bridging_the_long-range_gap_in_lvlms_with_three-step_inference-only_.md)**
...
**[Small Language Models For Efficient Agentic Tool Calling Outperforming Large Mod](small_language_models_for_efficient_agentic_tool_calling_outperforming_large_mod.md)**
...
**[Soscontrol Enhancing Human Motion Generation Through Saliency-Aware Symbolic Ori](soscontrol_enhancing_human_motion_generation_through_saliency-aware_symbolic_ori.md)**
...
**[Spatiotemporal-Untrammelled Mixture Of Experts For Multi-Person Motion Predictio](spatiotemporal-untrammelled_mixture_of_experts_for_multi-person_motion_predictio.md)**
...
**[Transferable Backdoor Attacks For Code Models Via Sharpness-Aware Adversarial Pe](transferable_backdoor_attacks_for_code_models_via_sharpness-aware_adversarial_pe.md)**
...
**[Vpho Joint Visual-Physical Cue Learning And Aggregation For Hand-Object Pose Est](vpho_joint_visual-physical_cue_learning_and_aggregation_for_hand-object_pose_est.md)**
...
**[W2S-Aligntree Weak-To-Strong Inference-Time Alignment For Large Language Models ](w2s-aligntree_weak-to-strong_inference-time_alignment_for_large_language_models_.md)**
...
**[Yes Florence I Will Do Better Next Time Agentic Feedback Reasoning For Humorous ](yes_florence_i_will_do_better_next_time_agentic_feedback_reasoning_for_humorous_.md)**
