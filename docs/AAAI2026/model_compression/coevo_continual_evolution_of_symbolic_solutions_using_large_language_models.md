...
description: >-
  [AAAI 2026][模型压缩][符号回归] 提出CoEvo框架，结合LLM与进化搜索方法论，通过动态知识库和多表示空间（自然语言/数学公式/代码）实现符号解的持续开放式进化，在AI Feynman基准上大幅超越现有符号回归方法。
tags:
  - AAAI 2026
  - 模型压缩
  - 符号回归
...
**LLM方法**（FunSearch、LLM-SR）：提升了搜索效率，但**缺乏持续精炼和扩展已发现解及其底层知识的能力**，限制了开放式创新
