...
| 🔬 [可解释性](#interpretability) | 31 |
| 📈 [时间序列](#time_series) | 31 |
| 🤖 [机器人/具身智能](#robotics) | 30 |
| ✂️ [语义分割](#segmentation) | 30 |
| 💡 [LLM 推理](#llm_reasoning) | 28 |
| 💬 [LLM / NLP](#llm_nlp) | 27 |
| 🔍 [信息检索/RAG](#information_retrieval) | 26 |
| 📐 [优化/理论](#optimization) | 23 |
| 🎵 [音频/语音](#audio_speech) | 21 |
| 🎁 [推荐系统](#recommender) | 21 |
| 📊 [LLM 评测](#llm_evaluation) | 20 |
...
| ⚡ [LLM 效率](#llm_efficiency) | 9 |
| 🌐 [多语言/翻译](#multilingual_mt) | 8 |
...
**[Cheating Stereo Matching in Full-Scale: Physical Adversarial Attack against Binocular Depth Estimation](autonomous_driving/cheating_stereo_matching_in_full-scale_physical_adversarial_attack_against_binoc.md)**
...
**[Structured Language Generation Model: Loss Calibration and Formatted Decoding for Efficient Text](model_compression/structured_language_generation_model_loss_calibration_and_formatted_decoding_for.md)**
...
**[FilmWeaver: Weaving Consistent Multi-Shot Videos with Cache-Guided Autoregressive Diffusion](video_understanding/filmweaver_weaving_consistent_multi-shot_videos_with_cache-guided_autoregressive.md)**
...
**[MoFu: Scale-Aware Modulation and Fourier Fusion for Multi-Subject Video Generation](video_understanding/mofu_scale-aware_modulation_and_fourier_fusion_for_multi-subject_video_generatio.md)**
...
**[Connectivity-Guided Sparsification of 2-FWL GNNs Preserving Full Expressivity](graph_learning/connectivity-guided_sparsification_of_2-fwl_gnns_preserving_full_expressivity_wi.md)**
