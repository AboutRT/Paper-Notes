...
1. **仅关注单物体提示**：如"a headshot of an assistant"，现有去偏方法对此类简单提示有效
2. **忽视组合语义绑定**：当提示变为"a headshot of an assistant wearing a pink hat"时，"pink hat"这个上下文本身携带女性偏见倾向，现有方法无法有效处理
