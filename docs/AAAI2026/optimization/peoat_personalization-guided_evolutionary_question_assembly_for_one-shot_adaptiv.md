...
1. **大规模考试**：交互成本高，逐题动态选择不切实际
2. **心理评估**：需要最小化噪声和干扰，逐题反馈可能影响评估质量
3. **远程/离线测试**：设备限制、响应延迟等因素制约交互
4. **资源受限环境**：时间敏感场景下无法支持多轮交互
...
OAT 的三大挑战：
1. **学生适应性**：无中间反馈，需在优化过程中确保题目与个体能力匹配
2. **巨大搜索空间**：从大量候选题目中选出 $L$ 题的组合数是指数级的
3. **编码稀疏性**：候选题库远大于测试长度，编码表示面临维度灾难
