---
description: "【论文笔记】pFed1BS: 基于单比特随机草图的双向通信压缩个性化联邦学习 论文解读 | AAAI 2026 | arXiv 2511.13144 | 联邦学习 federated learning | 提出 pFed1BS 框架，通过单比特随机草图实现联邦学习中上下行双向极致通信压缩（降低 99%+），同时引入基于符号的正则化器实现客户端模型个性化，在非 IID 数据场景下同时解决通信瓶颈和数据异质性两大难题。"
tags:
  - AAAI 2026
  - 联邦学习
