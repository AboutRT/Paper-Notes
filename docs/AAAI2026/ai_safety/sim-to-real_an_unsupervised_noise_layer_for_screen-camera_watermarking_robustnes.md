...
1. **无监督噪声域迁移（核心创新）**
   - 做什么：用非配对数据学习已知噪声域 $\mathcal{C}$ 到未知噪声域 $\mathcal{U}$ 的映射
...
3. **模块化可替换设计**
   - 做什么：数学建模模块 $T$ 和域迁移网络 $G$ 解耦，可独立替换
