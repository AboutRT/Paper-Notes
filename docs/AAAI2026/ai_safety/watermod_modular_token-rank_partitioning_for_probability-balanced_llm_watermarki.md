---
description: "【论文笔记】WaterMod: Modular Token-Rank Partitioning for Probability-Balanced LLM Watermarking 论文解读 | AAAI 2026 | arXiv 2511.07863 | LLM水印 | 提出 WaterMod，一种基于模算术 (rank bmod k) 的 LLM 文本水印方法，通过对概率排序后的词表进行模残差类划分，在零比特（k=2）和多比特（k>2）水印场景下统一实现高检测率和低质量损耗，无需外部同义词库或哈希技巧。"
tags:
  - AAAI 2026
  - LLM水印
  - 文本水印
