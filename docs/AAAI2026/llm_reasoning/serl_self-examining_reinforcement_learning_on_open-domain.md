...
## 研究背景与动机
**领域现状**：LLM自我改进是减少对外部标注依赖的重要方向，但自我评估的奖励信号质量是关键瓶颈。

**现有痛点**：(a) 自我评估容易产生偏好循环（A>B>C>A）；(b) 位置偏差和长度偏差影响判断质量；(c) 缺乏理论保证的奖励推导方法。

**核心矛盾**：自我评估主观且不一致，但外部评估又需要额外资源。

**本文目标** 从自身成对比较判断中推导出高质量的训练奖励。

**切入角度**：Copeland方法（投票理论）解决偏好循环+双奖励（actor+judge）联合优化。

**核心 idea**：Copeland成对比较推导奖励+actor/judge联合优化=无外部依赖的自我改进。
