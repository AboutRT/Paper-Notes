---
description: "【论文笔记】ReGal: A First Look at PPO-based Legal AI for Judgment Prediction and Summarization in India 论文解读 | AAAI 2026 | arXiv 2512.18014 | 法律AI | 本文首次将基于PPO的强化学习（RLAIF）应用于印度法律领域的判决预测与摘要生成任务，虽然性能未超越SFT和商业模型，但作为定位论文（position paper）揭示了RL在法律NLP中的关键挑战与未来方向。"
tags:
  - AAAI 2026
  - 法律AI
  - PPO
...
1. **法庭判决预测与解释（CJPE）**：预测案件结果（接受/驳回）并生成支持性解释
2. **法律文档摘要**：从冗长的法庭判决书中生成简洁摘要
