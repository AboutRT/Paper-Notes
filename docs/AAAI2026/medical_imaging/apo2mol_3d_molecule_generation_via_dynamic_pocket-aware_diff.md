---
title: >-
  [论文解读] Apo2Mol: 3D Molecule Generation via Dynamic Pocket-Aware Diffusion Models
description: >-
  [AAAI 2026][医学图像][结构药物设计] 提出Apo2Mol，一个基于扩散的全原子框架，从蛋白质apo（未结合）构象出发，同时生成3D配体分子和对应的holo（结合态）口袋构象，使用24K实验解析的apo-holo结构对训练，在结合亲和力（Vina min -7.86）和药物类似性上达到SOTA。
tags:
  - AAAI 2026
  - 医学图像
  - 结构药物设计
...
- [SynCoGen: Synthesizable 3D Molecule Generation via Joint Reaction and Coordinate Modeling](../../ICLR2026/medical_imaging/syncogen_synthesizable_3d_molecule_generation_via_joint_reaction_and_coordinate_.md)
