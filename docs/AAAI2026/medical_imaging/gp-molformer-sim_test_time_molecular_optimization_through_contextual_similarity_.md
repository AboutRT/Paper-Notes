---
description: "【论文笔记】GP-MoLFormer-Sim: Test Time Molecular Optimization through Contextual Similarity Guidance 论文解读 | AAAI 2026 | arXiv 2506.05628 | 分子优化 | 提出 GP-MoLFormer-Sim，一种无需训练的测试时分子生成引导方法：利用化学语言模型（GP-MoLFormer）自身的上下文嵌入计算与目标分子的相似度，在自回归解码时动态调整logits来引导生成，结合遗传算法（GP-MoLFormer-Sim+GA）后在PMO基准的23个任务上平均排名第2，且在黑盒oracle设定下优于依赖GPT-4的MOLLEO。"
tags:
  - AAAI 2026
  - 分子优化
  - 化学语言模型
