...
description: >-
  [ICLR 2026][多模态VLM][地理时空推理] 提出 GTR-Bench，一个面向大规模摄像头网络中移动目标地理时空推理的新基准，评估发现最强模型 Gemini-2.5-Pro（34.9%）远落后于人类水平（78.61%）…
tags:
  - "ICLR 2026"
  - "多模态VLM"
  - "地理时空推理"
