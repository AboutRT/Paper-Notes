...
description: >-
  [ICLR2026][多模态VLM][urban computing] 构建 CityLens——迄今最大规模的城市社会经济感知 benchmark（17 城市、6 大领域、11 个预测任务），评估 17 个 LVLM 在直接预测、归一化估计、特征回归三种范式下从卫星/街景图像推断社会经济指标的能力…
tags:
  - "ICLR2026"
  - "多模态VLM"
  - "urban computing"
