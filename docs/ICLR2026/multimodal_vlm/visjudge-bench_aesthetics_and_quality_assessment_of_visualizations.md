...
1. **图表问答基准**（如 ChartQA、ChartInsights）只关注图表内容理解，不评估设计质量
2. **自然图像美学基准**（如 AVA、ArtiMuse）仅关注艺术美感，忽略可视化的核心目的——有效传达数据
3. **可视化评估基准**（如 VisEval）主要评估 NL2VIS 生成准确性，而非可视化本身的内在设计质量
