...
description: >-
  [ICLR 2026][多模态][图像质量评估] 将空间定位（referring + grounding）与图像质量评估结合，构建 GIQA-160K 数据集训练多模态 LLM 生成带有边界框的质量描述和空间 VQA，在细粒度质量感知上显著优于通用 MLLM。
tags:
  - ICLR 2026
  - 多模态
  - 多模态VLM
...
2. **GIQA-VQA 生成**:
    ...
    - 功能：从 GIQA-DES 的描述中自动生成带空间信息的 QA 对
