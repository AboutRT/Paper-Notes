...
2. **总相关性（Total Correlation）分解**:
    ...
    - 功能：将 TC 分解为联合学习、单模态学习和对齐三个目标的统一
...
4. **TCMax 损失函数**:
    ...
    - 功能：将 TCNE 中的统计网络 $T_\theta$ 与分类预测头复用，得到无需额外参数的损失
...
- [\[CVPR 2025\] COAP: Memory-Efficient Training with Correlation-Aware Gradient Projection](../../CVPR2025/multimodal_vlm/coap_memory-efficient_training_with_correlation-aware_gradient_projection.md)
