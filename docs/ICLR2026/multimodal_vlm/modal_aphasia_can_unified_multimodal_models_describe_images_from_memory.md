...
**本文要解决什么？** (1) 严格定义并量化这种跨模态知识断裂现象；(2) 证明它是统一架构的系统性属性而非个别模型的训练偶然；(3) 揭示其对 AI 安全框架的实际威胁。
...
**核心idea一句话**：统一多模态模型中的知识迁移是不对称的——模型在视觉模态中成功记忆的概念无法在文本模态中被可靠访问，这构成了一种系统性的跨模态理解失败。
