---
description: "【论文笔记】Visual Prompt-Agnostic Evolution 论文解读 | ICLR2026 | arXiv 2601.20232 | 提示学习 Visual Prompt Tuning | 提出 Prompt-Agnostic Evolution (PAE)，通过频域感知的任务初始化 (MPA) 和 Koopman-Lyapunov 动力系统 (KLD) 跨层关联 prompt，加速 VPT 收敛（平均 1.41× 加速）并在 25 个数据集上提升 1–3% 精度，且对各类 VPT 变体即插即用、无推理开销。"
tags:
  - ICLR2026
  - 提示学习
  - Transformer
