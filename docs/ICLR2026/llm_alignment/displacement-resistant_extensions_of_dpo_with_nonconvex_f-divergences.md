---
description: "【论文笔记】Displacement-Resistant Extensions of DPO with Nonconvex $f$-Divergences 论文解读 | ICLR 2026 | arXiv 2602.06788 | DPO | 发现 f-DPO 的可解性不需要 f 凸（仅需 $\lim_{t\to 0^+} f'(t) = -\infty$），进一步证明 $\arg\min f(t) \geq 1$ 是抵抗概率位移的必要条件，由此提出 SquaredPO（$f(t) = \frac{1}{2}(\log t)^2$，非凸），在保持性能的同时显著缓解 winner 概率下降问题。"
tags:
  - ICLR 2026
  - DPO
  - f-divergence
