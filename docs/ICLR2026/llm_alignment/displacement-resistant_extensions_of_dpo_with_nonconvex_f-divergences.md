---
description: "【论文笔记】Displacement-Resistant Extensions of DPO with Nonconvex f-Divergences 论文解读 | ICLR 2026 | arXiv 2602.06788 | DPO | 发现 f-DPO 的可解性不需要 f 凸（仅需 lim_t→ 0⁺ f'(t) = -∞），进一步证明 argmin f(t) ≥ 1 是抵抗概率位移的必要条件，由此提出 SquaredPO（f(t) = frac12(log t)²，非凸），在保持性能的同时显著缓解 winner 概率下降问题。"
tags:
  - ICLR 2026
  - DPO
  - f-divergence
