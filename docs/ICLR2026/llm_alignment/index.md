---
title: >-
  ICLR2026 对齐/RLHF方向 38篇论文解读
description: >-
  38篇ICLR2026 对齐/RLHF方向论文深度解读，每篇5分钟读懂核心思想。每篇笔记含一句话总结、背景动机、方法详解、实验数据、亮点洞察与局限性分析。
---
...
**[Align Once Benefit Multilingually Enforcing Multilingual Consistency For Llm Saf](align_once_benefit_multilingually_enforcing_multilingual_consistency_for_llm_saf.md)**
...
**[Alignment Through Meta-Weighted Online Sampling Bridging The Gap Between Data Ge](alignment_through_meta-weighted_online_sampling_bridging_the_gap_between_data_ge.md)**
...
**[Beyond Rlhf And Nlhf Population-Proportional Alignment Under An Axiomatic Framew](beyond_rlhf_and_nlhf_population-proportional_alignment_under_an_axiomatic_framew.md)**
...
**[Chasing The Tail Effective Rubric-Based Reward Modeling For Large Language Model](chasing_the_tail_effective_rubric-based_reward_modeling_for_large_language_model.md)**
...
**[From Utterance To Vividity Training Expressive Subtitle Translation Llm Via Adap](from_utterance_to_vividity_training_expressive_subtitle_translation_llm_via_adap.md)**
...
**[Group-Relative Reinforce Is Secretly An Off-Policy Algorithm Demystifying Some M](group-relative_reinforce_is_secretly_an_off-policy_algorithm_demystifying_some_m.md)**
...
**[Is On-Policy Data Always The Best Choice For Direct Preference Optimization-Base](is_on-policy_data_always_the_best_choice_for_direct_preference_optimization-base.md)**
...
**[Jailnewsbench Multi-Lingual And Regional Benchmark For Fake News Generation Unde](jailnewsbench_multi-lingual_and_regional_benchmark_for_fake_news_generation_unde.md)**

:   提出首个评估 LLM 在越狱攻击下生成假新闻鲁棒性的多语言多区域基准 JailNewsBench，覆盖 34 个地区和 22 种语言、约 30 万实例，揭示最高 86.3% 的攻击成功率以及英语/美国话题防御显著弱于其他地区的安全不平衡现象。

**[Learning More With Less A Dynamic Dual-Level Down-Sampling Framework For Efficie](learning_more_with_less_a_dynamic_dual-level_down-sampling_framework_for_efficie.md)**
...
**[Learning Ordinal Probabilistic Reward From Preferences](learning_ordinal_probabilistic_reward_from_preferences.md)**
...
**[Mitigating The Safety Alignment Tax With Null-Space Constrained Policy Optimizat](mitigating_the_safety_alignment_tax_with_null-space_constrained_policy_optimizat.md)**

:   提出 NSPO，将安全对齐的策略梯度投影到通用任务表征的零空间中，从几何层面保证安全优化不损害通用能力，仅用 40% 安全数据即在 7 个安全 benchmark 上达到 SOTA，同时在数学/代码/指令遵循上几乎无性能损失。

**[No Prompt Left Behind Exploiting Zero-Variance Prompts In Llm Reinforcement Lear](no_prompt_left_behind_exploiting_zero-variance_prompts_in_llm_reinforcement_lear.md)**
...
**[Reinforcement Unlearning Via Group Relative Policy Optimization](reinforcement_unlearning_via_group_relative_policy_optimization.md)**
...
**[Safedpo Preference Optimization Safety](safedpo_preference_optimization_safety.md)**
...
**[Semantic-Aware Wasserstein Policy Regularization For Large Language Model Alignm](semantic-aware_wasserstein_policy_regularization_for_large_language_model_alignm.md)**
...
**[Swap-Guided Preference Learning For Personalized Reinforcement Learning From Hum](swap-guided_preference_learning_for_personalized_reinforcement_learning_from_hum.md)**
...
**[Token-Importance Guided Direct Preference Optimization](token-importance_guided_direct_preference_optimization.md)**

:   提出TI-DPO，通过梯度归因+高斯先验的混合权重机制精确量化每个token对偏好的贡献，结合三元组损失在连续语义空间引导优化，在6个基准上平均62.3分达到SOTA，同时具备可解释的token级控制能力。

**[Toward Universal And Transferable Jailbreak Attacks On Vision-Language Models](toward_universal_and_transferable_jailbreak_attacks_on_vision-language_models.md)**
...
**[Towards Understanding Valuable Preference Data For Large Language Model Alignmen](towards_understanding_valuable_preference_data_for_large_language_model_alignmen.md)**
...
**[Unifying Stable Optimization And Reference Regularization In Rlhf](unifying_stable_optimization_and_reference_regularization_in_rlhf.md)**
...
**[Why Dpo Is Misspecified Estimator](why_dpo_is_misspecified_estimator.md)**
