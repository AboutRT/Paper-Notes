...
1. **手工设计瓶颈**：现有智能体需要精心设计的工作流、提示词和迭代调优，这要求同时具备 LLM 技术和领域专业知识，严重限制了跨行业的可扩展性
2. **协调开销大**：传统多智能体架构采用点对点协作模型，允许智能体之间自由交互，导致协调开销增大、死锁和不可预测的行为
3. **缺乏自适应性**：现有框架依赖人工编写模板，缺乏系统推理能力，无法自主适应新任务和优化需求
4. **稳定性问题**：随着系统复杂度增加，智能体间的不可预测交互、资源冲突和涌现行为不稳定性问题日益突出
