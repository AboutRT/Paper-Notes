...
description: >-
  [ICLR 2026][自动驾驶][时序残差] ResWorld 提出时序残差世界模型（TR-World），通过计算 BEV 场景表征的时序残差来提取动态物体信息（无需检测/跟踪），避免对静态区域的冗余建模，结合未来引导轨迹优化（FGTR）模块利用预测的未来 BEV 特征修正规划轨迹…
tags:
  - "ICLR 2026"
  - "自动驾驶"
  - "时序残差"
...
1. **时序残差提取**:
    ...
    - 功能：从对齐的多帧 BEV 特征中，通过差分运算提取动态物体信息。
