---
title: >-
  ICLR2026 自动驾驶方向 15篇论文解读
description: >-
  15篇ICLR2026 自动驾驶方向论文深度解读，每篇5分钟读懂核心思想。每篇笔记含一句话总结、背景动机、方法详解、实验数据、亮点洞察与局限性分析。
---
...
**[Bridgedrive Diffusion Bridge Policy For Closed-Loop Trajectory Planning In Auton](bridgedrive_diffusion_bridge_policy_for_closed-loop_trajectory_planning_in_auton.md)**
...
**[Drivinggen A Comprehensive Benchmark For Generative Video World Models In Autono](drivinggen_a_comprehensive_benchmark_for_generative_video_world_models_in_autono.md)**
...
**[Marc Memory-Augmented Rl Token Compression For Efficient Video Un](marc_memory-augmented_rl_token_compression_for_efficient_video_un.md)**
...
**[Multi-Head Low-Rank Attention](multi-head_low-rank_attention.md)**
...
**[Segment Any Events With Language](segment_any_events_with_language.md)**
...
**[Simo Single-Modality-Operable Multimodal Collaborative Perceptio](simo_single-modality-operable_multimodal_collaborative_perceptio.md)**
...
**[Steerable Adversarial Scenario Generation Through Test-Time Preference Alignment](steerable_adversarial_scenario_generation_through_test-time_preference_alignment.md)**
