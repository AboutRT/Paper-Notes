---
description: "【论文笔记】Multi-Head Low-Rank Attention (MLRA) 论文解读 | ICLR 2026 | arXiv 2603.02188 | KV Cache | 提出 Multi-Head Low-Rank Attention (MLRA)，通过将 MLA 的单一 latent head 分解为多个可独立分片的 latent head，并对各分支注意力输出求和，实现原生 4-way 张量并行支持，在保持 SOTA 性能的同时获得 2.8× 的解码加速。"
tags:
  - ICLR 2026
  - KV Cache
  - 张量并行
