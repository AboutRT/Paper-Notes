...
description: >-
  [ICLR 2026][机器人][jailbreaking] 提出将对 LLM 驱动的社交媒体宣传机器人进行"越狱"（jailbreaking）重新定义为一种用户主导的、非暴力的去冲突化（de-escalation）和平建设实践…
tags:
  - "ICLR 2026"
  - "机器人"
  - "jailbreaking"
...
2. **Jailbreaking 作为用户实践**:
    ...
    - 功能：定义并描述用户如何在社交媒体上使用 prompt injection 揭露 bot
...
3. **和平建设理论框架**:
    ...
    - 功能：将 jailbreaking 定位在去冲突化理论体系中
