...
description: >-
  [ICLR 2026][LLM/NLP][3D generation] 提出 AssetFormer，基于 Llama 架构的自回归 Transformer，将模块化 3D 资产（由 primitive 序列组成）建模为离散 token 序列…
tags:
  - "ICLR 2026"
  - "LLM/NLP"
  - "3D generation"
...
- [\[ACL 2025\] A Modular Dataset to Demonstrate LLM Abstraction Capability](../../ACL2025/llm_nlp/a_modular_dataset_to_demonstrate_llm_abstraction_capability.md)
