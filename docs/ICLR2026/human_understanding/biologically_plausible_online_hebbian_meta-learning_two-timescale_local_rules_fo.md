...
description: >-
  [ICLR2026][人体理解][SNN] 提出一种无需BPTT的在线SNN解码器，通过三因子Hebbian局部学习规则结合双时间尺度eligibility trace和自适应学习率控制，在O(1)内存下实现可比离线训练方法的BCI神经解码精度（Pearson R≥0.63/0.81），并在闭环仿真中展现了对神经信号非平稳性的持续适应能力。
tags:
  - ICLR2026
  - 人体理解
  - SNN
...
2. **双时间尺度Eligibility Trace**：
    ...
    - 功能：将瞬时Hebbian更新累积到快/慢两条trace中，实现时间尺度上的信息整合
...
3. **双通道权重更新**：
    ...
    - 功能：通过快更新和慢更新两条路径分别应用eligibility trace
