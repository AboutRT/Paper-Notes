...
1. **基于 Bloom 分类学的数据集构建**：
    ...
    - 功能：为每个 AI/ML 知识点创建覆盖 Bloom 六层认知水平的题目集
...
2. **GPT-2 微调自动出题**：
    ...
    - 功能：在构建的 Bloom 标注数据集上微调 GPT-2，实现给定知识点和认知层次后自动生成相应难度的题目
