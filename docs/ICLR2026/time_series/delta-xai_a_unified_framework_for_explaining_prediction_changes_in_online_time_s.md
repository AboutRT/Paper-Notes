...
1. **逐步独立分析**：大多数XAI方法独立分析每个时间步的预测，忽略了时序依赖关系，无法解释"预测为什么从t-1到t发生了变化"
2. **在线动态利用不足**：现有方法没有充分利用在线监控的特性——即数据是逐步到达的，预测是持续更新的
3. **评估困难**：缺乏针对在线场景的系统化评估框架，无法全面评估解释的忠实度、充分性和一致性
