---
title: >-
  ICLR2026 自监督/表示学习方向 14篇论文解读
description: >-
  14篇ICLR2026 自监督/表示学习方向论文深度解读，每篇5分钟读懂核心思想。每篇笔记含一句话总结、背景动机、方法详解、实验数据、亮点洞察与局限性分析。
---
...
**[Difficult Examples Hurt Unsupervised Contrastive Learning A Theoretical Perspect](difficult_examples_hurt_unsupervised_contrastive_learning_a_theoretical_perspect.md)**
...
**[Enhancing Molecular Property Predictions By Learning From Bond Modelling And Int](enhancing_molecular_property_predictions_by_learning_from_bond_modelling_and_int.md)**

:   提出 DeMol 双图增强多尺度交互框架，通过并行的原子中心图和键中心图通道以及 Double-Helix Blocks 显式建模原子-原子、原子-键、键-键三类交互，在 PCQM4Mv2、OC20、QM9 等基准上取得 SOTA。

**[Fly-Cl A Fly-Inspired Framework For Enhancing Efficient Decorrelation And Reduce](fly-cl_a_fly-inspired_framework_for_enhancing_efficient_decorrelation_and_reduce.md)**
...
**[Regularized Latent Dynamics Prediction Is A Strong Baseline For Behavioral Found](regularized_latent_dynamics_prediction_is_a_strong_baseline_for_behavioral_found.md)**
...
**[Snap-Uq Self-Supervised Next-Activation Prediction For Single-Pass Uncertainty I](snap-uq_self-supervised_next-activation_prediction_for_single-pass_uncertainty_i.md)**
...
**[Why Prototypes Collapse Diagnosing And Preventing Partial Collapse In Prototypic](why_prototypes_collapse_diagnosing_and_preventing_partial_collapse_in_prototypic.md)**
