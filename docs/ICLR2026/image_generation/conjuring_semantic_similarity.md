...
description: >-
  [ICLR2026][图像生成][semantic similarity] 提出一种基于视觉想象的文本语义相似度度量——通过计算文本条件扩散模型在两个文本提示下诱导的反向 SDE 之间的 Jeffreys 散度来衡量语义距离，可用 Monte-Carlo 采样直接计算…
tags:
  - "ICLR2026"
  - "图像生成"
  - "semantic similarity"
