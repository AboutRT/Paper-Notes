...
description: >-
  [ICLR 2026][图像生成][多视角定制生成] 提出多视角定制（multi-view customization）新任务并设计 MVCustom 框架，通过视频扩散骨干网络结合密集时空注意力实现整体帧一致性，在推理阶段引入深度感知特征渲染和一致性感知潜码补全两项技术…
tags:
  - "ICLR 2026"
  - "图像生成"
  - "多视角定制生成"
...
- [\[ECCV 2024\] MVDD: Multi-View Depth Diffusion Models](../../ECCV2024/image_generation/mvdd_multi-view_depth_diffusion_models.md)
