...
description: >-
  [ICLR 2026][图像生成][VLM-as-a-Judge] 提出 K-Sort Eval 框架，通过后验校正和动态匹配策略，使 VLM 能可靠高效地替代人类进行视觉生成模型的偏好评估，通常只需不到 90 次模型运行即可得出与人类 Arena 一致的结果。
tags:
  - ICLR 2026
  - 图像生成
  - VLM-as-a-Judge
...
- [PhD: A ChatGPT-Prompted Visual Hallucination Evaluation Dataset](../../CVPR2025/image_generation/phd_a_chatgpt-prompted_visual_hallucination_evaluation_dataset.md)
