...
description: >-
  [ICLR 2026][图像生成][Shape Editing] 提出 Follow-Your-Shape，一个无需训练和掩码的形状感知编辑框架，通过计算反演与编辑轨迹间的 token 级速度差异构建 Trajectory Divergence Map (TDM) 来精确定位编辑区域…
tags:
  - "ICLR 2026"
  - "图像生成"
  - "Shape Editing"
...
- [\[ECCV 2024\] ShapeFusion: A 3D Diffusion Model for Localized Shape Editing](../../ECCV2024/image_generation/shapefusion_a_3d_diffusion_model_for_localized_shape_editing.md)
