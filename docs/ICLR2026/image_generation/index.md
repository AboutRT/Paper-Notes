...
**[Amortising Inference And Meta-Learning Priors In Neural Networks](amortising_inference_and_meta-learning_priors_in_neural_networks.md)**
...
**[Bridging Degradation Discrimination And Generation For Universal Image Restorati](bridging_degradation_discrimination_and_generation_for_universal_image_restorati.md)**

:   BDG 通过多角度多尺度灰度共生矩阵（MAS-GLCM）进行细粒度退化判别，并设计三阶段扩散训练（生成→桥接→修复）将退化判别能力与生成先验无缝融合，在 all-in-one 修复和真实世界超分辨率任务上取得显著的保真度提升。

**[Bridging Generalization Gap Of Heterogeneous Federated Clients Using Generative ](bridging_generalization_gap_of_heterogeneous_federated_clients_using_generative_.md)**

:   FedVTC 提出在模型异构联邦学习中，各客户端通过变分转置卷积网络（VTC）从聚合的特征分布统计量中生成合成数据来微调本地模型，无需公共数据集即可显著提升泛化能力，同时降低通信和内存开销。

**[Cmt Mid-Training For Efficient Learning Of Consistency Mean Flow And Flow Map Mo](cmt_mid-training_for_efficient_learning_of_consistency_mean_flow_and_flow_map_mo.md)**
...
**[Compose Your Policies Improving Diffusion-Based Or Flow-Based Robot Policies Via](compose_your_policies_improving_diffusion-based_or_flow-based_robot_policies_via.md)**
...
**[Concept-Trak Understanding How Diffusion Models Learn Concepts Through Concept-L](concept-trak_understanding_how_diffusion_models_learn_concepts_through_concept-l.md)**
...
**[Condition Errors Refinement In Autoregressive Image Generation With Diffusion Lo](condition_errors_refinement_in_autoregressive_image_generation_with_diffusion_lo.md)**
...
**[Conditionally Whitened Generative Models For Probabilistic Time Series Forecasti](conditionally_whitened_generative_models_for_probabilistic_time_series_forecasti.md)**
...
**[Contact-Guided 3D Genome Structure Generation Of E Coli Via Diffusion Transforme](contact-guided_3d_genome_structure_generation_of_e_coli_via_diffusion_transforme.md)**
...
**[Continual Unlearning For Text-To-Image Diffusion Models A Regularization Perspec](continual_unlearning_for_text-to-image_diffusion_models_a_regularization_perspec.md)**
...
**[Contractive Diffusion Policies Robust Action Diffusion Via Contractive Score-Bas](contractive_diffusion_policies_robust_action_diffusion_via_contractive_score-bas.md)**
...
**[Detecting And Mitigating Memorization In Diffusion Models Through Anisotropy Of ](detecting_and_mitigating_memorization_in_diffusion_models_through_anisotropy_of_.md)**
...
**[Diffink Glyph- And Style-Aware Latent Diffusion Transformer For Text To Online H](diffink_glyph-_and_style-aware_latent_diffusion_transformer_for_text_to_online_h.md)**
...
**[Does Semantic Noise Initialization Transfer From Images To Videos A Paired Diagn](does_semantic_noise_initialization_transfer_from_images_to_videos_a_paired_diagn.md)**
...
**[Doflow Flow-Based Generative Models For Interventional And Counterfactual Foreca](doflow_flow-based_generative_models_for_interventional_and_counterfactual_foreca.md)**
...
**[Draw-In-Mind Rebalancing Designer-Painter Roles In Unified Multimodal Models Ben](draw-in-mind_rebalancing_designer-painter_roles_in_unified_multimodal_models_ben.md)**
...
**[Easier Painting Than Thinking Can Text-To-Image Models Set The Stage But Not Dir](easier_painting_than_thinking_can_text-to-image_models_set_the_stage_but_not_dir.md)**
...
**[Editscore Unlocking Online Rl For Image Editing Via High-Fidelity Reward Modelin](editscore_unlocking_online_rl_for_image_editing_via_high-fidelity_reward_modelin.md)**
...
**[Error As Signal Stiffness-Aware Diffusion Sampling Via Embedded Runge-Kutta Guid](error_as_signal_stiffness-aware_diffusion_sampling_via_embedded_runge-kutta_guid.md)**
...
**[Everything In Its Place Benchmarking Spatial Intelligence Of Text-To-Image Model](everything_in_its_place_benchmarking_spatial_intelligence_of_text-to-image_model.md)**
...
**[Flow-Based Single-Step Completion For Efficient And Expressive Policy Learning](flow-based_single-step_completion_for_efficient_and_expressive_policy_learning.md)**
...
**[Flow2Gan Hybrid Flow Matching And Gan With Multi-Resolution Network For Few-Step](flow2gan_hybrid_flow_matching_and_gan_with_multi-resolution_network_for_few-step.md)**
...
**[Hierarchical Entity-Centric Reinforcement Learning With Factored Subgoal Diffusi](hierarchical_entity-centric_reinforcement_learning_with_factored_subgoal_diffusi.md)**
...
**[Image Can Bring Your Memory Back A Novel Multi-Modal Guided Attack Against Image](image_can_bring_your_memory_back_a_novel_multi-modal_guided_attack_against_image.md)**
...
**[Improved Object-Centric Diffusion Learning With Registers And Contrastive Alignm](improved_object-centric_diffusion_learning_with_registers_and_contrastive_alignm.md)**

:   提出 CODA 框架，通过引入 register slots 吸收残余注意力、微调交叉注意力投影以及对比对齐损失，解决基于扩散模型的物体中心学习中的 slot 纠缠和弱对齐问题，在合成和真实数据集上显著提升物体发现和组合式生成质量。

**[Improving Discrete Diffusion Unmasking Policies Beyond Explicit Reference Polici](improving_discrete_diffusion_unmasking_policies_beyond_explicit_reference_polici.md)**
...
**[K-Sort Eval Efficient Preference Evaluation For Visual Generation Via Corrected ](k-sort_eval_efficient_preference_evaluation_for_visual_generation_via_corrected_.md)**
...
**[Large Scale Diffusion Distillation Via Score-Regularized Continuous-Time Consist](large_scale_diffusion_distillation_via_score-regularized_continuous-time_consist.md)**
...
**[Localized Concept Erasure In Text-To-Image Diffusion Models Via High-Level Repre](localized_concept_erasure_in_text-to-image_diffusion_models_via_high-level_repre.md)**
...
**[Mod-Adapter Tuning-Free And Versatile Multi-Concept Personalization Via Modulati](mod-adapter_tuning-free_and_versatile_multi-concept_personalization_via_modulati.md)**
...
**[Neon Negative Extrapolation Image Generation](neon_negative_extrapolation_image_generation.md)**
...
**[Pcpo Proportionate Credit Policy Optimization For Aligning Image Generation Mode](pcpo_proportionate_credit_policy_optimization_for_aligning_image_generation_mode.md)**
...
**[Routing Matters In Moe Scaling Diffusion Transformers With Explicit Routing Guid](routing_matters_in_moe_scaling_diffusion_transformers_with_explicit_routing_guid.md)**

:   提出 ProMoE，一种针对扩散 Transformer 的 MoE 框架，通过两步路由器（条件路由 + 原型路由）和路由对比损失提供显式语义引导，促进专家特化，在 ImageNet 上显著超越现有 MoE 和稠密模型。

**[Safeflowmatcher Safe And Fast Planning Using Flow Matching With Control Barrier ](safeflowmatcher_safe_and_fast_planning_using_flow_matching_with_control_barrier_.md)**
...
**[Scdfm Distributional Flow Matching Model For Robust Single-Cell Perturbation Pre](scdfm_distributional_flow_matching_model_for_robust_single-cell_perturbation_pre.md)**

:   提出 scDFM，基于条件流匹配（CFM）的生成式框架，通过 MMD 正则化保证分布级保真度，并设计 PAD-Transformer 骨干处理噪声稀疏的单细胞数据，在组合扰动预测上比最强基线 CellFlow 的 MSE 降低 19.6%。

**[Seek-Cad A Self-Refined Generative Modeling For 3D Parametric Cad Using Local In](seek-cad_a_self-refined_generative_modeling_for_3d_parametric_cad_using_local_in.md)**
...
**[Songecho Towards Cover Song Generation Via Instance-Adaptive Element-Wise Linear](songecho_towards_cover_song_generation_via_instance-adaptive_element-wise_linear.md)**
...
**[Temporal Concept Dynamics In Diffusion Models Via Prompt-Conditioned Interventio](temporal_concept_dynamics_in_diffusion_models_via_prompt-conditioned_interventio.md)**
...
**[The Intricate Dance Of Prompt Complexity Quality Diversity And Consistency In T2](the_intricate_dance_of_prompt_complexity_quality_diversity_and_consistency_in_t2.md)**
...
**[There And Back Again On The Relation Between Noise And Image Inversions In Diffu](there_and_back_again_on_the_relation_between_noise_and_image_inversions_in_diffu.md)**
...
**[Translate Policy To Language Flow Matching Generated Rewards For Llm Explanation](translate_policy_to_language_flow_matching_generated_rewards_for_llm_explanation.md)**
...
**[Unsupervised Conformal Inference Bootstrapping And Alignment To Control Llm Unce](unsupervised_conformal_inference_bootstrapping_and_alignment_to_control_llm_unce.md)**

:   提出无监督共形推断框架（BB-UCP），通过Gram矩阵交互能量评分、批次自举校准和共形对齐，在无标签、API兼容条件下实现LLM生成的分布无关有限样本覆盖率保证，有效检测和过滤幻觉输出。

**[Verification Of The Implicit World Model In A Generative Model Via Adversarial S](verification_of_the_implicit_world_model_in_a_generative_model_via_adversarial_s.md)**
