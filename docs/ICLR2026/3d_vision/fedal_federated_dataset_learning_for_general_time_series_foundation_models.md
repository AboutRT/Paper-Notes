...
description: >-
  [ICLR 2026][3D视觉][Time Series Foundation Model] 提出 FeDaL 联邦框架，通过客户端域偏差消除（DBE）和服务器全局偏差消除（GBE）从头训练通用时序基础模型，在8类下游任务上以远少于集中式TSFM的参数达到竞争甚至超越的性能。
tags:
  - ICLR 2026
  - 3D视觉
