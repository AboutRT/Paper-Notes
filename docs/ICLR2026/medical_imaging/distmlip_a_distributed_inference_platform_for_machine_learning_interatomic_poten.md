...
- **功能**：分布式构建和计算三体 bond graph（line graph），这是许多 MLIP（如 CHGNet）中编码三体交互的关键结构。
...
- [Active Inference for Micro-Gesture Recognition: EFE-Guided Temporal Sampling and Adaptive Learning](../../CVPR2026/medical_imaging/active_inference_for_micro-gesture_recognition_efe-guided_temporal_sampling_and_.md)
