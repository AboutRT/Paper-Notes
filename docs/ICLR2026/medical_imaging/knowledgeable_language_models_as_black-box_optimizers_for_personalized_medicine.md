...
description: >-
  [ICLR 2026][医学图像][大语言模型优化] 提出 LEON（LLM-based Entropy-guided Optimization with kNowledgeable priors），一种数学原理严格的方法，将个性化医疗治疗方案设计建模为条件黑箱优化问题…
tags:
  - "ICLR 2026"
  - "医学图像"
  - "大语言模型优化"
