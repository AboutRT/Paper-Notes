...
**本文要解决什么？** (1) 如何在不预定义技能的前提下自动发现训练中的概念突破？(2) 如何处理单个样本同时经历多个技能突破的纠缠问题？(3) 如何将损失分解到可解释的梯度方向上？
...
**核心 idea 一句话**：沿 Hessian 特征向量构建的正交基分解每个样本的损失变化，再对投影损失轨迹聚类，即可无监督地发现隐藏在平滑训练曲线中的概念性突破。
