...
**本文要解决什么？** 为样条KAN建立系统化的初始化理论，回答三个问题：(1) MLP的方差保持原则能否适配KAN？(2) 什么样的初始化策略能跨任务、跨架构一致地优于基线？(3) 初始化如何影响KAN的优化动力学？
...
**核心idea一句话**：在KAN的三类参数上推导方差保持公式并提出幂律初始化族，通过126K+模型的系统实验证明幂律初始化全面最优。
