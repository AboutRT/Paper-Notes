...
description: >-
  [ICLR 2026][3D视觉 / 动态场景重建][3D Gaussian Splatting] 提出 MoE-GS，首个将混合专家架构引入动态高斯泼溅的框架，通过 Volume-aware Pixel Router 自适应融合多种异构变形先验（HexPlane/逐高斯/多项式/插值）…
tags:
  - "ICLR 2026"
  - "3D视觉 / 动态场景重建"
...
- [\[ACL 2025\] DIVE into MoE: Diversity-Enhanced Reconstruction of Large Language Models from Dense into Mixture-of-Experts](../../ACL2025/moe/dive_moe_reconstruction.md)
