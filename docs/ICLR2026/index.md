...
title: >-
  ICLR2026 1512篇论文解读
description: >-
  1512篇ICLR2026论文深度解读，每篇5分钟读懂核心思想。覆盖图像生成、强化学习、模型压缩、医学图像、多模态VLM、3D视觉等44个研究领域，每篇笔记含一句话总结、背景动机、方法详解、实验数据、亮点洞察与局限性分析。
---

<!-- 由 src/gen_blog_index.py 自动生成 -->
# 🔬 ICLR2026 论文笔记

**1512** 篇论文解读，覆盖 **44** 个领域。

## 领域概览

| 领域 | 篇数 |
|:-----|-----:|
| 🎨 [图像生成](#image_generation) | 153 |
| 🎮 [强化学习](#reinforcement_learning) | 130 |
| 📦 [模型压缩](#model_compression) | 100 |
| 🏥 [医学图像](#medical_imaging) | 77 |
| 🧩 [多模态VLM](#multimodal_vlm) | 77 |
| 🧊 [3D视觉](#3d_vision) | 65 |
| 💡 [LLM推理](#llm_reasoning) | 60 |
| 🧑 [人体理解](#human_understanding) | 54 |
| 🔬 [可解释性](#interpretability) | 53 |
| 🛡️ [AI安全](#ai_safety) | 47 |
| 📊 [LLM评测](#llm_evaluation) | 46 |
| 🤖 [机器人/具身智能](#robotics) | 46 |
| 📐 [优化/理论](#optimization) | 40 |
| 🦾 [LLM Agent](#llm_agent) | 39 |
| ⚖️ [对齐/RLHF](#llm_alignment) | 38 |
| 📹 [视频理解](#video_understanding) | 34 |
| 📈 [时间序列](#time_series) | 32 |
| 🔍 [信息检索/RAG](#information_retrieval) | 30 |
| 🎯 [目标检测](#object_detection) | 30 |
| 💬 [LLM/NLP](#llm_nlp) | 29 |
| 🎵 [音频/语音](#audio_speech) | 25 |
| 📚 [预训练/数据](#llm_pretraining) | 24 |
| 🕸️ [图学习](#graph_learning) | 22 |
| ⚡ [LLM效率](#llm_efficiency) | 22 |
| 💻 [代码智能](#code_intelligence) | 19 |
| 🔗 [因果推理](#causal_inference) | 18 |
| 🚗 [自动驾驶](#autonomous_driving) | 15 |
| 🖼️ [图像恢复](#image_restoration) | 15 |
| 🔄 [自监督/表示学习](#self_supervised) | 14 |
| 🔒 [LLM安全](#llm_safety) | 11 |
| ✂️ [语义分割](#segmentation) | 11 |
| 🎁 [推荐系统](#recommender) | 9 |
| ✏️ [知识编辑](#knowledge_editing) | 8 |
| 🧮 [科学计算](#scientific_computing) | 8 |
| 👥 [社会计算](#social_computing) | 8 |
| 🛰️ [遥感](#remote_sensing) | 6 |
| 🎬 [视频生成](#video_generation) | 6 |
| 🔎 [AIGC检测](#aigc_detection) | 5 |
| 🌐 [多语言/翻译](#multilingual_mt) | 5 |
| 🗣️ [对话系统](#dialogue) | 4 |
| 📡 [信号/通信](#signal_comm) | 4 |
...
**[Radiometrically Consistent Gaussian Surfels For Inverse Rendering](3d_vision/radiometrically_consistent_gaussian_surfels_for_inverse_rendering.md)**
...
**[Reducing Belief Deviation In Reinforcement Learning For Active Reasoning](video_understanding/reducing_belief_deviation_in_reinforcement_learning_for_active_reasoning.md)**
...
**[Spectrum Tuning Post-Training For Distributional Coverage And In-Context Steerab](self_supervised/spectrum_tuning_post-training_for_distributional_coverage_and_in-context_steerab.md)**
...
**[Learning Video Generation For Robotic Manipulation With Collaborative Trajectory](video_generation/learning_video_generation_for_robotic_manipulation_with_collaborative_trajectory.md)**
