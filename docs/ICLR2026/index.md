...
title: >-
  ICLR2026 1567篇论文解读
description: >-
  1567篇ICLR2026论文深度解读，每篇5分钟读懂核心思想。覆盖图像生成、强化学习、模型压缩、医学图像、多模态VLM、3D视觉等43个研究领域，每篇笔记含一句话总结、背景动机、方法详解、实验数据、亮点洞察与局限性分析。
---

<!-- 由 src/gen_blog_index.py 自动生成 -->
# 🔬 ICLR2026 论文笔记

共 **1567** 篇笔记，覆盖 **43** 个领域。
...
| 📦 [模型压缩](#model_compression) | 100 |
| 🏥 [医学图像](#medical_imaging) | 77 |
| 🧩 [多模态VLM](#multimodal_vlm) | 77 |
| 🧊 [3D视觉](#3d_vision) | 67 |
| 💡 [LLM推理](#llm_reasoning) | 66 |
| 🔬 [可解释性](#interpretability) | 56 |
| 🧑 [人体理解](#human_understanding) | 53 |
| 📊 [LLM评测](#llm_evaluation) | 51 |
| 🛡️ [AI安全](#ai_safety) | 49 |
| 🦾 [LLM Agent](#llm_agent) | 47 |
| 🤖 [机器人/具身智能](#robotics) | 46 |
| 📐 [优化/理论](#optimization) | 40 |
| ⚖️ [对齐/RLHF](#llm_alignment) | 38 |
| 💬 [LLM/NLP](#llm_nlp) | 36 |
| 🎬 [视频理解](#video_understanding) | 35 |
| 📈 [时间序列](#time_series) | 34 |
| 🎯 [目标检测](#object_detection) | 31 |
| 🔍 [信息检索/RAG](#information_retrieval) | 30 |
| 🎵 [音频/语音](#audio_speech) | 25 |
| ⚡ [LLM效率](#llm_efficiency) | 25 |
| 📚 [预训练/数据](#llm_pretraining) | 25 |
| 🕸️ [图学习](#graph_learning) | 22 |
| 💻 [代码智能](#code_intelligence) | 21 |
| 🔗 [因果推理](#causal_inference) | 19 |
| 🚗 [自动驾驶](#autonomous_driving) | 18 |
| 🖼️ [图像恢复](#image_restoration) | 15 |
| 🔒 [LLM安全](#llm_safety) | 13 |
| 🔄 [自监督/表示学习](#self_supervised) | 13 |
| ✂️ [语义分割](#segmentation) | 12 |
| ✏️ [知识编辑](#knowledge_editing) | 9 |
| 🎁 [推荐系统](#recommender) | 9 |
| 👥 [社会计算](#social_computing) | 9 |
| 🧮 [科学计算](#scientific_computing) | 8 |
| 📡 [信号/通信](#signal_comm) | 8 |
| 🌐 [多语言/翻译](#multilingual_mt) | 6 |
| 🛰️ [遥感](#remote_sensing) | 6 |
| 🔎 [AIGC检测](#aigc_detection) | 5 |
| 🗣️ [对话系统](#dialogue) | 4 |
...
**[Amortising Inference And Meta-Learning Priors In Neural Networks](image_generation/amortising_inference_and_meta-learning_priors_in_neural_networks.md)**
...
**[Bridging Degradation Discrimination And Generation For Universal Image Restorati](image_generation/bridging_degradation_discrimination_and_generation_for_universal_image_restorati.md)**

:   BDG 通过多角度多尺度灰度共生矩阵（MAS-GLCM）进行细粒度退化判别，并设计三阶段扩散训练（生成→桥接→修复）将退化判别能力与生成先验无缝融合，在 all-in-one 修复和真实世界超分辨率任务上取得显著的保真度提升。

**[Bridging Generalization Gap Of Heterogeneous Federated Clients Using Generative ](image_generation/bridging_generalization_gap_of_heterogeneous_federated_clients_using_generative_.md)**

:   FedVTC 提出在模型异构联邦学习中，各客户端通过变分转置卷积网络（VTC）从聚合的特征分布统计量中生成合成数据来微调本地模型，无需公共数据集即可显著提升泛化能力，同时降低通信和内存开销。

**[Cmt Mid-Training For Efficient Learning Of Consistency Mean Flow And Flow Map Mo](image_generation/cmt_mid-training_for_efficient_learning_of_consistency_mean_flow_and_flow_map_mo.md)**
...
**[Compose Your Policies Improving Diffusion-Based Or Flow-Based Robot Policies Via](image_generation/compose_your_policies_improving_diffusion-based_or_flow-based_robot_policies_via.md)**
...
**[Concept-Trak Understanding How Diffusion Models Learn Concepts Through Concept-L](image_generation/concept-trak_understanding_how_diffusion_models_learn_concepts_through_concept-l.md)**
...
**[Condition Errors Refinement In Autoregressive Image Generation With Diffusion Lo](image_generation/condition_errors_refinement_in_autoregressive_image_generation_with_diffusion_lo.md)**
...
**[Conditionally Whitened Generative Models For Probabilistic Time Series Forecasti](image_generation/conditionally_whitened_generative_models_for_probabilistic_time_series_forecasti.md)**
...
**[Contact-Guided 3D Genome Structure Generation Of E Coli Via Diffusion Transforme](image_generation/contact-guided_3d_genome_structure_generation_of_e_coli_via_diffusion_transforme.md)**
...
**[Continual Unlearning For Text-To-Image Diffusion Models A Regularization Perspec](image_generation/continual_unlearning_for_text-to-image_diffusion_models_a_regularization_perspec.md)**
...
**[Contractive Diffusion Policies Robust Action Diffusion Via Contractive Score-Bas](image_generation/contractive_diffusion_policies_robust_action_diffusion_via_contractive_score-bas.md)**
...
**[Detecting And Mitigating Memorization In Diffusion Models Through Anisotropy Of ](image_generation/detecting_and_mitigating_memorization_in_diffusion_models_through_anisotropy_of_.md)**
...
**[Diffink Glyph- And Style-Aware Latent Diffusion Transformer For Text To Online H](image_generation/diffink_glyph-_and_style-aware_latent_diffusion_transformer_for_text_to_online_h.md)**
...
**[Does Semantic Noise Initialization Transfer From Images To Videos A Paired Diagn](image_generation/does_semantic_noise_initialization_transfer_from_images_to_videos_a_paired_diagn.md)**
...
**[Doflow Flow-Based Generative Models For Interventional And Counterfactual Foreca](image_generation/doflow_flow-based_generative_models_for_interventional_and_counterfactual_foreca.md)**
...
**[Draw-In-Mind Rebalancing Designer-Painter Roles In Unified Multimodal Models Ben](image_generation/draw-in-mind_rebalancing_designer-painter_roles_in_unified_multimodal_models_ben.md)**
...
**[Easier Painting Than Thinking Can Text-To-Image Models Set The Stage But Not Dir](image_generation/easier_painting_than_thinking_can_text-to-image_models_set_the_stage_but_not_dir.md)**
...
**[Editscore Unlocking Online Rl For Image Editing Via High-Fidelity Reward Modelin](image_generation/editscore_unlocking_online_rl_for_image_editing_via_high-fidelity_reward_modelin.md)**
...
**[Error As Signal Stiffness-Aware Diffusion Sampling Via Embedded Runge-Kutta Guid](image_generation/error_as_signal_stiffness-aware_diffusion_sampling_via_embedded_runge-kutta_guid.md)**
...
**[Everything In Its Place Benchmarking Spatial Intelligence Of Text-To-Image Model](image_generation/everything_in_its_place_benchmarking_spatial_intelligence_of_text-to-image_model.md)**
...
**[Flow-Based Single-Step Completion For Efficient And Expressive Policy Learning](image_generation/flow-based_single-step_completion_for_efficient_and_expressive_policy_learning.md)**
...
**[Flow2Gan Hybrid Flow Matching And Gan With Multi-Resolution Network For Few-Step](image_generation/flow2gan_hybrid_flow_matching_and_gan_with_multi-resolution_network_for_few-step.md)**
...
**[Frame Guidance Training-Free Guidance For Frame-Level Control In Video Diffusion](image_generation/frame_guidance_training-free_guidance_for_frame-level_control_in_video_diffusion.md)**
...
**[From Prediction To Perfection Introducing Refinement To Autoregressive Image Gen](image_generation/from_prediction_to_perfection_introducing_refinement_to_autoregressive_image_gen.md)**
...
**[Generate Any Scene Scene Graph Driven Data Synthesis For Visual Generation Train](image_generation/generate_any_scene_scene_graph_driven_data_synthesis_for_visual_generation_train.md)**
...
**[Glass Flows Reward Alignment Diffusion](image_generation/glass_flows_reward_alignment_diffusion.md)**
...
**[Glyph-Sr Can We Achieve Both High-Quality Image Super-Resolution And High-Fideli](image_generation/glyph-sr_can_we_achieve_both_high-quality_image_super-resolution_and_high-fideli.md)**

:   提出GLYPH-SR，一个视觉-语言引导的扩散框架，通过双分支Text-SR融合ControlNet和ping-pong调度器同时优化图像质量和文本可读性，在SVT ×8上将OCR F1提升15.18个百分点。

**[Hierarchical Entity-Centric Reinforcement Learning With Factored Subgoal Diffusi](image_generation/hierarchical_entity-centric_reinforcement_learning_with_factored_subgoal_diffusi.md)**
...
**[Image Can Bring Your Memory Back A Novel Multi-Modal Guided Attack Against Image](image_generation/image_can_bring_your_memory_back_a_novel_multi-modal_guided_attack_against_image.md)**
...
**[Improved Object-Centric Diffusion Learning With Registers And Contrastive Alignm](image_generation/improved_object-centric_diffusion_learning_with_registers_and_contrastive_alignm.md)**

:   提出 CODA 框架，通过引入 register slots 吸收残余注意力、微调交叉注意力投影以及对比对齐损失，解决基于扩散模型的物体中心学习中的 slot 纠缠和弱对齐问题，在合成和真实数据集上显著提升物体发现和组合式生成质量。

**[Improving Discrete Diffusion Unmasking Policies Beyond Explicit Reference Polici](image_generation/improving_discrete_diffusion_unmasking_policies_beyond_explicit_reference_polici.md)**
...
**[K-Sort Eval Efficient Preference Evaluation For Visual Generation Via Corrected ](image_generation/k-sort_eval_efficient_preference_evaluation_for_visual_generation_via_corrected_.md)**
...
**[Large Scale Diffusion Distillation Via Score-Regularized Continuous-Time Consist](image_generation/large_scale_diffusion_distillation_via_score-regularized_continuous-time_consist.md)**
...
**[Learning Video Generation For Robotic Manipulation With Collaborative Trajectory](image_generation/learning_video_generation_for_robotic_manipulation_with_collaborative_trajectory.md)**
...
**[Localized Concept Erasure In Text-To-Image Diffusion Models Via High-Level Repre](image_generation/localized_concept_erasure_in_text-to-image_diffusion_models_via_high-level_repre.md)**
...
**[Lora-Edit Controllable First-Frame-Guided Video Editing Via Mask-Aware Lora Fine](image_generation/lora-edit_controllable_first-frame-guided_video_editing_via_mask-aware_lora_fine.md)**

:   提出 LoRA-Edit，利用时空 mask 引导 LoRA 微调预训练 I2V 模型，实现可控的首帧引导视频编辑——mask 同时作为编辑区域指令和 LoRA 学习内容的引导信号，支持运动继承和外观控制。

**[Lvtino Latent Video Consistency Inverse Solver For High Definition Video Restora](image_generation/lvtino_latent_video_consistency_inverse_solver_for_high_definition_video_restora.md)**

:   提出 LVTINO，首个基于视频一致性模型（VCM）的零样本/即插即用高清视频逆问题求解器，通过无需自动微分的条件化机制实现高质量视频重建，同时保证测量一致性和帧间时间平滑性。

**[Mac-Amp A Closed-Loop Multi-Agent Collaboration System For Multi-Objective Antim](image_generation/mac-amp_a_closed-loop_multi-agent_collaboration_system_for_multi-objective_antim.md)**
...
**[Mod-Adapter Tuning-Free And Versatile Multi-Concept Personalization Via Modulati](image_generation/mod-adapter_tuning-free_and_versatile_multi-concept_personalization_via_modulati.md)**
...
**[Mvcustom Multi-View Customized Diffusion Via Geometric Latent Rendering And Comp](image_generation/mvcustom_multi-view_customized_diffusion_via_geometric_latent_rendering_and_comp.md)**
...
**[Neon Negative Extrapolation Image Generation](image_generation/neon_negative_extrapolation_image_generation.md)**
...
**[No Caption No Problem Caption-Free Membership Inference Via Model-Fitted Embeddi](image_generation/no_caption_no_problem_caption-free_membership_inference_via_model-fitted_embeddi.md)**
...
**[Pcpo Proportionate Credit Policy Optimization For Aligning Image Generation Mode](image_generation/pcpo_proportionate_credit_policy_optimization_for_aligning_image_generation_mode.md)**
...
**[Routing Matters In Moe Scaling Diffusion Transformers With Explicit Routing Guid](image_generation/routing_matters_in_moe_scaling_diffusion_transformers_with_explicit_routing_guid.md)**

:   提出 ProMoE，一种针对扩散 Transformer 的 MoE 框架，通过两步路由器（条件路由 + 原型路由）和路由对比损失提供显式语义引导，促进专家特化，在 ImageNet 上显著超越现有 MoE 和稠密模型。

**[Safeflowmatcher Safe And Fast Planning Using Flow Matching With Control Barrier ](image_generation/safeflowmatcher_safe_and_fast_planning_using_flow_matching_with_control_barrier_.md)**
...
**[Scdfm Distributional Flow Matching Model For Robust Single-Cell Perturbation Pre](image_generation/scdfm_distributional_flow_matching_model_for_robust_single-cell_perturbation_pre.md)**

:   提出 scDFM，基于条件流匹配（CFM）的生成式框架，通过 MMD 正则化保证分布级保真度，并设计 PAD-Transformer 骨干处理噪声稀疏的单细胞数据，在组合扰动预测上比最强基线 CellFlow 的 MSE 降低 19.6%。

**[Seek-Cad A Self-Refined Generative Modeling For 3D Parametric Cad Using Local In](image_generation/seek-cad_a_self-refined_generative_modeling_for_3d_parametric_cad_using_local_in.md)**
...
**[Senseflow Scaling Distribution Matching For Flow-Based Text-To-Image Distillatio](image_generation/senseflow_scaling_distribution_matching_for_flow-based_text-to-image_distillatio.md)**

:   提出 SenseFlow，通过隐式分布对齐（IDA）和段内引导（ISG）将分布匹配蒸馏（DMD）扩展到大规模 flow-based 文生图模型（SD 3.5 Large 8B / FLUX.1 dev 12B），实现 4 步高质量图像生成。

**[Sigmark Scalable In-Generation Watermark With Blind Extraction For Video Diffusi](image_generation/sigmark_scalable_in-generation_watermark_with_blind_extraction_for_video_diffusi.md)**
...
**[Songecho Towards Cover Song Generation Via Instance-Adaptive Element-Wise Linear](image_generation/songecho_towards_cover_song_generation_via_instance-adaptive_element-wise_linear.md)**
...
**[Tavae A Vae With Adaptable Priors Explains Contextual Modulation In The Visual C](image_generation/tavae_a_vae_with_adaptable_priors_explains_contextual_modulation_in_the_visual_c.md)**

:   扩展 VAE 形式主义提出 Task-Amortized VAE (TAVAE)，通过在已学表示上灵活学习任务特异性先验来解释视觉皮层 V1 中的上下文调制现象，包括方向辨别任务中训练刺激与测试刺激不匹配时出现的双模态群体响应。

**[Temporal Concept Dynamics In Diffusion Models Via Prompt-Conditioned Interventio](image_generation/temporal_concept_dynamics_in_diffusion_models_via_prompt-conditioned_interventio.md)**
...
**[The Intricate Dance Of Prompt Complexity Quality Diversity And Consistency In T2](image_generation/the_intricate_dance_of_prompt_complexity_quality_diversity_and_consistency_in_t2.md)**
...
**[There And Back Again On The Relation Between Noise And Image Inversions In Diffu](image_generation/there_and_back_again_on_the_relation_between_noise_and_image_inversions_in_diffu.md)**
...
**[Translate Policy To Language Flow Matching Generated Rewards For Llm Explanation](image_generation/translate_policy_to_language_flow_matching_generated_rewards_for_llm_explanation.md)**
...
**[Twinflow Realizing One-Step Generation On Large Models With Self-Adversarial Flo](image_generation/twinflow_realizing_one-step_generation_on_large_models_with_self-adversarial_flo.md)**
...
**[Uni-X Mitigating Modality Conflict With A Two-End-Separated Architecture For Uni](image_generation/uni-x_mitigating_modality_conflict_with_a_two-end-separated_architecture_for_uni.md)**
...
**[Unsupervised Conformal Inference Bootstrapping And Alignment To Control Llm Unce](image_generation/unsupervised_conformal_inference_bootstrapping_and_alignment_to_control_llm_unce.md)**

:   提出无监督共形推断框架（BB-UCP），通过Gram矩阵交互能量评分、批次自举校准和共形对齐，在无标签、API兼容条件下实现LLM生成的分布无关有限样本覆盖率保证，有效检测和过滤幻觉输出。

**[Verification Of The Implicit World Model In A Generative Model Via Adversarial S](image_generation/verification_of_the_implicit_world_model_in_a_generative_model_via_adversarial_s.md)**
...
**[Vfscale Intrinsic Reasoning Through Verifier-Free Test-Time Scalable Diffusion M](image_generation/vfscale_intrinsic_reasoning_through_verifier-free_test-time_scalable_diffusion_m.md)**
...
**[When One Modality Rules Them All Backdoor Modality Collapse In Multimodal Diffus](image_generation/when_one_modality_rules_them_all_backdoor_modality_collapse_in_multimodal_diffus.md)**
...
**[Arm-Fm Automated Reward Machines Via Foundation Models For Compositional Reinfor](reinforcement_learning/arm-fm_automated_reward_machines_via_foundation_models_for_compositional_reinfor.md)**
...
**[Bayes Adaptive Monte Carlo Tree Search For Offline Model-Based Reinforcement Lea](reinforcement_learning/bayes_adaptive_monte_carlo_tree_search_for_offline_model-based_reinforcement_lea.md)**
...
**[Breaking Barriers Do Reinforcement Post Training Gains Transfer To Unseen Domain](reinforcement_learning/breaking_barriers_do_reinforcement_post_training_gains_transfer_to_unseen_domain.md)**
...
**[Co-Rewarding Stable Self-Supervised Rl For Eliciting Reasoning In Large Language](reinforcement_learning/co-rewarding_stable_self-supervised_rl_for_eliciting_reasoning_in_large_language.md)**
...
**[Distributionally Robust Cooperative Multi-Agent Reinforcement Learning Via Robus](reinforcement_learning/distributionally_robust_cooperative_multi-agent_reinforcement_learning_via_robus.md)**
...
**[Divide Harmonize Then Conquer It Shooting Multi-Commodity Flow Problems With Mul](reinforcement_learning/divide_harmonize_then_conquer_it_shooting_multi-commodity_flow_problems_with_mul.md)**
...
**[Dont Just Fine-Tune The Agent Tune The Environment](reinforcement_learning/dont_just_fine-tune_the_agent_tune_the_environment.md)**
...
**[Dvla-Rl Dual-Level Vision-Language Alignment With Reinforcement Learning Gating ](reinforcement_learning/dvla-rl_dual-level_vision-language_alignment_with_reinforcement_learning_gating_.md)**
...
**[Egg-Sr Embedding Symbolic Equivalence Into Symbolic Regression Via Equality Grap](reinforcement_learning/egg-sr_embedding_symbolic_equivalence_into_symbolic_regression_via_equality_grap.md)**
...
**[Emergence Of Spatial Representation In An Actor-Critic Agent With Hippocampus-In](reinforcement_learning/emergence_of_spatial_representation_in_an_actor-critic_agent_with_hippocampus-in.md)**
...
**[Entropy-Preserving Reinforcement Learning](reinforcement_learning/entropy-preserving_reinforcement_learning.md)**
...
**[Exploration Vs Exploitation Rethinking Rlvr Through Clipping Entropy And Spuriou](reinforcement_learning/exploration_vs_exploitation_rethinking_rlvr_through_clipping_entropy_and_spuriou.md)**
...
**[Flow Actor-Critic For Offline Reinforcement Learning](reinforcement_learning/flow_actor-critic_for_offline_reinforcement_learning.md)**
...
**[From Verifiable Dot To Reward Chain Harnessing Verifiable Reference-Based Reward](reinforcement_learning/from_verifiable_dot_to_reward_chain_harnessing_verifiable_reference-based_reward.md)**
...
**[Graphomni A Comprehensive And Extensible Benchmark Framework For Large Language ](reinforcement_learning/graphomni_a_comprehensive_and_extensible_benchmark_framework_for_large_language_.md)**

:   提出 GraphOmni，一个全面评估 LLM 在图论任务上推理能力的基准框架，系统考察图类型、序列化格式和提示策略三个维度的交互影响，并提出基于 RL 的自适应最优因子选择方法。

**[Helix Evolutionary Reinforcement Learning For Open-Ended Scientific Problem Solv](reinforcement_learning/helix_evolutionary_reinforcement_learning_for_open-ended_scientific_problem_solv.md)**
...
**[Is Pure Exploitation Sufficient In Exogenous Mdps With Linear Function Approxima](reinforcement_learning/is_pure_exploitation_sufficient_in_exogenous_mdps_with_linear_function_approxima.md)**
...
**[Laddersym A Multimodal Interleaved Transformer For Music Practice Error Detectio](reinforcement_learning/laddersym_a_multimodal_interleaved_transformer_for_music_practice_error_detectio.md)**
...
**[Loongrl Rl For Reasoning Long Contexts](reinforcement_learning/loongrl_rl_for_reasoning_long_contexts.md)**
...
**[Menlo From Preferences To Proficiency -- Evaluating And Modeling Native-Like Qua](reinforcement_learning/menlo_from_preferences_to_proficiency_--_evaluating_and_modeling_native-like_qua.md)**

:   提出 Menlo 框架，基于受众设计理论将母语级响应质量分解为四个维度，构建了覆盖 47 种语言变体的 6423 条标注偏好对数据集，并发现配对评估+RL 训练的 LLM 裁判可达到接近人类标注员的水平。

**[Mergemix A Unified Augmentation Paradigm For Visual And Multi-Modal Understandin](reinforcement_learning/mergemix_a_unified_augmentation_paradigm_for_visual_and_multi-modal_understandin.md)**
...
**[Metis-Specs Decoupling Multimodal Learning Via Self-Distilled Preference-Based C](reinforcement_learning/metis-specs_decoupling_multimodal_learning_via_self-distilled_preference-based_c.md)**
...
**[Model-Based Offline Rl Via Robust Value-Aware Model Learning With Implicitly Dif](reinforcement_learning/model-based_offline_rl_via_robust_value-aware_model_learning_with_implicitly_dif.md)**
...
**[Momagen Generating Demonstrations Under Soft And Hard Constraints For Multi-Step](reinforcement_learning/momagen_generating_demonstrations_under_soft_and_hard_constraints_for_multi-step.md)**
...
**[Near-Optimal Second-Order Guarantees For Model-Based Adversarial Imitation Learn](reinforcement_learning/near-optimal_second-order_guarantees_for_model-based_adversarial_imitation_learn.md)**
...
**[On The Generalization Of Sft A Reinforcement Learning Perspective With Reward Re](reinforcement_learning/on_the_generalization_of_sft_a_reinforcement_learning_perspective_with_reward_re.md)**
...
**[On The O1T Convergence Of Alternating Gradient Descent-Ascent In Bilinear Games](reinforcement_learning/on_the_o1t_convergence_of_alternating_gradient_descent-ascent_in_bilinear_games.md)**
...
**[Optimistic Task Inference Behavior Models](reinforcement_learning/optimistic_task_inference_behavior_models.md)**
...
**[Paras2S Benchmarking And Aligning Spoken Language Models For Paralinguistic-Awar](reinforcement_learning/paras2s_benchmarking_and_aligning_spoken_language_models_for_paralinguistic-awar.md)**
...
**[Policyflow Policy Optimization With Continuous Normalizing Flow In Reinforcement](reinforcement_learning/policyflow_policy_optimization_with_continuous_normalizing_flow_in_reinforcement.md)**
...
**[Pruning As A Cooperative Game Surrogate-Assisted Layer Contribution Estimation F](reinforcement_learning/pruning_as_a_cooperative_game_surrogate-assisted_layer_contribution_estimation_f.md)**
...
**[Reasoning As Representation Rethinking Visual Reinforcement Learning In Image Qu](reinforcement_learning/reasoning_as_representation_rethinking_visual_reinforcement_learning_in_image_qu.md)**
...
**[Remix Reinforcement Routing For Mixtures Of Loras In Llm Finetuning](reinforcement_learning/remix_reinforcement_routing_for_mixtures_of_loras_in_llm_finetuning.md)**
...
**[Retaining Suboptimal Actions To Follow Shifting Optima In Multi-Agent Reinforcem](reinforcement_learning/retaining_suboptimal_actions_to_follow_shifting_optima_in_multi-agent_reinforcem.md)**

:   提出S2Q解决合作MARL中值函数最优点在训练中漂移→次优收敛：逐步学习K个sub-value函数保留替代高价值动作+Softmax行为策略持续探索→最优变化时快速适应，SMAC Hard+和GRF上一致超越基线。

**[Rethinking Policy Diversity In Ensemble Policy Gradient In Large-Scale Reinforce](reinforcement_learning/rethinking_policy_diversity_in_ensemble_policy_gradient_in_large-scale_reinforce.md)**

:   从理论上分析了集成策略梯度方法中策略间多样性对学习效率的影响，提出通过KL散度约束调控多样性的Coupled Policy Optimization（CPO），在大规模并行环境中实现高效稳定的探索。

**[Revisiting Matrix Sketching In Linear Bandits Achieving Sublinear Regret Via Dya](reinforcement_learning/revisiting_matrix_sketching_in_linear_bandits_achieving_sublinear_regret_via_dya.md)**
...
**[Rewardmap Tackling Sparse Rewards In Fine-Grained Visual Reasoning Via Multi-Sta](reinforcement_learning/rewardmap_tackling_sparse_rewards_in_fine-grained_visual_reasoning_via_multi-sta.md)**
...
**[Self-Harmony Learning To Harmonize Self-Supervision And Self-Play In Test-Time R](reinforcement_learning/self-harmony_learning_to_harmonize_self-supervision_and_self-play_in_test-time_r.md)**
...
**[Shop-R1 Rewarding Llms To Simulate Human Behavior In Online Shopping Via Reinfor](reinforcement_learning/shop-r1_rewarding_llms_to_simulate_human_behavior_in_online_shopping_via_reinfor.md)**

:   提出 Shop-R1 框架，通过分层奖励机制和难度感知缩放的强化学习方法，显著提升 LLM 模拟真实人类在线购物行为的能力，相比 SFT 基线精确匹配提升超过 65%。

**[Single Index Bandits Generalized Linear Contextual Bandits With Unknown Reward F](reinforcement_learning/single_index_bandits_generalized_linear_contextual_bandits_with_unknown_reward_f.md)**

:   提出单指标赌博机（SIB）问题——将广义线性赌博机扩展到奖励函数未知的设定，基于 Stein 方法设计了一族高效算法（STOR/ESTOR/GSTOR），在单调递增奖励函数下实现了近最优遗憾界 $\tilde{O}(\sqrt{T})$。

**[Solving Football By Exploiting Equilibrium Structure Of 2P0S Differential Games ](reinforcement_learning/solving_football_by_exploiting_equilibrium_structure_of_2p0s_differential_games_.md)**
...
**[Solving Parameter-Robust Avoid Problems With Unknown Feasibility Using Reinforce](reinforcement_learning/solving_parameter-robust_avoid_problems_with_unknown_feasibility_using_reinforce.md)**
...
**[Spiral Self-Play On Zero-Sum Games Incentivizes Reasoning Via Multi-Agent Multi-](reinforcement_learning/spiral_self-play_on_zero-sum_games_incentivizes_reasoning_via_multi-agent_multi-.md)**
...
**[Stackelberg Coupling Of Online Representation Learning And Reinforcement Learnin](reinforcement_learning/stackelberg_coupling_of_online_representation_learning_and_reinforcement_learnin.md)**
...
**[Stop Unnecessary Reflection Training Lrms For Efficient Reasoning With Adaptive ](reinforcement_learning/stop_unnecessary_reflection_training_lrms_for_efficient_reasoning_with_adaptive_.md)**
...
**[Strict Subgoal Execution Reliable Long-Horizon Planning In Hierarchical Reinforc](reinforcement_learning/strict_subgoal_execution_reliable_long-horizon_planning_in_hierarchical_reinforc.md)**
...
**[Textbfre2 Unlocking Llm Reasoning Via Reinforcement Learning With Re-Solving](reinforcement_learning/textbfre2_unlocking_llm_reasoning_via_reinforcement_learning_with_re-solving.md)**
...
**[Thinking On The Fly Test-Time Reasoning Enhancement Via Latent Thought Policy Op](reinforcement_learning/thinking_on_the_fly_test-time_reasoning_enhancement_via_latent_thought_policy_op.md)**

:   本文提出潜在思维策略优化（LTPO），一种无需更新模型参数的测试时推理增强框架，通过将中间潜在"思维"向量视为可优化的动态参数，利用在线策略梯度方法和内在置信度奖励信号来增强冻结LLM的推理能力。

**[Toward A Dynamic Stackelberg Game-Theoretic Framework For Agent-Based Conversat](reinforcement_learning/toward_a_dynamic_stackelberg_game-theoretic_framework_for_agent-based_conversat.md)**

:   将 LLM 越狱攻防形式化为动态 Stackelberg 扩展形式博弈，结合快速扩展随机树 (RRT) 搜索提示空间，提出 Purple Agent 防御架构实现"红队思维，蓝队行动"的预见性防御。

**[Towards Bridging The Gap Between Large-Scale Pretraining And Efficient Finetunin](reinforcement_learning/towards_bridging_the_gap_between_large-scale_pretraining_and_efficient_finetunin.md)**
...
**[Traced Transition-Aware Regret Approximation With Co-Learnability For Environmen](reinforcement_learning/traced_transition-aware_regret_approximation_with_co-learnability_for_environmen.md)**
...
**[Unveiling The Cognitive Compass Theory-Of-Mind-Guided Multimodal Emotion Reasoni](reinforcement_learning/unveiling_the_cognitive_compass_theory-of-mind-guided_multimodal_emotion_reasoni.md)**
...
**[Verifybench Benchmarking Reference-Based Reward Systems For Large Language Model](reinforcement_learning/verifybench_benchmarking_reference-based_reward_systems_for_large_language_model.md)**
...
**[Vtool-R1 Vlms Learn To Think With Images Via Reinforcement Learning On Multimoda](reinforcement_learning/vtool-r1_vlms_learn_to_think_with_images_via_reinforcement_learning_on_multimoda.md)**

:   提出 VTool-R1，首个通过强化学习微调训练 VLM 生成交错文本和视觉中间推理步骤的框架，使模型学会"用图像思考"。

**[Whatever Remains Must Be True Filtering Drives Reasoning In Llms Shaping Diversi](reinforcement_learning/whatever_remains_must_be_true_filtering_drives_reasoning_in_llms_shaping_diversi.md)**
...
**[Wimle Uncertainty-Aware World Models With Imle For Sample-Efficient Continuous C](reinforcement_learning/wimle_uncertainty-aware_world_models_with_imle_for_sample-efficient_continuous_c.md)**
...
**[A Universal Compression Theory For Lottery Ticket Hypothesis And Neural Scaling ](model_compression/a_universal_compression_theory_for_lottery_ticket_hypothesis_and_neural_scaling_.md)**
...
**[Anybcq Hardware Efficient Flexible Binary-Coded Quantization For Multi-Precision](model_compression/anybcq_hardware_efficient_flexible_binary-coded_quantization_for_multi-precision.md)**
...
**[Bots A Unified Framework For Bayesian Online Task Selection In Llm Reinforcement](model_compression/bots_a_unified_framework_for_bayesian_online_task_selection_in_llm_reinforcement.md)**

:   提出 BOTS 框架，将 LLM 强化微调中的在线任务选择建模为贝叶斯推断问题，通过融合显式证据（直接评估）和隐式证据（跨任务推断）来自适应估计任务难度，并利用 Thompson 采样平衡探索与利用，显著提升训练效率。

**[Bridging Kolmogorov Complexity And Deep Learning Asymptotically Optimal Descript](model_compression/bridging_kolmogorov_complexity_and_deep_learning_asymptotically_optimal_descript.md)**
...
**[Cross Domain Lossy Compression Optimal Transport](model_compression/cross_domain_lossy_compression_optimal_transport.md)**
...
**[Dataset Color Quantization A Training-Oriented Framework For Dataset-Level Compr](model_compression/dataset_color_quantization_a_training-oriented_framework_for_dataset-level_compr.md)**
...
**[Discount Model Search For Quality Diversity Optimization In High-Dimensional Mea](model_compression/discount_model_search_for_quality_diversity_optimization_in_high-dimensional_mea.md)**
...
**[Es-Dllm Efficient Inference For Diffusion Large Language Models By Early-Skippin](model_compression/es-dllm_efficient_inference_for_diffusion_large_language_models_by_early-skippin.md)**
...
**[Evolution And Compression In Llms On The Emergence Of Human-Aligned Categorizati](model_compression/evolution_and_compression_in_llms_on_the_emergence_of_human-aligned_categorizati.md)**
...
**[Flyprompt Brain-Inspired Random-Expanded Routing](model_compression/flyprompt_brain-inspired_random-expanded_routing.md)**
...
**[Flyprompt Brain-Inspired Random-Expanded Routing With Temporal-Ensemble Experts ](model_compression/flyprompt_brain-inspired_random-expanded_routing_with_temporal-ensemble_experts_.md)**
...
**[Guidedsampling Steering Llms Towards Diverse Candidate Solutions At Inference-Ti](model_compression/guidedsampling_steering_llms_towards_diverse_candidate_solutions_at_inference-ti.md)**
...
**[Hifo-Prompt Prompting With Hindsight And Foresight For Llm-Based Automatic Heuri](model_compression/hifo-prompt_prompting_with_hindsight_and_foresight_for_llm-based_automatic_heuri.md)**
...
**[Incentivizing Agentic Reasoning In Llm Judges Via Tool-Integrated Reinforcement ](model_compression/incentivizing_agentic_reasoning_in_llm_judges_via_tool-integrated_reinforcement_.md)**

:   提出 TIR-Judge，一个端到端的 RL 框架，训练 LLM 评判模型在评估过程中交替使用推理和代码执行工具，在7个公开基准上以 8B 参数超越 32B 推理奖励模型，且无需蒸馏的 TIR-Judge-Zero 可自举提升。

**[Inftythink Breaking The Length Limits Of Long-Context Reasoning In Large Languag](model_compression/inftythink_breaking_the_length_limits_of_long-context_reasoning_in_large_languag.md)**
...
**[Is The Reversal Curse A Binding Problem Uncovering Limitations Of Transformers F](model_compression/is_the_reversal_curse_a_binding_problem_uncovering_limitations_of_transformers_f.md)**
...
**[Kbvq-Moe Klt-Guided Svd With Bias-Corrected Vector Quantization For Moe Large La](model_compression/kbvq-moe_klt-guided_svd_with_bias-corrected_vector_quantization_for_moe_large_la.md)**
...
**[Lookaheadkv Fast And Accurate Kv Cache Eviction By Glimpsing Into The Future Wit](model_compression/lookaheadkv_fast_and_accurate_kv_cache_eviction_by_glimpsing_into_the_future_wit.md)**
...
**[Mobilellm-R1 Exploring The Limits Of Sub-Billion Language Model Reasoners With O](model_compression/mobilellm-r1_exploring_the_limits_of_sub-billion_language_model_reasoners_with_o.md)**
...
**[Mone Replacing Redundant Experts With Lightweight Novices For Structured Pruning](model_compression/mone_replacing_redundant_experts_with_lightweight_novices_for_structured_pruning.md)**
...
**[Null-Space Filtering For Data-Free Continual Model Merging Preserving Stability ](model_compression/null-space_filtering_for_data-free_continual_model_merging_preserving_stability_.md)**

:   提出 NUFILT 框架，通过零空间滤波和投影感知 LoRA 适配，在不访问任何任务数据的条件下实现持续模型合并，同时保持稳定性和可塑性。

**[Obscure But Effective Classical Chinese Jailbreak Prompt Optimization Via Bio-In](model_compression/obscure_but_effective_classical_chinese_jailbreak_prompt_optimization_via_bio-in.md)**
...
**[Paser Post-Training Data Selection For Efficient Pruned Large Language Model Rec](model_compression/paser_post-training_data_selection_for_efficient_pruned_large_language_model_rec.md)**
...
**[Pi-Flow Policy-Based Few-Step Generation Via Imitation Distillation](model_compression/pi-flow_policy-based_few-step_generation_via_imitation_distillation.md)**
...
**[Rectified Decoupled Dataset Distillation A Closer Look For Fair And Comprehensiv](model_compression/rectified_decoupled_dataset_distillation_a_closer_look_for_fair_and_comprehensiv.md)**
...
**[Scaling Reasoning Hop Exposes Weaknesses Demystifying And Improving Hop Generali](model_compression/scaling_reasoning_hop_exposes_weaknesses_demystifying_and_improving_hop_generali.md)**
...
**[Sere Similarity-Based Expert Re-Routing For Efficient Batch Decoding In Moe Mode](model_compression/sere_similarity-based_expert_re-routing_for_efficient_batch_decoding_in_moe_mode.md)**

:   提出 SERE 方法，通过预计算专家相似度矩阵，在批量解码时将次要专家动态重路由到最相似的主要专家，实现最高 2.0 倍加速且质量损失极小，并提供即插即用的 vLLM CUDA 内核。

**[Sft Doesnt Always Hurt General Capabilities Revisiting Domain-Specific Fine-Tuni](model_compression/sft_doesnt_always_hurt_general_capabilities_revisiting_domain-specific_fine-tuni.md)**
...
**[Sparta Scalable And Principled Benchmark Of Tree-Structured Multi-Hop Qa Over Te](model_compression/sparta_scalable_and_principled_benchmark_of_tree-structured_multi-hop_qa_over_te.md)**
...
**[Star Similarity-Guided Teacher-Assisted Refinement For Super-Tiny Function Calli](model_compression/star_similarity-guided_teacher-assisted_refinement_for_super-tiny_function_calli.md)**

:   提出 STAR 框架，通过约束知识蒸馏（CKD）和相似度引导的强化学习（Sim-RL）协同工作，将大模型的 function calling 能力有效迁移到 0.6B 级别的超小模型，在 BFCL 和 ACEBench 上大幅超越基线。

**[Steering Moe Llms Via Expert Deactivation](model_compression/steering_moe_llms_via_expert_deactivation.md)**
...
**[Swireasoning Switch-Thinking In Latent And Explicit For Pareto-Superior Reasonin](model_compression/swireasoning_switch-thinking_in_latent_and_explicit_for_pareto-superior_reasonin.md)**
...
**[The Geometry Of Llm Quantization Gptq As Babais Nearest Plane Algorithm](model_compression/the_geometry_of_llm_quantization_gptq_as_babais_nearest_plane_algorithm.md)**

:   首次证明 GPTQ（从后向前执行时）在数学上等价于经典格理论中的 Babai 最近平面算法，由此获得几何解释和层级误差上界，并基于此设计了无裁剪的改进量化方法。

**[The Lattice Geometry Of Neural Network Quantization -- A Short Equivalence Proof](model_compression/the_lattice_geometry_of_neural_network_quantization_--_a_short_equivalence_proof.md)**
...
**[Topology And Geometry Of The Learning Space Of Relu Networks Connectivity And Si](model_compression/topology_and_geometry_of_the_learning_space_of_relu_networks_connectivity_and_si.md)**
...
**[Adaptive Test-Time Training For Predicting Need For Invasive Mechanical Ventilat](medical_imaging/adaptive_test-time_training_for_predicting_need_for_invasive_mechanical_ventilat.md)**

:   提出AdaTTT框架，通过动态特征感知self-supervised学习（自适应掩码策略）和原型引导的部分最优传输对齐，在ICU多中心EHR数据上实现鲁棒的测试时适应，用于提前24小时预测有创机械通气需求。

**[Afd-Instruction A Comprehensive Antibody Instruction Dataset With Functional Ann](medical_imaging/afd-instruction_a_comprehensive_antibody_instruction_dataset_with_functional_ann.md)**
...
**[Brain-Semantoks Learning Semantic Tokens Of Brain Dynamics With A Self-Distilled](medical_imaging/brain-semantoks_learning_semantic_tokens_of_brain_dynamics_with_a_self-distilled.md)**
...
**[Care Towards Clinical Accountability In Multi-Modal Medical Reasoning With An Ev](medical_imaging/care_towards_clinical_accountability_in_multi-modal_medical_reasoning_with_an_ev.md)**

:   提出 CARE Agent 框架，将医学 VQA 分解为实体提议、指称分割和证据引导推理三个专家模块，通过 GPT-5 作为动态协调器，在医学 VQA 基准上以 77.54% 准确率超越 32B 模型。

**[Causal Interpretation Of Neural Network Computations With Contribution Decomposi](medical_imaging/causal_interpretation_of_neural_network_computations_with_contribution_decomposi.md)**
...
**[Characterizing Human Semantic Navigation In Concept Production As Trajectories I](medical_imaging/characterizing_human_semantic_navigation_in_concept_production_as_trajectories_i.md)**
...
**[Cryonetrefine A One-Step Diffusion Model For Rapid Refinement Of Structural Mode](medical_imaging/cryonetrefine_a_one-step_diffusion_model_for_rapid_refinement_of_structural_mode.md)**
...
**[Decentralized Attention Fails Centralized Signals Rethinking Transformers For Me](medical_imaging/decentralized_attention_fails_centralized_signals_rethinking_transformers_for_me.md)**
...
**[Deep Hierarchical Learning With Nested Subspace Networks For Large Language Mode](medical_imaging/deep_hierarchical_learning_with_nested_subspace_networks_for_large_language_mode.md)**

:   提出嵌套子空间网络（NSN），通过低秩分解使线性层形成严格嵌套的子空间层次，配合不确定性感知多秩训练，使单个模型在测试时可即时调节计算量与性能的权衡（50% FLOPs 减少仅损失 5% 精度），且可后验应用于预训练 LLM。

**[Disco Densely-Overlapping Cell Instance Segmentation Via Adjacency-Aware Collabo](medical_imaging/disco_densely-overlapping_cell_instance_segmentation_via_adjacency-aware_collabo.md)**
...
**[Distmlip A Distributed Inference Platform For Machine Learning Interatomic Poten](medical_imaging/distmlip_a_distributed_inference_platform_for_machine_learning_interatomic_poten.md)**
...
**[Driftlite Lightweight Drift Control For Inference-Time Scaling Of Diffusion Mode](medical_imaging/driftlite_lightweight_drift_control_for_inference-time_scaling_of_diffusion_mode.md)**
...
**[Exploiting Low-Dimensional Manifold Of Features For Few-Shot Whole Slide Image C](medical_imaging/exploiting_low-dimensional_manifold_of_features_for_few-shot_whole_slide_image_c.md)**

:   发现病理基础模型特征具有低维流形几何结构（有效秩仅29.7/512维），而线性层会破坏这种结构导致少样本过拟合，提出即插即用的MR Block（冻结随机矩阵做几何锚+低秩残差路径做任务适配）在少样本WSI分类上达到SOTA。

**[Extending Sequence Length Is Not All You Need Effective Integration Of Multimoda](medical_imaging/extending_sequence_length_is_not_all_you_need_effective_integration_of_multimoda.md)**
...
**[From Conversation To Query Execution Benchmarking User And Tool Interactions For](medical_imaging/from_conversation_to_query_execution_benchmarking_user_and_tool_interactions_for.md)**
...
**[Histoprism Unlocking Functional Pathway Analysis From Pan-Cancer Histology Via G](medical_imaging/histoprism_unlocking_functional_pathway_analysis_from_pan-cancer_histology_via_g.md)**
...
**[Human Behavior Atlas Benchmarking Unified Psychological And Social Behavior Unde](medical_imaging/human_behavior_atlas_benchmarking_unified_psychological_and_social_behavior_unde.md)**

:   构建 Human Behavior Atlas——首个覆盖情感、认知、病理和社会过程四大维度的大规模多模态行为理解统一基准（101K+ 样本），并训练三种 OmniSapiens-7B 模型变体验证其在多任务训练和迁移学习中的有效性。

**[Improving 2D Diffusion Models For 3D Medical Imaging With Inter-Slice Consistent](medical_imaging/improving_2d_diffusion_models_for_3d_medical_imaging_with_inter-slice_consistent.md)**
...
**[Inference-Time Dynamic Modality Selection For Incomplete Multimodal Classificati](medical_imaging/inference-time_dynamic_modality_selection_for_incomplete_multimodal_classificati.md)**
...
**[Learning Domain-Aware Task Prompt Representations For Multi-Domain All-In-One Im](medical_imaging/learning_domain-aware_task_prompt_representations_for_multi-domain_all-in-one_im.md)**

:   提出首个多域全能图像复原方法DATPRL-IR，通过双提示池（任务提示池+域提示池）学习域感知的任务提示表征，利用MLLM蒸馏域先验并通过自适应门控融合指导复原，在自然/医学/遥感三域9任务上显著超越SOTA。

**[Learning Patient-Specific Disease Dynamics With Latent Flow Matching For Longitu](medical_imaging/learning_patient-specific_disease_dynamics_with_latent_flow_matching_for_longitu.md)**
...
**[Mclm A Modular Chemical Language Model That Generates Functional And Makeable Mo](medical_imaging/mclm_a_modular_chemical_language_model_that_generates_functional_and_makeable_mo.md)**

:   提出 mCLM（模块化化学语言模型），通过将分子表示为可合成构建模块的序列，使 LLM 能生成同时满足药理功能和自动化合成可行性的分子，在 430 种 FDA 批准药物上显著改善了药代动力学和毒性性质。

**[Medagentgym Agentic Training Biomedical](medical_imaging/medagentgym_agentic_training_biomedical.md)**
...
**[Mmedagent-Rl Optimizing Multi-Agent Collaboration For Multimodal Medical Reasoni](medical_imaging/mmedagent-rl_optimizing_multi-agent_collaboration_for_multimodal_medical_reasoni.md)**
...
**[Moving Beyond Medical Exams A Clinician-Annotated Fairness Dataset Of Real-World](medical_imaging/moving_beyond_medical_exams_a_clinician-annotated_fairness_dataset_of_real-world.md)**
...
**[Omni-Ieeg A Large-Scale Comprehensive Ieeg Dataset And Benchmark For Epilepsy Re](medical_imaging/omni-ieeg_a_large-scale_comprehensive_ieeg_dataset_and_benchmark_for_epilepsy_re.md)**
...
**[Q-Fsru Quantum-Augmented Frequency-Spectral For Medical Visual Question Answerin](medical_imaging/q-fsru_quantum-augmented_frequency-spectral_for_medical_visual_question_answerin.md)**

:   提出 Q-FSRU 框架，通过 FFT 将医学图像和文本特征变换到频率域进行融合，并引入量子启发的检索增强机制（Quantum RAG）从外部知识库中获取医学事实，在 VQA-RAD 数据集上取得 90.0% 准确率。

**[Resp-Agent An Agent-Based System For Multimodal Respiratory Sound Generation And](medical_imaging/resp-agent_an_agent-based_system_for_multimodal_respiratory_sound_generation_and.md)**
...
**[Scalable Spatio-Temporal Se3 Diffusion For Long-Horizon Protein Dynamics](medical_imaging/scalable_spatio-temporal_se3_diffusion_for_long-horizon_protein_dynamics.md)**
...
**[Shoot First Ask Questions Later Building Rational Agents That Explore And Act Li](medical_imaging/shoot_first_ask_questions_later_building_rational_agents_that_explore_and_act_li.md)**
...
**[Survhte-Bench A Benchmark For Heterogeneous Treatment Effect Estimation In Survi](medical_imaging/survhte-bench_a_benchmark_for_heterogeneous_treatment_effect_estimation_in_survi.md)**
...
**[Syncogen Synthesizable 3D Molecule Generation Via Joint Reaction And Coordinate ](medical_imaging/syncogen_synthesizable_3d_molecule_generation_via_joint_reaction_and_coordinate_.md)**
...
**[A-Tpt Angular Diversity Calibration Properties For Test-Time Prompt Tuning Of Vi](multimodal_vlm/a-tpt_angular_diversity_calibration_properties_for_test-time_prompt_tuning_of_vi.md)**

:   提出 A-TPT 框架，通过最大化归一化文本特征在单位超球面上的最小成对角距离来促进角度多样性，解决测试时提示调优 (TPT) 中 VLM 预测过度自信导致的校准不良问题，在自然分布偏移和医学数据集上均优于现有 TPT 校准方法。

**[Agilepruner An Empirical Study Of Attention And Diversity For Adaptive Visual To](multimodal_vlm/agilepruner_an_empirical_study_of_attention_and_diversity_for_adaptive_visual_to.md)**
...
**[Biocap Exploiting Synthetic Captions Beyond Labels In Biological Foundation Mode](multimodal_vlm/biocap_exploiting_synthetic_captions_beyond_labels_in_biological_foundation_mode.md)**
...
**[Bongard-Rwr Real-World Representations Of Fine-Grained Concepts In Bongard Probl](multimodal_vlm/bongard-rwr_real-world_representations_of_fine-grained_concepts_in_bongard_probl.md)**
...
**[Bootstrapping Mllm For Weakly-Supervised Class-Agnostic Object Counting](multimodal_vlm/bootstrapping_mllm_for_weakly-supervised_class-agnostic_object_counting.md)**

:   提出 WS-COC，首个基于 MLLM 的弱监督类无关目标计数框架，通过分而治之的对话微调（逐步缩小计数范围）、比较排序优化（学习图像间相对计数关系）和全局-局部计数增强三个策略，仅用图像级计数标注即可匹敌甚至超越全监督方法。

**[Breaking The Limits Of Open-Weight Clip An Optimization Framework For Self-Super](multimodal_vlm/breaking_the_limits_of_open-weight_clip_an_optimization_framework_for_self-super.md)**
...
**[Can Vision Language Models Assess Graphic Design Aesthetics A Benchmark Evaluati](multimodal_vlm/can_vision_language_models_assess_graphic_design_aesthetics_a_benchmark_evaluati.md)**
...
**[Customizing Visual Emotion Evaluation For Mllms An Open-Vocabulary Multifaceted ](multimodal_vlm/customizing_visual_emotion_evaluation_for_mllms_an_open-vocabulary_multifaceted_.md)**

:   提出情感陈述判断（ESJ）任务和 INSETS 自动标注流水线，构建 MVEI benchmark，系统评估 MLLMs 的视觉情感感知能力，揭示当前模型在情感极性辨别和感知主观性理解上的显著不足。

**[Detecting Misbehaviors Of Large Vision-Language Models By Evidential Uncertainty](multimodal_vlm/detecting_misbehaviors_of_large_vision-language_models_by_evidential_uncertainty.md)**
...
**[Diva-Grpo Enhancing Multimodal Reasoning Through Difficulty-Adaptive Variant Adv](multimodal_vlm/diva-grpo_enhancing_multimodal_reasoning_through_difficulty-adaptive_variant_adv.md)**
...
**[Dynamic Multimodal Activation Steering For Hallucination Mitigation In Large Vis](multimodal_vlm/dynamic_multimodal_activation_steering_for_hallucination_mitigation_in_large_vis.md)**
...
**[Error Notebook-Guided Training-Free Part Retrieval In 3D Cad Assemblies Via Visi](multimodal_vlm/error_notebook-guided_training-free_part_retrieval_in_3d_cad_assemblies_via_visi.md)**
...
**[Grasp Any Region Towards Precise Contextual Pixel Understanding For Multimodal L](multimodal_vlm/grasp_any_region_towards_precise_contextual_pixel_understanding_for_multimodal_l.md)**
...
**[Grounding-Iqa Grounding Multimodal Language Model For Image Quality Assessment](multimodal_vlm/grounding-iqa_grounding_multimodal_language_model_for_image_quality_assessment.md)**

:   将空间定位（referring + grounding）与图像质量评估结合，构建 GIQA-160K 数据集训练多模态 LLM 生成带有边界框的质量描述和空间 VQA，在细粒度质量感知上显著优于通用 MLLM。

**[Gtr-Bench Evaluating Geo-Temporal Reasoning In Vision-Language Mod](multimodal_vlm/gtr-bench_evaluating_geo-temporal_reasoning_in_vision-language_mod.md)**
...
**[Hidrop Hierarchical Vision Token Reduction In Mllms Via Late Injection Concave P](multimodal_vlm/hidrop_hierarchical_vision_token_reduction_in_mllms_via_late_injection_concave_p.md)**
...
**[Ivc-Prune Revealing The Implicit Visual Coordinates In Lvlms For Vision Token Pr](multimodal_vlm/ivc-prune_revealing_the_implicit_visual_coordinates_in_lvlms_for_vision_token_pr.md)**
...
**[Look Carefully Adaptive Visual Reinforcements In Multimodal Large Language Model](multimodal_vlm/look_carefully_adaptive_visual_reinforcements_in_multimodal_large_language_model.md)**
...
**[Mixing Importance With Diversity Joint Optimization For Kv Cache Compression In ](multimodal_vlm/mixing_importance_with_diversity_joint_optimization_for_kv_cache_compression_in_.md)**
...
**[Omnispatial Towards Comprehensive Spatial Reasoning Benchmark For Vision Languag](multimodal_vlm/omnispatial_towards_comprehensive_spatial_reasoning_benchmark_for_vision_languag.md)**
...
**[Ppe Positional Preservation Embedding For Token Compression In Multimodal Large ](multimodal_vlm/ppe_positional_preservation_embedding_for_token_compression_in_multimodal_large_.md)**
...
**[Seeing Across Views Benchmarking Spatial Reasoning Of Vision-Language Models In ](multimodal_vlm/seeing_across_views_benchmarking_spatial_reasoning_of_vision-language_models_in_.md)**
...
**[Self-Evolving Vision-Language Models For Image Quality Assessment Via Voting And](multimodal_vlm/self-evolving_vision-language_models_for_image_quality_assessment_via_voting_and.md)**

:   提出 EvoQuality 框架，通过成对多数投票生成伪排序标签、结合 GRPO 自迭代优化，使 VLM 在无人工标注下自主提升图像质量感知能力，零样本性能提升 31.8% PLCC，在 7 个 IQA 基准中 5 个超越有监督 SOTA。

**[Shuffle-R1 Efficient Rl Framework For Multimodal Large Language Models Via Data-](multimodal_vlm/shuffle-r1_efficient_rl_framework_for_multimodal_large_language_models_via_data-.md)**
...
**[Spatial-Dise A Unified Benchmark For Evaluating Spatial Reasoning In Vision-Lang](multimodal_vlm/spatial-dise_a_unified_benchmark_for_evaluating_spatial_reasoning_in_vision-lang.md)**
...
**[Spatial Captcha Generatively Benchmarking Spatial Reasoning For Human-Machine Di](multimodal_vlm/spatial_captcha_generatively_benchmarking_spatial_reasoning_for_human-machine_di.md)**
...
**[Steering And Rectifying Latent Representation Manifolds In Frozen Multi-Modal Ll](multimodal_vlm/steering_and_rectifying_latent_representation_manifolds_in_frozen_multi-modal_ll.md)**
...
**[Thinkomni Lifting Textual Reasoning To Omni-Modal Scenarios Via Guidance Decodin](multimodal_vlm/thinkomni_lifting_textual_reasoning_to_omni-modal_scenarios_via_guidance_decodin.md)**
...
**[U-Marvel Unveiling Key Factors For Universal Multimodal Retrieval Via Embedding ](multimodal_vlm/u-marvel_unveiling_key_factors_for_universal_multimodal_retrieval_via_embedding_.md)**
...
**[Visual Symbolic Mechanisms Vlm](multimodal_vlm/visual_symbolic_mechanisms_vlm.md)**
...
**[Why Keep Your Doubts To Yourself Trading Visual Uncertainties In Multi-Agent Ban](multimodal_vlm/why_keep_your_doubts_to_yourself_trading_visual_uncertainties_in_multi-agent_ban.md)**
...
**[Why Keep Your Doubts To Yourself Trading Visual Uncertainty](multimodal_vlm/why_keep_your_doubts_to_yourself_trading_visual_uncertainty.md)**
...
**[Why Reinforcement Fine-Tuning Enables Mllms Preserve Prior Knowledge Better A Da](multimodal_vlm/why_reinforcement_fine-tuning_enables_mllms_preserve_prior_knowledge_better_a_da.md)**
...
**[Ctrlshift High-Quality Geometry-Aware Object Manipulation In Visual Generation](3d_vision/ctrlshift_high-quality_geometry-aware_object_manipulation_in_visual_generation.md)**
...
**[Dissecting Chronos Sparse Autoencoders Reveal Causal Feature Hierarchies In Time](3d_vision/dissecting_chronos_sparse_autoencoders_reveal_causal_feature_hierarchies_in_time.md)**
...
**[Efficient-Lvsm Faster Cheaper And Better Large View Synthesis Model Via Decouple](3d_vision/efficient-lvsm_faster_cheaper_and_better_large_view_synthesis_model_via_decouple.md)**
...
**[Egonight Towards Egocentric Vision Understanding At Night With A Challenging Ben](3d_vision/egonight_towards_egocentric_vision_understanding_at_night_with_a_challenging_ben.md)**

:   构建首个系统性夜间第一人称视觉基准 EgoNight，包含日夜对齐的合成/真实视频和 3658 个 QA 对（12种类型，300+小时人工标注），揭示所有 SOTA MLLM 在日夜转换中的显著性能下降。

**[Egoworld Translating Exocentric View To Egocentric View Using Rich Exocentric Ob](3d_vision/egoworld_translating_exocentric_view_to_egocentric_view_using_rich_exocentric_ob.md)**

:   提出 EgoWorld 框架，通过从外部视角提取点云、3D 手部姿态和文本描述等多模态观测，利用两阶段管线将单张第三人称图像转换为高质量的第一人称视图。

**[Fast Estimation Of Wasserstein Distances Via Regression On Sliced Wasserstein Di](3d_vision/fast_estimation_of_wasserstein_distances_via_regression_on_sliced_wasserstein_di.md)**
...
**[Generalizable Coarse-To-Fine Robot Manipulation Via Language-Aligned 3D Keypoint](3d_vision/generalizable_coarse-to-fine_robot_manipulation_via_language-aligned_3d_keypoint.md)**
...
**[Geopurify A Data-Efficient Geometric Distillation Framework For Open-Vocabulary ](3d_vision/geopurify_a_data-efficient_geometric_distillation_framework_for_open-vocabulary_.md)**

:   提出 GeoPurify 框架，通过从 3D 自监督教师模型蒸馏几何先验来净化 2D VLM 投影到 3D 的噪声特征，仅用约 1.5% 的训练数据即可达到或超越全量训练的 SOTA 开放词汇 3D 分割性能。

**[Giq Benchmarking 3D Geometric Reasoning Of Vision Foundation Models With Simulat](3d_vision/giq_benchmarking_3d_geometric_reasoning_of_vision_foundation_models_with_simulat.md)**
...
**[Into The Rabbit Hull From Task-Relevant Concepts](3d_vision/into_the_rabbit_hull_from_task-relevant_concepts.md)**
...
**[Learning Part-Aware Dense 3D Feature Field For Generalizable Articulated Object ](3d_vision/learning_part-aware_dense_3d_feature_field_for_generalizable_articulated_object_.md)**
...
**[Megs2 Memory-Efficient Gaussian Splatting Via Spherical Gaussians And Unified Pr](3d_vision/megs2_memory-efficient_gaussian_splatting_via_spherical_gaussians_and_unified_pr.md)**
...
**[Mono4Dgs-Hdr High Dynamic Range 4D Gaussian Splatting From Alternating-Exposure ](3d_vision/mono4dgs-hdr_high_dynamic_range_4d_gaussian_splatting_from_alternating-exposure_.md)**
...
**[Multimat Multimodal Program Synthesis For Procedural Materials Using Large Multi](3d_vision/multimat_multimodal_program_synthesis_for_procedural_materials_using_large_multi.md)**
...
**[Omni-View Unlocking How Generation Facilitates Understanding In Unified 3D Model](3d_vision/omni-view_unlocking_how_generation_facilitates_understanding_in_unified_3d_model.md)**

:   构建统一的3D场景理解与生成模型 Omni-View，通过纹理模块（新视角合成）和几何模块（深度/位姿估计）的生成能力增强理解性能，在 VSI-Bench 上达到 55.4 分超越所有现有专用3D理解模型。

**[One2Scene Geometric Consistent Explorable 3D Scene Generation From A Single Ima](3d_vision/one2scene_geometric_consistent_explorable_3d_scene_generation_from_a_single_ima.md)**

:   提出 One2Scene 三阶段框架，将单图生成可探索 3D 场景分解为全景生成→前馈 3D 高斯溅射构建几何支架→支架引导的新视角合成，通过将全景深度估计重新表述为多视图立体匹配问题，实现几何一致且可自由探索的 3D 场景生成。

**[One2Scene Geometric Consistent Explorable 3D Scene Generation From A Single Imag](3d_vision/one2scene_geometric_consistent_explorable_3d_scene_generation_from_a_single_imag.md)**
...
**[Pd2Gs Part-Level Decoupling And Continuous Deformation Of Articulated Objects Vi](3d_vision/pd2gs_part-level_decoupling_and_continuous_deformation_of_articulated_objects_vi.md)**

:   提出 PD²GS 框架，通过学习共享的 canonical 高斯场并将每个交互状态建模为其连续形变，实现铰接物体的部件级解耦、重建和连续控制，采用粗到细的运动轨迹聚类 + SAM 引导的边界细化，无需手动监督。

**[Peering Into The Unknown Active View Selection With Neural Uncertainty Maps For ](3d_vision/peering_into_the_unknown_active_view_selection_with_neural_uncertainty_maps_for_.md)**
...
**[Scenetransporter Optimal Transport-Guided Compositional Latent Diffusion For Sin](3d_vision/scenetransporter_optimal_transport-guided_compositional_latent_diffusion_for_sin.md)**
...
**[Splat And Distill Augmenting Teachers With Feed-Forward 3D Reconstruction For 3D](3d_vision/splat_and_distill_augmenting_teachers_with_feed-forward_3d_reconstruction_for_3d.md)**
...
**[Streamsplat Towards Online Dynamic 3D Reconstruction From Uncalibrated Video Str](3d_vision/streamsplat_towards_online_dynamic_3d_reconstruction_from_uncalibrated_video_str.md)**
...
**[Surfsplat Conquering Feedforward 2D Gaussian Splatting With Surface Continuity P](3d_vision/surfsplat_conquering_feedforward_2d_gaussian_splatting_with_surface_continuity_p.md)**
...
**[Uncertainty Matters In Dynamic Gaussian Splatting For Monocular 4D Reconstructio](3d_vision/uncertainty_matters_in_dynamic_gaussian_splatting_for_monocular_4d_reconstructio.md)**
...
**[Urbangs A Scalable And Efficient Architecture For Geometrically Accurate Large-S](3d_vision/urbangs_a_scalable_and_efficient_architecture_for_geometrically_accurate_large-s.md)**
...
**[Agentmath Empowering Mathematical Reasoning For Large Language Models Via Tool-A](llm_reasoning/agentmath_empowering_mathematical_reasoning_for_large_language_models_via_tool-a.md)**
...
**[Aimcot Active Information-Driven Multimodal Chain-Of-Thought For Vision-Language](llm_reasoning/aimcot_active_information-driven_multimodal_chain-of-thought_for_vision-language.md)**
...
**[Compositional Generalization From Learned Skills Via Cot Training A Theoretical ](llm_reasoning/compositional_generalization_from_learned_skills_via_cot_training_a_theoretical_.md)**

:   本文通过信息论泛化界和可解释性分析证明，CoT 训练的核心机制是**组合泛化**——模型学会系统性地组合已学的简单技能来解决新颖复杂问题，并内化为两阶段组合推理电路，使中间结果在更浅层提取，释放深层专注于后续推理步骤。

**[Conflict-Aware Fusion Resolving Logic Inertia In Large Language Models Via Struc](llm_reasoning/conflict-aware_fusion_resolving_logic_inertia_in_large_language_models_via_struc.md)**
...
**[Doxing Via The Lens Revealing Location-Related Privacy Leakage In Vlms](llm_reasoning/doxing_via_the_lens_revealing_location-related_privacy_leakage_in_vlms.md)**

:   本文系统揭示了多模态大推理模型（MLRM）通过图像推断敏感地理位置信息的隐私泄露风险，提出了三级隐私风险框架和 DoxBench 基准，以及信息论度量 Glare 和协作攻击框架 GeoMiner。

**[Doxing Via The Lens Revealing Location-Related Privacy Leakage On Multi-Modal La](llm_reasoning/doxing_via_the_lens_revealing_location-related_privacy_leakage_on_multi-modal_la.md)**
...
**[Fastgrpo Accelerating Policy Optimization Via Concurrency-Aware Speculative Deco](llm_reasoning/fastgrpo_accelerating_policy_optimization_via_concurrency-aware_speculative_deco.md)**
...
**[Fine-R1 Make Multi-Modal Llms Excel In Fine-Grained Visual Recognition By Chain-](llm_reasoning/fine-r1_make_multi-modal_llms_excel_in_fine-grained_visual_recognition_by_chain-.md)**

:   Fine-R1 通过 CoT 监督微调（"视觉分析→候选子类→对比→预测"结构化推理链）+ 三元组增强策略优化 TAPO（类内增强提升鲁棒性 + 类间增强提升判别力），仅用 4-shot 训练即在细粒度视觉识别上超越 CLIP 和通用/推理型 MLLM。

**[Fixing The Broken Compass Diagnosing And Improving Inference-Time Reward Modelin](llm_reasoning/fixing_the_broken_compass_diagnosing_and_improving_inference-time_reward_modelin.md)**

:   系统诊断推理时奖励模型（RM）的三大失效模式——简单题性能退化、采样数增多时辨别力下降、高搜索多样性损害准确率，并提出 CRISP 算法通过答案聚类的奖励聚合与逐步前缀引导来缓解这些问题，准确率提升最高 5%。

**[From Abstract To Contextual What Llms Still Cannot Do In Math Word Problem Solvi](llm_reasoning/from_abstract_to_contextual_what_llms_still_cannot_do_in_math_word_problem_solvi.md)**
...
**[Harder Is Better Boosting Mathematical Reasoning Via Difficulty-Aware Grpo And M](llm_reasoning/harder_is_better_boosting_mathematical_reasoning_via_difficulty-aware_grpo_and_m.md)**
...
**[I Cant Believe Its Not Robust Catastrophic Collapse Of Safety Classifiers Under ](llm_reasoning/i_cant_believe_its_not_robust_catastrophic_collapse_of_safety_classifiers_under_.md)**
...
**[Is It Thinking Or Cheating Detecting Implicit Reward Hacking By Measuring Reason](llm_reasoning/is_it_thinking_or_cheating_detecting_implicit_reward_hacking_by_measuring_reason.md)**
...
**[Lingoly-Too Disentangling Reasoning From Knowledge With Templatised Orthographic](llm_reasoning/lingoly-too_disentangling_reasoning_from_knowledge_with_templatised_orthographic.md)**
...
**[Plan And Budget Effective And Efficient Test-Time Scaling On Reasoning Large Lan](llm_reasoning/plan_and_budget_effective_and_efficient_test-time_scaling_on_reasoning_large_lan.md)**

:   提出 Plan-and-Budget 框架，通过将复杂查询分解为子问题并基于估计复杂度自适应分配 token 预算，实现推理 LLM 的高效测试时缩放——最高提升 70% 准确率、减少 39% token、E3 指标提升 193.8%。

**[Prismaudio Decomposed Chain-Of-Thoughts And Multi-Dimensional Rewards For Video-](llm_reasoning/prismaudio_decomposed_chain-of-thoughts_and_multi-dimensional_rewards_for_video-.md)**
...
**[Rain-Merging A Gradient-Free Method To Enhance Instruction Following In Large Re](llm_reasoning/rain-merging_a_gradient-free_method_to_enhance_instruction_following_in_large_re.md)**
...
**[Rain-Merging A Gradient-Free Method To Enhance Instruction Following Through Mod](llm_reasoning/rain-merging_a_gradient-free_method_to_enhance_instruction_following_through_mod.md)**
...
**[Reform Reflective Autoformalization With Prospective Bounded Sequence Optimizati](llm_reasoning/reform_reflective_autoformalization_with_prospective_bounded_sequence_optimizati.md)**

:   提出 ReForm，一种反思式自动形式化范式，将自然语言数学问题转为 Lean 形式声明的过程从一次生成转变为"生成 → 语义自验证 → 修正"的迭代循环，并设计 PBSO 算法优化异构奖励信号，在四个基准上比最强基线平均提升 22.6 个百分点。

**[Rfeval Benchmarking Reasoning Faithfulness Under Counterfactual Reasoning Interv](llm_reasoning/rfeval_benchmarking_reasoning_faithfulness_under_counterfactual_reasoning_interv.md)**
...
**[The First Impression Problem Internal Bias Triggers Overthinking In Reasoning Mo](llm_reasoning/the_first_impression_problem_internal_bias_triggers_overthinking_in_reasoning_mo.md)**
...
**[The Path Of Least Resistance Guiding Llm Reasoning Trajectories With Prefix Cons](llm_reasoning/the_path_of_least_resistance_guiding_llm_reasoning_trajectories_with_prefix_cons.md)**
...
**[Towards Safe Reasoning In Large Reasoning Models Via Correct-By-Construction Gu](llm_reasoning/towards_safe_reasoning_in_large_reasoning_models_via_correct-by-construction_gu.md)**
...
**[Training Large Reasoning Models Efficiently Via Progressive Solution Complexity](llm_reasoning/training_large_reasoning_models_efficiently_via_progressive_solution_complexity.md)**
...
**[Tumorchain Interleaved Multimodal Chain-Of-Thought Reasoning For Traceable Clini](llm_reasoning/tumorchain_interleaved_multimodal_chain-of-thought_reasoning_for_traceable_clini.md)**
...
**[When Reasoning Meets Compression Understanding The Effects Of Llms Compression O](llm_reasoning/when_reasoning_meets_compression_understanding_the_effects_of_llms_compression_o.md)**

:   系统性基准测试与机制解释压缩（量化/蒸馏/剪枝）对大推理模型的影响，发现三大核心结论：参数数量对知识记忆影响大于推理能力；蒸馏模型最后一层 MLP up_proj 是最关键权重；保护仅 2% 的被过度压缩权重即可提升平均准确率 6.57%。

**[When Reasoning Meets Compression Understanding The Effects Of Pruning And Quant](llm_reasoning/when_reasoning_meets_compression_understanding_the_effects_of_pruning_and_quant.md)**

:   系统研究量化、蒸馏、剪枝三种压缩方法对大型推理模型 (LRM) 的影响，通过性能基准测试和机制可解释性分析，揭示权重数量对知识记忆影响大于推理、最后一层 MLP up_proj 是最关键组件、以及当前量化方法过度压缩最后层等核心发现。

**[When Shallow Wins Silent Failures And The Depth-Accuracy Paradox In Latent Reaso](llm_reasoning/when_shallow_wins_silent_failures_and_the_depth-accuracy_paradox_in_latent_reaso.md)**
...
**[Auditing Cascading Risks In Multi-Agent Systems Via Semanti-Geometric Co-Evolut](interpretability/auditing_cascading_risks_in_multi-agent_systems_via_semanti-geometric_co-evolut.md)**
...
**[Closing The Curvature Gap Full Transformer Hessians And Their Implications For S](interpretability/closing_the_curvature_gap_full_transformer_hessians_and_their_implications_for_s.md)**
...
**[Decomposing Representation Space Into Interpretable Subspaces With Unsupervised ](interpretability/decomposing_representation_space_into_interpretable_subspaces_with_unsupervised_.md)**
...
**[Decoupling Dynamical Richness From Representation Learning Towards Practical Mea](interpretability/decoupling_dynamical_richness_from_representation_learning_towards_practical_mea.md)**
...
**[Formal Mechanistic Interpretability Automated Circuit Discovery With Provable Gu](interpretability/formal_mechanistic_interpretability_automated_circuit_discovery_with_provable_gu.md)**
...
**[How Do Transformers Learn To Associate Tokens Gradient Leading Terms Bring Mecha](interpretability/how_do_transformers_learn_to_associate_tokens_gradient_leading_terms_bring_mecha.md)**
...
**[Implicit Statistical Inference In Transformers Approximating Likelihood-Ratio Te](interpretability/implicit_statistical_inference_in_transformers_approximating_likelihood-ratio_te.md)**
...
**[Lore Jointly Learning The Intrinsic Dimensionality And Relative Similarity Struc](interpretability/lore_jointly_learning_the_intrinsic_dimensionality_and_relative_similarity_struc.md)**
...
**[Salve Sparse Autoencoder-Latent Vector Editing For Mechanistic Control Of Neural](interpretability/salve_sparse_autoencoder-latent_vector_editing_for_mechanistic_control_of_neural.md)**
...
**[Semantic Regexes Auto-Interpreting Llm Features With A Structured Language Of Re](interpretability/semantic_regexes_auto-interpreting_llm_features_with_a_structured_language_of_re.md)**
...
**[Stretching Beyond The Obvious A Gradient-Free Framework To Unveil The Hidden Lan](interpretability/stretching_beyond_the_obvious_a_gradient-free_framework_to_unveil_the_hidden_lan.md)**
...
**[Temporal Sparse Autoencoders Leveraging The Sequential Nature Of Language For In](interpretability/temporal_sparse_autoencoders_leveraging_the_sequential_nature_of_language_for_in.md)**

:   提出 Temporal SAEs (T-SAEs)，通过引入时间对比损失鼓励高层特征在相邻 token 间保持一致激活，在无显式语义信号的自监督训练下实现语义与句法特征的解耦，恢复更平滑、连贯的语义概念且不牺牲重构质量。

**[The Reasoning Trap -- Logical Reasoning As A Mechanistic Pathway To Advanced Jai](interpretability/the_reasoning_trap_--_logical_reasoning_as_a_mechanistic_pathway_to_advanced_jai.md)**

:   提出 RAISE 框架，论证逻辑推理能力（演绎、归纳、溯因）的改进是 AI 情境意识（situational awareness）的机制性路径，改善推理不可避免地放大了情境意识的危险前提条件。

**[The Reasoning Trap -- Logical Reasoning As A Mechanistic Pathway To Situational ](interpretability/the_reasoning_trap_--_logical_reasoning_as_a_mechanistic_pathway_to_situational_.md)**
...
**[Zerotuning Unlocking The Initial Tokens Power To Enhance Large Language Models W](interpretability/zerotuning_unlocking_the_initial_tokens_power_to_enhance_large_language_models_w.md)**
...
**[Amemgym Interactive Memory Benchmarking For Assistants In Long-Horizon Conversat](human_understanding/amemgym_interactive_memory_benchmarking_for_assistants_in_long-horizon_conversat.md)**
...
**[Amped Adaptive Multi-Objective Projection For Balancing Exploration And Skill Di](human_understanding/amped_adaptive_multi-objective_projection_for_balancing_exploration_and_skill_di.md)**
...
**[An Efficient Provably Optimal Algorithm For The 0-1 Loss Linear Classification P](human_understanding/an_efficient_provably_optimal_algorithm_for_the_0-1_loss_linear_classification_p.md)**

:   提出增量单元枚举算法（ICE），首个具有严格证明的独立算法，可以在 $O(N^{D+1})$ 时间内精确求解0-1损失线性分类问题的全局最优解，并扩展到多项式超曲面分类。

**[Antibody Strengthening Defense Against Harmful Fine-Tuning For Large Language Mo](human_understanding/antibody_strengthening_defense_against_harmful_fine-tuning_for_large_language_mo.md)**
...
**[Anytouch 2 General Optical Tactile Representation Learning For Dynamic Tactile P](human_understanding/anytouch_2_general_optical_tactile_representation_learning_for_dynamic_tactile_p.md)**
...
**[Bah Dataset For Ambivalencehesitancy Recognition In Videos For Digital Behaviour](human_understanding/bah_dataset_for_ambivalencehesitancy_recognition_in_videos_for_digital_behaviour.md)**
...
**[Biologically Plausible Online Hebbian Meta-Learning Two-Timescale Local Rules Fo](human_understanding/biologically_plausible_online_hebbian_meta-learning_two-timescale_local_rules_fo.md)**
...
**[Cold-Steer Steering Large Language Models Via In-Context One-Step Learning Dynam](human_understanding/cold-steer_steering_large_language_models_via_in-context_one-step_learning_dynam.md)**

:   提出 COLD-Steer，通过近似梯度下降在上下文示例上产生的表征变化来实现无训练的 LLM 激活转向，在仅用 50 分之一样本量的情况下达到 95% 的转向效果。

**[Collectivekv Decoupling And Sharing Collaborative Information In Sequential Reco](human_understanding/collectivekv_decoupling_and_sharing_collaborative_information_in_sequential_reco.md)**
...
**[Distilling And Adapting A Topology-Aware Framework For Zero-Shot Interaction Pre](human_understanding/distilling_and_adapting_a_topology-aware_framework_for_zero-shot_interaction_pre.md)**
...
**[Evoking User Memory Personalizing Llm Via Recollection-Familiarity Adaptive Retr](human_understanding/evoking_user_memory_personalizing_llm_via_recollection-familiarity_adaptive_retr.md)**
...
**[Inverse Virtual Try-On Generating Multi-Category Product-Style Images From Cloth](human_understanding/inverse_virtual_try-on_generating_multi-category_product-style_images_from_cloth.md)**
...
**[Mollangbench A Comprehensive Benchmark For Language-Prompted Molecular Structure](human_understanding/mollangbench_a_comprehensive_benchmark_for_language-prompted_molecular_structure.md)**
...
**[Neurogaze-Distill Brain-Informed Distillation And Depression-Inspired Geometric ](human_understanding/neurogaze-distill_brain-informed_distillation_and_depression-inspired_geometric_.md)**
...
**[Omnieva Embodied Versatile Planner Via Task-Adaptive 3D-Grounded And Embodiment-](human_understanding/omnieva_embodied_versatile_planner_via_task-adaptive_3d-grounded_and_embodiment-.md)**
...
**[One Language Two Scripts Probing Script-Invariance In Llm Concept Representation](human_understanding/one_language_two_scripts_probing_script-invariance_in_llm_concept_representation.md)**
...
**[Scalable Exploration For High-Dimensional Continuous Control Via Value-Guided Fl](human_understanding/scalable_exploration_for_high-dimensional_continuous_control_via_value-guided_fl.md)**
...
**[Supervised Metric Regularization Through Alternating Optimization For Multi-Regi](human_understanding/supervised_metric_regularization_through_alternating_optimization_for_multi-regi.md)**
...
**[Think-While-Generating On-The-Fly Reasoning For Personalized Long-Form Generatio](human_understanding/think-while-generating_on-the-fly_reasoning_for_personalized_long-form_generatio.md)**
...
**[Time Is All It Takes Spike-Retiming Attacks On Event-Driven Spiking Neural Netwo](human_understanding/time_is_all_it_takes_spike-retiming_attacks_on_event-driven_spiking_neural_netwo.md)**
...
**[Timeomni-1 Incentivizing Complex Reasoning With Time Series In Large Language Mo](human_understanding/timeomni-1_incentivizing_complex_reasoning_with_time_series_in_large_language_mo.md)**

:   TimeOmni-1 提出了首个统一的时间序列推理模型，通过 TSR-Suite（首个推理导向的时序数据集套件）和两阶段训练（SFT注入时序先验 + RL精炼推理），在多项时间序列推理任务上显著超越 GPT-4.1。

**[Toprovar Efficient Visual Autoregressive Modeling Via Tri-Dimensional Entropy-Aw](human_understanding/toprovar_efficient_visual_autoregressive_modeling_via_tri-dimensional_entropy-aw.md)**
...
**[Accessible Realistic And Fair Evaluation Of Positive-Unlabeled Learning Algorith](llm_evaluation/accessible_realistic_and_fair_evaluation_of_positive-unlabeled_learning_algorith.md)**

:   提出首个 PU 学习统一基准，系统解决两个关键问题：(1) 用代理准确率和代理 AUC 实现无负样本的模型选择；(2) 发现并通过将正样本并入无标签集的简单校准方法解决单样本设置下的内部标签偏移问题，使双样本算法在单样本评估中得到公平比较。

**[Anessuite A Comprehensive Benchmark And Dataset Suite For Anesthesiology Reasoni](llm_evaluation/anessuite_a_comprehensive_benchmark_and_dataset_suite_for_anesthesiology_reasoni.md)**
...
**[Astabench Benchmarking Ai Agents](llm_evaluation/astabench_benchmarking_ai_agents.md)**
...
**[Breaking The Correlation Plateau On The Optimization And Capacity Limits Of Atte](llm_evaluation/breaking_the_correlation_plateau_on_the_optimization_and_capacity_limits_of_atte.md)**
...
**[Counselbench Llm Mental Health Qa](llm_evaluation/counselbench_llm_mental_health_qa.md)**
...
**[Disentangling Shared And Private Neural Dynamics With Spire A Latent Modeling Fr](llm_evaluation/disentangling_shared_and_private_neural_dynamics_with_spire_a_latent_modeling_fr.md)**
...
**[Mitigating Spurious Correlation Via Distributionally Robust Learning With Hierar](llm_evaluation/mitigating_spurious_correlation_via_distributionally_robust_learning_with_hierar.md)**
...
**[Noise-Aware Generalization Robustness To In-Domain Noise And Out-Of-Domain Gener](llm_evaluation/noise-aware_generalization_robustness_to_in-domain_noise_and_out-of-domain_gener.md)**
...
**[Predicting Llm Reasoning Performance With Small Proxy Models](llm_evaluation/predicting_llm_reasoning_performance_with_small_proxy_models.md)**
...
**[Same Content Different Representations A Controlled Study For T](llm_evaluation/same_content_different_representations_a_controlled_study_for_t.md)**

:   首个控制变量研究：在保持表格内容完全相同的条件下变换表示形式（结构化 vs 半结构化），系统评估 NL2SQL、LLM、混合三类方法在不同表格大小/模式质量/查询复杂度下的鲁棒性，发现表示形式是影响 Table QA 性能的一阶因素。

**[Simpletom Exposing The Gap Between Explicit Tom Inference And Implicit Tom Appli](llm_evaluation/simpletom_exposing_the_gap_between_explicit_tom_inference_and_implicit_tom_appli.md)**
...
**[Truthfulness Despite Weak Supervision Evaluating And Training Llms Using Peer Pr](llm_evaluation/truthfulness_despite_weak_supervision_evaluating_and_training_llms_using_peer_pr.md)**

:   提出将博弈论中的 Peer Prediction 机制应用于 LLM 评估和训练，通过衡量参与者答案的互预测性来区分诚实与欺骗回答，无需真值标签即可实现诚实性激励，展现出惊人的"逆向缩放"特性——专家越弱反而越能抵抗强模型的欺骗。

**[Uis-Digger Towards Comprehensive Research Agent Systems For Real-World Unindexed](llm_evaluation/uis-digger_towards_comprehensive_research_agent_systems_for_real-world_unindexed.md)**
...
**[Unpacking Human Preference For Llms Demographically Aware Evaluation Of Long-Fo](llm_evaluation/unpacking_human_preference_for_llms_demographically_aware_evaluation_of_long-fo.md)**
...
**[Unpacking Human Preference For Llms Demographically Aware Evaluation With The Hu](llm_evaluation/unpacking_human_preference_for_llms_demographically_aware_evaluation_with_the_hu.md)**
...
**[When And Where To Reset Matters For Long-Term Test-Time Adaptation](llm_evaluation/when_and_where_to_reset_matters_for_long-term_test-time_adaptation.md)**
...
**[When Priors Backfire On The Vulnerability Of Unlearnable Examples To Data Augmen](llm_evaluation/when_priors_backfire_on_the_vulnerability_of_unlearnable_examples_to_data_augmen.md)**
...
**[When To Ensemble Identifying Token-Level Points For Stable And Fast Llm Ensembli](llm_evaluation/when_to_ensemble_identifying_token-level_points_for_stable_and_fast_llm_ensembli.md)**
...
**[Audiotrust Benchmarking The Multifaceted Trustworthiness Of Audio Large Language](ai_safety/audiotrust_benchmarking_the_multifaceted_trustworthiness_of_audio_large_language.md)**
...
**[Back To Square Roots An Optimal Bound On The Matrix Factorization Error For Mult](ai_safety/back_to_square_roots_an_optimal_bound_on_the_matrix_factorization_error_for_mult.md)**

:   提出 Banded Inverse Square Root (BISR) 矩阵分解方法，通过对逆相关矩阵（而非相关矩阵本身）施加带状结构，首次在多轮参与差分隐私 SGD 中实现渐近最优的分解误差界，并配套低存储优化变体 BandInvMF。

**[Beat Visual Backdoor Attacks On Vlm-Based Embodied Agents Via Contrastive Trigge](ai_safety/beat_visual_backdoor_attacks_on_vlm-based_embodied_agents_via_contrastive_trigge.md)**
...
**[Beware Untrusted Simulators -- Reward-Free Backdoor Attacks In Reinforcement Lea](ai_safety/beware_untrusted_simulators_--_reward-free_backdoor_attacks_in_reinforcement_lea.md)**
...
**[Biasbusters Uncovering And Mitigating Tool Selection Bias In Large Language Mode](ai_safety/biasbusters_uncovering_and_mitigating_tool_selection_bias_in_large_language_mode.md)**
...
**[Bridging Fairness And Explainability Can Input-Based Explanations Promote Fairne](ai_safety/bridging_fairness_and_explainability_can_input-based_explanations_promote_fairne.md)**
...
**[Dataless Weight Disentanglement In Task Arithmetic Via Kronecker-Factored Approx](ai_safety/dataless_weight_disentanglement_in_task_arithmetic_via_kronecker-factored_approx.md)**

:   提出 TAK 方法，将任务算术中的表征漂移正则化等价为 Jacobian Gram 矩阵的二次型，利用 KFAC 近似实现无需外部任务数据的高效权重解纠缠，在任务加法和任务否定上达到 SOTA。

**[Efficient Resource-Constrained Training Of Transformers Via Subspace Optimizatio](ai_safety/efficient_resource-constrained_training_of_transformers_via_subspace_optimizatio.md)**
...
**[Fair In Mind Fair In Action A Synchronous Benchmark For Understanding And Genera](ai_safety/fair_in_mind_fair_in_action_a_synchronous_benchmark_for_understanding_and_genera.md)**
...
**[Faithful Bi-Directional Model Steering Via Distribution Matching And Distributed](ai_safety/faithful_bi-directional_model_steering_via_distribution_matching_and_distributed.md)**
...
**[From Static Benchmarks To Dynamic Protocol Agent-Centric Text Anomaly Detection ](ai_safety/from_static_benchmarks_to_dynamic_protocol_agent-centric_text_anomaly_detection_.md)**
...
**[Improving The Trade-Off Between Watermark Strength And Speculative Sampling Effi](ai_safety/improving_the_trade-off_between_watermark_strength_and_speculative_sampling_effi.md)**

:   将 LLM 水印强度从二值定义升级为连续量化（期望KL散度），完整刻画水印强度与speculative sampling效率的Pareto曲线，并提出伪随机接受机制使两者同时达到理论最大值。

**[Inoculation Prompting Eliciting Traits From Llms During Training Can Suppress Th](ai_safety/inoculation_prompting_eliciting_traits_from_llms_during_training_can_suppress_th.md)**
...
**[Measuring Physical-World Privacy Awareness Of Large Language Models An Evaluatio](ai_safety/measuring_physical-world_privacy_awareness_of_large_language_models_an_evaluatio.md)**
...
**[Membership Inference Attacks Against Fine-Tuned Diffusion Language Models](ai_safety/membership_inference_attacks_against_fine-tuned_diffusion_language_models.md)**
...
**[Pmark Towards Robust And Distortion-Free Semantic-Level Watermarking With Channe](ai_safety/pmark_towards_robust_and_distortion-free_semantic-level_watermarking_with_channe.md)**
...
**[Purifying Generative Llms From Backdoors Without Prior Knowledge Or Clean Refere](ai_safety/purifying_generative_llms_from_backdoors_without_prior_knowledge_or_clean_refere.md)**
...
**[Sample-Efficient Distributionally Robust Multi-Agent Reinforcement Learning Via ](ai_safety/sample-efficient_distributionally_robust_multi-agent_reinforcement_learning_via_.md)**

:   本文首次研究了分布鲁棒马尔可夫博弈（DRMGs）的在线学习问题，提出 MORNAVI 算法，在无需模拟器或离线数据的情况下，通过在线交互高效学习最优鲁棒策略，并提供了 TV 散度和 KL 散度不确定性集下的首个可证明遗憾界。

**[Secp-Tuning Efficient Privacy-Preserving Prompt Tuning For Large Language Mode](ai_safety/secp-tuning_efficient_privacy-preserving_prompt_tuning_for_large_language_mode.md)**

:   提出首个基于安全多方计算（MPC）的隐私保护提示调优框架 SecP-Tuning，通过前向调优消除反向传播开销、通过隐私保护随机特征注意力（RFA）替代 softmax 降低通信复杂度，实现约 12-16 倍加速和 17-20 倍通信量缩减。

**[Secp-Tuning Efficient Privacy-Preserving Prompt Tuning For Large Language Models](ai_safety/secp-tuning_efficient_privacy-preserving_prompt_tuning_for_large_language_models.md)**
...
**[She-Lora Selective Homomorphic Encryption For Federated Tuning With Heterogeneou](ai_safety/she-lora_selective_homomorphic_encryption_for_federated_tuning_with_heterogeneou.md)**
...
**[Shield Suppressing Hallucinations In Lvlm Encoders Via Bias And Vulnerability De](ai_safety/shield_suppressing_hallucinations_in_lvlm_encoders_via_bias_and_vulnerability_de.md)**
...
**[Skirting Additive Error Barriers For Private Turnstile Streaming](ai_safety/skirting_additive_error_barriers_for_private_turnstile_streaming.md)**
...
**[Tree-Based Dialogue Reinforced Policy Optimization For Red-Teaming Attacks](ai_safety/tree-based_dialogue_reinforced_policy_optimization_for_red-teaming_attacks.md)**
...
**[Unmasking Backdoors An Explainable Defense Via Gradient-Attention Anomaly Scorin](ai_safety/unmasking_backdoors_an_explainable_defense_via_gradient-attention_anomaly_scorin.md)**
...
**[Watermark-Based Attribution Of Ai-Generated Content](ai_safety/watermark-based_attribution_of_ai-generated_content.md)**
...
**[A Benchmark For Deep Information Synthesis](llm_agent/a_benchmark_for_deep_information_synthesis.md)**
...
**[Exploratory Memory-Augmented Llm Agent Via Hybrid On- And Off-Policy Optimizatio](llm_agent/exploratory_memory-augmented_llm_agent_via_hybrid_on-_and_off-policy_optimizatio.md)**
...
**[Hamlet A Hierarchical And Adaptive Multi-Agent Framework For Live Embodied Theat](llm_agent/hamlet_a_hierarchical_and_adaptive_multi-agent_framework_for_live_embodied_theat.md)**

:   提出 HAMLET 多智能体框架，将 AI 戏剧创作和在线表演解耦为离线规划和在线表演两阶段，通过叙事蓝图、感知与决策（PAD）模块和层级控制系统，实现了具有主动性、物理环境交互能力和即兴表演自由的 AI 戏剧体验。

**[Harnessing Uncertainty Entropy-Modulated Policy Gradients For Long-Horizon Llm A](llm_agent/harnessing_uncertainty_entropy-modulated_policy_gradients_for_long-horizon_llm_a.md)**
...
**[Livenewsbench Evaluating Llm Web Search Capabilities With Fresh News](llm_agent/livenewsbench_evaluating_llm_web_search_capabilities_with_fresh_news.md)**
...
**[M2-Miner Multi-Agent Enhanced Mcts For Mobile Gui Agent](llm_agent/m2-miner_multi-agent_enhanced_mcts_for_mobile_gui_agent.md)**
...
**[M2-Miner Multi-Agent Enhanced Mcts For Mobile Gui Agent Data Mining](llm_agent/m2-miner_multi-agent_enhanced_mcts_for_mobile_gui_agent_data_mining.md)**
...
**[Mc-Search Evaluating And Enhancing Multimodal Agentic Search](llm_agent/mc-search_evaluating_and_enhancing_multimodal_agentic_search.md)**

:   提出 MC-Search，首个面向代理式多模态 RAG 的基准，包含 3,333 个高质量样本、5 种推理拓扑结构和步级标注的推理链，同时引入过程级评估指标和 Search-Align 对齐框架显著提升开源 MLLM 的搜索规划能力。

**[Mc-Search Evaluating And Enhancing Multimodal Agentic Search With Structured Lon](llm_agent/mc-search_evaluating_and_enhancing_multimodal_agentic_search_with_structured_lon.md)**
...
**[Membership Privacy Risks Of Sharpness Aware Minimization](llm_agent/membership_privacy_risks_of_sharpness_aware_minimization.md)**
...
**[Openagentsafety A Comprehensive Framework For Evaluating Real-World Ai Agent Saf](llm_agent/openagentsafety_a_comprehensive_framework_for_evaluating_real-world_ai_agent_saf.md)**
...
**[Radiometrically Consistent Gaussian Surfels For Inverse Rendering](llm_agent/radiometrically_consistent_gaussian_surfels_for_inverse_rendering.md)**
...
**[Reducing Belief Deviation In Reinforcement Learning For Active Reasoning](llm_agent/reducing_belief_deviation_in_reinforcement_learning_for_active_reasoning.md)**
...
**[Remem Reasoning With Episodic Memory In Language Agent](llm_agent/remem_reasoning_with_episodic_memory_in_language_agent.md)**
...
**[Solving The Granularity Mismatch Hierarchical Preference Learning For Long-Horiz](llm_agent/solving_the_granularity_mismatch_hierarchical_preference_learning_for_long-horiz.md)**
...
**[St-Webagentbench A Benchmark For Evaluating Safety And Trustworthiness In Web Ag](llm_agent/st-webagentbench_a_benchmark_for_evaluating_safety_and_trustworthiness_in_web_ag.md)**
...
**[The Controllability Trap A Governance Framework For Military Ai Systems](llm_agent/the_controllability_trap_a_governance_framework_for_military_ai_systems.md)**

:   提出 Agentic Military AI Governance Framework (AMAGF)，一个围绕可测量的控制质量分数 (CQS) 构建的军事 AI 代理治理框架，通过预防-检测-纠正三个支柱应对六类代理治理失败。

**[The Tool Decathlon Benchmarking Language Agents For Diverse Realistic And Long-H](llm_agent/the_tool_decathlon_benchmarking_language_agents_for_diverse_realistic_and_long-h.md)**
...
**[Tooltree Efficient Llm Agent Tool Planning Via Dual-Feedback Monte Carlo Tree Se](llm_agent/tooltree_efficient_llm_agent_tool_planning_via_dual-feedback_monte_carlo_tree_se.md)**

:   提出 ToolTree，一种基于 MCTS 的 LLM Agent 工具规划框架，通过执行前/后双阶段评估和双向剪枝机制，在固定计算预算下实现前瞻性工具选择，在 4 个 benchmark 上平均提升约 10%。

**[Toolweaver Weaving Collaborative Semantics For Scalable Tool Use In Large Langua](llm_agent/toolweaver_weaving_collaborative_semantics_for_scalable_tool_use_in_large_langua.md)**
...
**[Toward A Dynamic Stackelberg Game-Theoretic Framework For Agentic Ai Defense Aga](llm_agent/toward_a_dynamic_stackelberg_game-theoretic_framework_for_agentic_ai_defense_aga.md)**
...
**[Zerodaybench Evaluating Llm Agents On Unseen Zero-Day Vulnerabilities For Cyberd](llm_agent/zerodaybench_evaluating_llm_agents_on_unseen_zero-day_vulnerabilities_for_cyberd.md)**
...
**[All-Day Multi-Scenes Lifelong Vision-And-Language Navigation With Tucker Adaptat](robotics/all-day_multi-scenes_lifelong_vision-and-language_navigation_with_tucker_adaptat.md)**
...
**[D2E Scaling Vision-Action Pretraining On Desktop Data For Transfer To Embodied A](robotics/d2e_scaling_vision-action_pretraining_on_desktop_data_for_transfer_to_embodied_a.md)**
...
**[Enhancing Instruction Following Of Llms Via Activation Steering With Dynamic Rej](robotics/enhancing_instruction_following_of_llms_via_activation_steering_with_dynamic_rej.md)**

:   提出 Directer（Dynamic Rejection Steering），通过在每个解码步动态调节 KV 缓存引导强度并引入合理性约束，显著提升 LLM 指令遵循能力，同时避免过度引导导致的文本质量下降。

**[Evaluating Vlms Spatial Reasoning Over Robot Motion A Step Towards Robot Plannin](robotics/evaluating_vlms_spatial_reasoning_over_robot_motion_a_step_towards_robot_plannin.md)**
...
**[From Spatial To Actions Grounding Vision-Language-Action Model In Spatial Founda](robotics/from_spatial_to_actions_grounding_vision-language-action_model_in_spatial_founda.md)**
...
**[Grounding Generative Planners In Verifiable Logic A Hybrid Architecture For Trus](robotics/grounding_generative_planners_in_verifiable_logic_a_hybrid_architecture_for_trus.md)**
...
**[Ignore All Previous Instructions Jailbreaking As A De-Escalatory Peace Building ](robotics/ignore_all_previous_instructions_jailbreaking_as_a_de-escalatory_peace_building_.md)**
...
**[Janusvln Decoupling Semantics And Spatiality With Dual Implicit Memory For Visio](robotics/janusvln_decoupling_semantics_and_spatiality_with_dual_implicit_memory_for_visio.md)**
...
**[Lets Think In Two Steps Mitigating Agreement Bias In Mllms With Self-Grounded Ve](robotics/lets_think_in_two_steps_mitigating_agreement_bias_in_mllms_with_self-grounded_ve.md)**
...
**[Memoryvla Perceptual-Cognitive Memory In Vision-Language-Action Models For Robot](robotics/memoryvla_perceptual-cognitive_memory_in_vision-language-action_models_for_robot.md)**
...
**[One Demo Is All It Takes Planning Domain Derivation With Llms From A Single Demo](robotics/one_demo_is_all_it_takes_planning_domain_derivation_with_llms_from_a_single_demo.md)**
...
**[Persona Dynamic And Compositional Inference-Time Personality Control Via Activat](robotics/persona_dynamic_and_compositional_inference-time_personality_control_via_activat.md)**
...
**[Rei-Bench Can Embodied Agents Understand Vague Human Instructions In Task Planni](robotics/rei-bench_can_embodied_agents_understand_vague_human_instructions_in_task_planni.md)**
...
**[Robocasa365 A Large-Scale Simulation Framework For Training And Benchmarking Gen](robotics/robocasa365_a_large-scale_simulation_framework_for_training_and_benchmarking_gen.md)**
...
**[Robointer A Holistic Intermediate Representation Suite Towards Robotic Manipulat](robotics/robointer_a_holistic_intermediate_representation_suite_towards_robotic_manipulat.md)**
...
**[Robopara Dual-Arm Robot Planning With Parallel Allocation And Recomposition Acro](robotics/robopara_dual-arm_robot_planning_with_parallel_allocation_and_recomposition_acro.md)**
...
**[String Seed Of Thought Prompting Llms For Distribution-Faithful And Diverse Gene](robotics/string_seed_of_thought_prompting_llms_for_distribution-faithful_and_diverse_gene.md)**
...
**[Synthworlds Controlled Parallel Worlds For Disentangling Reasoning And Knowledge](robotics/synthworlds_controlled_parallel_worlds_for_disentangling_reasoning_and_knowledge.md)**
...
**[Theory Of Space Can Foundation Models Construct Spatial Beliefs Through Active E](robotics/theory_of_space_can_foundation_models_construct_spatial_beliefs_through_active_e.md)**
...
**[Token Taxes Mitigating Agis Economic Risks](robotics/token_taxes_mitigating_agis_economic_risks.md)**
...
**[Twinvla Data-Efficient Bimanual Manipulation With Twin Single-Arm Vision-Languag](robotics/twinvla_data-efficient_bimanual_manipulation_with_twin_single-arm_vision-languag.md)**
...
**[Visual Planning Lets Think Only With Images](robotics/visual_planning_lets_think_only_with_images.md)**
...
**[Whats The Plan Metrics For Implicit Planning In Llms And Their Application To Rh](robotics/whats_the_plan_metrics_for_implicit_planning_in_llms_and_their_application_to_rh.md)**
...
**[Adaptive Rollout Allocation For Online Reinforcement Learning With Verifiable Re](optimization/adaptive_rollout_allocation_for_online_reinforcement_learning_with_verifiable_re.md)**
...
**[Cogflow Bridging Perception And Reasoning Through Knowledge Internalization For ](optimization/cogflow_bridging_perception_and_reasoning_through_knowledge_internalization_for_.md)**
...
**[Constraint Matters Multi-Modal Representation For Reducing Mixed-Integer Linear ](optimization/constraint_matters_multi-modal_representation_for_reducing_mixed-integer_linear_.md)**
...
**[Directional Convergence Benign Overfitting Of Gradient Descent In Leaky Relu Two](optimization/directional_convergence_benign_overfitting_of_gradient_descent_in_leaky_relu_two.md)**
...
**[Exploring Diverse Generation Paths Via Inference-Time Stiefel Activation Steerin](optimization/exploring_diverse_generation_paths_via_inference-time_stiefel_activation_steerin.md)**
...
**[Feddag Clustered Federated Learning Via Global Data And Gradient Integration For](optimization/feddag_clustered_federated_learning_via_global_data_and_gradient_integration_for.md)**

:   提出 FedDAG 聚类联邦学习框架，通过融合数据和梯度信息进行加权类别级相似度计算来实现更准确的客户端聚类，并通过双编码器架构实现跨集群特征迁移，在多种异构性设置下一致超越现有基线。

**[Frontierco Real-World And Large-Scale Evaluation Of Machine Learning Solvers For](optimization/frontierco_real-world_and_large-scale_evaluation_of_machine_learning_solvers_for.md)**
...
**[Minor First Major Last A Depth-Induced Implicit Bias Of Sharpness-Aware Minimiza](optimization/minor_first_major_last_a_depth-induced_implicit_bias_of_sharpness-aware_minimiza.md)**
...
**[Nabla-Reasoner Llm Reasoning Via Test-Time Gradient Descent In Latent Space](optimization/nabla-reasoner_llm_reasoning_via_test-time_gradient_descent_in_latent_space.md)**
...
**[Neural Networks Learn Generic Multi-Index Models Near Information-Theoretic Limi](optimization/neural_networks_learn_generic_multi-index_models_near_information-theoretic_limi.md)**
...
**[Pinet Optimizing Hard-Constrained Neural Networks With Orthogonal Projection Lay](optimization/pinet_optimizing_hard-constrained_neural_networks_with_orthogonal_projection_lay.md)**
...
**[Saddle-To-Saddle Dynamics Explains A Simplicity Bias Across Neural Network Archi](optimization/saddle-to-saddle_dynamics_explains_a_simplicity_bias_across_neural_network_archi.md)**

:   提出统一的理论框架，通过 saddle-to-saddle 学习动力学解释多种神经网络架构（全连接、卷积、注意力）中普遍存在的 simplicity bias——即梯度下降倾向于先学习简单解再逐步学习复杂解的现象。

**[Scaf-Grpo Scaffolded Group Relative Policy Optimization For Enhancing Llm Reason](optimization/scaf-grpo_scaffolded_group_relative_policy_optimization_for_enhancing_llm_reason.md)**
...
**[Align Once Benefit Multilingually Enforcing Multilingual Consistency For Llm Saf](llm_alignment/align_once_benefit_multilingually_enforcing_multilingual_consistency_for_llm_saf.md)**
...
**[Alignment Through Meta-Weighted Online Sampling Bridging The Gap Between Data Ge](llm_alignment/alignment_through_meta-weighted_online_sampling_bridging_the_gap_between_data_ge.md)**
...
**[Beyond Rlhf And Nlhf Population-Proportional Alignment Under An Axiomatic Framew](llm_alignment/beyond_rlhf_and_nlhf_population-proportional_alignment_under_an_axiomatic_framew.md)**
...
**[Chasing The Tail Effective Rubric-Based Reward Modeling For Large Language Model](llm_alignment/chasing_the_tail_effective_rubric-based_reward_modeling_for_large_language_model.md)**
...
**[From Utterance To Vividity Training Expressive Subtitle Translation Llm Via Adap](llm_alignment/from_utterance_to_vividity_training_expressive_subtitle_translation_llm_via_adap.md)**
...
**[Group-Relative Reinforce Is Secretly An Off-Policy Algorithm Demystifying Some M](llm_alignment/group-relative_reinforce_is_secretly_an_off-policy_algorithm_demystifying_some_m.md)**
...
**[Is On-Policy Data Always The Best Choice For Direct Preference Optimization-Base](llm_alignment/is_on-policy_data_always_the_best_choice_for_direct_preference_optimization-base.md)**
...
**[Jailnewsbench Multi-Lingual And Regional Benchmark For Fake News Generation Unde](llm_alignment/jailnewsbench_multi-lingual_and_regional_benchmark_for_fake_news_generation_unde.md)**

:   提出首个评估 LLM 在越狱攻击下生成假新闻鲁棒性的多语言多区域基准 JailNewsBench，覆盖 34 个地区和 22 种语言、约 30 万实例，揭示最高 86.3% 的攻击成功率以及英语/美国话题防御显著弱于其他地区的安全不平衡现象。

**[Learning More With Less A Dynamic Dual-Level Down-Sampling Framework For Efficie](llm_alignment/learning_more_with_less_a_dynamic_dual-level_down-sampling_framework_for_efficie.md)**
...
**[Learning Ordinal Probabilistic Reward From Preferences](llm_alignment/learning_ordinal_probabilistic_reward_from_preferences.md)**
...
**[Mitigating The Safety Alignment Tax With Null-Space Constrained Policy Optimizat](llm_alignment/mitigating_the_safety_alignment_tax_with_null-space_constrained_policy_optimizat.md)**

:   提出 NSPO，将安全对齐的策略梯度投影到通用任务表征的零空间中，从几何层面保证安全优化不损害通用能力，仅用 40% 安全数据即在 7 个安全 benchmark 上达到 SOTA，同时在数学/代码/指令遵循上几乎无性能损失。

**[No Prompt Left Behind Exploiting Zero-Variance Prompts In Llm Reinforcement Lear](llm_alignment/no_prompt_left_behind_exploiting_zero-variance_prompts_in_llm_reinforcement_lear.md)**
...
**[Reinforcement Unlearning Via Group Relative Policy Optimization](llm_alignment/reinforcement_unlearning_via_group_relative_policy_optimization.md)**
...
**[Safedpo Preference Optimization Safety](llm_alignment/safedpo_preference_optimization_safety.md)**
...
**[Semantic-Aware Wasserstein Policy Regularization For Large Language Model Alignm](llm_alignment/semantic-aware_wasserstein_policy_regularization_for_large_language_model_alignm.md)**
...
**[Swap-Guided Preference Learning For Personalized Reinforcement Learning From Hum](llm_alignment/swap-guided_preference_learning_for_personalized_reinforcement_learning_from_hum.md)**
...
**[Token-Importance Guided Direct Preference Optimization](llm_alignment/token-importance_guided_direct_preference_optimization.md)**

:   提出TI-DPO，通过梯度归因+高斯先验的混合权重机制精确量化每个token对偏好的贡献，结合三元组损失在连续语义空间引导优化，在6个基准上平均62.3分达到SOTA，同时具备可解释的token级控制能力。

**[Toward Universal And Transferable Jailbreak Attacks On Vision-Language Models](llm_alignment/toward_universal_and_transferable_jailbreak_attacks_on_vision-language_models.md)**
...
**[Towards Understanding Valuable Preference Data For Large Language Model Alignmen](llm_alignment/towards_understanding_valuable_preference_data_for_large_language_model_alignmen.md)**
...
**[Unifying Stable Optimization And Reference Regularization In Rlhf](llm_alignment/unifying_stable_optimization_and_reference_regularization_in_rlhf.md)**
...
**[Why Dpo Is Misspecified Estimator](llm_alignment/why_dpo_is_misspecified_estimator.md)**
...
**[Compositional-Arc Assessing Systematic Generalization In Abstract Spatial Reason](llm_nlp/compositional-arc_assessing_systematic_generalization_in_abstract_spatial_reason.md)**
...
**[D2Cache Accelerating Diffusion-Based Llms Via Dual Adaptive Caching](llm_nlp/d2cache_accelerating_diffusion-based_llms_via_dual_adaptive_caching.md)**
...
**[Ellmob Event-Driven Human Mobility Generation With Self-Aligned Language Models](llm_nlp/ellmob_event-driven_human_mobility_generation_with_self-aligned_language_models.md)**
...
**[Enhancing Persona Following At Decoding Time Via Dynamic Importance-Guided Token](llm_nlp/enhancing_persona_following_at_decoding_time_via_dynamic_importance-guided_token.md)**

:   提出 Persona Dynamic Decoding (PDD) 框架，通过条件互信息动态估计人格属性的场景依赖重要性，并将重要性分数整合到多目标奖励引导解码中，实现无需微调的推理时人格跟随。

**[Enhancing Persona Following At Decoding Time Via Dynamic Importance Estimation ](llm_nlp/enhancing_persona_following_at_decoding_time_via_dynamic_importance_estimation_.md)**

:   提出 Persona Dynamic Decoding (PDD) 框架，通过条件互信息动态估计人格属性的场景相关重要性，并以加权多目标奖励引导解码，实现无需微调的推理时自适应人格跟随。

**[Enhancing Persona Following At Decoding Time Via Dynamic Importance Estimation F](llm_nlp/enhancing_persona_following_at_decoding_time_via_dynamic_importance_estimation_f.md)**

:   提出 PDD（Persona Dynamic Decoding）框架，通过条件互信息动态估计不同场景下人设属性的重要性，并以加权多目标奖励引导推理时解码，实现无需微调的自适应人设遵循。

**[Evaluating Text Creativity Across Diverse Domains A Dataset And Large Language M](llm_nlp/evaluating_text_creativity_across_diverse_domains_a_dataset_and_large_language_m.md)**
...
**[First Is Not Really Better Than Last Evaluating Layer Choice And Aggregation Str](llm_nlp/first_is_not_really_better_than_last_evaluating_layer_choice_and_aggregation_str.md)**
...
**[From Assumptions To Actions Turning Llm Reasoning Into Uncertainty-Aware Plannin](llm_nlp/from_assumptions_to_actions_turning_llm_reasoning_into_uncertainty-aware_plannin.md)**

:   提出 PCE（Planner-Composer-Evaluator）框架，将 LLM 推理链中隐含的环境假设显式提取并组织为决策树，通过似然度-增益-成本评分实现不确定性感知的行动选择，大幅减少多智能体协作中的通信开销。

**[Function Induction And Task Generalization An Interpretability Study With Off-By](llm_nlp/function_induction_and_task_generalization_an_interpretability_study_with_off-by.md)**
...
**[Llema Evolutionary Search With Llms For Multi-Objective Material Design](llm_nlp/llema_evolutionary_search_with_llms_for_multi-objective_material_design.md)**
...
**[Quamo Quaternion Motions For Vision-Based 3D Human Kinematics Capture](llm_nlp/quamo_quaternion_motions_for_vision-based_3d_human_kinematics_capture.md)**
...
**[Statistical Advantage Of Softmax Attention Insights From Single-Location Regress](llm_nlp/statistical_advantage_of_softmax_attention_insights_from_single-location_regress.md)**
...
**[The Path Of Least Resistance Guiding Llm Reasoning Trajectories For Efficient Co](llm_nlp/the_path_of_least_resistance_guiding_llm_reasoning_trajectories_for_efficient_co.md)**
...
**[Webdevjudge Mllm Web Development](llm_nlp/webdevjudge_mllm_web_development.md)**

:   构建 WebDevJudge 元评估基准，系统评估 LLM/MLLM 及智能体工作流在 Web 开发质量评估任务上作为裁判的能力，发现当前最强模型与人类专家之间仍存在约15%的一致率差距，并揭示了功能等价识别失败和可行性验证薄弱两大根本瓶颈。

**[Weight Decay May Matter More Than Mup For Learning Rate Transfer In Practice](llm_nlp/weight_decay_may_matter_more_than_mup_for_learning_rate_transfer_in_practice.md)**

:   本文通过大规模实证分析表明，μP 的核心对齐假设仅在训练初期短暂成立，实际训练中是独立权重衰减（independent weight decay）而非 μP 在正确稳定跨宽度的特征学习动态，μP 的实际益处可被解释为一种隐式学习率预热。

**[When Stability Fails Hidden Failure Modes Of Llms In Data-Constrained Scientific](llm_nlp/when_stability_fails_hidden_failure_modes_of_llms_in_data-constrained_scientific.md)**

:   通过控制性行为评估框架，揭示 LLM 在数据约束的科学决策任务中的四种隐藏失败模式：高稳定性≠正确性、prompt 措辞敏感性、放宽阈值下的过度选择、以及幻觉产生无效标识符。

**[When Stability Fails Hidden Failure Modes Of Llms In Data-Critical Statistical ](llm_nlp/when_stability_fails_hidden_failure_modes_of_llms_in_data-critical_statistical_.md)**
...
**[Adaem An Adaptively And Automated Extensible Measurement Of Llms Value Differenc](video_understanding/adaem_an_adaptively_and_automated_extensible_measurement_of_llms_value_differenc.md)**

:   提出 AdAEM，一个自适应、自扩展的 LLM 价值观评估框架，通过信息论优化自动生成能最大化揭示不同 LLM 价值差异的测试问题，解决现有静态基准无法区分模型价值取向的"信息量不足"问题。

**[Air Enabling Adaptive Iterative And Reasoning-Based Frame Selection For Video Qu](video_understanding/air_enabling_adaptive_iterative_and_reasoning-based_frame_selection_for_video_qu.md)**
...
**[Anveshanaai A Multimodal Platform For Adaptive Aiml Education Through Automated ](video_understanding/anveshanaai_a_multimodal_platform_for_adaptive_aiml_education_through_automated_.md)**
...
**[Emergence Of Superposition Unveiling The Training Dynamics Of Chain Of Continuou](video_understanding/emergence_of_superposition_unveiling_the_training_dynamics_of_chain_of_continuou.md)**
...
**[Flashvid Efficient Video Large Language Models Via Training-Free Tree-Based Spat](video_understanding/flashvid_efficient_video_large_language_models_via_training-free_tree-based_spat.md)**
...
**[Floc Facility Location-Based Efficient Visual Token Compression For Long Video U](video_understanding/floc_facility_location-based_efficient_visual_token_compression_for_long_video_u.md)**
...
**[From Vicious To Virtuous Cycles Synergistic Representation Learning For Unsuperv](video_understanding/from_vicious_to_virtuous_cycles_synergistic_representation_learning_for_unsuperv.md)**
...
**[Javisdit Joint Audio-Video Diffusion Transformer With Hierarchical Spatio-Tempor](video_understanding/javisdit_joint_audio-video_diffusion_transformer_with_hierarchical_spatio-tempor.md)**
...
**[Lets Split Up Zero-Shot Classifier Edits For Fine-Grained Video Understanding](video_understanding/lets_split_up_zero-shot_classifier_edits_for_fine-grained_video_understanding.md)**
...
**[Lumos-1 On Autoregressive Video Generation With Discrete Diffusion From A Unifie](video_understanding/lumos-1_on_autoregressive_video_generation_with_discrete_diffusion_from_a_unifie.md)**
...
**[Precisecache Precise Feature Caching For Efficient And High-Fidelity Video Gener](video_understanding/precisecache_precise_feature_caching_for_efficient_and_high-fidelity_video_gener.md)**
...
**[Quantsparse Comprehensively Compressing Video Diffusion Transformer With Model Q](video_understanding/quantsparse_comprehensively_compressing_video_diffusion_transformer_with_model_q.md)**
...
**[Stabilizing Policy Gradients For Sample-Efficient Reinforcement Learning In Llm ](video_understanding/stabilizing_policy_gradients_for_sample-efficient_reinforcement_learning_in_llm_.md)**
...
**[Towards Reliable Benchmarking A Contamination Free Controllable Evaluation Frame](video_understanding/towards_reliable_benchmarking_a_contamination_free_controllable_evaluation_frame.md)**
...
**[Video-Ktr Reinforcing Video Reasoning Via Key Token Attribution](video_understanding/video-ktr_reinforcing_video_reasoning_via_key_token_attribution.md)**
...
**[Watermark Robustness And Radioactivity May Be At Odds In Federated Learning](video_understanding/watermark_robustness_and_radioactivity_may_be_at_odds_in_federated_learning.md)**
...
**[Adapt Data To Model Adaptive Transformation Optimization For Domain-Shared Time ](time_series/adapt_data_to_model_adaptive_transformation_optimization_for_domain-shared_time_.md)**
...
**[Cpiri Channel Permutation-Invariant Relational Interaction For Multivariate Time](time_series/cpiri_channel_permutation-invariant_relational_interaction_for_multivariate_time.md)**

:   提出 CPiRi 框架，通过冻结的预训练时序编码器 + 轻量空间 Transformer + 通道打乱训练策略，实现通道排列不变 (CPI) 的跨通道关系建模，在 5 个基准上达到 SOTA 且通道打乱后性能几乎无损 ($\Delta$WAPE < 0.25%)。

**[Cpiri Channel Permutation-Invariant Relational Interaction For Multivariate Time Se](time_series/cpiri_channel_permutation-invariant_relational_interaction_for_multivariate_time_se.md)**

:   提出 CPiRi 框架，通过冻结预训练时序编码器 + 可训练置换等变空间模块 + 通道打乱训练策略，在不牺牲跨通道建模能力的前提下实现通道排序不变性（CPI），在多个交通基准上达到 SOTA。

**[Delta-Xai A Unified Framework For Explaining Prediction Changes In Online Time S](time_series/delta-xai_a_unified_framework_for_explaining_prediction_changes_in_online_time_s.md)**
...
**[Edinet-Bench Evaluating Llms On Complex Financial Tasks Using Japanese Financial](time_series/edinet-bench_evaluating_llms_on_complex_financial_tasks_using_japanese_financial.md)**
...
**[Gtm A General Time-Series Model For Enhanced Representation Learning Of Time-Ser](time_series/gtm_a_general_time-series_model_for_enhanced_representation_learning_of_time-ser.md)**

:   提出 GTM，一个通过频域注意力机制捕获时间粒度感知特征的通用时序基础模型，结合混合掩码预训练策略，首次实现无需任务特定修改即可适配所有生成式时序任务。

**[Gtm A General Time-Series Model For Enhanced Representation Learning Of Time-Series](time_series/gtm_a_general_time-series_model_for_enhanced_representation_learning_of_time-series.md)**
...
**[Language In The Flow Of Time Time-Series-Paired Texts Weaved Into A Unified Temp](time_series/language_in_the_flow_of_time_time-series-paired_texts_weaved_into_a_unified_temp.md)**

:   发现时间序列配对文本具有与时间序列相似的周期性（Chronological Textual Resonance），提出 TaTS 框架将文本表征转化为辅助变量，以即插即用方式增强任意现有时间序列模型的预测和插补性能。

**[Learning Recursive Multi-Scale Representations For Irregular Multivariate Time S](time_series/learning_recursive_multi-scale_representations_for_irregular_multivariate_time_s.md)**
...
**[Routing Channel-Patch Dependencies In Time Series Forecasting With Graph Spectra](time_series/routing_channel-patch_dependencies_in_time_series_forecasting_with_graph_spectra.md)**
...
**[Swiftts A Swift Selection Framework For Time Series Pre-Trained Models Via Multi](time_series/swiftts_a_swift_selection_framework_for_time_series_pre-trained_models_via_multi.md)**
...
**[Timesliver Symbolic-Linear Decomposition For Explainable Time Series Classificat](time_series/timesliver_symbolic-linear_decomposition_for_explainable_time_series_classificat.md)**
...
**[Towards Generalizable Pde Dynamics Forecasting Via Physics-Guided Invariant Lear](time_series/towards_generalizable_pde_dynamics_forecasting_via_physics-guided_invariant_lear.md)**
...
**[Towards Robust Real-World Multivariate Time Series Forecasting A Unified Framewo](time_series/towards_robust_real-world_multivariate_time_series_forecasting_a_unified_framewo.md)**
...
**[Tspulse Tiny Pre-Trained Models With Disentangled Representations For Rapid Time](time_series/tspulse_tiny_pre-trained_models_with_disentangled_representations_for_rapid_time.md)**

:   提出 TSPulse，仅 1M 参数的超轻量时间序列预训练模型，通过双空间掩码重建和双嵌入解耦策略，在分类（+5-16%）、异常检测（+20%）、插补（+50%）和相似性检索（+25%）四大任务上超越 10-100 倍大的模型。

**[Tuning The Burn-In Phase In Training Recurrent Neural Networks Improves Their Pe](time_series/tuning_the_burn-in_phase_in_training_recurrent_neural_networks_improves_their_pe.md)**

:   从理论上证明了 RNN 训练中 burn-in 阶段长度 $m$ 对截断反向传播时间（TBPTT）训练性能的关键影响，建立了训练遗憾的上界估计，并通过系统辨识和时间序列预测实验验证，合理调节 burn-in 可将预测误差降低超过 60%。

**[Unlocking The Value Of Text Event-Driven Reasoning And Multi-Level Alignment For](time_series/unlocking_the_value_of_text_event-driven_reasoning_and_multi-level_alignment_for.md)**

:   提出 VoT，一种通过事件驱动推理（利用 LLM 对外生文本进行结构化推理获取数值预测）和多层对齐（表征级内生文本对齐 + 预测级自适应频率融合）充分挖掘文本信息价值的多模态时间序列预测方法，在 10 个领域的真实数据集上全面超越现有方法。

**[Weight-Space Linear Recurrent Neural Networks](time_series/weight-space_linear_recurrent_neural_networks.md)**
...
**[Breaking Scale Anchoring Frequency Representation Learning For Accurate High-Res](object_detection/breaking_scale_anchoring_frequency_representation_learning_for_accurate_high-res.md)**
...
**[Context Tokens Are Anchors Understanding The Repetition Curse In Dmllms From An ](object_detection/context_tokens_are_anchors_understanding_the_repetition_curse_in_dmllms_from_an_.md)**
...
**[From Narrow To Panoramic Vision Attention-Guided Cold-Start Reshapes Multimodal ](object_detection/from_narrow_to_panoramic_vision_attention-guided_cold-start_reshapes_multimodal_.md)**

:   发现多模态 LLM 的推理性能与视觉注意力分数（VAS）高度相关（r=0.96），提出 AVAR 框架通过视觉锚定数据合成、注意力引导训练目标和视觉锚定奖励塑造三个阶段提升 VAS，在 77 个基准上平均提升 7%。

**[Fsod-Vfm Few-Shot Object Detection With Vision Foundation Models And Graph Diffu](object_detection/fsod-vfm_few-shot_object_detection_with_vision_foundation_models_and_graph_diffu.md)**
...
**[Is Your Paper Being Reviewed By An Llm Benchmarking Ai Text Detection In Peer Re](object_detection/is_your_paper_being_reviewed_by_an_llm_benchmarking_ai_text_detection_in_peer_re.md)**
...
**[Sage Spatial-Visual Adaptive Graph Exploration For Efficient Visual Place Recogn](object_detection/sage_spatial-visual_adaptive_graph_exploration_for_efficient_visual_place_recogn.md)**
...
**[Serum Simple Efficient Robust And Unifying Marking For Diffusion-Based Image Gen](object_detection/serum_simple_efficient_robust_and_unifying_marking_for_diffusion-based_image_gen.md)**

:   提出SERUM水印方法，将唯一水印噪声添加到扩散模型初始噪声中，训练轻量检测器直接从生成图像识别水印（无需昂贵的DDIM反演），在多种攻击下达到最高检测率，且注入/检测极快，支持多用户场景。

**[Spectralgcd Spectral Concept Selection And Cross-Modal Representation Learni](object_detection/spectralgcd_spectral_concept_selection_and_cross-modal_representation_learni.md)**

:   提出 SpectralGCD，通过将图像表示为 CLIP 跨模态图像-文本相似度向量（语义概念混合），并用谱滤波自动筛选任务相关概念 + 正反向知识蒸馏保持语义质量，在六个基准上以接近单模态方法的训练开销取得多模态 GCD 新 SOTA。

**[Spectralgcd Spectral Concept Selection And Cross-Modal Representation Learning F](object_detection/spectralgcd_spectral_concept_selection_and_cross-modal_representation_learning_f.md)**
...
**[Vidguard-R1 Ai-Generated Video Detection And Explanation Via Reasoning Mllms And](object_detection/vidguard-r1_ai-generated_video_detection_and_explanation_via_reasoning_mllms_and.md)**
...
**[Vlbiman Vision-Language Anchored One-Shot Demonstration Enables Generalizable Bi](object_detection/vlbiman_vision-language_anchored_one-shot_demonstration_enables_generalizable_bi.md)**
...
**[When Agents Misremember Collectively Exploring The Mandela Effect In Llm-Based M](object_detection/when_agents_misremember_collectively_exploring_the_mandela_effect_in_llm-based_m.md)**
...
**[Zero-Shot Hoi Detection With Mllm-Based Detector-Agnostic Interaction Recognitio](object_detection/zero-shot_hoi_detection_with_mllm-based_detector-agnostic_interaction_recognitio.md)**
...
**[Bayesian Attention Mechanism A Probabilistic Framework For Positional Encoding A](information_retrieval/bayesian_attention_mechanism_a_probabilistic_framework_for_positional_encoding_a.md)**

:   将位置编码重新表述为贝叶斯注意力机制中的先验分布，统一了 NoPE（均匀先验）和 ALiBi（拉普拉斯先验），并提出广义高斯先验（GGD-BAM），仅增加 384 个参数即可在 500 倍训练长度上实现完美的 passkey 检索。

**[Beyond Rag Vs Long-Context Learning Distraction-Aware Retrieval For Efficient Kn](information_retrieval/beyond_rag_vs_long-context_learning_distraction-aware_retrieval_for_efficient_kn.md)**
...
**[Btzsc A Benchmark For Zero-Shot Text Classification Across Cross-Encoders Embedd](information_retrieval/btzsc_a_benchmark_for_zero-shot_text_classification_across_cross-encoders_embedd.md)**
...
**[Efficient Discriminative Joint Encoders For Large Scale Vision-Language Rerankin](information_retrieval/efficient_discriminative_joint_encoders_for_large_scale_vision-language_rerankin.md)**
...
**[Flow Of Spans Generalizing Language Models To Dynamic Span-Vocabulary Via Gflown](information_retrieval/flow_of_spans_generalizing_language_models_to_dynamic_span-vocabulary_via_gflown.md)**

:   提出 FoSS，首次将 GFlowNets 引入 span 级别语言模型，通过构建 DAG 结构的状态空间代替传统 token-by-token 的树形结构，实现更灵活多样的文本生成，MAUVE 分数最高提升 12.5%。

**[Futuremind Equipping Small Language Models With Strategic Thinking-Pattern Prior](information_retrieval/futuremind_equipping_small_language_models_with_strategic_thinking-pattern_prior.md)**

:   提出FutureMind无训练框架，将LLM的结构化推理和检索策略蒸馏为可复用的思维模式先验，通过四阶段pipeline（问题分析→逻辑推理→策略规划→检索指导）和三种检索范式，使SLM在多跳QA上达到SOTA。

**[G-Reasoner Foundation Models For Unified Reasoning Over Graph-Structured Knowled](information_retrieval/g-reasoner_foundation_models_for_unified_reasoning_over_graph-structured_knowled.md)**
...
**[Judges Verdict A Comprehensive Analysis Of Llm Judge Capability Through Human Ag](information_retrieval/judges_verdict_a_comprehensive_analysis_of_llm_judge_capability_through_human_ag.md)**
...
**[Lightretriever A Llm-Based Text Retrieval Architecture With Extremely Faster Que](information_retrieval/lightretriever_a_llm-based_text_retrieval_architecture_with_extremely_faster_que.md)**
...
**[On The Wings Of Imagination Conflicting Script-Based Multi-Role Framework For Hu](information_retrieval/on_the_wings_of_imagination_conflicting_script-based_multi-role_framework_for_hu.md)**
...
**[Ravenea A Benchmark For Multimodal Retrieval-Augmented Visual Culture Understand](information_retrieval/ravenea_a_benchmark_for_multimodal_retrieval-augmented_visual_culture_understand.md)**
...
**[Retrieval-Augmented Generation For Predicting Cellular Responses To Gene Perturb](information_retrieval/retrieval-augmented_generation_for_predicting_cellular_responses_to_gene_perturb.md)**
...
**[Dynamic Parameter Memory Temporary Lora-Enhanced Llm For Long-Sequence Emotion R](audio_speech/dynamic_parameter_memory_temporary_lora-enhanced_llm_for_long-sequence_emotion_r.md)**
...
**[Echomind An Interrelated Multi-Level Benchmark For Evaluating Empathetic Speech ](audio_speech/echomind_an_interrelated_multi-level_benchmark_for_evaluating_empathetic_speech_.md)**

:   提出 EchoMind，首个面向共情对话的多层级关联基准，通过理解→推理→对话的认知流程，系统评估 Speech Language Models 感知非语言声学线索并生成共情回复的能力。

**[Efficient Audio-Visual Speech Separation With Discrete Lip Semantics And Multi-S](audio_speech/efficient_audio-visual_speech_separation_with_discrete_lip_semantics_and_multi-s.md)**
...
**[Emotionthinker Prosody-Aware Reinforcement Learning For Explainable Speech Emoti](audio_speech/emotionthinker_prosody-aware_reinforcement_learning_for_explainable_speech_emoti.md)**
...
**[Pay Attention To Ctc Fast And Robust Pseudo-Labelling For Unified Speech Recogni](audio_speech/pay_attention_to_ctc_fast_and_robust_pseudo-labelling_for_unified_speech_recogni.md)**
...
**[Query-Guided Spatial-Temporal-Frequency Interaction For Music Audio-Visual Quest](audio_speech/query-guided_spatial-temporal-frequency_interaction_for_music_audio-visual_quest.md)**
...
**[Redteamcua Adversarial Testing Agents](audio_speech/redteamcua_adversarial_testing_agents.md)**
...
**[Stitch Simultaneous Thinking And Talking With Chunked Reasoning For Spoken Langu](audio_speech/stitch_simultaneous_thinking_and_talking_with_chunked_reasoning_for_spoken_langu.md)**
...
**[Vowelprompt Hearing Speech Emotions From Text Via Vowel-Level Prosodic Augmentat](audio_speech/vowelprompt_hearing_speech_emotions_from_text_via_vowel-level_prosodic_augmentat.md)**
...
**[Did You Check The Right Pocket Cost-Sensitive Store Routing For Memory-Augmented](llm_efficiency/did_you_check_the_right_pocket_cost-sensitive_store_routing_for_memory-augmented.md)**
...
**[Evoengineer Mastering Automated Cuda Kernel Code Evolution With Large Language M](llm_efficiency/evoengineer_mastering_automated_cuda_kernel_code_evolution_with_large_language_m.md)**
...
**[Fast Catch-Up Late Switching Optimal Batch Size Scheduling Via Functional Scalin](llm_efficiency/fast_catch-up_late_switching_optimal_batch_size_scheduling_via_functional_scalin.md)**
...
**[Lycheedecode Accelerating Long-Context Llm Inference Via Hybrid-Head Sparse Deco](llm_efficiency/lycheedecode_accelerating_long-context_llm_inference_via_hybrid-head_sparse_deco.md)**
...
**[Lycheedecode Accelerating Long-Context Llm Inference Via Hybrid Speculative Deco](llm_efficiency/lycheedecode_accelerating_long-context_llm_inference_via_hybrid_speculative_deco.md)**

:   提出 LycheeDecode，一种细粒度的混合头稀疏解码方法，通过将注意力头分为少量"检索头"和大量"稀疏头"，并用 HardKuma 分布进行可微头类型识别，在 128K 上下文下实现 2.7× 加速且性能持平甚至超越全注意力基线。

**[Mvar Visual Autoregressive Modeling With Scale And Spatial Markovian Conditionin](llm_efficiency/mvar_visual_autoregressive_modeling_with_scale_and_spatial_markovian_conditionin.md)**
...
**[One-Prompt Strikes Back Sparse Mixture Of Experts For Prompt-Based Continual Lea](llm_efficiency/one-prompt_strikes_back_sparse_mixture_of_experts_for_prompt-based_continual_lea.md)**
...
**[Q Rag Long Context Multi Step Retrieval](llm_efficiency/q_rag_long_context_multi_step_retrieval.md)**
...
**[Rethinking Benign Relearning Syntax As The Hidden Driver Of The Safety Tax](llm_efficiency/rethinking_benign_relearning_syntax_as_the_hidden_driver_of_the_safety_tax.md)**
...
**[Semantic Parallelism Redefining Efficient Moe Inference Via Model-Data Co-Schedu](llm_efficiency/semantic_parallelism_redefining_efficient_moe_inference_via_model-data_co-schedu.md)**
...
**[Swingarena Competitive Programming Arena For Long-Context Github Issue Solving](llm_efficiency/swingarena_competitive_programming_arena_for_long-context_github_issue_solving.md)**
...
**[Understanding And Improving Length Generalization In Hierarchical Sparse Attenti](llm_efficiency/understanding_and_improving_length_generalization_in_hierarchical_sparse_attenti.md)**
...
**[When Does Divide And Conquer Work For Long Context Llm A Noise Decomposition Fra](llm_efficiency/when_does_divide_and_conquer_work_for_long_context_llm_a_noise_decomposition_fra.md)**
...
**[Common Corpus Ethical Data For Llm Pretraining](llm_pretraining/common_corpus_ethical_data_for_llm_pretraining.md)**
...
**[Implicit Bias And Loss Of Plasticity In Matrix Completion Depth Promotes Low-Ran](llm_pretraining/implicit_bias_and_loss_of_plasticity_in_matrix_completion_depth_promotes_low-ran.md)**
...
**[Moma A Modular Deep Learning Framework For Material Property Prediction](llm_pretraining/moma_a_modular_deep_learning_framework_for_material_property_prediction.md)**

:   提出 MoMa 模块化材料属性预测框架，先在多任务上训练专用模块并集中存储为 MoMa Hub，再通过表示驱动的无训练自适应模块组合算法（AMC）为下游任务定制模型，在 17 个数据集上平均超越最强基线 14%。

**[Mt-Dao Multi-Timescale Distributed Adaptive Optimizers With Local Updates](llm_pretraining/mt-dao_multi-timescale_distributed_adaptive_optimizers_with_local_updates.md)**
...
**[Predicting Training Re-Evaluation Curves Enables Effective Data Curriculums For ](llm_pretraining/predicting_training_re-evaluation_curves_enables_effective_data_curriculums_for_.md)**
...
**[Semhitok A Unified Image Tokenizer Via Semantic-Guided Hierarchical Codebook For](llm_pretraining/semhitok_a_unified_image_tokenizer_via_semantic-guided_hierarchical_codebook_for.md)**
...
**[Taste Text-Aligned Speech Tokenization And Embedding For Spoken Language Modelin](llm_pretraining/taste_text-aligned_speech_tokenization_and_embedding_for_spoken_language_modelin.md)**
...
**[Understanding The Emergence Of Seemingly Useless Features In Deep Learning](llm_pretraining/understanding_the_emergence_of_seemingly_useless_features_in_deep_learning.md)**
...
**[Understanding The Emergence Of Seemingly Useless Features In Next-Token Predicto](llm_pretraining/understanding_the_emergence_of_seemingly_useless_features_in_next-token_predicto.md)**
...
**[Embodied Agents Meet Personalization Investigating Challenges And Solutions Thro](graph_learning/embodied_agents_meet_personalization_investigating_challenges_and_solutions_thro.md)**
...
**[Explore-On-Graph Incentivizing Autonomous Exploration Of Large Language Models O](graph_learning/explore-on-graph_incentivizing_autonomous_exploration_of_large_language_models_o.md)**

:   提出 Explore-on-Graph（EoG），通过 SFT + 两阶段强化学习（结果奖励 + 路径精炼奖励），激励 LLM 在知识图谱上自主探索超出训练分布的推理路径，在五个 KGQA 基准上超越 GPT-5 和 Gemini 2.5 Pro。

**[Graph Homophily Booster Reimagining The Role Of Discrete Features In Heterophili](graph_learning/graph_homophily_booster_reimagining_the_role_of_discrete_features_in_heterophili.md)**
...
**[Improving Long-Range Interactions In Graph Neural Simulators Via Hamiltonian Dyn](graph_learning/improving_long-range_interactions_in_graph_neural_simulators_via_hamiltonian_dyn.md)**
...
**[Neurocircuitry-Inspired Hierarchical Graph Causal Attention Networks For Explain](graph_learning/neurocircuitry-inspired_hierarchical_graph_causal_attention_networks_for_explain.md)**
...
**[Structurally Human Semantically Biased Detecting Llm-Generated References With E](graph_learning/structurally_human_semantically_biased_detecting_llm-generated_references_with_e.md)**
...
**[Ambig-Swe Interactive Agents To Overcome Underspecificity In Software Engineerin](code_intelligence/ambig-swe_interactive_agents_to_overcome_underspecificity_in_software_engineerin.md)**
...
**[Breaking The Sft Plateau Multimodal Structured Reinforcement Learning For Chart-](code_intelligence/breaking_the_sft_plateau_multimodal_structured_reinforcement_learning_for_chart-.md)**
...
**[Dro-Instructzero Distributionally Robust Prompt Optimization For Instruction Fol](code_intelligence/dro-instructzero_distributionally_robust_prompt_optimization_for_instruction_fol.md)**

:   将分布鲁棒优化（DRO）引入贝叶斯优化框架以实现零样本指令优化，使优化后的指令在分布偏移和对抗性评估条件下仍保持可靠性能。

**[Dro-Instructzero Distributionally Robust Prompt Optimization For Large Language ](code_intelligence/dro-instructzero_distributionally_robust_prompt_optimization_for_large_language_.md)**
...
**[Mathfimer Enhancing Mathematical Reasoning By Expanding Reasoning Steps Through ](code_intelligence/mathfimer_enhancing_mathematical_reasoning_by_expanding_reasoning_steps_through_.md)**
...
**[Supervised Reinforcement Learning From Expert Trajectories To Step-Wise Reasonin](code_intelligence/supervised_reinforcement_learning_from_expert_trajectories_to_step-wise_reasonin.md)**
...
**[Training Large Language Models To Reason In Parallel With Global Reflection](code_intelligence/training_large_language_models_to_reason_in_parallel_with_global_reflection.md)**
...
**[Agenttrace Causal Graph Tracing For Root Cause Analysis In Deployed Multi-Agent ](causal_inference/agenttrace_causal_graph_tracing_for_root_cause_analysis_in_deployed_multi-agent_.md)**
...
**[Distributional Equivalence In Linear Non-Gaussian Latent-Variable Cyclic Causal ](causal_inference/distributional_equivalence_in_linear_non-gaussian_latent-variable_cyclic_causal_.md)**
...
**[Flattery Fluff And Fog Diagnosing And Mitigating Idiosyncratic Biases In Prefere](causal_inference/flattery_fluff_and_fog_diagnosing_and_mitigating_idiosyncratic_biases_in_prefere.md)**

:   系统研究偏好模型对五种表面特征（冗长、结构化、术语、谄媚、模糊）的过度依赖——通过因果反事实对量化偏差来源于训练数据的分布不平衡，并提出基于**反事实数据增强 (CDA)** 的后训练方法，将模型与人类判断的平均失校准率从 39.4% 降至 32.5%。

**[Function Induction And Task Generalization An Interpretability Study With Off-By](causal_inference/function_induction_and_task_generalization_an_interpretability_study_with_off-by.md)**

:   通过 off-by-one addition（如 1+1=3, 2+2=5）这一反事实任务，利用 path patching 发现大语言模型内部存在 **function induction** 机制——一种超越 token 级别 pattern matching、在函数级别进行归纳推理的注意力头电路，并证明该机制可跨任务复用。

**[Journey To The Centre Of Cluster Harnessing Interior Nodes For Ab Testing Under ](causal_inference/journey_to_the_centre_of_cluster_harnessing_interior_nodes_for_ab_testing_under_.md)**
...
**[Synthesising Counterfactual Explanations Via Label-Conditional Gaussian Mixture ](causal_inference/synthesising_counterfactual_explanations_via_label-conditional_gaussian_mixture_.md)**

:   提出 L-GMVAE（标签条件高斯混合 VAE）和 LAPACE 算法，通过在潜空间中学习每个类别的多个高斯聚类中心，然后从输入潜表征到目标类别中心进行线性插值，生成路径式反事实解释，同时保证有效性、似合性、多样性和对输入扰动的完美鲁棒性。

**[Validating Interpretability In Sirna Efficacy Prediction A Perturbation-Based Da](causal_inference/validating_interpretability_in_sirna_efficacy_prediction_a_perturbation-based_da.md)**
...
**[Adaptive Augmentation-Aware Latent Learning For Robust Lidar Semantic Segmentati](autonomous_driving/adaptive_augmentation-aware_latent_learning_for_robust_lidar_semantic_segmentati.md)**

:   提出 A3Point 框架，通过语义混淆先验（SCP）隐式学习和语义偏移区域（SSR）定位两个核心组件，自适应地利用不同强度的数据增强来提升 LiDAR 语义分割在恶劣天气下的鲁棒性，在多个泛化基准上取得 SOTA。

**[Advancing Multi-Agent Traffic Simulation Via R1-Style Reinforcement Fine-Tuning](autonomous_driving/advancing_multi-agent_traffic_simulation_via_r1-style_reinforcement_fine-tuning.md)**
...
**[Bridgedrive Diffusion Bridge Policy For Closed-Loop Trajectory Planning In Auton](autonomous_driving/bridgedrive_diffusion_bridge_policy_for_closed-loop_trajectory_planning_in_auton.md)**
...
**[Drivinggen A Comprehensive Benchmark For Generative Video World Models In Autono](autonomous_driving/drivinggen_a_comprehensive_benchmark_for_generative_video_world_models_in_autono.md)**
...
**[Marc Memory-Augmented Rl Token Compression For Efficient Video Un](autonomous_driving/marc_memory-augmented_rl_token_compression_for_efficient_video_un.md)**
...
**[Multi-Head Low-Rank Attention](autonomous_driving/multi-head_low-rank_attention.md)**
...
**[Segment Any Events With Language](autonomous_driving/segment_any_events_with_language.md)**
...
**[Simo Single-Modality-Operable Multimodal Collaborative Perceptio](autonomous_driving/simo_single-modality-operable_multimodal_collaborative_perceptio.md)**
...
**[Steerable Adversarial Scenario Generation Through Test-Time Preference Alignment](autonomous_driving/steerable_adversarial_scenario_generation_through_test-time_preference_alignment.md)**
...
**[Beyond Scattered Acceptance Fast And Coherent Inference For Dlms Via Longest Sta](image_restoration/beyond_scattered_acceptance_fast_and_coherent_inference_for_dlms_via_longest_sta.md)**
...
**[Generalizing Linear Autoencoder Recommenders With Decoupled Expec](image_restoration/generalizing_linear_autoencoder_recommenders_with_decoupled_expec.md)**
...
**[Skip To The Good Part Representation Structure Inference-Time Layer Skipping In ](image_restoration/skip_to_the_good_part_representation_structure_inference-time_layer_skipping_in_.md)**
...
**[Toward Safer Diffusion Language Models Discovery And Mitigation Of Priming Vulne](image_restoration/toward_safer_diffusion_language_models_discovery_and_mitigation_of_priming_vulne.md)**
...
**[Trust But Verify Adaptive Conditioning For Reference-Based Diffusion Super-Resol](image_restoration/trust_but_verify_adaptive_conditioning_for_reference-based_diffusion_super-resol.md)**
...
**[Gaussian Certified Unlearning](llm_safety/gaussian_certified_unlearning.md)**
...
**[How Far Are Llms From Professional Poker Players Revisiting Game-Theoretic Reaso](llm_safety/how_far_are_llms_from_professional_poker_players_revisiting_game-theoretic_reaso.md)**
...
**[Lh-Deception Simulating And Understanding Llm Deceptive Behaviors In Long-Horizo](llm_safety/lh-deception_simulating_and_understanding_llm_deceptive_behaviors_in_long-horizo.md)**
...
**[Perturbation-Induced Linearization Constructing Unlearnable Data With Solely Lin](llm_safety/perturbation-induced_linearization_constructing_unlearnable_data_with_solely_lin.md)**

:   提出PIL方法，仅使用无偏置线性分类器作为代理模型生成不可学习扰动，通过诱导深度模型线性化来阻止其学习语义特征，比现有方法快100倍以上（CIFAR-10上不到1分钟GPU时间）。

**[Redirection For Erasing Memory Rem Towards A Universal Unlearning Method For Cor](llm_safety/redirection_for_erasing_memory_rem_towards_a_universal_unlearning_method_for_cor.md)**
...
**[Understanding Sensitivity Of Differential Attention Through The Lens Of Adversar](llm_safety/understanding_sensitivity_of_differential_attention_through_the_lens_of_adversar.md)**
...
**[Understanding Sensitivity Of Differential Attention Through The Lens Of Softmax ](llm_safety/understanding_sensitivity_of_differential_attention_through_the_lens_of_softmax_.md)**
...
**[Veritrail Closed-Domain Hallucination Detection With Traceable Evidence Synthes](llm_safety/veritrail_closed-domain_hallucination_detection_with_traceable_evidence_synthes.md)**
...
**[Difficult Examples Hurt Unsupervised Contrastive Learning A Theoretical Perspect](self_supervised/difficult_examples_hurt_unsupervised_contrastive_learning_a_theoretical_perspect.md)**
...
**[Enhancing Molecular Property Predictions By Learning From Bond Modelling And Int](self_supervised/enhancing_molecular_property_predictions_by_learning_from_bond_modelling_and_int.md)**

:   提出 DeMol 双图增强多尺度交互框架，通过并行的原子中心图和键中心图通道以及 Double-Helix Blocks 显式建模原子-原子、原子-键、键-键三类交互，在 PCQM4Mv2、OC20、QM9 等基准上取得 SOTA。

**[Fly-Cl A Fly-Inspired Framework For Enhancing Efficient Decorrelation And Reduce](self_supervised/fly-cl_a_fly-inspired_framework_for_enhancing_efficient_decorrelation_and_reduce.md)**
...
**[No Other Representation Component Is Needed Diffusion Transformers Can Provide R](self_supervised/no_other_representation_component_is_needed_diffusion_transformers_can_provide_r.md)**
...
**[Regularized Latent Dynamics Prediction Is A Strong Baseline For Behavioral Found](self_supervised/regularized_latent_dynamics_prediction_is_a_strong_baseline_for_behavioral_found.md)**
...
**[Snap-Uq Self-Supervised Next-Activation Prediction For Single-Pass Uncertainty I](self_supervised/snap-uq_self-supervised_next-activation_prediction_for_single-pass_uncertainty_i.md)**
...
**[Why Prototypes Collapse Diagnosing And Preventing Partial Collapse In Prototypic](self_supervised/why_prototypes_collapse_diagnosing_and_preventing_partial_collapse_in_prototypic.md)**
...
**[Efficient-Sam2 Accelerating Sam2 With Object-Aware Visual Encoding And Memory Re](segmentation/efficient-sam2_accelerating_sam2_with_object-aware_visual_encoding_and_memory_re.md)**
...
**[Bilinear Representation Mitigates Reversal Curse And Enables Consistent Model Ed](knowledge_editing/bilinear_representation_mitigates_reversal_curse_and_enables_consistent_model_ed.md)**
...
**[When Large Multimodal Models Confront Evolving Knowledge Challenges And Explorat](knowledge_editing/when_large_multimodal_models_confront_evolving_knowledge_challenges_and_explorat.md)**
...
**[C2Al Cohort-Contrastive Auxiliary Learning For Large-Scale Recommendation System](recommender/c2al_cohort-contrastive_auxiliary_learning_for_large-scale_recommendation_system.md)**
...
**[In Agents We Trust But Who Do Agents Trust Latent Source Preferences Steer Llm G](recommender/in_agents_we_trust_but_who_do_agents_trust_latent_source_preferences_steer_llm_g.md)**

:   通过对12个LLM在新闻、学术、电商三个领域的大规模控制实验，揭示了LLM存在系统性的**隐式信息源偏好**（latent source preferences），这种偏好可以压倒内容本身的影响，且无法通过简单提示消除。

**[Propersim Developing Proactive And Personalized Ai Assistants Through User-Assis](recommender/propersim_developing_proactive_and_personalized_ai_assistants_through_user-assis.md)**
...
**[Rae A Neural Network Dimensionality Reduction Method For Nearest Neighbors Prese](recommender/rae_a_neural_network_dimensionality_reduction_method_for_nearest_neighbors_prese.md)**
...
**[Rejuvenating Cross-Entropy Loss In Knowledge Distillation For Recommender System](recommender/rejuvenating_cross-entropy_loss_in_knowledge_distillation_for_recommender_system.md)**
...
**[Functional Embeddings Enable Aggregation Of Multi-Area Seeg Recordings Over Subj](social_computing/functional_embeddings_enable_aggregation_of_multi-area_seeg_recordings_over_subj.md)**
...
**[Empirical Stability Analysis Of Kolmogorov-Arnold Networks In Hard-Constrained R](scientific_computing/empirical_stability_analysis_of_kolmogorov-arnold_networks_in_hard-constrained_r.md)**
...
**[Hyperkkl Enabling Non-Autonomous State Estimation Through Dynamic Weight Conditi](scientific_computing/hyperkkl_enabling_non-autonomous_state_estimation_through_dynamic_weight_conditi.md)**
...
**[One Operator To Rule Them All On Boundary-Indexed Operator Families In Neural Pd](scientific_computing/one_operator_to_rule_them_all_on_boundary-indexed_operator_families_in_neural_pd.md)**

:   论证神经 PDE 求解器在边界条件变化时学到的不是单一的解算子，而是由边界条件索引的算子族，并从学习理论角度形式化了 ERM 下边界分布偏移导致的不可辨识性问题。

**[Policy Myopia As A Mechanism Of Gradual Disempowerment In Post-Agi Governance Ci](scientific_computing/policy_myopia_as_a_mechanism_of_gradual_disempowerment_in_post-agi_governance_ci.md)**
...
**[Group Representational Position Encoding](signal_comm/group_representational_position_encoding.md)**
...
**[Spectrum Tuning Post-Training For Distributional Coverage And In-Context Steerab](signal_comm/spectrum_tuning_post-training_for_distributional_coverage_and_in-context_steerab.md)**
...
**[Atlas Adaptive Transfer Scaling Laws For Multilingual Pretraining Finetuning And](multilingual_mt/atlas_adaptive_transfer_scaling_laws_for_multilingual_pretraining_finetuning_and.md)**
...
**[Prior-Based Noisy Text Data Filtering Fast And Strong Alternative To Perplexity](multilingual_mt/prior-based_noisy_text_data_filtering_fast_and_strong_alternative_to_perplexity.md)**

:   提出基于 token 先验（词频统计）的文本数据过滤方法，利用文档内 token 先验的均值和标准差作为 PPL 的近似替代，在 20 个下游基准上取得最高平均性能，同时比 PPL 过滤快 1000 倍以上。

**[Sasft Sparse Autoencoder-Guided Supervised Finetuning To Mitigate Unexpected Cod](multilingual_mt/sasft_sparse_autoencoder-guided_supervised_finetuning_to_mitigate_unexpected_cod.md)**
...
**[Spectral Gaps And Spatial Priors Studying Hyperspectral Downstream Adaptation Us](remote_sensing/spectral_gaps_and_spatial_priors_studying_hyperspectral_downstream_adaptation_us.md)**

:   研究未经高光谱预训练的多模态地理空间基础模型 TerraMind 能否通过通道适配策略（朴素波段选择 vs. SRF 分组）有效适配高光谱下游任务，结果表明朴素波段选择一致优于物理感知的 SRF 方法，但性能差距随任务光谱复杂度增大而扩大。

**[Tamms Change Understanding And Forecasting In Satellite Image Time Series With T](remote_sensing/tamms_change_understanding_and_forecasting_in_satellite_image_time_series_with_t.md)**
...
**[Clarc Cc Benchmark For Robust Code Search](aigc_detection/clarc_cc_benchmark_for_robust_code_search.md)**
...
**[Death Of The Novelty Beyond N-Gram Novelty As A Metric For Textual Creativity](aigc_detection/death_of_the_novelty_beyond_n-gram_novelty_as_a_metric_for_textual_creativity.md)**
...
**[Fs-Dfm Fast And Accurate Long Text Generation With Few-Step Diffusion Language M](nlp_generation/fs-dfm_fast_and_accurate_long_text_generation_with_few-step_diffusion_language_m.md)**
...
**[A Federated Generalized Expectation-Maximization Algorithm For Mixture Models Wi](others/a_federated_generalized_expectation-maximization_algorithm_for_mixture_models_wi.md)**
...
**[Addressing Divergent Representations Causal](others/addressing_divergent_representations_causal.md)**
...
**[Agnostics Learning To Code In Any Programming Language Via Reinforcement With A ](others/agnostics_learning_to_code_in_any_programming_language_via_reinforcement_with_a_.md)**
...
**[An Information-Theoretic Framework For Optimizing Experimental Design To Disting](others/an_information-theoretic_framework_for_optimizing_experimental_design_to_disting.md)**
...
**[Ano Faster Is Better In Noisy Landscape](others/ano_faster_is_better_in_noisy_landscape.md)**
...
**[Characterizing And Optimizing The Spatial Kernel Of Multi Resolution Hash Encodi](others/characterizing_and_optimizing_the_spatial_kernel_of_multi_resolution_hash_encodi.md)**
...
**[Chlu The Causal Hamiltonian Learning Unit As A Symplectic Primitive For Deep Lea](others/chlu_the_causal_hamiltonian_learning_unit_as_a_symplectic_primitive_for_deep_lea.md)**

:   CHLU 是一种基于相对论哈密顿力学和辛积分的计算学习原语，通过强制相空间体积守恒和引入因果速度上限，解决了 LSTM 的梯度爆炸/消失和 Neural ODE 的信息耗散问题，实现无限时域稳定性和热力学生成能力。

**[Completing Missing Annotation Multi-Agent Debate For Accurate And Scalable Relev](others/completing_missing_annotation_multi-agent_debate_for_accurate_and_scalable_relev.md)**
...
**[Compositional Diffusion Long Horizon Planning](others/compositional_diffusion_long_horizon_planning.md)**
...
**[Directional Sheaf Hypergraph Networks Unifying Learning On Directed And Undirect](others/directional_sheaf_hypergraph_networks_unifying_learning_on_directed_and_undirect.md)**
...
**[Distributionally Robust Classification For Multi-Source Unsupervised Domain Adap](others/distributionally_robust_classification_for_multi-source_unsupervised_domain_adap.md)**

:   提出一种分布鲁棒学习框架，通过联合建模目标域协变量分布和条件标签分布的不确定性，在目标数据极度稀缺或源域存在虚假相关性的UDA场景中显著提升泛化性能。

**[Distributions As Actions A Unified Framework For Diverse Action Spaces](others/distributions_as_actions_a_unified_framework_for_diverse_action_spaces.md)**
...
**[Enhancing Generative Auto Bidding](others/enhancing_generative_auto_bidding.md)**
...
**[Evaluating Gflownet From Partial Episodes For Stable And Flexible Policy-Based T](others/evaluating_gflownet_from_partial_episodes_for_stable_and_flexible_policy-based_t.md)**

:   建立GFlowNet中状态流函数与策略评价函数之间的理论联系，提出子轨迹评价平衡（Sub-EB）目标用于可靠学习评价函数，增强策略基GFlowNet训练的稳定性和灵活性。

**[Exchangeability Gnn Representations](others/exchangeability_gnn_representations.md)**
...
**[Fast And Stable Riemannian Metrics On Spd Manifolds Via Cholesky Product Geometr](others/fast_and_stable_riemannian_metrics_on_spd_manifolds_via_cholesky_product_geometr.md)**

:   揭示Cholesky流形上的简单乘积结构，基于此提出两种快速且数值稳定的SPD度量（PCM和BWCM），所有黎曼算子均有闭式表达式，在SPD深度学习中实现效果、效率和稳定性的三重提升。

**[Fastlsq Solving Pdes In One Shot Via Fourier Features With Exact Analytical Deri](others/fastlsq_solving_pdes_in_one_shot_via_fourier_features_with_exact_analytical_deri.md)**
...
**[Fire Frobenius Isometry Reinitialization](others/fire_frobenius_isometry_reinitialization.md)**
...
**[From Movement To Cognitive Maps](others/from_movement_to_cognitive_maps.md)**
...
**[Implicit Bias Of Per-Sample Adam On Separable Data Departure From The Full-Batch](others/implicit_bias_of_per-sample_adam_on_separable_data_departure_from_the_full-batch.md)**
...
**[Jackpot Optimal Budgeted Rejection Sampling For Extreme Actor-Policy Mismatch Re](others/jackpot_optimal_budgeted_rejection_sampling_for_extreme_actor-policy_mismatch_re.md)**
...
**[Key And Value Weights Are Probably All You Need On The Necessity Of The Query Ke](others/key_and_value_weights_are_probably_all_you_need_on_the_necessity_of_the_query_ke.md)**

:   理论证明Transformer自注意力中Query/Key/Value权重三元组存在冗余——Query权重可被替换为单位矩阵（减少25%注意力参数），GPT风格模型从头训练验证在适当超参数调整下性能不降，且训练在3倍更低权重衰减下仍然稳定。

**[Latent Equivariant Operators For Robust Object Recognition Promises And Challeng](others/latent_equivariant_operators_for_robust_object_recognition_promises_and_challeng.md)**
...
**[Latent Particle World Models Self-Supervised Object-Centric Stochastic Dynamics ](others/latent_particle_world_models_self-supervised_object-centric_stochastic_dynamics_.md)**
...
**[Learning Adaptive Distribution Alignment With Neural Characteristic Function For](others/learning_adaptive_distribution_alignment_with_neural_characteristic_function_for.md)**

:   提出ADAlign框架，利用神经特征函数在谱域自适应对齐源/目标图分布——无需手动选择对齐标准，自动识别每个迁移场景中最显著的分布差异。在10个数据集16个迁移任务上达SOTA，同时降低内存和训练时间。

**[Learning On A Razors Edge Identifiability And Singularity Of Polynomial Neural N](others/learning_on_a_razors_edge_identifiability_and_singularity_of_polynomial_neural_n.md)**
...
**[Lipnext Scaling Up Lipschitz-Based Certified Robustness To Billion-Parameter Mod](others/lipnext_scaling_up_lipschitz-based_certified_robustness_to_billion-parameter_mod.md)**
...
**[On The Lipschitz Continuity Of Set Aggregation Functions And Neural Networks For](others/on_the_lipschitz_continuity_of_set_aggregation_functions_and_neural_networks_for.md)**
...
**[Oversmoothing Oversquashing Heterophily Long-Range And More Demystifying Common ](others/oversmoothing_oversquashing_heterophily_long-range_and_more_demystifying_common_.md)**
...
**[Revisiting Sharpness-Aware Minimization A More Faithful And Effective Implementa](others/revisiting_sharpness-aware_minimization_a_more_faithful_and_effective_implementa.md)**

:   对 SAM 的底层机制提出新的直觉解释——扰动点梯度近似局部最大值方向，并揭示其不精确性及多步退化问题，进而提出 XSAM 通过显式估计最大值方向实现更忠实更有效的锐度感知最小化。

**[Scalable Random Wavelet Features Efficient Non-Stationary Kernel Approximation W](others/scalable_random_wavelet_features_efficient_non-stationary_kernel_approximation_w.md)**
...
**[Speculative Actions Faster Ai Agents](others/speculative_actions_faster_ai_agents.md)**
...
**[The Hot Mess Of Ai How Does Misalignment Scale With Model Intelligence And Task ](others/the_hot_mess_of_ai_how_does_misalignment_scale_with_model_intelligence_and_task_.md)**
