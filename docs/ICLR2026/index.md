...
title: >-
  ICLR2026 1519篇论文解读
description: >-
  1519篇ICLR2026论文深度解读，每篇5分钟读懂核心思想。覆盖图像生成、强化学习、模型压缩、医学图像、多模态VLM、3D视觉等44个研究领域，每篇笔记含一句话总结、背景动机、方法详解、实验数据、亮点洞察与局限性分析。
---

<!-- 由 src/gen_blog_index.py 自动生成 -->
# 🔬 ICLR2026 论文笔记

**1519** 篇论文解读，覆盖 **44** 个领域。
...
**[Frame Guidance Training-Free Guidance For Frame-Level Control In Video Diffusion](video_generation/frame_guidance_training-free_guidance_for_frame-level_control_in_video_diffusion.md)**
...
**[Javisdit Joint Audio-Video Diffusion Transformer With Hierarchical Spatio-Tempor](video_generation/javisdit_joint_audio-video_diffusion_transformer_with_hierarchical_spatio-tempor.md)**
...
**[Lora-Edit Controllable First-Frame-Guided Video Editing Via Mask-Aware Lora Fine](video_generation/lora-edit_controllable_first-frame-guided_video_editing_via_mask-aware_lora_fine.md)**

:   提出 LoRA-Edit，利用时空 mask 引导 LoRA 微调预训练 I2V 模型，实现可控的首帧引导视频编辑——mask 同时作为编辑区域指令和 LoRA 学习内容的引导信号，支持运动继承和外观控制。

**[Lumos-1 On Autoregressive Video Generation With Discrete Diffusion From A Unifie](video_generation/lumos-1_on_autoregressive_video_generation_with_discrete_diffusion_from_a_unifie.md)**
...
**[Precisecache Precise Feature Caching For Efficient And High-Fidelity Video Gener](video_generation/precisecache_precise_feature_caching_for_efficient_and_high-fidelity_video_gener.md)**
...
**[Quantsparse Comprehensively Compressing Video Diffusion Transformer With Model Q](video_generation/quantsparse_comprehensively_compressing_video_diffusion_transformer_with_model_q.md)**
...
**[Sigmark Scalable In-Generation Watermark With Blind Extraction For Video Diffusi](video_generation/sigmark_scalable_in-generation_watermark_with_blind_extraction_for_video_diffusi.md)**
