---
description: "【论文笔记】Optimistic Task Inference for Behavior Foundation Models 论文解读 | ICLR 2026 Oral | arXiv 2510.20264 | behavior foundation models | 提出 OpTI-BFM——在 Behavior Foundation Model 测试时，不需要完整奖励函数或标注数据集，而是通过与环境交互仅 5 个 episode 即可推断任务并恢复 Oracle 性能，核心是利用 successor features 的线性结构将任务推断归约为线性 bandit 问题并用 UCB 策略乐观探索，提供正式的 regret bound。"
tags:
  - ICLR 2026 Oral
