...
**[Arm-Fm Automated Reward Machines Via Foundation Models For Compositional Reinfor](arm-fm_automated_reward_machines_via_foundation_models_for_compositional_reinfor.md)**
...
**[Bayes Adaptive Monte Carlo Tree Search For Offline Model-Based Reinforcement Lea](bayes_adaptive_monte_carlo_tree_search_for_offline_model-based_reinforcement_lea.md)**
...
**[Breaking Barriers Do Reinforcement Post Training Gains Transfer To Unseen Domain](breaking_barriers_do_reinforcement_post_training_gains_transfer_to_unseen_domain.md)**
...
**[Co-Rewarding Stable Self-Supervised Rl For Eliciting Reasoning In Large Language](co-rewarding_stable_self-supervised_rl_for_eliciting_reasoning_in_large_language.md)**
...
**[Distributionally Robust Cooperative Multi-Agent Reinforcement Learning Via Robus](distributionally_robust_cooperative_multi-agent_reinforcement_learning_via_robus.md)**
...
**[Divide Harmonize Then Conquer It Shooting Multi-Commodity Flow Problems With Mul](divide_harmonize_then_conquer_it_shooting_multi-commodity_flow_problems_with_mul.md)**
...
**[Dont Just Fine-Tune The Agent Tune The Environment](dont_just_fine-tune_the_agent_tune_the_environment.md)**
...
**[Egg-Sr Embedding Symbolic Equivalence Into Symbolic Regression Via Equality Grap](egg-sr_embedding_symbolic_equivalence_into_symbolic_regression_via_equality_grap.md)**
...
**[Emergence Of Spatial Representation In An Actor-Critic Agent With Hippocampus-In](emergence_of_spatial_representation_in_an_actor-critic_agent_with_hippocampus-in.md)**
...
**[Entropy-Preserving Reinforcement Learning](entropy-preserving_reinforcement_learning.md)**
...
**[Exploration Vs Exploitation Rethinking Rlvr Through Clipping Entropy And Spuriou](exploration_vs_exploitation_rethinking_rlvr_through_clipping_entropy_and_spuriou.md)**
...
**[Flow Actor-Critic For Offline Reinforcement Learning](flow_actor-critic_for_offline_reinforcement_learning.md)**
...
**[From Verifiable Dot To Reward Chain Harnessing Verifiable Reference-Based Reward](from_verifiable_dot_to_reward_chain_harnessing_verifiable_reference-based_reward.md)**
...
**[Laddersym A Multimodal Interleaved Transformer For Music Practice Error Detectio](laddersym_a_multimodal_interleaved_transformer_for_music_practice_error_detectio.md)**
...
**[Momagen Generating Demonstrations Under Soft And Hard Constraints For Multi-Step](momagen_generating_demonstrations_under_soft_and_hard_constraints_for_multi-step.md)**
...
**[Near-Optimal Second-Order Guarantees For Model-Based Adversarial Imitation Learn](near-optimal_second-order_guarantees_for_model-based_adversarial_imitation_learn.md)**
...
**[On The O1T Convergence Of Alternating Gradient Descent-Ascent In Bilinear Games](on_the_o1t_convergence_of_alternating_gradient_descent-ascent_in_bilinear_games.md)**
...
**[Optimistic Task Inference Behavior Models](optimistic_task_inference_behavior_models.md)**
...
**[Paras2S Benchmarking And Aligning Spoken Language Models For Paralinguistic-Awar](paras2s_benchmarking_and_aligning_spoken_language_models_for_paralinguistic-awar.md)**
...
**[Pruning As A Cooperative Game Surrogate-Assisted Layer Contribution Estimation F](pruning_as_a_cooperative_game_surrogate-assisted_layer_contribution_estimation_f.md)**
...
**[Revisiting Matrix Sketching In Linear Bandits Achieving Sublinear Regret Via Dya](revisiting_matrix_sketching_in_linear_bandits_achieving_sublinear_regret_via_dya.md)**
...
**[Rewardmap Tackling Sparse Rewards In Fine-Grained Visual Reasoning Via Multi-Sta](rewardmap_tackling_sparse_rewards_in_fine-grained_visual_reasoning_via_multi-sta.md)**
...
**[Self-Harmony Learning To Harmonize Self-Supervision And Self-Play In Test-Time R](self-harmony_learning_to_harmonize_self-supervision_and_self-play_in_test-time_r.md)**
...
**[Shop-R1 Rewarding Llms To Simulate Human Behavior In Online Shopping Via Reinfor](shop-r1_rewarding_llms_to_simulate_human_behavior_in_online_shopping_via_reinfor.md)**

:   提出 Shop-R1 框架，通过分层奖励机制和难度感知缩放的强化学习方法，显著提升 LLM 模拟真实人类在线购物行为的能力，相比 SFT 基线精确匹配提升超过 65%。

**[Single Index Bandits Generalized Linear Contextual Bandits With Unknown Reward F](single_index_bandits_generalized_linear_contextual_bandits_with_unknown_reward_f.md)**

:   提出单指标赌博机（SIB）问题——将广义线性赌博机扩展到奖励函数未知的设定，基于 Stein 方法设计了一族高效算法（STOR/ESTOR/GSTOR），在单调递增奖励函数下实现了近最优遗憾界 $\tilde{O}(\sqrt{T})$。

**[Solving Football By Exploiting Equilibrium Structure Of 2P0S Differential Games ](solving_football_by_exploiting_equilibrium_structure_of_2p0s_differential_games_.md)**
...
**[Solving Parameter-Robust Avoid Problems With Unknown Feasibility Using Reinforce](solving_parameter-robust_avoid_problems_with_unknown_feasibility_using_reinforce.md)**
...
**[Spiral Self-Play On Zero-Sum Games Incentivizes Reasoning Via Multi-Agent Multi-](spiral_self-play_on_zero-sum_games_incentivizes_reasoning_via_multi-agent_multi-.md)**
...
**[Stackelberg Coupling Of Online Representation Learning And Reinforcement Learnin](stackelberg_coupling_of_online_representation_learning_and_reinforcement_learnin.md)**
...
**[Stop Unnecessary Reflection Training Lrms For Efficient Reasoning With Adaptive ](stop_unnecessary_reflection_training_lrms_for_efficient_reasoning_with_adaptive_.md)**
...
**[Strict Subgoal Execution Reliable Long-Horizon Planning In Hierarchical Reinforc](strict_subgoal_execution_reliable_long-horizon_planning_in_hierarchical_reinforc.md)**
...
**[Textbfre2 Unlocking Llm Reasoning Via Reinforcement Learning With Re-Solving](textbfre2_unlocking_llm_reasoning_via_reinforcement_learning_with_re-solving.md)**
...
**[Traced Transition-Aware Regret Approximation With Co-Learnability For Environmen](traced_transition-aware_regret_approximation_with_co-learnability_for_environmen.md)**
...
**[Unveiling The Cognitive Compass Theory-Of-Mind-Guided Multimodal Emotion Reasoni](unveiling_the_cognitive_compass_theory-of-mind-guided_multimodal_emotion_reasoni.md)**
...
**[Verifybench Benchmarking Reference-Based Reward Systems For Large Language Model](verifybench_benchmarking_reference-based_reward_systems_for_large_language_model.md)**
...
**[Vtool-R1 Vlms Learn To Think With Images Via Reinforcement Learning On Multimoda](vtool-r1_vlms_learn_to_think_with_images_via_reinforcement_learning_on_multimoda.md)**

:   提出 VTool-R1，首个通过强化学习微调训练 VLM 生成交错文本和视觉中间推理步骤的框架，使模型学会"用图像思考"。

**[Whatever Remains Must Be True Filtering Drives Reasoning In Llms Shaping Diversi](whatever_remains_must_be_true_filtering_drives_reasoning_in_llms_shaping_diversi.md)**
...
**[Wimle Uncertainty-Aware World Models With Imle For Sample-Efficient Continuous C](wimle_uncertainty-aware_world_models_with_imle_for_sample-efficient_continuous_c.md)**
