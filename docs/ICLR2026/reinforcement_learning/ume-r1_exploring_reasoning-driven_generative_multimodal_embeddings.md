---
description: "【论文笔记】UME-R1: Exploring Reasoning-Driven Generative Multimodal Embeddings 论文解读 | ICLR 2026 | arXiv 2511.00405 | 多模态 multimodal embeddings | 提出 UME-R1，首次探索推理驱动的生成式多模态嵌入范式，通过两阶段训练（冷启动SFT + 强化学习）让嵌入模型先推理再生成表示，在 MMEB-V2 基准的 78 个任务上显著超越传统判别式嵌入模型。"
tags:
  - ICLR 2026
  - 多模态
