---
title: >-
  ICLR2026 图学习方向 22篇论文解读
description: >-
  22篇ICLR2026 图学习方向论文深度解读，每篇5分钟读懂核心思想。每篇笔记含一句话总结、背景动机、方法详解、实验数据、亮点洞察与局限性分析。
---
...
**[Explore-On-Graph Incentivizing Autonomous Exploration Of Large Language Models O](explore-on-graph_incentivizing_autonomous_exploration_of_large_language_models_o.md)**

:   提出 Explore-on-Graph（EoG），通过 SFT + 两阶段强化学习（结果奖励 + 路径精炼奖励），激励 LLM 在知识图谱上自主探索超出训练分布的推理路径，在五个 KGQA 基准上超越 GPT-5 和 Gemini 2.5 Pro。

**[Graph Homophily Booster Reimagining The Role Of Discrete Features In Heterophili](graph_homophily_booster_reimagining_the_role_of_discrete_features_in_heterophili.md)**
...
**[Improving Long-Range Interactions In Graph Neural Simulators Via Hamiltonian Dyn](improving_long-range_interactions_in_graph_neural_simulators_via_hamiltonian_dyn.md)**
...
**[Neurocircuitry-Inspired Hierarchical Graph Causal Attention Networks For Explain](neurocircuitry-inspired_hierarchical_graph_causal_attention_networks_for_explain.md)**
...
**[Structurally Human Semantically Biased Detecting Llm-Generated References With E](structurally_human_semantically_biased_detecting_llm-generated_references_with_e.md)**
